...
export interface IGlobalVars {
  ...
  get basic_BaseboardDepthLogic(): string;
  get basic_BaseboardSplitLogic(): string;
  get basic_BaseboardOverdimensionBack(): number;
  get basic_BaseboardOverdimensionLeft(): number;
  get basic_BaseboardOverdimensionRight(): number;
  get basic_BaseboardThk(): number;
  get basic_CornerunitDimensionLogic(): string;
  get basic_CornerunitStraightDimensionLogic(): string;
  get basic_UprightThk(): number;
  get basic_FrontColor(): string;
  get basic_CarcaseColor(): string;
  get basic_CarcaseOutsideColor(): string;
  get basic_CarcaseBackwallColor(): string;
  get basic_CarcaseEdgeBackColor(): string;
  get basic_CarcaseEdgeFrontColor(): string;
  get basic_CarcaseEdgeColor(): string;
  get basic_FrontEdgeColor(): string;
  get basic_PaneltopConstruction(): string;
  get basic_CarcaseVisLeftSelection(): string;
  get basic_CarcaseVisRightSelection(): string;
  get basic_PlinthAreaVisLeftSelection(): string;
  get basic_PlinthAreaVisRightSelection(): string;
  get basic_CarcaseOverdimensionBackLogic(): string;
  get basic_CeilingAreaVisLeftSelection(): string;
  get basic_CeilingAreaVisRightSelection(): string;
  get basic_CeilingFillerConstruction(): string;
...
export class GlobalVars {
  constructor(setGlobalVarsWithExceptions: boolean = false) {
    if (setGlobalVarsWithExceptions) {
      this.setDefaultValuesForGlobalVarsWithExceptions();
    }
  }
  ...
  getAttributes(): Map<string, any> {
    ...
    res.set('basic_BaseboardDepthLogic', this._basic_BaseboardDepthLogic);
    res.set('basic_BaseboardSplitLogic', this._basic_BaseboardSplitLogic);
    res.set('basic_BaseboardOverdimensionBack', this._basic_BaseboardOverdimensionBack);
    res.set('basic_BaseboardOverdimensionLeft', this._basic_BaseboardOverdimensionLeft);
    res.set('basic_BaseboardOverdimensionRight', this._basic_BaseboardOverdimensionRight);
    res.set('basic_BaseboardThk', this._basic_BaseboardThk);
    res.set('basic_CornerunitDimensionLogic', this._basic_CornerunitDimensionLogic);
    res.set('basic_CornerunitStraightDimensionLogic', this._basic_CornerunitStraightDimensionLogic);
    res.set('basic_UprightThk', this._basic_UprightThk);
    res.set('basic_FrontColor', this._basic_FrontColor);
    res.set('basic_CarcaseColor', this._basic_CarcaseColor);
    res.set('basic_CarcaseOutsideColor', this._basic_CarcaseOutsideColor);
    res.set('basic_CarcaseBackwallColor', this._basic_CarcaseBackwallColor);
    res.set('basic_CarcaseEdgeBackColor', this._basic_CarcaseEdgeBackColor);
    res.set('basic_CarcaseEdgeFrontColor', this._basic_CarcaseEdgeFrontColor);
    res.set('basic_CarcaseEdgeColor', this._basic_CarcaseEdgeColor);
    res.set('basic_FrontEdgeColor', this._basic_FrontEdgeColor);
    res.set('basic_PaneltopConstruction', this._basic_PaneltopConstruction);
    res.set('basic_CarcaseVisLeftSelection', this._basic_CarcaseVisLeftSelection);
    res.set('basic_CarcaseVisRightSelection', this._basic_CarcaseVisRightSelection);
    res.set('basic_PlinthAreaVisLeftSelection', this._basic_PlinthAreaVisLeftSelection);
    res.set('basic_PlinthAreaVisRightSelection', this._basic_PlinthAreaVisRightSelection);
    res.set('basic_CarcaseOverdimensionBackLogic', this._basic_CarcaseOverdimensionBackLogic);
    res.set('basic_CeilingAreaVisLeftSelection', this._basic_CeilingAreaVisLeftSelection);
    res.set('basic_CeilingAreaVisRightSelection', this._basic_CeilingAreaVisRightSelection);
    res.set('basic_CeilingFillerConstruction', this._basic_CeilingFillerConstruction);
  ...
  _basic_RailverttopfrontOffsetFront?: number;
  ...
  _basic_CarcaseShelftopConstruction?: string;
  ...
  _basic_ShelfadjDrillDistance: number = 0;
  ...
  _basic_CarcaseBackwallConstruction?: string;
  ...
  _basic_ShelfadjDesign: string = "Automatic";
  ...
  _basic_PlinthAreaDesign?: string;
  ...
  _basic_SidepanelmiddleShortWidth?: number;
  ...
  _basic_SidepanelmiddleThk?: number;
  ...
  _basic_FrontDesign: string = "Standard";
  ...
  _basic_SlopedCeilingDimensionLogic?: string;
  ...
  _basic_BaseboardSplitLogic: string = "BetweenCabinets";
  get basic_BaseboardSplitLogic(): string { this.checkMsg('basic_BaseboardSplitLogic'); return this._basic_BaseboardSplitLogic; }
  _basic_BaseboardOverdimensionBack: number = 0;
  get basic_BaseboardOverdimensionBack(): number { this.checkMsg('basic_BaseboardOverdimensionBack'); return this._basic_BaseboardOverdimensionBack; }
  _basic_BaseboardOverdimensionLeft: number = 0;
  get basic_BaseboardOverdimensionLeft(): number { this.checkMsg('basic_BaseboardOverdimensionLeft'); return this._basic_BaseboardOverdimensionLeft; }
  _basic_BaseboardOverdimensionRight: number = 0;
  get basic_BaseboardOverdimensionRight(): number { this.checkMsg('basic_BaseboardOverdimensionRight'); return this._basic_BaseboardOverdimensionRight; }
  _basic_BaseboardThk: number = 19;
  get basic_BaseboardThk(): number { this.checkMsg('basic_BaseboardThk'); return this._basic_BaseboardThk; }
  _basic_CornerunitDimensionLogic: string = "BasedInFrontDimension";
  get basic_CornerunitDimensionLogic(): string { this.checkMsg('basic_CornerunitDimensionLogic'); return this._basic_CornerunitDimensionLogic; }
  _basic_CornerunitStraightDimensionLogic: string = "Standard";
  get basic_CornerunitStraightDimensionLogic(): string { this.checkMsg('basic_CornerunitStraightDimensionLogic'); return this._basic_CornerunitStraightDimensionLogic; }
  _basic_UprightThk: number = 19;
  get basic_UprightThk(): number { this.checkMsg('basic_UprightThk'); return this._basic_UprightThk; }
  _basic_FrontColor: string = "240";
  get basic_FrontColor(): string { this.checkMsg('basic_FrontColor'); return this._basic_FrontColor; }
  _basic_CarcaseColor: string = "178";
  get basic_CarcaseColor(): string { this.checkMsg('basic_CarcaseColor'); return this._basic_CarcaseColor; }
  _basic_CarcaseOutsideColor: string = "178";
  get basic_CarcaseOutsideColor(): string { this.checkMsg('basic_CarcaseOutsideColor'); return this._basic_CarcaseOutsideColor; }
  _basic_CarcaseBackwallColor: string = "178";
  get basic_CarcaseBackwallColor(): string { this.checkMsg('basic_CarcaseBackwallColor'); return this._basic_CarcaseBackwallColor; }
  _basic_CarcaseEdgeBackColor: string = "178";
  get basic_CarcaseEdgeBackColor(): string { this.checkMsg('basic_CarcaseEdgeBackColor'); return this._basic_CarcaseEdgeBackColor; }
  _basic_CarcaseEdgeFrontColor: string = "178";
  get basic_CarcaseEdgeFrontColor(): string { this.checkMsg('basic_CarcaseEdgeFrontColor'); return this._basic_CarcaseEdgeFrontColor; }
  _basic_CarcaseEdgeColor: string = "178";
  get basic_CarcaseEdgeColor(): string { this.checkMsg('basic_CarcaseEdgeColor'); return this._basic_CarcaseEdgeColor; }
  _basic_FrontEdgeColor: string = "Automatic";
  get basic_FrontEdgeColor(): string { this.checkMsg('basic_FrontEdgeColor'); return this._basic_FrontEdgeColor; }
  _basic_PaneltopConstruction: string = "Construction1";
  get basic_PaneltopConstruction(): string { this.checkMsg('basic_PaneltopConstruction'); return this._basic_PaneltopConstruction; }
  _basic_CarcaseVisLeftSelection: string = "Automatic";
  get basic_CarcaseVisLeftSelection(): string { this.checkMsg('basic_CarcaseVisLeftSelection'); return this._basic_CarcaseVisLeftSelection; }
  _basic_CarcaseVisRightSelection: string = "Automatic";
  get basic_CarcaseVisRightSelection(): string { this.checkMsg('basic_CarcaseVisRightSelection'); return this._basic_CarcaseVisRightSelection; }
  _basic_PlinthAreaVisLeftSelection: string = "Automatic";
  get basic_PlinthAreaVisLeftSelection(): string { this.checkMsg('basic_PlinthAreaVisLeftSelection'); return this._basic_PlinthAreaVisLeftSelection; }
  _basic_PlinthAreaVisRightSelection: string = "Automatic";
  get basic_PlinthAreaVisRightSelection(): string { this.checkMsg('basic_PlinthAreaVisRightSelection'); return this._basic_PlinthAreaVisRightSelection; }
  _basic_CarcaseOverdimensionBackLogic: string = "WallClosureIfVisible";
  get basic_CarcaseOverdimensionBackLogic(): string { this.checkMsg('basic_CarcaseOverdimensionBackLogic'); return this._basic_CarcaseOverdimensionBackLogic; }
  _basic_CeilingAreaVisLeftSelection: string = "Automatic";
  ...
  setDefaultValuesForGlobalVarsWithExceptions() {
    ...
    this._basic_HangerType = "NoHanger";
    this._basic_HardwareColor = "WhiteColor";
    this._basic_PlinthAreaDesign = "30";
    this._basic_FrontGapHorTop = 0;
    this._basic_SidepanelmiddleShortWidth = 47;
    this._basic_SidepanelmiddleThk = 19;
    this._basic_CountertopThk = 25;
    this._basic_HandlePosType = "03";
    this._basic_HandleColor = "StainlessSteel";
    this._basic_HandleLength = 128;
    this._basic_SlopedCeilingDimensionLogic = "FollowWallMaxHeight";
  }
  setRootModuleData(root: any, withSetExceptions: boolean = true) {
    try {
      // ###############################################################
      // ####################### CUSTOM SCRIPTS ########################
      // ###############################################################
