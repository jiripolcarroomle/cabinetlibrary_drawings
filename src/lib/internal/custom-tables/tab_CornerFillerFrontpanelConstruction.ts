...
import { ITableParents_mf_CornerFillerFront_mr_CornerFiller } from '../var-interfaces';

export interface cti_tab_CornerFillerFrontpanelConstruction {
  readonly in_ParentModule?: string;
  readonly in_CornerFillerFrontConstruction?: string;
  readonly in_CarcaseDirection?: string;
}

export interface ctm_tab_CornerFillerFrontpanelConstruction {
}

export interface cto_tab_CornerFillerFrontpanelConstruction extends ctm_tab_CornerFillerFrontpanelConstruction {
  readonly _id: number;
  readonly Module?: string;
  readonly InsertModule?: boolean;
  readonly FrontId?: string;
  readonly Direction?: string;
  Width(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number;
  Height(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number;
  Depth(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number;
  WidthPos(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number;
  HeigthPos(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number;
  DepthPos(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number;
  readonly RotationAngle: number;
  readonly RotationDirection?: string;
  RotationPointWidth(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number;
  RotationPointHeight(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number;
  RotationPointDepth(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number;
}

export interface ICT_tab_CornerFillerFrontpanelConstruction
  extends cti_tab_CornerFillerFrontpanelConstruction, cto_tab_CornerFillerFrontpanelConstruction { }

export class ct2_tab_CornerFillerFrontpanelConstruction {

  public findExactly(
    in_ParentModule: string | undefined,
    in_CornerFillerFrontConstruction: string | undefined,
    in_CarcaseDirection: string | undefined,
  ): cto_tab_CornerFillerFrontpanelConstruction | undefined {
    const res = ct_tab_CornerFillerFrontpanelConstruction.find((p) =>
      p.in_ParentModule === in_ParentModule
      && p.in_CornerFillerFrontConstruction === in_CornerFillerFrontConstruction
  ...
  public find(
    predicate: (value: cti_tab_CornerFillerFrontpanelConstruction) => boolean
  ): cto_tab_CornerFillerFrontpanelConstruction | undefined {
    for (let index = 0; index < ct_tab_CornerFillerFrontpanelConstruction.length; index++) {
      const element = ct_tab_CornerFillerFrontpanelConstruction[index];
...
export var ct_tab_CornerFillerFrontpanelConstruction: ICT_tab_CornerFillerFrontpanelConstruction[] = [
  {
    _id: 73,
    in_ParentModule: "mf_CornerFillerFront",
    in_CornerFillerFrontConstruction: "Construction01",
    in_CarcaseDirection: "Left",
    Module: "mc_CornerFillerFront01",
    InsertModule: true,
    FrontId: "CornerStraightFiller",
    Direction: "Left",
    Width(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return widthLeft - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase;
    }
    ,
    Height(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return heightLeft;
    ...
    ,
    Depth(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return m.mod_ThkLeft;
    }
    ,
    WidthPos(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return carcaseWidth - cornerUnitFrontWidth - m.mod_FrontGapVert / 2 - (widthRight - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase) - (widthLeft - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase);
    }
    ,
    HeigthPos(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return startPositionHeight;
    }
    ,
    DepthPos(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return m.mod_FrontGapCarcase + carcaseDepth;
    }
    ,
    RotationAngle: 90,
    RotationDirection: "y",
    RotationPointWidth(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return carcaseWidth - cornerUnitFrontWidth - m.mod_FrontGapVert / 2 - (widthRight - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase);
    }
    ,
    RotationPointHeight(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return startPositionHeight;
  ...
  , {
    ...
    Direction: "Right",
    Width(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return widthRight - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase;
    }
    ,
    Height(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return heightRight;
  ...
  , {
    _id: 75,
    in_ParentModule: "mf_CornerFillerFront",
    in_CornerFillerFrontConstruction: "Construction02",
    in_CarcaseDirection: "Left",
    Module: "mc_CornerFillerFront01",
    InsertModule: true,
    FrontId: "CornerStraightFiller",
    ...
    ,
    WidthPos(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return carcaseWidth - cornerUnitFrontWidth - m.mod_FrontGapVert / 2 - (widthRight - m.mod_ThkLeft - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase) - (widthLeft - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase);
    }
    ,
    HeigthPos(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return startPositionHeight;
    ...
    RotationDirection: "y",
    RotationPointWidth(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return carcaseWidth - cornerUnitFrontWidth - m.mod_FrontGapVert / 2 - (widthRight - m.mod_ThkLeft - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase) - m.mod_ThkLeft / 2;
    }
    ,
    RotationPointHeight(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return startPositionHeight;
    ...
    ,
    RotationPointDepth(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return m.mod_FrontGapCarcase + carcaseDepth + m.mod_ThkLeft / 2;
    }
  ...
  , {
    ...
    Direction: "Right",
    Width(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return widthRight - m.mod_ThkLeft - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase;
    }
    ,
    Height(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return heightRight;
    ...
    ,
    WidthPos(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return carcaseWidth - cornerUnitFrontWidth - m.mod_FrontGapVert / 2 - (widthRight - m.mod_ThkLeft - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase);
    }
    ,
    HeigthPos(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return startPositionHeight;
  ...
  , {
    _id: 77,
    in_ParentModule: "mf_CornerFillerFront",
    in_CornerFillerFrontConstruction: "Construction03",
    in_CarcaseDirection: "Left",
    Module: "mc_CornerFillerFront01",
    InsertModule: true,
    FrontId: "CornerStraightFiller",
    Direction: "Left",
    Width(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return widthLeft - m.mod_ThkRight - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase;
    }
    ,
    Height(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return heightLeft;
    ...
    ,
    WidthPos(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return carcaseWidth - cornerUnitFrontWidth - m.mod_FrontGapVert / 2 - (widthRight - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase) - (widthLeft - m.mod_ThkRight - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase);
    }
    ,
    HeigthPos(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return startPositionHeight;
    ...
    RotationDirection: "y",
    RotationPointWidth(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return carcaseWidth - cornerUnitFrontWidth - m.mod_FrontGapVert / 2 - (widthRight - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase) + m.mod_ThkRight / 2;
    }
    ,
    RotationPointHeight(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return startPositionHeight;
    ...
    ,
    RotationPointDepth(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return m.mod_FrontGapCarcase + carcaseDepth + m.mod_ThkRight / 2;
    }
  ...
  , {
    ...
    ,
    WidthPos(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return cornerUnitFrontWidth + m.mod_FrontGapVert / 2;
    }
    ,
    HeigthPos(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return startPositionHeight;
  ...
  , {
    ...
    ,
    WidthPos(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return cornerUnitFrontWidth + m.mod_FrontGapVert / 2 + (widthLeft - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase);
    }
    ,
    HeigthPos(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return startPositionHeight;
  ...
  , {
    ...
    Direction: "Left",
    Width(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return widthLeft - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase - m.mod_ThkRight;
    }
    ,
    Height(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return heightLeft;
  ...
  , {
    ...
    ,
    WidthPos(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return cornerUnitFrontWidth + m.mod_FrontGapVert / 2 + (widthLeft - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase - m.mod_ThkRight);
    }
    ,
    HeigthPos(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return startPositionHeight;
    ...
    RotationDirection: "y",
    RotationPointWidth(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return cornerUnitFrontWidth + m.mod_FrontGapVert / 2 + (widthLeft - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase - m.mod_ThkRight) + m.mod_ThkRight / 2;
    }
    ,
    RotationPointHeight(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return startPositionHeight;
  ...
  , {
    ...
    Direction: "Right",
    Width(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return widthRight - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase - m.mod_ThkLeft;
    }
    ,
    Height(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return heightRight;
    ...
    RotationDirection: "y",
    RotationPointWidth(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return cornerUnitFrontWidth + m.mod_FrontGapVert / 2 + (widthLeft - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase) - m.mod_ThkLeft / 2;
    }
    ,
    RotationPointHeight(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return startPositionHeight;
  ...
  , {
    _id: 85,
    in_ParentModule: "mr_CornerFiller",
    in_CornerFillerFrontConstruction: "Construction01",
    in_CarcaseDirection: "Left",
    Module: "mc_CornerFillerFront01",
    InsertModule: true,
    FrontId: "CornerFiller",
    Direction: "Left",
    Width(m: ITableParents_mf_CornerFillerFront_mr_CornerFiller, widthLeft: number, widthRight: number, heightLeft: number, heightRight: number, carcaseWidth: number, carcaseDepth: number, startPositionHeight: number, cornerUnitFrontWidth: number): number {
      return widthLeft - m.mod_FrontGapVert / 2 - m.mod_FrontGapCarcase;
    }
