...
export interface cti_tab_PantryPulloutColorMapping {
  readonly in_HardwareColor?: string;
  readonly in_PantryPulloutType?: string;
  readonly in_PantryPulloutDesign?: string;
}

export interface ctm_tab_PantryPulloutColorMapping {
}

export interface cto_tab_PantryPulloutColorMapping extends ctm_tab_PantryPulloutColorMapping {
  readonly _id: number;
  readonly PantryPulloutColor?: string;
}

export interface ICT_tab_PantryPulloutColorMapping
  extends cti_tab_PantryPulloutColorMapping, cto_tab_PantryPulloutColorMapping { }

export class ct2_tab_PantryPulloutColorMapping {

  public findExactly(
    in_HardwareColor: string | undefined,
    in_PantryPulloutType: string | undefined,
    in_PantryPulloutDesign: string | undefined,
  ): cto_tab_PantryPulloutColorMapping | undefined {
    const res = ct_tab_PantryPulloutColorMapping.find((p) =>
  ...
  public find(
    predicate: (value: cti_tab_PantryPulloutColorMapping) => boolean
  ): cto_tab_PantryPulloutColorMapping | undefined {
    for (let index = 0; index < ct_tab_PantryPulloutColorMapping.length; index++) {
      const element = ct_tab_PantryPulloutColorMapping[index];
...
export var ct_tab_PantryPulloutColorMapping: ICT_tab_PantryPulloutColorMapping[] = [
  {
    _id: 1,
    in_HardwareColor: "DarkColor",
    in_PantryPulloutType: "Dispensa",
    in_PantryPulloutDesign: "Classic",
    PantryPulloutColor: "SilverGrey"
  }
  , {
    _id: 2,
