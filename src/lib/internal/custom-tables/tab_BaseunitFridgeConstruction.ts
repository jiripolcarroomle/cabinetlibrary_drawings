...
export interface cti_tab_BaseunitFridgeConstruction {
  readonly in_ConstructionId?: string;
}

export interface ctm_tab_BaseunitFridgeConstruction {
}

export interface cto_tab_BaseunitFridgeConstruction extends ctm_tab_BaseunitFridgeConstruction {
  readonly _id: number;
...
export interface ICT_tab_BaseunitFridgeConstruction
  extends cti_tab_BaseunitFridgeConstruction, cto_tab_BaseunitFridgeConstruction { }

export class ct2_tab_BaseunitFridgeConstruction {

  public findExactly(
    in_ConstructionId: string | undefined,
  ): cto_tab_BaseunitFridgeConstruction | undefined {
    const res = ct_tab_BaseunitFridgeConstruction.find((p) =>
  ...
  public find(
    predicate: (value: cti_tab_BaseunitFridgeConstruction) => boolean
  ): cto_tab_BaseunitFridgeConstruction | undefined {
    for (let index = 0; index < ct_tab_BaseunitFridgeConstruction.length; index++) {
      const element = ct_tab_BaseunitFridgeConstruction[index];
...
export var ct_tab_BaseunitFridgeConstruction: ICT_tab_BaseunitFridgeConstruction[] = [
  {
    _id: 1,
    in_ConstructionId: "KU21WAHG0",
    NominalWidth: 600,
    MinHeight: 820,
    MaxHeight: 820,
    MinDepth: 560,
  ...
  , {
    _id: 3,
    in_ConstructionId: "KU21RADE0",
    NominalWidth: 600,
    MinHeight: 820,
    MaxHeight: 820,
    MinDepth: 550,
    Integration: "FullPanel"
  }
];
