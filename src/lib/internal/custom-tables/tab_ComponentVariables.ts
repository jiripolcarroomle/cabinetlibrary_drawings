...
export interface cti_tab_ComponentVariables {
  readonly in_ComponentId?: string;
}

export interface ctm_tab_ComponentVariables {
}

export interface cto_tab_ComponentVariables extends ctm_tab_ComponentVariables {
  readonly _id: number;
  readonly Variable?: string;
  VariableValue(partSelf: any /* WARNING: No parent found; assuming 'any' */, part2: any /* WARNING: No parent found; assuming 'any' */): number;
}

export interface ICT_tab_ComponentVariables
  extends cti_tab_ComponentVariables, cto_tab_ComponentVariables { }

export class ct2_tab_ComponentVariables {

  public findExactly(
    in_ComponentId: string | undefined,
  ): cto_tab_ComponentVariables | undefined {
    const res = ct_tab_ComponentVariables.find((p) =>
      p.in_ComponentId === in_ComponentId
    );
    return res;
  }

  public find(
    predicate: (value: cti_tab_ComponentVariables) => boolean
  ): cto_tab_ComponentVariables | undefined {
    for (let index = 0; index < ct_tab_ComponentVariables.length; index++) {
      const element = ct_tab_ComponentVariables[index];
...
export var ct_tab_ComponentVariables: ICT_tab_ComponentVariables[] = [
  {
    _id: 6,
    in_ComponentId: "FrontTuscanMilling",
    Variable: "L",
    VariableValue(partSelf: any /* WARNING: No parent found; assuming 'any' */, part2: any /* WARNING: No parent found; assuming 'any' */): number {
