...
export interface cti_tab_PantryPulloutConstruction {
  readonly in_ConstructionId?: string;
}

export interface ctm_tab_PantryPulloutConstruction {
}

export interface cto_tab_PantryPulloutConstruction extends ctm_tab_PantryPulloutConstruction {
  readonly _id: number;
  readonly HardwareSpaceHeight: number;
  readonly BasketDescriptor?: string;
  readonly BasketPosDepth: number;
  readonly FramePosHeight: number;
  readonly FrameReductionHeight: number;
  readonly FramePosDepth: number;
  readonly ConnectorTopPosHeight: number;
  readonly ConnectorBtmPosHeight: number;
  readonly SlidePosDepth: number;
}

export interface ICT_tab_PantryPulloutConstruction
  extends cti_tab_PantryPulloutConstruction, cto_tab_PantryPulloutConstruction { }

export class ct2_tab_PantryPulloutConstruction {

  public findExactly(
    in_ConstructionId: string | undefined,
  ): cto_tab_PantryPulloutConstruction | undefined {
    const res = ct_tab_PantryPulloutConstruction.find((p) =>
  ...
  public find(
    predicate: (value: cti_tab_PantryPulloutConstruction) => boolean
  ): cto_tab_PantryPulloutConstruction | undefined {
    for (let index = 0; index < ct_tab_PantryPulloutConstruction.length; index++) {
      const element = ct_tab_PantryPulloutConstruction[index];
...
export var ct_tab_PantryPulloutConstruction: ICT_tab_PantryPulloutConstruction[] = [
  {
    _id: 67,
    in_ConstructionId: "DispensaClassic160",
    HardwareSpaceHeight: 1600,
    BasketDescriptor: "90mm_333mm_333mm_333mm_1",
    BasketPosDepth: 15,
    FramePosHeight: 43,
    FrameReductionHeight: 60,
    FramePosDepth: 0,
    ConnectorTopPosHeight: 30,
    ConnectorBtmPosHeight: 30,
    SlidePosDepth: 10
  }
  , {
    _id: 68,
    in_ConstructionId: "DispensaClassic190",
    HardwareSpaceHeight: 1900,
    BasketDescriptor: "90mm_333mm_333mm_333mm_333mm_1",
    BasketPosDepth: 15,
    FramePosHeight: 43,
    FrameReductionHeight: 60,
    FramePosDepth: 0,
  ...
  , {
    _id: 69,
    in_ConstructionId: "DispensaClassic230",
    HardwareSpaceHeight: 2300,
    BasketDescriptor: "90mm_333mm_333mm_333mm_333mm_333mm_1",
    BasketPosDepth: 15,
    FramePosHeight: 43,
    FrameReductionHeight: 60,
    FramePosDepth: 0,
  ...
  , {
    _id: 70,
    in_ConstructionId: "DispensaStyle160",
    HardwareSpaceHeight: 1600,
    BasketDescriptor: "90mm_333mm_333mm_333mm_1",
    BasketPosDepth: 15,
    FramePosHeight: 43,
  ...
  , {
    _id: 71,
    in_ConstructionId: "DispensaStyle190",
    HardwareSpaceHeight: 1900,
    BasketDescriptor: "90mm_333mm_333mm_333mm_333mm_1",
    BasketPosDepth: 15,
    FramePosHeight: 43,
  ...
  , {
    _id: 72,
    in_ConstructionId: "DispensaStyle230",
    HardwareSpaceHeight: 2300,
    BasketDescriptor: "90mm_333mm_333mm_333mm_333mm_333mm_1",
    BasketPosDepth: 15,
    FramePosHeight: 43,
