...
export interface cti_tab_ComponentLibrary {
  readonly in_ProcessingId?: string;
}

export interface ctm_tab_ComponentLibrary {
}

export interface cto_tab_ComponentLibrary extends ctm_tab_ComponentLibrary {
  readonly _id: number;
  readonly ComponentId?: string;
  readonly ComponentMPR?: string;
  XA(partSelf: any /* WARNING: No parent found; assuming 'any' */, part2: any /* WARNING: No parent found; assuming 'any' */): number;
  YA(partSelf: any /* WARNING: No parent found; assuming 'any' */, part2: any /* WARNING: No parent found; assuming 'any' */): number;
  ZA(partSelf: any /* WARNING: No parent found; assuming 'any' */, part2: any /* WARNING: No parent found; assuming 'any' */): number;
  readonly EM?: string;
  readonly KAT?: string;
  readonly KO?: string;
...
export interface ICT_tab_ComponentLibrary
  extends cti_tab_ComponentLibrary, cto_tab_ComponentLibrary { }

export class ct2_tab_ComponentLibrary {

  public findExactly(
    in_ProcessingId: string | undefined,
  ): cto_tab_ComponentLibrary | undefined {
    const res = ct_tab_ComponentLibrary.find((p) =>
  ...
  public find(
    predicate: (value: cti_tab_ComponentLibrary) => boolean
  ): cto_tab_ComponentLibrary | undefined {
    for (let index = 0; index < ct_tab_ComponentLibrary.length; index++) {
      const element = ct_tab_ComponentLibrary[index];
...
export var ct_tab_ComponentLibrary: ICT_tab_ComponentLibrary[] = [
  {
    _id: 2,
    in_ProcessingId: "FrontTuscanMilling",
    ComponentId: "FrontTuscanMilling",
    ComponentMPR: "FrontTuscanMilling.mpr",
    XA(partSelf: any /* WARNING: No parent found; assuming 'any' */, part2: any /* WARNING: No parent found; assuming 'any' */): number {
      return 0;
    }
    ,
