...
export interface cti_tab_FrameFillingMapping {
...
export interface ctm_tab_FrameFillingMapping {
}

export interface cto_tab_FrameFillingMapping extends ctm_tab_FrameFillingMapping {
  readonly _id: number;
  readonly FillingType?: string;
  readonly FillingColor?: string;
  readonly FillingGrain?: string;
}

export interface ICT_tab_FrameFillingMapping
  extends cti_tab_FrameFillingMapping, cto_tab_FrameFillingMapping { }

export class ct2_tab_FrameFillingMapping {
  ...
  ): cto_tab_FrameFillingMapping | undefined {
    const res = ct_tab_FrameFillingMapping.find((p) =>
  ...
  public find(
    predicate: (value: cti_tab_FrameFillingMapping) => boolean
  ): cto_tab_FrameFillingMapping | undefined {
    for (let index = 0; index < ct_tab_FrameFillingMapping.length; index++) {
      const element = ct_tab_FrameFillingMapping[index];
...
export var ct_tab_FrameFillingMapping: ICT_tab_FrameFillingMapping[] = [
  {
    _id: 104,
    in_PartGroup: "Door",
    in_FrontProgram: "Tradition",
    in_FrontDesign: "Standard",
    in_FrontColor: "All",
    FillingType: "WoodVertical",
    FillingColor: "LikeFrameColor",
    FillingGrain: "NoGrain"
  }
  , {
    _id: 105,
    in_PartGroup: "Drawer",
  ...
  , {
    ...
    in_PartGroup: "Door",
    in_FrontProgram: "Tradition",
    in_FrontDesign: "FillingWoodClassic",
    in_FrontColor: "All",
    FillingType: "WoodVertical",
    FillingColor: "LikeFrameColor",
    FillingGrain: "NoGrain"
  ...
  , {
    ...
    in_PartGroup: "Door",
    in_FrontProgram: "Tradition",
    in_FrontDesign: "FillingWoodModern",
    in_FrontColor: "All",
    FillingType: "WoodHorizontal",
    FillingColor: "LikeFrameColor",
    FillingGrain: "NoGrain"
  }
  , {
