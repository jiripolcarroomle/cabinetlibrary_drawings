...
export interface cti_tab_FridgeNicheConstruction {
  readonly in_StartPosMin: number;
  readonly in_StartPosMax: number;
  readonly in_FrontHeightMin: number;
  readonly in_FrontHeightMax: number;
  readonly in_NicheHeightMin: number;
  readonly in_NicheHeightMax: number;
  readonly in_SplittedDoor?: boolean;
  readonly in_FirstFrontHeightMin: number;
  readonly in_FirstFrontHeightMax: number;
  readonly in_PosType?: string;
}

export interface ctm_tab_FridgeNicheConstruction {
}

export interface cto_tab_FridgeNicheConstruction extends ctm_tab_FridgeNicheConstruction {
  readonly _id: number;
  readonly BtmShelfType?: string;
  readonly TopShelfType?: string;
  readonly PositionType?: string;
  readonly CarcaseDescriptor?: string;
  readonly FrontDescriptor?: string;
  readonly BackwallPosTop: number;
}

export interface ICT_tab_FridgeNicheConstruction
  extends cti_tab_FridgeNicheConstruction, cto_tab_FridgeNicheConstruction { }

export class ct2_tab_FridgeNicheConstruction {

  public findExactly(
    in_StartPosMin: number,
    in_StartPosMax: number,
    in_FrontHeightMin: number,
    in_FrontHeightMax: number,
    in_NicheHeightMin: number,
    in_NicheHeightMax: number,
    in_SplittedDoor: boolean | undefined,
    in_FirstFrontHeightMin: number,
    in_FirstFrontHeightMax: number,
    in_PosType: string | undefined,
  ): cto_tab_FridgeNicheConstruction | undefined {
    const res = ct_tab_FridgeNicheConstruction.find((p) =>
      p.in_StartPosMin === in_StartPosMin
      && p.in_StartPosMax === in_StartPosMax
      && p.in_FrontHeightMin === in_FrontHeightMin
      && p.in_FrontHeightMax === in_FrontHeightMax
      && p.in_NicheHeightMin === in_NicheHeightMin
      && p.in_NicheHeightMax === in_NicheHeightMax
      && p.in_SplittedDoor === in_SplittedDoor
      && p.in_FirstFrontHeightMin === in_FirstFrontHeightMin
      && p.in_FirstFrontHeightMax === in_FirstFrontHeightMax
  ...
  public find(
    predicate: (value: cti_tab_FridgeNicheConstruction) => boolean
  ): cto_tab_FridgeNicheConstruction | undefined {
    for (let index = 0; index < ct_tab_FridgeNicheConstruction.length; index++) {
      const element = ct_tab_FridgeNicheConstruction[index];
...
export var ct_tab_FridgeNicheConstruction: ICT_tab_FridgeNicheConstruction[] = [
  {
    _id: 18,
    in_StartPosMin: 0,
    in_StartPosMax: 25,
    in_FrontHeightMin: 1200,
    in_FrontHeightMax: 1300,
    in_NicheHeightMin: 1220,
    in_NicheHeightMax: 1250,
    in_SplittedDoor: false,
    in_FirstFrontHeightMin: 0,
    in_FirstFrontHeightMax: 0,
    in_PosType: "Automatic",
    BtmShelfType: "None",
    TopShelfType: "Filler",
    PositionType: "Bottom",
    CarcaseDescriptor: "",
  ...
  , {
    ...
    in_StartPosMin: 0,
    in_StartPosMax: 25,
    in_FrontHeightMin: 1300,
    in_FrontHeightMax: 1350,
    in_NicheHeightMin: 1220,
    in_NicheHeightMax: 1250,
    in_SplittedDoor: false,
    in_FirstFrontHeightMin: 0,
  ...
  , {
    ...
    in_StartPosMin: 0,
    in_StartPosMax: 25,
    in_FrontHeightMin: 1350,
    in_FrontHeightMax: 1450,
    in_NicheHeightMin: 1220,
    in_NicheHeightMax: 1250,
    in_SplittedDoor: false,
    in_FirstFrontHeightMin: 0,
  ...
  , {
    ...
    in_StartPosMin: 0,
    in_StartPosMax: 25,
    in_FrontHeightMin: 1750,
    in_FrontHeightMax: 9999,
    in_NicheHeightMin: 1750,
    in_NicheHeightMax: 1800,
    in_SplittedDoor: true,
    in_FirstFrontHeightMin: 600,
    in_FirstFrontHeightMax: 700,
    in_PosType: "Automatic",
    BtmShelfType: "Airflow",
    TopShelfType: "Storage",
    PositionType: "Free",
    CarcaseDescriptor: "",
    FrontDescriptor: "720mm_1",
    BackwallPosTop: 0
  }
  , {
    _id: 25,
  ...
  , {
    ...
    in_StartPosMin: 0,
    in_StartPosMax: 25,
    in_FrontHeightMin: 1850,
    in_FrontHeightMax: 1950,
    in_NicheHeightMin: 1750,
    in_NicheHeightMax: 1800,
    in_SplittedDoor: false,
    in_FirstFrontHeightMin: 0,
