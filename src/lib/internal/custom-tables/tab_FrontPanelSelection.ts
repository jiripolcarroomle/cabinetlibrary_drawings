...
export interface cti_tab_FrontPanelSelection {
...
export interface ctm_tab_FrontPanelSelection {
}

export interface cto_tab_FrontPanelSelection extends ctm_tab_FrontPanelSelection {
  readonly _id: number;
...
export interface ICT_tab_FrontPanelSelection
  extends cti_tab_FrontPanelSelection, cto_tab_FrontPanelSelection { }

export class ct2_tab_FrontPanelSelection {
  ...
  public findExactly(
    ...
    in_WidthMin: number,
    in_WidthMax: number,
  ): cto_tab_FrontPanelSelection | undefined {
    const res = ct_tab_FrontPanelSelection.find((p) =>
  ...
  public find(
    predicate: (value: cti_tab_FrontPanelSelection) => boolean
  ): cto_tab_FrontPanelSelection | undefined {
    for (let index = 0; index < ct_tab_FrontPanelSelection.length; index++) {
      const element = ct_tab_FrontPanelSelection[index];
...
export var ct_tab_FrontPanelSelection: ICT_tab_FrontPanelSelection[] = [
  {
    _id: 1,
    in_PartId: "part_Door",
