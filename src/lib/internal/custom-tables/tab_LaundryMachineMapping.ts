...
export interface cti_tab_LaundryMachineMapping {
  readonly in_Supplier?: string;
  readonly in_LaundryMachineId?: string;
}

export interface ctm_tab_LaundryMachineMapping {
}

export interface cto_tab_LaundryMachineMapping extends ctm_tab_LaundryMachineMapping {
  readonly _id: number;
  readonly ConstructionId?: string;
  readonly GraphicId?: string;
}

export interface ICT_tab_LaundryMachineMapping
  extends cti_tab_LaundryMachineMapping, cto_tab_LaundryMachineMapping { }

export class ct2_tab_LaundryMachineMapping {

  public findExactly(
    in_Supplier: string | undefined,
    in_LaundryMachineId: string | undefined,
  ): cto_tab_LaundryMachineMapping | undefined {
    const res = ct_tab_LaundryMachineMapping.find((p) =>
      p.in_Supplier === in_Supplier
      && p.in_LaundryMachineId === in_LaundryMachineId
    );
    return res;
  }

  public find(
    predicate: (value: cti_tab_LaundryMachineMapping) => boolean
  ): cto_tab_LaundryMachineMapping | undefined {
    for (let index = 0; index < ct_tab_LaundryMachineMapping.length; index++) {
      const element = ct_tab_LaundryMachineMapping[index];
...
export var ct_tab_LaundryMachineMapping: ICT_tab_LaundryMachineMapping[] = [
  {
    _id: 1,
    in_Supplier: "GenericSupplier",
    in_LaundryMachineId: "GenericMachine",
    ConstructionId: "None",
    GraphicId: "GenericLaundryMachine"
  }
];
