...
export interface cti_tab_ClothingOrganizerMapping {
  readonly in_Type?: string;
  readonly in_Design?: string;
  readonly in_Color?: string;
  readonly in_ConnectionPosition?: string;
}

export interface ctm_tab_ClothingOrganizerMapping {
}

export interface cto_tab_ClothingOrganizerMapping extends ctm_tab_ClothingOrganizerMapping {
  readonly _id: number;
  readonly Object?: string;
}

export interface ICT_tab_ClothingOrganizerMapping
  extends cti_tab_ClothingOrganizerMapping, cto_tab_ClothingOrganizerMapping { }

export class ct2_tab_ClothingOrganizerMapping {

  public findExactly(
    in_Type: string | undefined,
    in_Design: string | undefined,
    in_Color: string | undefined,
    in_ConnectionPosition: string | undefined,
  ): cto_tab_ClothingOrganizerMapping | undefined {
    const res = ct_tab_ClothingOrganizerMapping.find((p) =>
      p.in_Type === in_Type
      && p.in_Design === in_Design
      && p.in_Color === in_Color
      && p.in_ConnectionPosition === in_ConnectionPosition
    );
    return res;
  }

  public find(
    predicate: (value: cti_tab_ClothingOrganizerMapping) => boolean
  ): cto_tab_ClothingOrganizerMapping | undefined {
    for (let index = 0; index < ct_tab_ClothingOrganizerMapping.length; index++) {
      const element = ct_tab_ClothingOrganizerMapping[index];
...
export var ct_tab_ClothingOrganizerMapping: ICT_tab_ClothingOrganizerMapping[] = [
  {
    _id: 6,
    in_Type: "WardrobeLift",
    in_Design: "ConeroLift",
    in_Color: "Black",
    in_ConnectionPosition: "Left&Right",
    Object: "Conero625"
  }
  , {
    _id: 7,
  ...
  , {
    ...
    in_Design: "ConeroTie",
    in_Color: "Black",
    in_ConnectionPosition: "Left",
    Object: "ConeroRigid_Left"
  }
  , {
    _id: 10,
    in_Type: "TieRack",
    in_Design: "ConeroTie",
    in_Color: "Black",
    in_ConnectionPosition: "Right",
    Object: "ConeroRigid_Right"
  }
];
