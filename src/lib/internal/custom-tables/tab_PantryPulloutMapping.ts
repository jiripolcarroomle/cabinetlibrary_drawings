...
export interface cti_tab_PantryPulloutMapping {
  readonly in_PantryPulloutType?: string;
  readonly in_PantryPulloutDesign?: string;
  readonly in_PantryPulloutColor?: string;
...
export interface ctm_tab_PantryPulloutMapping {
}

export interface cto_tab_PantryPulloutMapping extends ctm_tab_PantryPulloutMapping {
  readonly _id: number;
  readonly ConstructionId?: string;
  readonly ObjectFrame?: string;
  readonly ObjectBasket?: string;
}

export interface ICT_tab_PantryPulloutMapping
  extends cti_tab_PantryPulloutMapping, cto_tab_PantryPulloutMapping { }

export class ct2_tab_PantryPulloutMapping {

  public findExactly(
    in_PantryPulloutType: string | undefined,
    in_PantryPulloutDesign: string | undefined,
    in_PantryPulloutColor: string | undefined,
  ...
  ): cto_tab_PantryPulloutMapping | undefined {
    const res = ct_tab_PantryPulloutMapping.find((p) =>
      p.in_PantryPulloutType === in_PantryPulloutType
      && p.in_PantryPulloutDesign === in_PantryPulloutDesign
      && p.in_PantryPulloutColor === in_PantryPulloutColor
  ...
  public find(
    predicate: (value: cti_tab_PantryPulloutMapping) => boolean
  ): cto_tab_PantryPulloutMapping | undefined {
    for (let index = 0; index < ct_tab_PantryPulloutMapping.length; index++) {
      const element = ct_tab_PantryPulloutMapping[index];
...
export var ct_tab_PantryPulloutMapping: ICT_tab_PantryPulloutMapping[] = [
  {
    _id: 19,
    in_PantryPulloutType: "Dispensa",
    in_PantryPulloutDesign: "Classic",
    in_PantryPulloutColor: "SilverGrey",
    in_CarcaseFreeSpaceWidthMin: 260,
    in_CarcaseFreeSpaceWidthMax: 359.99,
    in_CarcaseFreeSpaceDepthMin: 510,
    in_CarcaseFreeSpaceDepthMax: 9999,
    in_CarcaseFreeSpaceHeightMin: 1200,
    in_CarcaseFreeSpaceHeightMax: 1600,
    ConstructionId: "DispensaClassic160",
    ObjectFrame: "DispensaClassic16030",
    ObjectBasket: "DispensaClassic30"
  }
  , {
    _id: 20,
    in_PantryPulloutType: "Dispensa",
    ...
    in_CarcaseFreeSpaceDepthMin: 510,
    in_CarcaseFreeSpaceDepthMax: 9999,
    in_CarcaseFreeSpaceHeightMin: 1600,
    in_CarcaseFreeSpaceHeightMax: 1950,
    ConstructionId: "DispensaClassic190",
    ObjectFrame: "DispensaClassic19030",
    ObjectBasket: "DispensaClassic30"
  }
  , {
    _id: 21,
    ...
    in_CarcaseFreeSpaceDepthMin: 510,
    in_CarcaseFreeSpaceDepthMax: 9999,
    in_CarcaseFreeSpaceHeightMin: 1950,
    in_CarcaseFreeSpaceHeightMax: 9999,
    ConstructionId: "DispensaClassic230",
    ObjectFrame: "DispensaClassic23030",
    ObjectBasket: "DispensaClassic30"
  }
  , {
    _id: 22,
    ...
    in_PantryPulloutDesign: "Classic",
    in_PantryPulloutColor: "SilverGrey",
    in_CarcaseFreeSpaceWidthMin: 360,
    in_CarcaseFreeSpaceWidthMax: 460,
    in_CarcaseFreeSpaceDepthMin: 510,
    in_CarcaseFreeSpaceDepthMax: 9999,
    in_CarcaseFreeSpaceHeightMin: 1200,
    in_CarcaseFreeSpaceHeightMax: 1600,
    ConstructionId: "DispensaClassic160",
    ObjectFrame: "DispensaClassic16040",
    ObjectBasket: "DispensaClassic40"
  }
  , {
    _id: 23,
    in_PantryPulloutType: "Dispensa",
    ...
    in_CarcaseFreeSpaceHeightMax: 1950,
    ConstructionId: "DispensaClassic190",
    ObjectFrame: "DispensaClassic19040",
    ObjectBasket: "DispensaClassic40"
  }
  , {
    _id: 24,
    ...
    in_CarcaseFreeSpaceHeightMax: 9999,
    ConstructionId: "DispensaClassic230",
    ObjectFrame: "DispensaClassic23040",
    ObjectBasket: "DispensaClassic40"
  }
  , {
    _id: 25,
    in_PantryPulloutType: "Dispensa",
    in_PantryPulloutDesign: "Style",
    in_PantryPulloutColor: "SilverGrey",
    in_CarcaseFreeSpaceWidthMin: 260,
    in_CarcaseFreeSpaceWidthMax: 359.99,
    in_CarcaseFreeSpaceDepthMin: 510,
    ...
    in_CarcaseFreeSpaceHeightMin: 1200,
    in_CarcaseFreeSpaceHeightMax: 1600,
    ConstructionId: "DispensaStyle160",
    ObjectFrame: "DispensaStyle16030_Grey",
    ObjectBasket: "DispensaStyle30_Grey"
  }
  , {
    _id: 26,
    in_PantryPulloutType: "Dispensa",
    ...
    in_CarcaseFreeSpaceHeightMin: 1600,
    in_CarcaseFreeSpaceHeightMax: 1950,
    ConstructionId: "DispensaStyle190",
    ObjectFrame: "DispensaStyle19030_Grey",
    ObjectBasket: "DispensaStyle30_Grey"
  }
  , {
    _id: 27,
    ...
    in_CarcaseFreeSpaceHeightMin: 1950,
    in_CarcaseFreeSpaceHeightMax: 9999,
    ConstructionId: "DispensaStyle230",
    ObjectFrame: "DispensaStyle23030_Grey",
    ObjectBasket: "DispensaStyle30_Grey"
  }
  , {
    _id: 28,
    ...
    in_CarcaseFreeSpaceHeightMax: 1600,
    ConstructionId: "DispensaStyle160",
    ObjectFrame: "DispensaStyle16040_Grey",
    ObjectBasket: "DispensaStyle40_Grey"
  }
  , {
    _id: 29,
    in_PantryPulloutType: "Dispensa",
    ...
    in_CarcaseFreeSpaceHeightMax: 1950,
    ConstructionId: "DispensaStyle190",
    ObjectFrame: "DispensaStyle19040_Grey",
    ObjectBasket: "DispensaStyle40_Grey"
  }
  , {
    _id: 30,
    ...
    in_CarcaseFreeSpaceHeightMax: 9999,
    ConstructionId: "DispensaStyle230",
    ObjectFrame: "DispensaStyle23040_Grey",
    ObjectBasket: "DispensaStyle40_Grey"
  }
  , {
    _id: 31,
    in_PantryPulloutType: "Dispensa",
    in_PantryPulloutDesign: "Style",
    in_PantryPulloutColor: "Anthrazit",
    in_CarcaseFreeSpaceWidthMin: 260,
    in_CarcaseFreeSpaceWidthMax: 359.99,
    in_CarcaseFreeSpaceDepthMin: 510,
    in_CarcaseFreeSpaceDepthMax: 9999,
    ...
    in_CarcaseFreeSpaceHeightMax: 1600,
    ConstructionId: "DispensaStyle160",
    ObjectFrame: "DispensaStyle16030_Anthrazit",
    ObjectBasket: "DispensaStyle30_Anthrazit"
  }
  , {
    _id: 32,
    in_PantryPulloutType: "Dispensa",
    ...
    in_CarcaseFreeSpaceHeightMax: 1950,
    ConstructionId: "DispensaStyle190",
    ObjectFrame: "DispensaStyle19030_Anthrazit",
    ObjectBasket: "DispensaStyle30_Anthrazit"
  }
  , {
    _id: 33,
    ...
    in_CarcaseFreeSpaceHeightMax: 9999,
    ConstructionId: "DispensaStyle230",
    ObjectFrame: "DispensaStyle23030_Anthrazit",
    ObjectBasket: "DispensaStyle30_Anthrazit"
  }
  , {
    _id: 34,
    ...
    in_CarcaseFreeSpaceHeightMax: 1600,
    ConstructionId: "DispensaStyle160",
    ObjectFrame: "DispensaStyle16040_Anthrazit",
    ObjectBasket: "DispensaStyle40_Anthrazit"
  }
  , {
    _id: 35,
    in_PantryPulloutType: "Dispensa",
    ...
    in_CarcaseFreeSpaceHeightMax: 1950,
    ConstructionId: "DispensaStyle190",
    ObjectFrame: "DispensaStyle19040_Anthrazit",
    ObjectBasket: "DispensaStyle40_Anthrazit"
  }
  , {
    _id: 36,
    ...
    in_CarcaseFreeSpaceHeightMax: 9999,
    ConstructionId: "DispensaStyle230",
    ObjectFrame: "DispensaStyle23040_Anthrazit",
    ObjectBasket: "DispensaStyle40_Anthrazit"
  }
];
