...
export interface cti_tab_ClothingOrganizerExtraItemMapping {
  readonly in_ClothesOrganizerType?: string;
  readonly in_ClothesOrganizerDesign?: string;
  readonly in_ClothesOrganizerExtraItemColor?: string;
  readonly in_CarcaseProgram?: string;
  readonly in_HardwareColor?: string;
}

export interface ctm_tab_ClothingOrganizerExtraItemMapping {
}

export interface cto_tab_ClothingOrganizerExtraItemMapping extends ctm_tab_ClothingOrganizerExtraItemMapping {
  readonly _id: number;
  PartWidth(freeSpaceWidth: number): number;
  PartDepth(freeSpaceDepth: number): number;
  PartThickness(): number;
  PartInsertionPointX(): number;
}

export interface ICT_tab_ClothingOrganizerExtraItemMapping
  extends cti_tab_ClothingOrganizerExtraItemMapping, cto_tab_ClothingOrganizerExtraItemMapping { }

export class ct2_tab_ClothingOrganizerExtraItemMapping {

  public findExactly(
    in_ClothesOrganizerType: string | undefined,
    in_ClothesOrganizerDesign: string | undefined,
    in_ClothesOrganizerExtraItemColor: string | undefined,
    in_CarcaseProgram: string | undefined,
    in_HardwareColor: string | undefined,
  ): cto_tab_ClothingOrganizerExtraItemMapping | undefined {
    const res = ct_tab_ClothingOrganizerExtraItemMapping.find((p) =>
      p.in_ClothesOrganizerType === in_ClothesOrganizerType
      && p.in_ClothesOrganizerDesign === in_ClothesOrganizerDesign
      && p.in_ClothesOrganizerExtraItemColor === in_ClothesOrganizerExtraItemColor
  ...
  public find(
    predicate: (value: cti_tab_ClothingOrganizerExtraItemMapping) => boolean
  ): cto_tab_ClothingOrganizerExtraItemMapping | undefined {
    for (let index = 0; index < ct_tab_ClothingOrganizerExtraItemMapping.length; index++) {
      const element = ct_tab_ClothingOrganizerExtraItemMapping[index];
...
export var ct_tab_ClothingOrganizerExtraItemMapping: ICT_tab_ClothingOrganizerExtraItemMapping[] = [
  {
    _id: 2,
    in_ClothesOrganizerType: "LiftRailShelf",
    in_ClothesOrganizerDesign: "CONEROTOP",
    in_ClothesOrganizerExtraItemColor: "LikeCarcaseColor",
    in_CarcaseProgram: "All",
    in_HardwareColor: "All",
    PartWidth(freeSpaceWidth: number): number {
      return freeSpaceWidth - 100;
    }
    ,
    PartDepth(freeSpaceDepth: number): number {
      return freeSpaceDepth - 50;
    }
    ,
    PartThickness(): number {
      return 19;
  ...
  , {
    _id: 3,
    in_ClothesOrganizerType: "None",
    in_ClothesOrganizerDesign: "None",
    in_ClothesOrganizerExtraItemColor: "LikeCarcaseColor",
    in_CarcaseProgram: "All",
    in_HardwareColor: "All",
    PartWidth(freeSpaceWidth: number): number {
