...
export interface cti_tab_ClothingOrganizerDepthPosition {
  readonly in_ClothingOrganizerType?: string;
  readonly in_ClothingOrganizerDesign?: string;
}

export interface ctm_tab_ClothingOrganizerDepthPosition {
}

export interface cto_tab_ClothingOrganizerDepthPosition extends ctm_tab_ClothingOrganizerDepthPosition {
  readonly _id: number;
  readonly DescriptorDepthPosition?: string;
}

export interface ICT_tab_ClothingOrganizerDepthPosition
  extends cti_tab_ClothingOrganizerDepthPosition, cto_tab_ClothingOrganizerDepthPosition { }

export class ct2_tab_ClothingOrganizerDepthPosition {

  public findExactly(
    in_ClothingOrganizerType: string | undefined,
    in_ClothingOrganizerDesign: string | undefined,
  ): cto_tab_ClothingOrganizerDepthPosition | undefined {
    const res = ct_tab_ClothingOrganizerDepthPosition.find((p) =>
      p.in_ClothingOrganizerType === in_ClothingOrganizerType
  ...
  public find(
    predicate: (value: cti_tab_ClothingOrganizerDepthPosition) => boolean
  ): cto_tab_ClothingOrganizerDepthPosition | undefined {
    for (let index = 0; index < ct_tab_ClothingOrganizerDepthPosition.length; index++) {
      const element = ct_tab_ClothingOrganizerDepthPosition[index];
...
export var ct_tab_ClothingOrganizerDepthPosition: ICT_tab_ClothingOrganizerDepthPosition[] = [
  {
    _id: 114,
    in_ClothingOrganizerType: "WardrobeLift",
    in_ClothingOrganizerDesign: "ConeroLift",
    DescriptorDepthPosition: "240mm_1"
  }
  , {
    _id: 115,
    in_ClothingOrganizerType: "WardrobeLift",
  ...
  , {
    _id: 116,
    in_ClothingOrganizerType: "TrouserRack",
    in_ClothingOrganizerDesign: "ConeroTrouser",
    DescriptorDepthPosition: "1_482mm"
  }
  , {
    _id: 117,
    in_ClothingOrganizerType: "TieRack",
    in_ClothingOrganizerDesign: "ConeroTie",
    DescriptorDepthPosition: "1_473.9mm"
  }
];
