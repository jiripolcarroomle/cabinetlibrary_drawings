...
export interface cti_tab_PanelWoodFrameConstruction {
  ...
  readonly in_FillingType?: string;
}
...
export class ct2_tab_PanelWoodFrameConstruction {
  ...
  public findExactly(
    ...
    in_FillingType: string | undefined,
    ...
    const res = ct_tab_PanelWoodFrameConstruction.find((p) =>
      ...
      && p.in_FillingType === in_FillingType
    );
    return res;
  }
...
export var ct_tab_PanelWoodFrameConstruction: ICT_tab_PanelWoodFrameConstruction[] = [
  {
    ...
    FrameFillingThk: 4,
    Weight: 25,
    FrameHorGrainDirection: "Crosswise",
  ...
  , {
    ...
    FrameVertGrainDirection: "Lengthwise",
