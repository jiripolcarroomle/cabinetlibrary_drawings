...
export interface cti_tab_SegmentFrontConstruction {
  readonly in_PartGroup?: string;
  readonly in_FrontConstructionId?: string;
  readonly in_FrontColorGrainGroupId?: string;
  readonly in_SegmentColorGrainGroupId?: string;
  readonly in_SegmentType?: string;
  readonly in_SegmentColor?: string;
  readonly in_FrontStartPos: number;
  readonly in_FrontOverlapBtm: number;
}

export interface ctm_tab_SegmentFrontConstruction {
}

export interface cto_tab_SegmentFrontConstruction extends ctm_tab_SegmentFrontConstruction {
  readonly _id: number;
  readonly InHouseProduction?: boolean;
  readonly DescriptorHeight?: string;
  readonly DescriptorDepth?: string;
  readonly FrontThk: number;
  readonly SegmentThk: number;
  readonly Weight: number;
  readonly SegmentWeight: number;
  readonly FrontGrainDirection?: string;
  readonly SegmentGrainDirection?: string;
}

export interface ICT_tab_SegmentFrontConstruction
  extends cti_tab_SegmentFrontConstruction, cto_tab_SegmentFrontConstruction { }

export class ct2_tab_SegmentFrontConstruction {

  public findExactly(
    in_PartGroup: string | undefined,
    in_FrontConstructionId: string | undefined,
    in_FrontColorGrainGroupId: string | undefined,
    in_SegmentColorGrainGroupId: string | undefined,
    in_SegmentType: string | undefined,
    in_SegmentColor: string | undefined,
    in_FrontStartPos: number,
    in_FrontOverlapBtm: number,
  ): cto_tab_SegmentFrontConstruction | undefined {
    const res = ct_tab_SegmentFrontConstruction.find((p) =>
      ...
      && p.in_SegmentColorGrainGroupId === in_SegmentColorGrainGroupId
      && p.in_SegmentType === in_SegmentType
      && p.in_SegmentColor === in_SegmentColor
      && p.in_FrontStartPos === in_FrontStartPos
      && p.in_FrontOverlapBtm === in_FrontOverlapBtm
    );
    return res;
  }

  public find(
    predicate: (value: cti_tab_SegmentFrontConstruction) => boolean
  ): cto_tab_SegmentFrontConstruction | undefined {
    for (let index = 0; index < ct_tab_SegmentFrontConstruction.length; index++) {
      const element = ct_tab_SegmentFrontConstruction[index];
...
export var ct_tab_SegmentFrontConstruction: ICT_tab_SegmentFrontConstruction[] = [
  {
    _id: 49,
    in_PartGroup: "Door",
    in_FrontConstructionId: "SegmentFront01",
    in_FrontColorGrainGroupId: "NoGrain",
    in_SegmentColorGrainGroupId: "NoGrain",
    in_SegmentType: "Glass",
    in_SegmentColor: "FloatGlass",
    in_FrontStartPos: 700,
    in_FrontOverlapBtm: 0,
    InHouseProduction: true,
    DescriptorHeight: "200mm_300mm_1",
    DescriptorDepth: "1_5mm_1",
    FrontThk: 19,
    SegmentThk: 5,
    Weight: 25,
    SegmentWeight: 12,
    FrontGrainDirection: "None",
    SegmentGrainDirection: "None"
  }
  , {
    _id: 50,
    in_PartGroup: "Door",
    ...
    in_FrontOverlapBtm: 0,
    InHouseProduction: true,
    DescriptorHeight: "1_300mm_200mm",
    DescriptorDepth: "1_5mm_1",
    FrontThk: 19,
    SegmentThk: 5,
    Weight: 25,
  ...
  , {
    ...
    in_SegmentColor: "FloatGlass",
    in_FrontStartPos: 700,
    in_FrontOverlapBtm: 17,
    InHouseProduction: true,
    DescriptorHeight: "250mm_300mm_1",
    DescriptorDepth: "1_5mm_1",
    FrontThk: 19,
    SegmentThk: 5,
    Weight: 25,
  ...
  , {
    ...
    in_FrontOverlapBtm: 17,
    InHouseProduction: true,
    DescriptorHeight: "1_300mm_250mm",
    DescriptorDepth: "1_5mm_1",
    FrontThk: 19,
    SegmentThk: 5,
    Weight: 25,
