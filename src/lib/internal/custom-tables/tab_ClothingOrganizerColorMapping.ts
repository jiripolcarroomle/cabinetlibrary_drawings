...
export interface ctm_tab_ClothingOrganizerColorMapping {
}

export interface cto_tab_ClothingOrganizerColorMapping extends ctm_tab_ClothingOrganizerColorMapping {
  readonly _id: number;
  readonly MappedColor?: string;
  readonly BoardColor?: string;
  readonly GrainGroupID?: string;
}

export interface ICT_tab_ClothingOrganizerColorMapping
  extends cti_tab_ClothingOrganizerColorMapping, cto_tab_ClothingOrganizerColorMapping { }

export class ct2_tab_ClothingOrganizerColorMapping {

  public findExactly(
    in_HardwareColor: string | undefined,
    in_Type: string | undefined,
    in_Design: string | undefined,
  ): cto_tab_ClothingOrganizerColorMapping | undefined {
    const res = ct_tab_ClothingOrganizerColorMapping.find((p) =>
  ...
  public find(
    predicate: (value: cti_tab_ClothingOrganizerColorMapping) => boolean
  ): cto_tab_ClothingOrganizerColorMapping | undefined {
    for (let index = 0; index < ct_tab_ClothingOrganizerColorMapping.length; index++) {
      const element = ct_tab_ClothingOrganizerColorMapping[index];
