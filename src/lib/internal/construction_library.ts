...
export function dataCompletionAndCreateBuildPlan(json: any, manufacturerMode: boolean, generationContours?: GenerationContour[], roomContours?: RoomContour[], withDropContainers?: boolean): OD_Base {
...
export function processMultipleArticles(json: any, manMode: boolean, withBom: boolean, withAllOutputs: boolean, withPerformanceLogs: boolean | undefined, withDropContainers: boolean | undefined): MultiArticleResult {
  ...
  json.forEach(o => {
    if (!checkIfModuleWasGenerated(o)) {
      var ares = calculateOrderItem(o, manMode, undefined, ol?.roomContours, withDropContainers);
