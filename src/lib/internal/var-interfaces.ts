...
export interface IModVar_mod_BacksplashId { mod_BacksplashId?: string; }
export interface IModVarNonNull_mod_BacksplashId { get mod_BacksplashId(): string; }
...
export interface IModVar_mod_BaseboardColor { mod_BaseboardColor?: string; }
export interface IModVarNonNull_mod_BaseboardColor { get mod_BaseboardColor(): string; get mod_BaseboardColor_matrix(): IMatrix_mod_BaseboardColor; }
export interface IModVar_mod_BaseboardDepth { mod_BaseboardDepth?: number; }
export interface IModVarNonNull_mod_BaseboardDepth { get mod_BaseboardDepth(): number; }
export interface IModVar_mod_BaseboardDepthLogic { mod_BaseboardDepthLogic?: string; }
export interface IModVarNonNull_mod_BaseboardDepthLogic { get mod_BaseboardDepthLogic(): string; }
export interface IModVar_mod_BaseboardEdgeBackColor { mod_BaseboardEdgeBackColor?: string; }
export interface IModVarNonNull_mod_BaseboardEdgeBackColor { get mod_BaseboardEdgeBackColor(): string; }
export interface IModVar_mod_BaseboardEdgeColor { mod_BaseboardEdgeColor?: string; }
export interface IModVarNonNull_mod_BaseboardEdgeColor { get mod_BaseboardEdgeColor(): string; }
export interface IModVar_mod_BaseboardEdgeFrontColor { mod_BaseboardEdgeFrontColor?: string; }
export interface IModVarNonNull_mod_BaseboardEdgeFrontColor { get mod_BaseboardEdgeFrontColor(): string; }
export interface IModVar_mod_BaseboardId { mod_BaseboardId?: string; }
export interface IModVarNonNull_mod_BaseboardId { get mod_BaseboardId(): string; }
export interface IModVar_mod_BaseboardLength { mod_BaseboardLength?: number; }
export interface IModVarNonNull_mod_BaseboardLength { get mod_BaseboardLength(): number; }
export interface IModVar_mod_BaseboardOverdimensionBack { mod_BaseboardOverdimensionBack?: number; }
export interface IModVarNonNull_mod_BaseboardOverdimensionBack { get mod_BaseboardOverdimensionBack(): number; }
export interface IModVar_mod_BaseboardOverdimensionLeft { mod_BaseboardOverdimensionLeft?: number; }
export interface IModVarNonNull_mod_BaseboardOverdimensionLeft { get mod_BaseboardOverdimensionLeft(): number; }
export interface IModVar_mod_BaseboardOverdimensionRight { mod_BaseboardOverdimensionRight?: number; }
export interface IModVarNonNull_mod_BaseboardOverdimensionRight { get mod_BaseboardOverdimensionRight(): number; }
export interface IModVar_mod_BaseboardProgram { mod_BaseboardProgram?: string; }
export interface IModVarNonNull_mod_BaseboardProgram { get mod_BaseboardProgram(): string; get mod_BaseboardProgram_matrix(): IMatrix_mod_BaseboardProgram; }
export interface IModVar_mod_BaseboardSplitLogic { mod_BaseboardSplitLogic?: string; }
export interface IModVarNonNull_mod_BaseboardSplitLogic { get mod_BaseboardSplitLogic(): string; }
export interface IModVar_mod_BaseboardThk { mod_BaseboardThk?: number; }
export interface IModVarNonNull_mod_BaseboardThk { get mod_BaseboardThk(): number; }
export interface IModVar_mod_BaseunitFridgeId { mod_BaseunitFridgeId?: string; }
export interface IModVarNonNull_mod_BaseunitFridgeId { get mod_BaseunitFridgeId(): string; }
export interface IModVar_mod_BaseunitFridgeInfo { mod_BaseunitFridgeInfo: string[]; }
export interface IModVarNonNull_mod_BaseunitFridgeInfo { get mod_BaseunitFridgeInfo(): string[]; }
export interface IModVar_mod_BaseunitFridgeSupplier { mod_BaseunitFridgeSupplier?: string; }
export interface IModVarNonNull_mod_BaseunitFridgeSupplier { get mod_BaseunitFridgeSupplier(): string; }
export interface IModVar_mod_BoardShelfColor { mod_BoardShelfColor?: string; }
export interface IModVarNonNull_mod_BoardShelfColor { get mod_BoardShelfColor(): string; get mod_BoardShelfColor_matrix(): IMatrix_mod_BoardShelfColor; }
export interface IModVar_mod_BoardShelfDepth { mod_BoardShelfDepth?: number; }
export interface IModVarNonNull_mod_BoardShelfDepth { get mod_BoardShelfDepth(): number; }
export interface IModVar_mod_BoardShelfPositionHeight { mod_BoardShelfPositionHeight?: number; }
export interface IModVarNonNull_mod_BoardShelfPositionHeight { get mod_BoardShelfPositionHeight(): number; }
export interface IModVar_mod_BoardShelfPositionWidth { mod_BoardShelfPositionWidth?: number; }
export interface IModVarNonNull_mod_BoardShelfPositionWidth { get mod_BoardShelfPositionWidth(): number; }
export interface IModVar_mod_BoardShelfProgram { mod_BoardShelfProgram?: string; }
export interface IModVarNonNull_mod_BoardShelfProgram { get mod_BoardShelfProgram(): string; get mod_BoardShelfProgram_matrix(): IMatrix_mod_BoardShelfProgram; }
export interface IModVar_mod_BoardShelfThickness { mod_BoardShelfThickness?: number; }
export interface IModVarNonNull_mod_BoardShelfThickness { get mod_BoardShelfThickness(): number; }
export interface IModVar_mod_BoardShelfWidth { mod_BoardShelfWidth?: number; }
export interface IModVarNonNull_mod_BoardShelfWidth { get mod_BoardShelfWidth(): number; }
...
export interface IModVar_mod_CarcaseOverdimensionBackLogic { mod_CarcaseOverdimensionBackLogic?: string; }
export interface IModVarNonNull_mod_CarcaseOverdimensionBackLogic { get mod_CarcaseOverdimensionBackLogic(): string; }
...
export interface IModVarNonNull_mod_CeilingFillerColor { get mod_CeilingFillerColor(): string; get mod_CeilingFillerColor_matrix(): IMatrix_mod_CeilingFillerColor; }
export interface IModVar_mod_CeilingFillerConstruction { mod_CeilingFillerConstruction?: string; }
export interface IModVarNonNull_mod_CeilingFillerConstruction { get mod_CeilingFillerConstruction(): string; }
export interface IModVar_mod_CeilingFillerEdgeBackColor { mod_CeilingFillerEdgeBackColor?: string; }
export interface IModVarNonNull_mod_CeilingFillerEdgeBackColor { get mod_CeilingFillerEdgeBackColor(): string; }
export interface IModVar_mod_CeilingFillerEdgeFrontColor { mod_CeilingFillerEdgeFrontColor?: string; }
export interface IModVarNonNull_mod_CeilingFillerEdgeFrontColor { get mod_CeilingFillerEdgeFrontColor(): string; }
export interface IModVar_mod_CeilingFillerEdgeLeftColor { mod_CeilingFillerEdgeLeftColor?: string; }
export interface IModVarNonNull_mod_CeilingFillerEdgeLeftColor { get mod_CeilingFillerEdgeLeftColor(): string; }
export interface IModVar_mod_CeilingFillerEdgeRightColor { mod_CeilingFillerEdgeRightColor?: string; }
export interface IModVarNonNull_mod_CeilingFillerEdgeRightColor { get mod_CeilingFillerEdgeRightColor(): string; }
...
export interface IModVar_mod_CeilingFillerId { mod_CeilingFillerId?: string; }
export interface IModVarNonNull_mod_CeilingFillerId { get mod_CeilingFillerId(): string; }
export interface IModVar_mod_CeilingFillerProgram { mod_CeilingFillerProgram?: string; }
export interface IModVarNonNull_mod_CeilingFillerProgram { get mod_CeilingFillerProgram(): string; get mod_CeilingFillerProgram_matrix(): IMatrix_mod_CeilingFillerProgram; }
export interface IModVar_mod_CeilingFillerRecess { mod_CeilingFillerRecess?: number; }
export interface IModVarNonNull_mod_CeilingFillerRecess { get mod_CeilingFillerRecess(): number; }
export interface IModVar_mod_CeilingFillerRecessLeft { mod_CeilingFillerRecessLeft?: number; }
export interface IModVarNonNull_mod_CeilingFillerRecessLeft { get mod_CeilingFillerRecessLeft(): number; }
export interface IModVar_mod_CeilingFillerRecessRight { mod_CeilingFillerRecessRight?: number; }
export interface IModVarNonNull_mod_CeilingFillerRecessRight { get mod_CeilingFillerRecessRight(): number; }
...
export interface IModVar_mod_CeilingFillerTransitionType { mod_CeilingFillerTransitionType?: string; }
export interface IModVarNonNull_mod_CeilingFillerTransitionType { get mod_CeilingFillerTransitionType(): string; }
...
export interface IModVar_mod_ClothingOrganizerBoardColor { mod_ClothingOrganizerBoardColor?: string; }
export interface IModVarNonNull_mod_ClothingOrganizerBoardColor { get mod_ClothingOrganizerBoardColor(): string; }
export interface IModVar_mod_ClothingOrganizerColor { mod_ClothingOrganizerColor?: string; }
export interface IModVarNonNull_mod_ClothingOrganizerColor { get mod_ClothingOrganizerColor(): string; }
export interface IModVar_mod_ClothingOrganizerConnectionPosition { mod_ClothingOrganizerConnectionPosition?: string; }
export interface IModVarNonNull_mod_ClothingOrganizerConnectionPosition { get mod_ClothingOrganizerConnectionPosition(): string; }
export interface IModVar_mod_ClothingOrganizerDepthPosition { mod_ClothingOrganizerDepthPosition?: string; }
export interface IModVarNonNull_mod_ClothingOrganizerDepthPosition { get mod_ClothingOrganizerDepthPosition(): string; }
export interface IModVar_mod_ClothingOrganizerDesign { mod_ClothingOrganizerDesign?: string; }
export interface IModVarNonNull_mod_ClothingOrganizerDesign { get mod_ClothingOrganizerDesign(): string; get mod_ClothingOrganizerDesign_matrix(): IMatrix_mod_ClothingOrganizerDesign; }
export interface IModVar_mod_ClothingOrganizerDistanceBlock { mod_ClothingOrganizerDistanceBlock?: string; }
export interface IModVarNonNull_mod_ClothingOrganizerDistanceBlock { get mod_ClothingOrganizerDistanceBlock(): string; }
export interface IModVar_mod_ClothingOrganizerHeightPosition { mod_ClothingOrganizerHeightPosition?: number; }
export interface IModVarNonNull_mod_ClothingOrganizerHeightPosition { get mod_ClothingOrganizerHeightPosition(): number; }
export interface IModVar_mod_ClothingOrganizerType { mod_ClothingOrganizerType?: string; }
export interface IModVarNonNull_mod_ClothingOrganizerType { get mod_ClothingOrganizerType(): string; }
export interface IModVar_mod_CoatBoardColor { mod_CoatBoardColor?: string; }
export interface IModVarNonNull_mod_CoatBoardColor { get mod_CoatBoardColor(): string; get mod_CoatBoardColor_matrix(): IMatrix_mod_CoatBoardColor; }
export interface IModVar_mod_CoatBoardId { mod_CoatBoardId?: string; }
export interface IModVarNonNull_mod_CoatBoardId { get mod_CoatBoardId(): string; }
export interface IModVar_mod_CoatBoardProgram { mod_CoatBoardProgram?: string; }
export interface IModVarNonNull_mod_CoatBoardProgram { get mod_CoatBoardProgram(): string; get mod_CoatBoardProgram_matrix(): IMatrix_mod_CoatBoardProgram; }
export interface IModVar_mod_CoatBoardThickness { mod_CoatBoardThickness?: number; }
export interface IModVarNonNull_mod_CoatBoardThickness { get mod_CoatBoardThickness(): number; }
...
export interface IModVar_mod_CornerunitStraightDimensionLogic { mod_CornerunitStraightDimensionLogic?: string; }
export interface IModVarNonNull_mod_CornerunitStraightDimensionLogic { get mod_CornerunitStraightDimensionLogic(): string; }
...
export interface IModVarNonNull_mod_DoorDirection { get mod_DoorDirection(): string; }
export interface IModVar_mod_DoorDirectionSelection { mod_DoorDirectionSelection?: string; }
export interface IModVarNonNull_mod_DoorDirectionSelection { get mod_DoorDirectionSelection(): string; }
export interface IModVar_mod_DoorType { mod_DoorType?: string; }
export interface IModVarNonNull_mod_DoorType { get mod_DoorType(): string; }
export interface IModVar_mod_DoorTypeSelection { mod_DoorTypeSelection?: string; }
export interface IModVarNonNull_mod_DoorTypeSelection { get mod_DoorTypeSelection(): string; }
...
export interface IModVar_mod_FirstFront { mod_FirstFront?: boolean; }
export interface IModVarNonNull_mod_FirstFront { get mod_FirstFront(): boolean; }
...
export interface IModVar_mod_FrameFillingType { mod_FrameFillingType?: string; }
export interface IModVarNonNull_mod_FrameFillingType { get mod_FrameFillingType(): string; }
...
export interface IModVar_mod_FrontSegmentColor { mod_FrontSegmentColor?: string; }
export interface IModVarNonNull_mod_FrontSegmentColor { get mod_FrontSegmentColor(): string; get mod_FrontSegmentColor_matrix(): IMatrix_mod_FrontSegmentColor; }
export interface IModVar_mod_FrontSegmentDescriptor { mod_FrontSegmentDescriptor?: string; }
export interface IModVarNonNull_mod_FrontSegmentDescriptor { get mod_FrontSegmentDescriptor(): string; }
export interface IModVar_mod_FrontSegmentType { mod_FrontSegmentType?: string; }
export interface IModVarNonNull_mod_FrontSegmentType { get mod_FrontSegmentType(): string; }
...
export interface IModVar_mod_GlobalFrontOversizeBtm { mod_GlobalFrontOversizeBtm?: number; }
export interface IModVarNonNull_mod_GlobalFrontOversizeBtm { get mod_GlobalFrontOversizeBtm(): number; }
export interface IModVar_mod_GlobalFrontOversizeLeft { mod_GlobalFrontOversizeLeft?: number; }
export interface IModVarNonNull_mod_GlobalFrontOversizeLeft { get mod_GlobalFrontOversizeLeft(): number; }
export interface IModVar_mod_GlobalFrontOversizeRight { mod_GlobalFrontOversizeRight?: number; }
export interface IModVarNonNull_mod_GlobalFrontOversizeRight { get mod_GlobalFrontOversizeRight(): number; }
export interface IModVar_mod_GlobalFrontOversizeTop { mod_GlobalFrontOversizeTop?: number; }
export interface IModVarNonNull_mod_GlobalFrontOversizeTop { get mod_GlobalFrontOversizeTop(): number; }
...
export interface IModVar_mod_HandleActivated { mod_HandleActivated?: string; }
export interface IModVarNonNull_mod_HandleActivated { get mod_HandleActivated(): string; }
...
export interface IModVar_mod_HandleInsertion { mod_HandleInsertion?: boolean; }
export interface IModVarNonNull_mod_HandleInsertion { get mod_HandleInsertion(): boolean; }
...
export interface IModVar_mod_HandlePosMatrixMultiple { mod_HandlePosMatrixMultiple?: string; }
export interface IModVarNonNull_mod_HandlePosMatrixMultiple { get mod_HandlePosMatrixMultiple(): string; get mod_HandlePosMatrixMultiple_matrix(): IMatrix_mod_HandlePosMatrixMultiple; }
...
export interface IModVar_mod_LastFront { mod_LastFront?: boolean; }
export interface IModVarNonNull_mod_LastFront { get mod_LastFront(): boolean; }
...
export interface IModVar_mod_LaundryMachineId { mod_LaundryMachineId?: string; }
export interface IModVarNonNull_mod_LaundryMachineId { get mod_LaundryMachineId(): string; }
export interface IModVar_mod_LaundryMachineSupplier { mod_LaundryMachineSupplier?: string; }
export interface IModVarNonNull_mod_LaundryMachineSupplier { get mod_LaundryMachineSupplier(): string; }
...
export interface IModVar_mod_MirrorBoardColor { mod_MirrorBoardColor?: string; }
export interface IModVarNonNull_mod_MirrorBoardColor { get mod_MirrorBoardColor(): string; get mod_MirrorBoardColor_matrix(): IMatrix_mod_MirrorBoardColor; }
export interface IModVar_mod_MirrorBoardId { mod_MirrorBoardId?: string; }
export interface IModVarNonNull_mod_MirrorBoardId { get mod_MirrorBoardId(): string; }
export interface IModVar_mod_MirrorBoardProgram { mod_MirrorBoardProgram?: string; }
export interface IModVarNonNull_mod_MirrorBoardProgram { get mod_MirrorBoardProgram(): string; get mod_MirrorBoardProgram_matrix(): IMatrix_mod_MirrorBoardProgram; }
export interface IModVar_mod_MirrorBoardThickness { mod_MirrorBoardThickness?: number; }
export interface IModVarNonNull_mod_MirrorBoardThickness { get mod_MirrorBoardThickness(): number; }
export interface IModVar_mod_MirrorColor { mod_MirrorColor?: string; }
export interface IModVarNonNull_mod_MirrorColor { get mod_MirrorColor(): string; }
export interface IModVar_mod_MirrorHeight { mod_MirrorHeight?: number; }
export interface IModVarNonNull_mod_MirrorHeight { get mod_MirrorHeight(): number; }
export interface IModVar_mod_MirrorPositionHeight { mod_MirrorPositionHeight?: number; }
export interface IModVarNonNull_mod_MirrorPositionHeight { get mod_MirrorPositionHeight(): number; }
export interface IModVar_mod_MirrorPositionWidth { mod_MirrorPositionWidth?: number; }
export interface IModVarNonNull_mod_MirrorPositionWidth { get mod_MirrorPositionWidth(): number; }
export interface IModVar_mod_MirrorThickness { mod_MirrorThickness?: number; }
export interface IModVarNonNull_mod_MirrorThickness { get mod_MirrorThickness(): number; }
export interface IModVar_mod_MirrorWidth { mod_MirrorWidth?: number; }
export interface IModVarNonNull_mod_MirrorWidth { get mod_MirrorWidth(): number; }
...
export interface IModVar_mod_PantryPulloutColor { mod_PantryPulloutColor?: string; }
export interface IModVarNonNull_mod_PantryPulloutColor { get mod_PantryPulloutColor(): string; }
export interface IModVar_mod_PantryPulloutDesign { mod_PantryPulloutDesign?: string; }
export interface IModVarNonNull_mod_PantryPulloutDesign { get mod_PantryPulloutDesign(): string; }
export interface IModVar_mod_PantryPulloutType { mod_PantryPulloutType?: string; }
export interface IModVarNonNull_mod_PantryPulloutType { get mod_PantryPulloutType(): string; }
...
export interface IModVar_mod_PlinthAreaVisLeftSelection { mod_PlinthAreaVisLeftSelection?: string; }
export interface IModVarNonNull_mod_PlinthAreaVisLeftSelection { get mod_PlinthAreaVisLeftSelection(): string; }
...
export interface IModVar_mod_PlinthAreaVisRightSelection { mod_PlinthAreaVisRightSelection?: string; }
export interface IModVarNonNull_mod_PlinthAreaVisRightSelection { get mod_PlinthAreaVisRightSelection(): string; }
...
export interface IModVar_mod_PulloutConnectionPosition { mod_PulloutConnectionPosition?: string; }
export interface IModVarNonNull_mod_PulloutConnectionPosition { get mod_PulloutConnectionPosition(): string; }
...
export interface IModVar_mod_PulloutElementColor { mod_PulloutElementColor?: string; }
export interface IModVarNonNull_mod_PulloutElementColor { get mod_PulloutElementColor(): string; }
...
export interface IModVarNonNull_mod_ShelfadjDesign { get mod_ShelfadjDesign(): string; }
...
export interface IModVar_mod_ShelfadjGroupPositionY { mod_ShelfadjGroupPositionY?: number; }
export interface IModVarNonNull_mod_ShelfadjGroupPositionY { get mod_ShelfadjGroupPositionY(): number; }
...
export interface IModVar_mod_TotalDepth { mod_TotalDepth?: number; }
export interface IModVarNonNull_mod_TotalDepth { get mod_TotalDepth(): number; }
...
export interface IModVar_mod_TotalWidth { mod_TotalWidth?: number; }
export interface IModVarNonNull_mod_TotalWidth { get mod_TotalWidth(): number; }
...
export interface IModVarNonNull_mod_UprightColor { get mod_UprightColor(): string; get mod_UprightColor_matrix(): IMatrix_mod_UprightColor; }
export interface IModVar_mod_UprightConstruction { mod_UprightConstruction?: string; }
export interface IModVarNonNull_mod_UprightConstruction { get mod_UprightConstruction(): string; get mod_UprightConstruction_matrix(): IMatrix_mod_UprightConstruction; }
...
export interface IModVar_mod_UprightOverdimensionBtm { mod_UprightOverdimensionBtm?: number; }
export interface IModVarNonNull_mod_UprightOverdimensionBtm { get mod_UprightOverdimensionBtm(): number; }
export interface IModVar_mod_UprightOverdimensionTop { mod_UprightOverdimensionTop?: number; }
export interface IModVarNonNull_mod_UprightOverdimensionTop { get mod_UprightOverdimensionTop(): number; }
...
export interface IModVar_mod_UprightProgram { mod_UprightProgram?: string; }
export interface IModVarNonNull_mod_UprightProgram { get mod_UprightProgram(): string; get mod_UprightProgram_matrix(): IMatrix_mod_UprightProgram; }
...
export interface IModVar_mod_WidthBlind { mod_WidthBlind?: number; }
export interface IModVarNonNull_mod_WidthBlind { get mod_WidthBlind(): number; }
...
export interface ITableParents_mf_CornerFillerFront_mr_CornerFiller extends IModVarNonNull_mod_WidthLeft
  , IModVarNonNull_mod_WidthRight
  , IModVarNonNull_mod_HeightLeft
  , IModVarNonNull_mod_HeightRight
  , IModVarNonNull_mod_CarcaseId
  , IModVarNonNull_mod_FingergripTop
...
export interface ITableParents_mr_CornerunitStraight extends IModVarNonNull_mod_BackwallFixedHeight
  ...
  , IModVarNonNull_mod_FrameFillingType
  ...
  , IModVarNonNull_mod_GlobalFrontOversizeLeft
  , IModVarNonNull_mod_GlobalFrontOversizeRight
  , IModVarNonNull_mod_GlobalFrontOversizeTop
  , IModVarNonNull_mod_GlobalFrontOversizeBtm
  , IModVarNonNull_mod_CreateBacksplash
  , IModVarNonNull_mod_CornerunitStraightDimensionLogic
  , IModVarNonNull_mod_TotalDepth
  , IModVarNonNull_mod_TotalWidth
  , IModVarNonNull_mod_WidthBlind
...
export interface ITableParents_mc_Drawer01 extends IModVarNonNull_mod_BackwallPos
  ...
  , IModVarNonNull_mod_FrameFillingColor
  , IModVarNonNull_mod_FirstFront
  , IModVarNonNull_mod_LastFront
  , IModVarNonNull_mod_FrontSegmentType
  , IModVarNonNull_mod_FrontSegmentColor
  , IModVarNonNull_mod_FrontSegmentDescriptor {
  get g(): IGlobalVars;
}
...
export interface ITableParents_mc_BaseunitFridge01_mc_CornerFillerFront01_mc_Dishwasher01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01_mc_Pullout01 extends IModVarNonNull_mod_FrontColor
  , IModVarNonNull_mod_FrontDesign
  , IModVarNonNull_mod_FrontEdgeColor
  , IModVarNonNull_mod_FrontEdgeThk
  , IModVarNonNull_mod_FrontGapCarcase
...
export interface ITableParents_mc_Pullout01 extends IModVarNonNull_mod_BackwallPos
  , IModVarNonNull_mod_CarcaseDepth
  , IModVarNonNull_mod_CarcaseHeight
  , IModVarNonNull_mod_CarcaseId
  , IModVarNonNull_mod_CarcaseWidth
  ...
  , IModVarNonNull_mod_FrameFillingType
  , IModVarNonNull_mod_FrameFillingColor
  , IModVarNonNull_mod_PulloutElementColor
  , IModVarNonNull_mod_DrawerOpeningDistance
  , IModVarNonNull_mod_PulloutDesign
...
import { dc_mc_CornerunitStraight01 } from './modules/mc_CornerunitStraight01'
import { dc_mf_RackArea } from './modules/mf_RackArea'
import { dc_mf_Drawer } from './modules/mf_Drawer'
import { dc_mf_CornerFillerFront } from './modules/mf_CornerFillerFront'
...
import { dc_me_ShelfadjMultiple01 } from './modules/me_ShelfadjMultiple01'
import { dc_me_ClothingOrganizer01 } from './modules/me_ClothingOrganizer01'
import { dc_me_HoodInsert } from './modules/me_HoodInsert'
import { dc_md_EquipmentPlaceholder } from './modules/md_EquipmentPlaceholder'
...
import { dc_mc_CornerFillerFront01 } from './modules/mc_CornerFillerFront01'
...
export interface IFuncParents_mf_Door extends IModBaseProp, IModVarNonNull_mod_BackwallPos
  ...
  , IModVarNonNull_mod_FirstFront
  , IModVarNonNull_mod_LastFront
  , IModVarNonNull_mod_HandlePosMatrixMultiple
  , IModVarNonNull_mod_FrontSegmentType
  , IModVarNonNull_mod_FrontSegmentColor
  , IModVarNonNull_mod_FrontSegmentDescriptor
  , IModVarNonNull_mod_DoorDirectionSelection
  , IModVarNonNull_mod_Information
  , IModVarNonNull_mod_DoorTypeSelection {
  get m(): OD_Base[];
  ...
  addOD_M_me_HoodInsert(index?: number): dc_me_HoodInsert
  addOD_M_md_EquipmentPlaceholder(index?: number): dc_md_EquipmentPlaceholder
}
...
export interface IFuncParents_mc_PulloutHardware01 extends IModBaseProp, IModVarNonNull_mod_PulloutConnectionPosition
  , IModVarNonNull_mod_PulloutDesign
  , IModVarNonNull_mod_PulloutElementColor
  , IModVarNonNull_mod_PulloutType
  , IModVarNonNull_mod_OpeningType
...
export interface IFuncParents_mf_CornerFillerFront_mr_CornerFiller extends IModBaseProp, IModVarNonNull_mod_WidthLeft
  , IModVarNonNull_mod_WidthRight
  , IModVarNonNull_mod_HeightLeft
  , IModVarNonNull_mod_HeightRight
  , IModVarNonNull_mod_CarcaseId
