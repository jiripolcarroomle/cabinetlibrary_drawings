...
import { IP_part_BaseunitFridgePanelWoodFrame_PartVarsWritable } from './parts/part_BaseunitFridgePanelWoodFrame'
...
import { IP_part_PulloutUnit_PartVarsWritable } from './parts/part_PulloutUnit'
import { IP_part_PulloutHardware_PartVarsWritable } from './parts/part_PulloutHardware'
import { IP_part_PulloutHardwareDrillings_PartVarsWritable } from './parts/part_PulloutHardwareDrillings'
import { IP_part_ApplianceUnit_PartVarsWritable } from './parts/part_ApplianceUnit'
import { IP_part_BaseboardGroup_PartVarsWritable } from './parts/part_BaseboardGroup'
import { IP_part_Baseboard_PartVarsWritable } from './parts/part_Baseboard'
import { IP_part_PantryPulloutUnit_PartVarsWritable } from './parts/part_PantryPulloutUnit'
import { IP_part_MirrorBoardGroup_PartVarsWritable } from './parts/part_MirrorBoardGroup'
import { IP_part_CoatBoardGroup_PartVarsWritable } from './parts/part_CoatBoardGroup'
import { IP_part_PantryPulloutBom_PartVarsWritable } from './parts/part_PantryPulloutBom'
import { IP_part_PantryPulloutHardware_PartVarsWritable } from './parts/part_PantryPulloutHardware'
import { IP_part_PantryPulloutDrill_PartVarsWritable } from './parts/part_PantryPulloutDrill'
import { IP_part_MirrorBoard_PartVarsWritable } from './parts/part_MirrorBoard'
import { IP_part_Mirror_PartVarsWritable } from './parts/part_Mirror'
import { IP_part_BoardShelf_PartVarsWritable } from './parts/part_BoardShelf'
import { IP_part_CoatBoard_PartVarsWritable } from './parts/part_CoatBoard'
import { IP_part_BoardHanger_PartVarsWritable } from './parts/part_BoardHanger'
import { IP_part_ClothingOrganizerUnit_PartVarsWritable } from './parts/part_ClothingOrganizerUnit'
import { IP_part_ClothingOrganizerDrilling_PartVarsWritable } from './parts/part_ClothingOrganizerDrilling'
import { IP_part_ClothingOrganizerGraphic_PartVarsWritable } from './parts/part_ClothingOrganizerGraphic'
import { IP_part_ClothingOrganizerBOM_PartVarsWritable } from './parts/part_ClothingOrganizerBOM'
import { IP_part_ClothingOrganizerBoard_PartVarsWritable } from './parts/part_ClothingOrganizerBoard'
...
export interface IPartAdd_part_Pullout {
  addpart_Pullout(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Pullout_PartVarsWritable;
}
export interface IPartAdd_part_BaseunitFridgePanel {
  addpart_BaseunitFridgePanel(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_BaseunitFridgePanel_PartVarsWritable;
}
...
export interface IPartAdd_part_BaseunitFridgePanelWoodFrame {
  addpart_BaseunitFridgePanelWoodFrame(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_BaseunitFridgePanelWoodFrame_PartVarsWritable;
}
...
export interface IPartAdd_part_PulloutHardwareDrillings {
...
export interface IPartAdd_part_BaseboardGroup {
...
export interface IPartAdd_part_MirrorBoardGroup {
...
export interface IPartAdd_part_CoatBoardGroup {
...
export interface IPartAdd_part_PantryPulloutBom {
...
export interface IPartAdd_part_PantryPulloutHardware {
...
export interface IPartAdd_part_PantryPulloutDrill {
...
export interface IPartAdd_part_MirrorBoard {
  addpart_MirrorBoard(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_MirrorBoard_PartVarsWritable;
}
export interface IPartAdd_part_Mirror {
  addpart_Mirror(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Mirror_PartVarsWritable;
}
export interface IPartAdd_part_BoardShelf {
  addpart_BoardShelf(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_BoardShelf_PartVarsWritable;
}
export interface IPartAdd_part_CoatBoard {
  addpart_CoatBoard(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_CoatBoard_PartVarsWritable;
}
export interface IPartAdd_part_BoardHanger {
  addpart_BoardHanger(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_BoardHanger_PartVarsWritable;
}
export interface IPartAdd_part_ClothingOrganizerUnit {
...
export interface IPartAdd_part_ClothingOrganizerDrilling {
  addpart_ClothingOrganizerDrilling(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_ClothingOrganizerDrilling_PartVarsWritable;
}
export interface IPartAdd_part_ClothingOrganizerGraphic {
  addpart_ClothingOrganizerGraphic(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_ClothingOrganizerGraphic_PartVarsWritable;
}
export interface IPartAdd_part_ClothingOrganizerBOM {
  addpart_ClothingOrganizerBOM(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_ClothingOrganizerBOM_PartVarsWritable;
}
export interface IPartAdd_part_ClothingOrganizerBoard {
  addpart_ClothingOrganizerBoard(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_ClothingOrganizerBoard_PartVarsWritable;
}
export interface IPartAdd_part_DoorSegmented {
  addpart_DoorSegmented(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_DoorSegmented_PartVarsWritable;
}
export interface IPartAdd_part_SegmentedFront {
  addpart_SegmentedFront(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_SegmentedFront_PartVarsWritable;
}
