...
export interface adc_mf_Drawer extends adc_base_mf_Drawer {
  addOD_M_mc_Drawer01(index?: number): dc_mc_Drawer01;
}

export interface ccm_mf_Drawer extends adc_base_mf_Drawer {
}
...
export class OD_M_mf_Drawer extends OD_Base implements dc_mf_Drawer
  ...
  override validateSelections(): void {
    ...
    this.mod_DrawerBoxWeightType_matrix = VariantValidation.mod_DrawerBoxWeightType(this, this.mod_DrawerBoxWeightType);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mf_Drawer_NonNull(this);
...
class OD_M_mf_Drawer_NonNull implements cbp_mf_Drawer, adc_mf_Drawer, ccm_mf_Drawer, IPartParentsNonNull_mf_Drawer {
  ...
  #calculateContainerModulesInternal = mf_Drawer_calculateContainerModules;
