...
import { IModParents_mf_BoardShelf } from '../mod-interfaces'
import { IP_part_BoardShelf_PartVarsWritable, P_part_BoardShelf } from '../parts/part_BoardShelf'
import { IModuleNonNull_mc_BoardShelf, IModParents_mc_BoardShelf, IPartParentsNonNull_mc_BoardShelf } from '../mod-interfaces'
import { IModVar_mod_FrontId, IModVarNonNull_mod_FrontId, IModVar_mod_BoardShelfColor, IModVarNonNull_mod_BoardShelfColor, IModVar_mod_BoardShelfProgram, IModVarNonNull_mod_BoardShelfProgram, IModVar_mod_BoardShelfWidth, IModVarNonNull_mod_BoardShelfWidth, IModVar_mod_BoardShelfDepth, IModVarNonNull_mod_BoardShelfDepth, IModVar_mod_BoardShelfThickness, IModVarNonNull_mod_BoardShelfThickness } from '../var-interfaces'
import { VariantValidation, IMatrix_mod_FrontId, IMatrix_mod_BoardShelfColor, IMatrix_mod_BoardShelfProgram, IMatrix_mod_BoardShelfWidth, IMatrix_mod_BoardShelfDepth, IMatrix_mod_BoardShelfThickness } from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_BoardShelf } from '../part-add-interfaces';
import { mc_BoardShelf_createBuildPlan, mc_BoardShelf_afterDataCompletion, mc_BoardShelf_manufacturerDataCompletion, mc_BoardShelf_calculateContainerModules, mc_BoardShelf_prepareContext } from '../../modules/mc_BoardShelf';

export interface cbp_mc_BoardShelf extends IModBaseProp
  , IPartAdd_part_BoardShelf, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_BoardShelfColor, IModVarNonNull_mod_BoardShelfProgram, IModVarNonNull_mod_BoardShelfWidth, IModVarNonNull_mod_BoardShelfDepth, IModVarNonNull_mod_BoardShelfThickness {
  parent: IModParents_mf_BoardShelf;
...
export interface dc_mc_BoardShelf extends IModBaseProp
  , IModVar_mod_FrontId, IModVar_mod_BoardShelfColor, IModVar_mod_BoardShelfProgram, IModVar_mod_BoardShelfWidth, IModVar_mod_BoardShelfDepth, IModVar_mod_BoardShelfThickness {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
  seal(): IModuleNonNull_mc_BoardShelf;
  parent: IModParents_mf_BoardShelf;
}

export interface pc_mc_BoardShelf extends dc_mc_BoardShelf {
...
export interface adc_base_mc_BoardShelf extends IModBaseProp
  , IModVarNonNull_mod_FrontId, IModVarNonNull_mod_BoardShelfColor, IModVarNonNull_mod_BoardShelfProgram, IModVarNonNull_mod_BoardShelfWidth, IModVarNonNull_mod_BoardShelfDepth, IModVarNonNull_mod_BoardShelfThickness {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_BoardShelf extends adc_base_mc_BoardShelf {
}

export interface ccm_mc_BoardShelf extends adc_base_mc_BoardShelf {
}


export class OD_M_mc_BoardShelf extends OD_Base implements pc_mc_BoardShelf, dc_mc_BoardShelf
  , IModParents_mc_BoardShelf
  , IModVar_mod_FrontId, IModVar_mod_BoardShelfColor, IModVar_mod_BoardShelfProgram, IModVar_mod_BoardShelfWidth, IModVar_mod_BoardShelfDepth, IModVar_mod_BoardShelfThickness {
  constructor(parent: IModParents_mf_BoardShelf, manufacturerMode?: boolean) {
    super('mc_BoardShelf', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_BoardShelf_NonNull(this);
  }
  parent: IModParents_mf_BoardShelf;
  _selfNonNull: OD_M_mc_BoardShelf_NonNull;

  override variants: string[] = ['mod_FrontId', 'mod_BoardShelfColor', 'mod_BoardShelfProgram', 'mod_BoardShelfWidth', 'mod_BoardShelfDepth', 'mod_BoardShelfThickness',];
  #mod_FrontId?: string;
  ...
  #dataCompletionAssignDerivedData() {
    ...
    if (this.mod_BoardShelfWidth === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_BoardShelfWidth')) {
          let pv = <IModVar_mod_BoardShelfWidth>s;
          if (pv.mod_BoardShelfWidth !== undefined) {
            this.mod_BoardShelfWidth = (<IModVar_mod_BoardShelfWidth>s).mod_BoardShelfWidth;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_BoardShelfDepth === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_BoardShelfDepth')) {
          let pv = <IModVar_mod_BoardShelfDepth>s;
          if (pv.mod_BoardShelfDepth !== undefined) {
            this.mod_BoardShelfDepth = (<IModVar_mod_BoardShelfDepth>s).mod_BoardShelfDepth;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_BoardShelfThickness === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_BoardShelfThickness')) {
          let pv = <IModVar_mod_BoardShelfThickness>s;
          if (pv.mod_BoardShelfThickness !== undefined) {
            this.mod_BoardShelfThickness = (<IModVar_mod_BoardShelfThickness>s).mod_BoardShelfThickness;
            break;
          };
        }
        s = s.parentBase;
  ...
  #manufacturerDataCompletionInternal = mc_BoardShelf_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_BoardShelf_NonNull(this);
  ...
  #prepareContextInternal = mc_BoardShelf_prepareContext;
  seal(): IModuleNonNull_mc_BoardShelf {
    this.afterDataCompletion();
    const adc = new OD_M_mc_BoardShelf_NonNull(this);
    return adc;
  }
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_BoardShelf_NonNull(this);
  ...
  addpart_BoardShelf(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_BoardShelf_PartVarsWritable {
    var c = new P_part_BoardShelf(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }

  override createBuildPlan(): void {
    var cbp = new OD_M_mc_BoardShelf_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_BoardShelf_NonNull implements cbp_mc_BoardShelf, adc_mc_BoardShelf, ccm_mc_BoardShelf, IPartParentsNonNull_mc_BoardShelf {
  constructor(parent: OD_M_mc_BoardShelf) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_BoardShelf;
  ...
  #createBuildPlanInternal = mc_BoardShelf_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_BoardShelf_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = mc_BoardShelf_calculateContainerModules;
  ...
  parent: IModParents_mf_BoardShelf;
  addpart_BoardShelf(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_BoardShelf_PartVarsWritable {
    return this.#internalParent.addpart_BoardShelf(x, y, z, dimx, dimy, dimz);
  }
