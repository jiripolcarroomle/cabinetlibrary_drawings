...
import { mc_MetalFrame01_createBuildPlan, mc_MetalFrame01_afterDataCompletion, mc_MetalFrame01_manufacturerDataCompletion, mc_MetalFrame01_calculateContainerModules, mc_MetalFrame01_prepareContext } from '../../modules/mc_MetalFrame01';
...
export interface pc_mc_MetalFrame01 extends dc_mc_MetalFrame01 {
...
export interface adc_base_mc_MetalFrame01 extends IModBaseProp
  , IModVarNonNull_mod_Depth, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_FrontType, IModVarNonNull_mod_Height, IModVarNonNull_mod_PartInfo, IModVarNonNull_mod_Width, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_FrontpanelWeightCalculations, IModVarNonNull_mod_FrontpanelWeightLogic, IModVarNonNull_mod_Information {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_MetalFrame01 extends adc_base_mc_MetalFrame01 {
}

export interface ccm_mc_MetalFrame01 extends adc_base_mc_MetalFrame01 {
}


export class OD_M_mc_MetalFrame01 extends OD_Base implements pc_mc_MetalFrame01, dc_mc_MetalFrame01
  ...
  #prepareContextInternal = mc_MetalFrame01_prepareContext;
  seal(): IModuleNonNull_mc_MetalFrame01 {
  ...
  override validateSelections(): void {
    ...
    this.mod_FrontpanelWeightLogic_matrix = VariantValidation.mod_FrontpanelWeightLogic(this, this.mod_FrontpanelWeightLogic);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_MetalFrame01_NonNull(this);
...
class OD_M_mc_MetalFrame01_NonNull implements cbp_mc_MetalFrame01, adc_mc_MetalFrame01, ccm_mc_MetalFrame01 {
  ...
  #calculateContainerModulesInternal = mc_MetalFrame01_calculateContainerModules;
