...
export interface pc_mc_Panelblind01 extends dc_mc_Panelblind01 {
...
export interface adc_base_mc_Panelblind01 extends IModBaseProp
...
export interface adc_mc_Panelblind01 extends adc_base_mc_Panelblind01 {
}

export interface ccm_mc_Panelblind01 extends adc_base_mc_Panelblind01 {
}


export class OD_M_mc_Panelblind01 extends OD_Base implements pc_mc_Panelblind01, dc_mc_Panelblind01
  ...
  #prepareContextInternal = mc_Panelblind01_prepareContext;
  seal(): IModuleNonNull_mc_Panelblind01 {
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Panelblind01_NonNull(this);
  ...
  addpart_Panelblind(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Panelblind_PartVarsWritable {
    var c = new P_part_Panelblind(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_Panelblind01_NonNull implements cbp_mc_Panelblind01, adc_mc_Panelblind01, ccm_mc_Panelblind01, IPartParentsNonNull_mc_Panelblind01 {
  ...
  #calculateContainerModulesInternal = mc_Panelblind01_calculateContainerModules;
