...
export interface adc_mc_CornerunitStraight01 extends adc_base_mc_CornerunitStraight01 {
  addOD_M_mc_Panelblind01(index?: number): dc_mc_Panelblind01;
  addOD_M_mc_VertDivider01(index?: number): dc_mc_VertDivider01;
}

export interface ccm_mc_CornerunitStraight01 extends adc_base_mc_CornerunitStraight01 {
}
...
export class OD_M_mc_CornerunitStraight01 extends OD_Base implements dc_mc_CornerunitStraight01
  ...
  override validateSelections(): void {
    ...
    this.mod_PanelblindThk_matrix = VariantValidation.mod_PanelblindThk(this, this.mod_PanelblindThk);
    ...
    this.mod_SidepanelmiddleShortWidth_matrix = VariantValidation.mod_SidepanelmiddleShortWidth(this, this.mod_SidepanelmiddleShortWidth);
    this.mod_SidepanelmiddleThk_matrix = VariantValidation.mod_SidepanelmiddleThk(this, this.mod_SidepanelmiddleThk);
    this.mod_CleatThk_matrix = VariantValidation.mod_CleatThk(this, this.mod_CleatThk);
    this.mod_CleatWidth_matrix = VariantValidation.mod_CleatWidth(this, this.mod_CleatWidth);
  }

  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_CornerunitStraight01_NonNull(this);
...
class OD_M_mc_CornerunitStraight01_NonNull implements cbp_mc_CornerunitStraight01, adc_mc_CornerunitStraight01, ccm_mc_CornerunitStraight01, IPartParentsNonNull_mc_CornerunitStraight01, IPartParentsNonNull_mc_CornerunitStraight01_mc_Storageunit01 {
  ...
  #calculateContainerModulesInternal = mc_CornerunitStraight01_calculateContainerModules;
