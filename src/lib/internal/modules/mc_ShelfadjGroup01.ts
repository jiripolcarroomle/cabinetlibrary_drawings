...
export interface pc_mc_ShelfadjGroup01 extends dc_mc_ShelfadjGroup01 {
...
export interface adc_base_mc_ShelfadjGroup01 extends IModBaseProp
  , IModVarNonNull_mod_ShelfadjDesign, IModVarNonNull_mod_Height, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Width, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_CarcaseColor, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseProgram, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_ShelfadjOffsetFront, IModVarNonNull_mod_ShelfadjOffsetBack, IModVarNonNull_mod_ShelfadjDrillType, IModVarNonNull_mod_ShelfadjDrillDistance, IModVarNonNull_mod_ShelfadjThk, IModVarNonNull_mod_ShelfadjDrillinglineOffsetTop, IModVarNonNull_mod_ShelfadjDrillinglineOffsetBtm, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_ShelfadjPartParentName, IModVarNonNull_mod_ShelfadjPartParentType, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_HardwareId, IModVarNonNull_mod_CarcaseSpaceDimension, IModVarNonNull_mod_VertDividerType, IModVarNonNull_mod_VertDividerPosition, IModVarNonNull_mod_ShelfadjColor, IModVarNonNull_mod_ShelfadjDescriptor {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_ShelfadjGroup01 extends adc_base_mc_ShelfadjGroup01 {
  addOD_M_mc_ShelfadjWood01(index?: number): dc_mc_ShelfadjWood01;
  addOD_M_mc_ShelfadjGlass01(index?: number): dc_mc_ShelfadjGlass01;
  addOD_M_mc_ShelfadjDrill01(index?: number): dc_mc_ShelfadjDrill01;
  addOD_M_mc_ShelfadjFitting01(index?: number): dc_mc_ShelfadjFitting01;
...
export interface ccm_mc_ShelfadjGroup01 extends adc_base_mc_ShelfadjGroup01 {
}


export class OD_M_mc_ShelfadjGroup01 extends OD_Base implements pc_mc_ShelfadjGroup01, dc_mc_ShelfadjGroup01
  , IModParents_mc_ShelfadjFitting01_mc_ShelfadjGroup01, IModParents_mc_ShelfadjGroup01_me_ShelfadjMultiple01
  , IModVar_mod_ShelfadjDesign, IModVar_mod_Height, IModVar_mod_Depth, IModVar_mod_Width, IModVar_mod_TypeElement, IModVar_mod_CarcaseColor, IModVar_mod_CarcaseId, IModVar_mod_CarcaseProgram, IModVar_mod_FrontDesign, IModVar_mod_ShelfadjOffsetFront, IModVar_mod_ShelfadjOffsetBack, IModVar_mod_ShelfadjDrillType, IModVar_mod_ShelfadjDrillDistance, IModVar_mod_ShelfadjThk, IModVar_mod_ShelfadjDrillinglineOffsetTop, IModVar_mod_ShelfadjDrillinglineOffsetBtm, IModVar_mod_ModuleName, IModVar_mod_ShelfadjPartParentName, IModVar_mod_ShelfadjPartParentType, IModVar_mod_FrontProgram, IModVar_mod_HardwareId, IModVar_mod_CarcaseSpaceDimension, IModVar_mod_VertDividerType, IModVar_mod_VertDividerPosition, IModVar_mod_ShelfadjColor, IModVar_mod_ShelfadjDescriptor {
  ...
  override variants: string[] = ['mod_ShelfadjDesign', 'mod_Height', 'mod_Depth', 'mod_Width', 'mod_TypeElement', 'mod_CarcaseColor', 'mod_CarcaseId', 'mod_CarcaseProgram', 'mod_FrontDesign', 'mod_ShelfadjOffsetFront', 'mod_ShelfadjOffsetBack', 'mod_ShelfadjDrillType', 'mod_ShelfadjDrillDistance', 'mod_ShelfadjThk', 'mod_ShelfadjDrillinglineOffsetTop', 'mod_ShelfadjDrillinglineOffsetBtm', 'mod_ModuleName', 'mod_ShelfadjPartParentName', 'mod_ShelfadjPartParentType', 'mod_FrontProgram', 'mod_HardwareId', 'mod_CarcaseSpaceDimension', 'mod_VertDividerType', 'mod_VertDividerPosition', 'mod_ShelfadjColor', 'mod_ShelfadjDescriptor',];
  ...
  #dataCompletionAssignDerivedData() {
    ...
    if (this.mod_ShelfadjOffsetFront === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_ShelfadjOffsetFront')) {
          let pv = <IModVar_mod_ShelfadjOffsetFront>s;
          if (pv.mod_ShelfadjOffsetFront !== undefined) {
            this.mod_ShelfadjOffsetFront = (<IModVar_mod_ShelfadjOffsetFront>s).mod_ShelfadjOffsetFront;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_ShelfadjOffsetBack === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_ShelfadjOffsetBack')) {
          let pv = <IModVar_mod_ShelfadjOffsetBack>s;
          if (pv.mod_ShelfadjOffsetBack !== undefined) {
            this.mod_ShelfadjOffsetBack = (<IModVar_mod_ShelfadjOffsetBack>s).mod_ShelfadjOffsetBack;
            break;
          };
        }
        s = s.parentBase;
  ...
  #prepareContextInternal = mc_ShelfadjGroup01_prepareContext;
  seal(): IModuleNonNull_mc_ShelfadjGroup01 {
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_ShelfadjGroup01_NonNull(this);
  ...
  addpart_ShelfadjFitting(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_ShelfadjFitting_PartVarsWritable {
    var c = new P_part_ShelfadjFitting(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_ShelfadjGroup01_NonNull implements cbp_mc_ShelfadjGroup01, adc_mc_ShelfadjGroup01, ccm_mc_ShelfadjGroup01, IPartParentsNonNull_mc_ShelfadjFitting01_mc_ShelfadjGroup01, IPartParentsNonNull_mc_ShelfadjGroup01_me_ShelfadjMultiple01 {
  ...
  #calculateContainerModulesInternal = mc_ShelfadjGroup01_calculateContainerModules;
