...
import { mc_FlipliftHardware01_createBuildPlan, mc_FlipliftHardware01_afterDataCompletion, mc_FlipliftHardware01_manufacturerDataCompletion, mc_FlipliftHardware01_calculateContainerModules, mc_FlipliftHardware01_prepareContext } from '../../modules/mc_FlipliftHardware01';
...
export interface pc_mc_FlipliftHardware01 extends dc_mc_FlipliftHardware01 {
...
export interface adc_base_mc_FlipliftHardware01 extends IModBaseProp
  , IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcasePartInfo, IModVarNonNull_mod_FlipliftFrontHeightList, IModVarNonNull_mod_FrontHeight, IModVarNonNull_mod_FlipliftType, IModVarNonNull_mod_Width, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Height, IModVarNonNull_mod_FlipliftFrontNumber, IModVarNonNull_mod_FlipliftHardwareColor, IModVarNonNull_mod_FlipliftHardwareType, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_OpeningType, IModVarNonNull_mod_OpeningAngle, IModVarNonNull_mod_FrontpanelWeightCalculations, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_FrontThk, IModVarNonNull_mod_FrontType, IModVarNonNull_mod_HardwareColor, IModVarNonNull_mod_HardwareTypeList, IModVarNonNull_mod_FrontOverlayInfo, IModVarNonNull_mod_HandleWeightCalculations, IModVarNonNull_mod_FlipliftLogic {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_FlipliftHardware01 extends adc_base_mc_FlipliftHardware01 {
}

export interface ccm_mc_FlipliftHardware01 extends adc_base_mc_FlipliftHardware01 {
}


export class OD_M_mc_FlipliftHardware01 extends OD_Base implements pc_mc_FlipliftHardware01, dc_mc_FlipliftHardware01
  ...
  #prepareContextInternal = mc_FlipliftHardware01_prepareContext;
  seal(): IModuleNonNull_mc_FlipliftHardware01 {
  ...
  override validateSelections(): void {
    ...
    this.mod_FrontOverlayInfo_matrix = VariantValidation.mod_FrontOverlayInfo(this, this.mod_FrontOverlayInfo);
    this.mod_FlipliftLogic_matrix = VariantValidation.mod_FlipliftLogic(this, this.mod_FlipliftLogic);
  }

  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_FlipliftHardware01_NonNull(this);
  ...
  addpart_FlipliftHardwareBom(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_FlipliftHardwareBom_PartVarsWritable {
    var c = new P_part_FlipliftHardwareBom(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_FlipliftHardwareGraphic(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_FlipliftHardwareGraphic_PartVarsWritable {
    var c = new P_part_FlipliftHardwareGraphic(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_FlipliftHardwareFrontpanelDrilling(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_FlipliftHardwareFrontpanelDrilling_PartVarsWritable {
    var c = new P_part_FlipliftHardwareFrontpanelDrilling(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_FlipliftHardwareSidepanelDrilling(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_FlipliftHardwareSidepanelDrilling_PartVarsWritable {
    var c = new P_part_FlipliftHardwareSidepanelDrilling(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_FlipliftHardware01_NonNull implements cbp_mc_FlipliftHardware01, adc_mc_FlipliftHardware01, ccm_mc_FlipliftHardware01, IPartParentsNonNull_mc_FlipliftHardware01 {
  ...
  #calculateContainerModulesInternal = mc_FlipliftHardware01_calculateContainerModules;
