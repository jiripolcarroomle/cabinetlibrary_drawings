...
export interface adc_mr_IslandBackwall extends adc_base_mr_IslandBackwall {
  addOD_M_mc_Panel01(index?: number): dc_mc_Panel01;
}

export interface ccm_mr_IslandBackwall extends adc_base_mr_IslandBackwall {
}
...
export class OD_M_mr_IslandBackwall extends OD_Base implements dc_mr_IslandBackwall
  ...
  override validateSelections(): void {
    ...
    this.mod_IslandBackwallOverdimension_matrix = VariantValidation.mod_IslandBackwallOverdimension(this, this.mod_IslandBackwallOverdimension);
    this.mod_IslandBackwallWidth_matrix = VariantValidation.mod_IslandBackwallWidth(this, this.mod_IslandBackwallWidth);
  }

  override calculateContainerModules(): void {
    let ccm = new OD_M_mr_IslandBackwall_NonNull(this);
...
class OD_M_mr_IslandBackwall_NonNull implements cbp_mr_IslandBackwall, adc_mr_IslandBackwall, ccm_mr_IslandBackwall, IPartParentsNonNull_mr_IslandBackwall {
  ...
  #calculateContainerModulesInternal = mr_IslandBackwall_calculateContainerModules;
