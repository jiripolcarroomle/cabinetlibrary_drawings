...
import { mc_StorageunitShelftop02_createBuildPlan, mc_StorageunitShelftop02_afterDataCompletion, mc_StorageunitShelftop02_manufacturerDataCompletion, mc_StorageunitShelftop02_calculateContainerModules, mc_StorageunitShelftop02_prepareContext } from '../../modules/mc_StorageunitShelftop02';
...
export interface pc_mc_StorageunitShelftop02 extends dc_mc_StorageunitShelftop02 {
...
export interface adc_base_mc_StorageunitShelftop02 extends IModBaseProp
  , IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseVisTop, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Height, IModVarNonNull_mod_ShelftopConstruction, IModVarNonNull_mod_Width, IModVarNonNull_mod_CarcaseColor, IModVarNonNull_mod_CarcaseOutsideColor, IModVarNonNull_mod_CarcaseEdgeBackColor, IModVarNonNull_mod_CarcaseEdgeColor, IModVarNonNull_mod_CarcaseEdgeFrontColor, IModVarNonNull_mod_CarcaseProgram, IModVarNonNull_mod_CarcaseOutsideProgram, IModVarNonNull_mod_EdgeFrontType, IModVarNonNull_mod_EdgeBackType, IModVarNonNull_mod_EdgeLeftType, IModVarNonNull_mod_EdgeRightType, IModVarNonNull_mod_EdgeJointType, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_CarcaseConnectionLeftTop, IModVarNonNull_mod_CarcaseConnectionRightTop, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_HardwareColor, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_FittingConnectionLeftTop, IModVarNonNull_mod_FittingConnectionRightTop, IModVarNonNull_mod_FittingConnectionTopVert, IModVarNonNull_mod_CarcasePartConnectionTopVert, IModVarNonNull_mod_PartInfo, IModVarNonNull_mod_SlopeAngle {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_StorageunitShelftop02 extends adc_base_mc_StorageunitShelftop02 {
}

export interface ccm_mc_StorageunitShelftop02 extends adc_base_mc_StorageunitShelftop02 {
}


export class OD_M_mc_StorageunitShelftop02 extends OD_Base implements pc_mc_StorageunitShelftop02, dc_mc_StorageunitShelftop02
  ...
  #prepareContextInternal = mc_StorageunitShelftop02_prepareContext;
  seal(): IModuleNonNull_mc_StorageunitShelftop02 {
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_StorageunitShelftop02_NonNull(this);
  ...
  addpart_Heatshelf(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Heatshelf_PartVarsWritable {
    var c = new P_part_Heatshelf(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_HeatshelfFront(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_HeatshelfFront_PartVarsWritable {
    var c = new P_part_HeatshelfFront(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_StorageunitShelftop02_NonNull implements cbp_mc_StorageunitShelftop02, adc_mc_StorageunitShelftop02, ccm_mc_StorageunitShelftop02, IPartParentsNonNull_mc_StorageunitShelftop02 {
  ...
  #calculateContainerModulesInternal = mc_StorageunitShelftop02_calculateContainerModules;
