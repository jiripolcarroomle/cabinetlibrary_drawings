...
import { IModuleNonNull_mc_Sink01, IModParents_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood, IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood } from '../mod-interfaces'
...
import { mc_Sink01_createBuildPlan, mc_Sink01_afterDataCompletion, mc_Sink01_manufacturerDataCompletion, mc_Sink01_calculateContainerModules, mc_Sink01_prepareContext } from '../../modules/mc_Sink01';
...
export interface pc_mc_Sink01 extends dc_mc_Sink01 {
...
export interface adc_base_mc_Sink01 extends IModBaseProp
  , IModVarNonNull_mod_SinkConstructionId, IModVarNonNull_mod_SinkGraphicId {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_Sink01 extends adc_base_mc_Sink01 {
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic;
}

export interface ccm_mc_Sink01 extends adc_base_mc_Sink01 {
}


export class OD_M_mc_Sink01 extends OD_Base implements pc_mc_Sink01, dc_mc_Sink01
  ...
  #prepareContextInternal = mc_Sink01_prepareContext;
  seal(): IModuleNonNull_mc_Sink01 {
  ...
  override validateSelections(): void {
    this.mod_SinkConstructionId_matrix = VariantValidation.mod_SinkConstructionId(this, this.mod_SinkConstructionId);
    this.mod_SinkGraphicId_matrix = VariantValidation.mod_SinkGraphicId(this, this.mod_SinkGraphicId);
  }

  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Sink01_NonNull(this);
...
class OD_M_mc_Sink01_NonNull implements cbp_mc_Sink01, adc_mc_Sink01, ccm_mc_Sink01, IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood {
  ...
  #calculateContainerModulesInternal = mc_Sink01_calculateContainerModules;
