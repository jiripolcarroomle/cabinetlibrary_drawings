...
import { mc_Paneltop01_createBuildPlan, mc_Paneltop01_afterDataCompletion, mc_Paneltop01_manufacturerDataCompletion, mc_Paneltop01_calculateContainerModules, mc_Paneltop01_prepareContext } from '../../modules/mc_Paneltop01';
...
export interface pc_mc_Paneltop01 extends dc_mc_Paneltop01 {
...
export interface adc_mc_Paneltop01 extends adc_base_mc_Paneltop01 {
}

export interface ccm_mc_Paneltop01 extends adc_base_mc_Paneltop01 {
}


export class OD_M_mc_Paneltop01 extends OD_Base implements pc_mc_Paneltop01, dc_mc_Paneltop01
  ...
  #prepareContextInternal = mc_Paneltop01_prepareContext;
  seal(): IModuleNonNull_mc_Paneltop01 {
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Paneltop01_NonNull(this);
  ...
  addpart_CeilingFillerFittingPanel(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_CeilingFillerFittingPanel_PartVarsWritable {
    var c = new P_part_CeilingFillerFittingPanel(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  ...
  addpart_PaneltopGroup(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_PaneltopGroup_PartVarsWritable {
    var c = new P_part_PaneltopGroup(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_Paneltop(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Paneltop_PartVarsWritable {
    var c = new P_part_Paneltop(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_Paneltop01_NonNull implements cbp_mc_Paneltop01, adc_mc_Paneltop01, ccm_mc_Paneltop01, IPartParentsNonNull_mc_Paneltop01, IPartParentsNonNull_mc_CeilingFiller01_mc_Paneltop01 {
  ...
  #calculateContainerModulesInternal = mc_Paneltop01_calculateContainerModules;
