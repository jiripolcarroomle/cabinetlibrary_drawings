...
import { IModVar_mod_Width, IModVarNonNull_mod_Width, IModVar_mod_Depth, IModVarNonNull_mod_Depth, IModVar_mod_Height, IModVarNonNull_mod_Height, IModVar_mod_ShelfadjThk, IModVarNonNull_mod_ShelfadjThk, IModVar_mod_CarcaseId, IModVarNonNull_mod_CarcaseId, IModVar_mod_CarcaseColor, IModVarNonNull_mod_CarcaseColor, IModVar_mod_CarcaseEdgeColor, IModVarNonNull_mod_CarcaseEdgeColor, IModVar_mod_CarcaseEdgeFrontColor, IModVarNonNull_mod_CarcaseEdgeFrontColor, IModVar_mod_ModuleName, IModVarNonNull_mod_ModuleName, IModVar_mod_CarcaseProgram, IModVarNonNull_mod_CarcaseProgram, IModVar_mod_ShelfadjColor, IModVarNonNull_mod_ShelfadjColor, IModVar_mod_TypeElement, IModVarNonNull_mod_TypeElement } from '../var-interfaces'
import { VariantValidation, IMatrix_mod_Width, IMatrix_mod_Depth, IMatrix_mod_Height, IMatrix_mod_ShelfadjThk, IMatrix_mod_CarcaseId, IMatrix_mod_CarcaseColor, IMatrix_mod_CarcaseEdgeColor, IMatrix_mod_CarcaseEdgeFrontColor, IMatrix_mod_ModuleName, IMatrix_mod_CarcaseProgram, IMatrix_mod_ShelfadjColor, IMatrix_mod_TypeElement } from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_ShelfadjWood } from '../part-add-interfaces';
import { mc_ShelfadjWood01_createBuildPlan, mc_ShelfadjWood01_afterDataCompletion, mc_ShelfadjWood01_manufacturerDataCompletion, mc_ShelfadjWood01_calculateContainerModules, mc_ShelfadjWood01_prepareContext } from '../../modules/mc_ShelfadjWood01';

export interface cbp_mc_ShelfadjWood01 extends IModBaseProp
  , IPartAdd_part_ShelfadjWood, IModVarNonNull_mod_Width, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Height, IModVarNonNull_mod_ShelfadjThk, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseColor, IModVarNonNull_mod_CarcaseEdgeColor, IModVarNonNull_mod_CarcaseEdgeFrontColor, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_CarcaseProgram, IModVarNonNull_mod_ShelfadjColor, IModVarNonNull_mod_TypeElement {
...
export interface dc_mc_ShelfadjWood01 extends IModBaseProp
  , IModVar_mod_Width, IModVar_mod_Depth, IModVar_mod_Height, IModVar_mod_ShelfadjThk, IModVar_mod_CarcaseId, IModVar_mod_CarcaseColor, IModVar_mod_CarcaseEdgeColor, IModVar_mod_CarcaseEdgeFrontColor, IModVar_mod_ModuleName, IModVar_mod_CarcaseProgram, IModVar_mod_ShelfadjColor, IModVar_mod_TypeElement {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
...
export interface pc_mc_ShelfadjWood01 extends dc_mc_ShelfadjWood01 {
...
export interface adc_base_mc_ShelfadjWood01 extends IModBaseProp
  , IModVarNonNull_mod_Width, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Height, IModVarNonNull_mod_ShelfadjThk, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseColor, IModVarNonNull_mod_CarcaseEdgeColor, IModVarNonNull_mod_CarcaseEdgeFrontColor, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_CarcaseProgram, IModVarNonNull_mod_ShelfadjColor, IModVarNonNull_mod_TypeElement {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_ShelfadjWood01 extends adc_base_mc_ShelfadjWood01 {
}

export interface ccm_mc_ShelfadjWood01 extends adc_base_mc_ShelfadjWood01 {
}


export class OD_M_mc_ShelfadjWood01 extends OD_Base implements pc_mc_ShelfadjWood01, dc_mc_ShelfadjWood01
  ...
  override variants: string[] = ['mod_Width', 'mod_Depth', 'mod_Height', 'mod_ShelfadjThk', 'mod_CarcaseId', 'mod_CarcaseColor', 'mod_CarcaseEdgeColor', 'mod_CarcaseEdgeFrontColor', 'mod_ModuleName', 'mod_CarcaseProgram', 'mod_ShelfadjColor', 'mod_TypeElement',];
  #mod_Width?: number;
  ...
  #prepareContextInternal = mc_ShelfadjWood01_prepareContext;
  seal(): IModuleNonNull_mc_ShelfadjWood01 {
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_ShelfadjWood01_NonNull(this);
  ...
  addpart_ShelfadjWood(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_ShelfadjWood_PartVarsWritable {
    var c = new P_part_ShelfadjWood(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_ShelfadjWood01_NonNull implements cbp_mc_ShelfadjWood01, adc_mc_ShelfadjWood01, ccm_mc_ShelfadjWood01, IPartParentsNonNull_mc_ShelfadjWood01 {
  ...
  #calculateContainerModulesInternal = mc_ShelfadjWood01_calculateContainerModules;
