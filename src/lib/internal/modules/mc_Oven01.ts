...
import { IModuleNonNull_mc_Oven01, IModParents_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood, IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood } from '../mod-interfaces'
...
import { mc_Oven01_createBuildPlan, mc_Oven01_afterDataCompletion, mc_Oven01_manufacturerDataCompletion, mc_Oven01_calculateContainerModules, mc_Oven01_prepareContext } from '../../modules/mc_Oven01';
...
export interface pc_mc_Oven01 extends dc_mc_Oven01 {
...
export interface adc_base_mc_Oven01 extends IModBaseProp
  , IModVarNonNull_mod_CarcaseHeight, IModVarNonNull_mod_CarcaseDepth, IModVarNonNull_mod_CarcaseWidth, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_OvenId {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_Oven01 extends adc_base_mc_Oven01 {
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic;
}

export interface ccm_mc_Oven01 extends adc_base_mc_Oven01 {
}


export class OD_M_mc_Oven01 extends OD_Base implements pc_mc_Oven01, dc_mc_Oven01
  ...
  #prepareContextInternal = mc_Oven01_prepareContext;
  seal(): IModuleNonNull_mc_Oven01 {
  ...
  override validateSelections(): void {
    ...
    this.mod_OvenId_matrix = VariantValidation.mod_OvenId(this, this.mod_OvenId);
  }

  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Oven01_NonNull(this);
...
class OD_M_mc_Oven01_NonNull implements cbp_mc_Oven01, adc_mc_Oven01, ccm_mc_Oven01, IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood {
  ...
  #calculateContainerModulesInternal = mc_Oven01_calculateContainerModules;
