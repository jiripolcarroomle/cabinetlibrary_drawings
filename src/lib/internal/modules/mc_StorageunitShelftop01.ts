...
import { IModParents_mc_FillerStraight01_mc_Storageunit01 } from '../mod-interfaces'
...
import { VariantValidation, IMatrix_mod_CarcaseId, IMatrix_mod_CarcaseVisTop, IMatrix_mod_Depth, IMatrix_mod_Height, IMatrix_mod_ShelftopConstruction, IMatrix_mod_Width, IMatrix_mod_CarcaseColor, IMatrix_mod_CarcaseOutsideColor, IMatrix_mod_CarcaseEdgeBackColor, IMatrix_mod_CarcaseEdgeColor, IMatrix_mod_CarcaseEdgeFrontColor, IMatrix_mod_CarcaseProgram, IMatrix_mod_CarcaseOutsideProgram, IMatrix_mod_EdgeFrontType, IMatrix_mod_EdgeBackType, IMatrix_mod_EdgeLeftType, IMatrix_mod_EdgeRightType, IMatrix_mod_EdgeJointType, IMatrix_mod_ModuleName, IMatrix_mod_CarcaseConnectionLeftTop, IMatrix_mod_CarcaseConnectionRightTop, IMatrix_mod_TypeElement, IMatrix_mod_HardwareColor, IMatrix_mod_ParentName, IMatrix_mod_FittingConnectionLeftTop, IMatrix_mod_FittingConnectionRightTop, IMatrix_mod_FittingConnectionTopVert, IMatrix_mod_CarcasePartConnectionTopVert, IMatrix_mod_PartInfo, IMatrix_mod_SlopeAngle } from '../selections'
...
import { mc_StorageunitShelftop01_createBuildPlan, mc_StorageunitShelftop01_afterDataCompletion, mc_StorageunitShelftop01_manufacturerDataCompletion, mc_StorageunitShelftop01_calculateContainerModules, mc_StorageunitShelftop01_prepareContext } from '../../modules/mc_StorageunitShelftop01';
...
export interface cbp_mc_StorageunitShelftop01 extends IModBaseProp
  ...
  parent: IModParents_mc_FillerStraight01_mc_Storageunit01;
...
export interface pc_mc_StorageunitShelftop01 extends dc_mc_StorageunitShelftop01 {
...
export interface adc_mc_StorageunitShelftop01 extends adc_base_mc_StorageunitShelftop01 {
}

export interface ccm_mc_StorageunitShelftop01 extends adc_base_mc_StorageunitShelftop01 {
}


export class OD_M_mc_StorageunitShelftop01 extends OD_Base implements pc_mc_StorageunitShelftop01, dc_mc_StorageunitShelftop01
  , IModParents_mc_StorageunitShelftop01
  , IModVar_mod_CarcaseId, IModVar_mod_CarcaseVisTop, IModVar_mod_Depth, IModVar_mod_Height, IModVar_mod_ShelftopConstruction, IModVar_mod_Width, IModVar_mod_CarcaseColor, IModVar_mod_CarcaseOutsideColor, IModVar_mod_CarcaseEdgeBackColor, IModVar_mod_CarcaseEdgeColor, IModVar_mod_CarcaseEdgeFrontColor, IModVar_mod_CarcaseProgram, IModVar_mod_CarcaseOutsideProgram, IModVar_mod_EdgeFrontType, IModVar_mod_EdgeBackType, IModVar_mod_EdgeLeftType, IModVar_mod_EdgeRightType, IModVar_mod_EdgeJointType, IModVar_mod_ModuleName, IModVar_mod_CarcaseConnectionLeftTop, IModVar_mod_CarcaseConnectionRightTop, IModVar_mod_TypeElement, IModVar_mod_HardwareColor, IModVar_mod_ParentName, IModVar_mod_FittingConnectionLeftTop, IModVar_mod_FittingConnectionRightTop, IModVar_mod_FittingConnectionTopVert, IModVar_mod_CarcasePartConnectionTopVert, IModVar_mod_PartInfo, IModVar_mod_SlopeAngle {
  constructor(parent: IModParents_mc_FillerStraight01_mc_Storageunit01, manufacturerMode?: boolean) {
  ...
  #prepareContextInternal = mc_StorageunitShelftop01_prepareContext;
  seal(): IModuleNonNull_mc_StorageunitShelftop01 {
  ...
  override validateSelections(): void {
    ...
    this.mod_ShelftopConstruction_matrix = VariantValidation.mod_ShelftopConstruction(this, this.mod_ShelftopConstruction);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_StorageunitShelftop01_NonNull(this);
  ...
  addpart_Shelftop(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Shelftop_PartVarsWritable {
    var c = new P_part_Shelftop(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_Railhortopfront(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Railhortopfront_PartVarsWritable {
    var c = new P_part_Railhortopfront(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_Railhortopback(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Railhortopback_PartVarsWritable {
    var c = new P_part_Railhortopback(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_Railverttopfront(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Railverttopfront_PartVarsWritable {
    var c = new P_part_Railverttopfront(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_Railverttopback(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Railverttopback_PartVarsWritable {
    var c = new P_part_Railverttopback(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_StorageunitShelftop01_NonNull implements cbp_mc_StorageunitShelftop01, adc_mc_StorageunitShelftop01, ccm_mc_StorageunitShelftop01, IPartParentsNonNull_mc_StorageunitShelftop01 {
  ...
  #calculateContainerModulesInternal = mc_StorageunitShelftop01_calculateContainerModules;
