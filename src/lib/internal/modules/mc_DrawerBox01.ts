...
export interface adc_mc_DrawerBox01 extends adc_base_mc_DrawerBox01 {
}

export interface ccm_mc_DrawerBox01 extends adc_base_mc_DrawerBox01 {
}
...
export class OD_M_mc_DrawerBox01 extends OD_Base implements dc_mc_DrawerBox01
  ...
  override validateSelections(): void {
    ...
    this.mod_DrawerBoxLogic_matrix = VariantValidation.mod_DrawerBoxLogic(this, this.mod_DrawerBoxLogic);
    ...
    this.mod_PartgroupDrawerWeight_matrix = VariantValidation.mod_PartgroupDrawerWeight(this, this.mod_PartgroupDrawerWeight);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_DrawerBox01_NonNull(this);
  ...
  addpart_DrawerShelfbtm(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_DrawerShelfbtm_PartVarsWritable {
    var c = new P_part_DrawerShelfbtm(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_DrawerBackwallWood(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_DrawerBackwallWood_PartVarsWritable {
    var c = new P_part_DrawerBackwallWood(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_DrawerBackwallSteel(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_DrawerBackwallSteel_PartVarsWritable {
    var c = new P_part_DrawerBackwallSteel(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_DrawerBox(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_DrawerBox_PartVarsWritable {
    var c = new P_part_DrawerBox(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_DrawerSideLeft(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_DrawerSideLeft_PartVarsWritable {
    var c = new P_part_DrawerSideLeft(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_DrawerSideRight(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_DrawerSideRight_PartVarsWritable {
    var c = new P_part_DrawerSideRight(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_DrawerBoxDrilling(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_DrawerBoxDrilling_PartVarsWritable {
    var c = new P_part_DrawerBoxDrilling(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_DrawerBoxBom(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_DrawerBoxBom_PartVarsWritable {
    var c = new P_part_DrawerBoxBom(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_DrawerSlideLeft(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_DrawerSlideLeft_PartVarsWritable {
    var c = new P_part_DrawerSlideLeft(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_DrawerSlideRight(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_DrawerSlideRight_PartVarsWritable {
    var c = new P_part_DrawerSlideRight(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_DrawerFrontConnector(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_DrawerFrontConnector_PartVarsWritable {
    var c = new P_part_DrawerFrontConnector(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_DrawerShelfbtmConnector(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_DrawerShelfbtmConnector_PartVarsWritable {
    var c = new P_part_DrawerShelfbtmConnector(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_DrawerShelfbtmConnectorDrilling(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_DrawerShelfbtmConnectorDrilling_PartVarsWritable {
    var c = new P_part_DrawerShelfbtmConnectorDrilling(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_DrawerBoxSynchronization(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_DrawerBoxSynchronization_PartVarsWritable {
    var c = new P_part_DrawerBoxSynchronization(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_DrawerBox01_NonNull implements cbp_mc_DrawerBox01, adc_mc_DrawerBox01, ccm_mc_DrawerBox01, IPartParentsNonNull_mc_DrawerBox01 {
  ...
  #calculateContainerModulesInternal = mc_DrawerBox01_calculateContainerModules;
