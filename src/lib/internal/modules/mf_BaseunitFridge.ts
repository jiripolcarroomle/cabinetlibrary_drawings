...
export interface dc_mf_BaseunitFridge extends IModBaseProp
  , IModVar_mod_BaseunitFridgeId, IModVar_mod_BaseunitFridgeInfo, IModVar_mod_BaseunitFridgeSupplier, IModVar_mod_Depth, IModVar_mod_FrameFillingColor, IModVar_mod_FrameFillingType, IModVar_mod_FrontColor, IModVar_mod_FrontDescriptor, IModVar_mod_FrontDesign, IModVar_mod_FrontEdgeColor, IModVar_mod_FrontEdgeThk, IModVar_mod_FrontGapCarcase, IModVar_mod_FrontGapHor, IModVar_mod_FrontGapHorTop, IModVar_mod_FrontGapVert, IModVar_mod_FrontHeight, IModVar_mod_FrontHeightSelection, IModVar_mod_FrontId, IModVar_mod_FrontOversizeBtm, IModVar_mod_FrontOversizeLeft, IModVar_mod_FrontOversizeRight, IModVar_mod_FrontOversizeTop, IModVar_mod_FrontPosStart, IModVar_mod_FrontProgram, IModVar_mod_FrontQtyElements, IModVar_mod_FrontSplit, IModVar_mod_FrontSplitHeight1, IModVar_mod_FrontSplitHeight2, IModVar_mod_FrontSplitHeight3, IModVar_mod_FrontSplitType1, IModVar_mod_FrontSplitType2, IModVar_mod_FrontThk, IModVar_mod_FrontWidth, IModVar_mod_HandleColor, IModVar_mod_HandleDesign, IModVar_mod_FingergripBtmType, IModVar_mod_FingergripTop, IModVar_mod_FingergripTopType, IModVar_mod_HandleDrill, IModVar_mod_HandleLength, IModVar_mod_HandleLine, IModVar_mod_HandleOffsetX, IModVar_mod_HandleOffsetY, IModVar_mod_HandlePosLogic, IModVar_mod_HandlePosMatrix, IModVar_mod_HandlePosType, IModVar_mod_HandlestripPos, IModVar_mod_Height, IModVar_mod_HeightPosInsertion, IModVar_mod_HingeLogic, IModVar_mod_ModuleName, IModVar_mod_Originpos, IModVar_mod_ParentName, IModVar_mod_PlinthAreaHeight, IModVar_mod_TypeElement, IModVar_mod_DoorDirection, IModVar_mod_DoorDirectionSelection {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
  seal(): IModuleNonNull_mf_BaseunitFridge;
  parent: IModParents_mr_Appliance;
  addOD_M_mc_BaseunitFridge01(index?: number): dc_mc_BaseunitFridge01;
}

export interface pc_mf_BaseunitFridge extends dc_mf_BaseunitFridge {
...
export interface adc_base_mf_BaseunitFridge extends IModBaseProp
  , IModVarNonNull_mod_BaseunitFridgeId, IModVarNonNull_mod_BaseunitFridgeInfo, IModVarNonNull_mod_BaseunitFridgeSupplier, IModVarNonNull_mod_Depth, IModVarNonNull_mod_FrameFillingColor, IModVarNonNull_mod_FrameFillingType, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontDescriptor, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapHorTop, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontHeight, IModVarNonNull_mod_FrontHeightSelection, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontOversizeBtm, IModVarNonNull_mod_FrontOversizeLeft, IModVarNonNull_mod_FrontOversizeRight, IModVarNonNull_mod_FrontOversizeTop, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_FrontQtyElements, IModVarNonNull_mod_FrontSplit, IModVarNonNull_mod_FrontSplitHeight1, IModVarNonNull_mod_FrontSplitHeight2, IModVarNonNull_mod_FrontSplitHeight3, IModVarNonNull_mod_FrontSplitType1, IModVarNonNull_mod_FrontSplitType2, IModVarNonNull_mod_FrontThk, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_HandleColor, IModVarNonNull_mod_HandleDesign, IModVarNonNull_mod_FingergripBtmType, IModVarNonNull_mod_FingergripTop, IModVarNonNull_mod_FingergripTopType, IModVarNonNull_mod_HandleDrill, IModVarNonNull_mod_HandleLength, IModVarNonNull_mod_HandleLine, IModVarNonNull_mod_HandleOffsetX, IModVarNonNull_mod_HandleOffsetY, IModVarNonNull_mod_HandlePosLogic, IModVarNonNull_mod_HandlePosMatrix, IModVarNonNull_mod_HandlePosType, IModVarNonNull_mod_HandlestripPos, IModVarNonNull_mod_Height, IModVarNonNull_mod_HeightPosInsertion, IModVarNonNull_mod_HingeLogic, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_DoorDirection, IModVarNonNull_mod_DoorDirectionSelection {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mf_BaseunitFridge extends adc_base_mf_BaseunitFridge {
  addOD_M_mc_BaseunitFridge01(index?: number): dc_mc_BaseunitFridge01;
}

export interface ccm_mf_BaseunitFridge extends adc_base_mf_BaseunitFridge {
}


export class OD_M_mf_BaseunitFridge extends OD_Base implements pc_mf_BaseunitFridge, dc_mf_BaseunitFridge
  , IModParents_mf_BaseunitFridge
  , IModVar_mod_BaseunitFridgeId, IModVar_mod_BaseunitFridgeInfo, IModVar_mod_BaseunitFridgeSupplier, IModVar_mod_Depth, IModVar_mod_FrameFillingColor, IModVar_mod_FrameFillingType, IModVar_mod_FrontColor, IModVar_mod_FrontDescriptor, IModVar_mod_FrontDesign, IModVar_mod_FrontEdgeColor, IModVar_mod_FrontEdgeThk, IModVar_mod_FrontGapCarcase, IModVar_mod_FrontGapHor, IModVar_mod_FrontGapHorTop, IModVar_mod_FrontGapVert, IModVar_mod_FrontHeight, IModVar_mod_FrontHeightSelection, IModVar_mod_FrontId, IModVar_mod_FrontOversizeBtm, IModVar_mod_FrontOversizeLeft, IModVar_mod_FrontOversizeRight, IModVar_mod_FrontOversizeTop, IModVar_mod_FrontPosStart, IModVar_mod_FrontProgram, IModVar_mod_FrontQtyElements, IModVar_mod_FrontSplit, IModVar_mod_FrontSplitHeight1, IModVar_mod_FrontSplitHeight2, IModVar_mod_FrontSplitHeight3, IModVar_mod_FrontSplitType1, IModVar_mod_FrontSplitType2, IModVar_mod_FrontThk, IModVar_mod_FrontWidth, IModVar_mod_HandleColor, IModVar_mod_HandleDesign, IModVar_mod_FingergripBtmType, IModVar_mod_FingergripTop, IModVar_mod_FingergripTopType, IModVar_mod_HandleDrill, IModVar_mod_HandleLength, IModVar_mod_HandleLine, IModVar_mod_HandleOffsetX, IModVar_mod_HandleOffsetY, IModVar_mod_HandlePosLogic, IModVar_mod_HandlePosMatrix, IModVar_mod_HandlePosType, IModVar_mod_HandlestripPos, IModVar_mod_Height, IModVar_mod_HeightPosInsertion, IModVar_mod_HingeLogic, IModVar_mod_ModuleName, IModVar_mod_Originpos, IModVar_mod_ParentName, IModVar_mod_PlinthAreaHeight, IModVar_mod_TypeElement, IModVar_mod_DoorDirection, IModVar_mod_DoorDirectionSelection {
  constructor(parent: IModParents_mr_Appliance, manufacturerMode?: boolean) {
    super('mf_BaseunitFridge', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mf_BaseunitFridge_NonNull(this);
  }
  parent: IModParents_mr_Appliance;
  _selfNonNull: OD_M_mf_BaseunitFridge_NonNull;

  override variants: string[] = ['mod_BaseunitFridgeId', 'mod_BaseunitFridgeInfo', 'mod_BaseunitFridgeSupplier', 'mod_Depth', 'mod_FrameFillingColor', 'mod_FrameFillingType', 'mod_FrontColor', 'mod_FrontDescriptor', 'mod_FrontDesign', 'mod_FrontEdgeColor', 'mod_FrontEdgeThk', 'mod_FrontGapCarcase', 'mod_FrontGapHor', 'mod_FrontGapHorTop', 'mod_FrontGapVert', 'mod_FrontHeight', 'mod_FrontHeightSelection', 'mod_FrontId', 'mod_FrontOversizeBtm', 'mod_FrontOversizeLeft', 'mod_FrontOversizeRight', 'mod_FrontOversizeTop', 'mod_FrontPosStart', 'mod_FrontProgram', 'mod_FrontQtyElements', 'mod_FrontSplit', 'mod_FrontSplitHeight1', 'mod_FrontSplitHeight2', 'mod_FrontSplitHeight3', 'mod_FrontSplitType1', 'mod_FrontSplitType2', 'mod_FrontThk', 'mod_FrontWidth', 'mod_HandleColor', 'mod_HandleDesign', 'mod_FingergripBtmType', 'mod_FingergripTop', 'mod_FingergripTopType', 'mod_HandleDrill', 'mod_HandleLength', 'mod_HandleLine', 'mod_HandleOffsetX', 'mod_HandleOffsetY', 'mod_HandlePosLogic', 'mod_HandlePosMatrix', 'mod_HandlePosType', 'mod_HandlestripPos', 'mod_Height', 'mod_HeightPosInsertion', 'mod_HingeLogic', 'mod_ModuleName', 'mod_Originpos', 'mod_ParentName', 'mod_PlinthAreaHeight', 'mod_TypeElement', 'mod_DoorDirection', 'mod_DoorDirectionSelection',];
  #mod_BaseunitFridgeId?: string;
  get mod_BaseunitFridgeId(): string | undefined { return this.#mod_BaseunitFridgeId }
  set mod_BaseunitFridgeId(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_BaseunitFridgeId' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_BaseunitFridgeId === value) return;
    this.#mod_BaseunitFridgeId = value;
  }

  mod_BaseunitFridgeId_matrix?: IMatrix_mod_BaseunitFridgeId;
  #mod_BaseunitFridgeInfo: string[] = [];
  get mod_BaseunitFridgeInfo(): string[] { return this.#mod_BaseunitFridgeInfo; }
  #mod_BaseunitFridgeSupplier?: string;
  get mod_BaseunitFridgeSupplier(): string | undefined { return this.#mod_BaseunitFridgeSupplier }
  set mod_BaseunitFridgeSupplier(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_BaseunitFridgeSupplier' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_BaseunitFridgeSupplier === value) return;
    this.#mod_BaseunitFridgeSupplier = value;
  }

  mod_BaseunitFridgeSupplier_matrix?: IMatrix_mod_BaseunitFridgeSupplier;
  #mod_Depth?: number;
  ...
  override getAttributes(): Map<string, any> {
    ...
    res.set('mod_BaseunitFridgeId', this.mod_BaseunitFridgeId);
    res.set('mod_BaseunitFridgeInfo', JSON.stringify(this.mod_BaseunitFridgeInfo));
    res.set('mod_BaseunitFridgeSupplier', this.mod_BaseunitFridgeSupplier);
  ...
  override loadJson(json: any, withSubModules: boolean = true, manufacturerMode: boolean) {
    ...
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_BaseunitFridgeId');
      const val = _toString(json['attributes']['mod_BaseunitFridgeId'], 'mod_BaseunitFridgeId');
      internal_leaveValidateVariant();
      this.mod_BaseunitFridgeId = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_BaseunitFridgeSupplier');
      const val = _toString(json['attributes']['mod_BaseunitFridgeSupplier'], 'mod_BaseunitFridgeSupplier');
      internal_leaveValidateVariant();
      this.mod_BaseunitFridgeSupplier = val;
    }
    {
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_BaseunitFridgeId === undefined) {
      this.mod_BaseunitFridgeId = "KU21WAHG0";
    }
    if (this.mod_BaseunitFridgeSupplier === undefined) {
      this.mod_BaseunitFridgeSupplier = "Siemens";
    }
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mf_BaseunitFridge";
    }
    if (this.mod_DoorDirection === undefined) {
      this.mod_DoorDirection = "Right";
    }
    if (this.mod_DoorDirectionSelection === undefined) {
      this.mod_DoorDirectionSelection = "Left";
    }
  ...
  #manufacturerDataCompletionInternal = mf_BaseunitFridge_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mf_BaseunitFridge_NonNull(this);
  ...
  #prepareContextInternal = mf_BaseunitFridge_prepareContext;
  seal(): IModuleNonNull_mf_BaseunitFridge {
    this.afterDataCompletion();
    const adc = new OD_M_mf_BaseunitFridge_NonNull(this);
    return adc;
  }

  addOD_M_mc_BaseunitFridge01(index?: number): dc_mc_BaseunitFridge01 {
    var m = new OD_M_mc_BaseunitFridge01(this);
    m.dataCompletion();
  ...
  override validateSelections(): void {
    this.mod_BaseunitFridgeId_matrix = VariantValidation.mod_BaseunitFridgeId(this, this.mod_BaseunitFridgeId);
    this.mod_BaseunitFridgeSupplier_matrix = VariantValidation.mod_BaseunitFridgeSupplier(this, this.mod_BaseunitFridgeSupplier);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mf_BaseunitFridge_NonNull(this);
  ...
  override createBuildPlan(): void {
    var cbp = new OD_M_mf_BaseunitFridge_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mf_BaseunitFridge_NonNull implements cbp_mf_BaseunitFridge, adc_mf_BaseunitFridge, ccm_mf_BaseunitFridge, IPartParentsNonNull_mf_BaseunitFridge {
  constructor(parent: OD_M_mf_BaseunitFridge) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mf_BaseunitFridge;
  ...
  #createBuildPlanInternal = mf_BaseunitFridge_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mf_BaseunitFridge_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = mf_BaseunitFridge_calculateContainerModules;
  ...
  parent: IModParents_mr_Appliance;
  get mod_BaseunitFridgeId(): string {
    return this.#internalParent.mod_BaseunitFridgeId!;
  }
  get mod_BaseunitFridgeInfo(): string[] {
    return this.#internalParent.mod_BaseunitFridgeInfo!;
  }
  get mod_BaseunitFridgeSupplier(): string {
    return this.#internalParent.mod_BaseunitFridgeSupplier!;
  }
  ...
  addOD_M_mc_BaseunitFridge01(index?: number): dc_mc_BaseunitFridge01 {
    return this.#internalParent.addOD_M_mc_BaseunitFridge01(index);
  }
}
