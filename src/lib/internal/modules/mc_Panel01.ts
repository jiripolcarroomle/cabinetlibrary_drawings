...
import { mc_Panel01_createBuildPlan, mc_Panel01_afterDataCompletion, mc_Panel01_manufacturerDataCompletion, mc_Panel01_calculateContainerModules, mc_Panel01_prepareContext } from '../../modules/mc_Panel01';
...
export interface pc_mc_Panel01 extends dc_mc_Panel01 {
...
export interface adc_base_mc_Panel01 extends IModBaseProp
  , IModVarNonNull_mod_PanelId, IModVarNonNull_mod_Color, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Program, IModVarNonNull_mod_Thk, IModVarNonNull_mod_Width, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_Height, IModVarNonNull_mod_PaneltopColor, IModVarNonNull_mod_PaneltopThk, IModVarNonNull_mod_IslandBackwallOverhangFront {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_Panel01 extends adc_base_mc_Panel01 {
}

export interface ccm_mc_Panel01 extends adc_base_mc_Panel01 {
}


export class OD_M_mc_Panel01 extends OD_Base implements pc_mc_Panel01, dc_mc_Panel01
  ...
  #prepareContextInternal = mc_Panel01_prepareContext;
  seal(): IModuleNonNull_mc_Panel01 {
  ...
  override validateSelections(): void {
    this.mod_PanelId_matrix = VariantValidation.mod_PanelId(this, this.mod_PanelId);
    this.mod_Color_matrix = VariantValidation.mod_Color(this, this.mod_Color);
    this.mod_Depth_matrix = VariantValidation.mod_Depth(this, this.mod_Depth);
    this.mod_Program_matrix = VariantValidation.mod_Program(this, this.mod_Program);
    this.mod_Thk_matrix = VariantValidation.mod_Thk(this, this.mod_Thk);
    ...
    this.mod_IslandBackwallOverhangFront_matrix = VariantValidation.mod_IslandBackwallOverhangFront(this, this.mod_IslandBackwallOverhangFront);
  }

  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Panel01_NonNull(this);
...
class OD_M_mc_Panel01_NonNull implements cbp_mc_Panel01, adc_mc_Panel01, ccm_mc_Panel01, IPartParentsNonNull_mc_Panel01 {
  ...
  #calculateContainerModulesInternal = mc_Panel01_calculateContainerModules;
