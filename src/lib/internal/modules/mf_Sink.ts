...
import { IModuleNonNull_mf_Sink, IModParents_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood, IModParents_mf_Sink, IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood, IPartParentsNonNull_mf_Sink } from '../mod-interfaces'
...
import { mf_Sink_createBuildPlan, mf_Sink_afterDataCompletion, mf_Sink_manufacturerDataCompletion, mf_Sink_calculateContainerModules, mf_Sink_prepareContext } from '../../modules/mf_Sink';
...
export interface pc_mf_Sink extends dc_mf_Sink {
...
export interface adc_base_mf_Sink extends IModBaseProp
  , IModVarNonNull_mod_SinkId, IModVarNonNull_mod_SinkMoveDepth, IModVarNonNull_mod_SinkMoveWidth, IModVarNonNull_mod_SinkSupplier, IModVarNonNull_mod_MixerId, IModVarNonNull_mod_MixerSupplier, IModVarNonNull_mod_CountertopInfo {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mf_Sink extends adc_base_mf_Sink {
  addOD_M_mc_Sink01(index?: number): dc_mc_Sink01;
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic;
}

export interface ccm_mf_Sink extends adc_base_mf_Sink {
}


export class OD_M_mf_Sink extends OD_Base implements pc_mf_Sink, dc_mf_Sink
  , IModParents_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood, IModParents_mf_Sink
  , IModVar_mod_SinkId, IModVar_mod_SinkMoveDepth, IModVar_mod_SinkMoveWidth, IModVar_mod_SinkSupplier, IModVar_mod_MixerId, IModVar_mod_MixerSupplier, IModVar_mod_CountertopInfo {
  ...
  #prepareContextInternal = mf_Sink_prepareContext;
  seal(): IModuleNonNull_mf_Sink {
  ...
  override validateSelections(): void {
    this.mod_SinkId_matrix = VariantValidation.mod_SinkId(this, this.mod_SinkId);
    this.mod_SinkMoveDepth_matrix = VariantValidation.mod_SinkMoveDepth(this, this.mod_SinkMoveDepth);
    this.mod_SinkMoveWidth_matrix = VariantValidation.mod_SinkMoveWidth(this, this.mod_SinkMoveWidth);
    this.mod_SinkSupplier_matrix = VariantValidation.mod_SinkSupplier(this, this.mod_SinkSupplier);
    this.mod_MixerId_matrix = VariantValidation.mod_MixerId(this, this.mod_MixerId);
    this.mod_MixerSupplier_matrix = VariantValidation.mod_MixerSupplier(this, this.mod_MixerSupplier);
  }

  override calculateContainerModules(): void {
    let ccm = new OD_M_mf_Sink_NonNull(this);
...
class OD_M_mf_Sink_NonNull implements cbp_mf_Sink, adc_mf_Sink, ccm_mf_Sink, IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood, IPartParentsNonNull_mf_Sink {
  ...
  #calculateContainerModulesInternal = mf_Sink_calculateContainerModules;
