...
import { IModParents_mc_PantryPullout01 } from '../mod-interfaces'
import { IP_part_PantryPulloutBom_PartVarsWritable, P_part_PantryPulloutBom } from '../parts/part_PantryPulloutBom'
import { IP_part_PantryPulloutHardware_PartVarsWritable, P_part_PantryPulloutHardware } from '../parts/part_PantryPulloutHardware'
import { IP_part_PantryPulloutDrill_PartVarsWritable, P_part_PantryPulloutDrill } from '../parts/part_PantryPulloutDrill'
import { IModuleNonNull_mc_PantryPulloutHardware01, IModParents_mc_PantryPulloutHardware01, IPartParentsNonNull_mc_PantryPulloutHardware01 } from '../mod-interfaces'
import { IModVar_mod_PantryPulloutDesign, IModVarNonNull_mod_PantryPulloutDesign, IModVar_mod_PantryPulloutType, IModVarNonNull_mod_PantryPulloutType, IModVar_mod_PantryPulloutColor, IModVarNonNull_mod_PantryPulloutColor, IModVar_mod_FrontId, IModVarNonNull_mod_FrontId, IModVar_mod_HardwareColor, IModVarNonNull_mod_HardwareColor, IModVar_mod_TypeElement, IModVarNonNull_mod_TypeElement, IModVar_mod_ParentName, IModVarNonNull_mod_ParentName, IModVar_mod_ModuleName, IModVarNonNull_mod_ModuleName, IModVar_mod_FrontWidth, IModVarNonNull_mod_FrontWidth, IModVar_mod_Depth, IModVarNonNull_mod_Depth, IModVar_mod_Width, IModVarNonNull_mod_Width, IModVar_mod_Height, IModVarNonNull_mod_Height, IModVar_mod_Information, IModVarNonNull_mod_Information } from '../var-interfaces'
import { VariantValidation, IMatrix_mod_PantryPulloutDesign, IMatrix_mod_PantryPulloutType, IMatrix_mod_PantryPulloutColor, IMatrix_mod_FrontId, IMatrix_mod_HardwareColor, IMatrix_mod_TypeElement, IMatrix_mod_ParentName, IMatrix_mod_ModuleName, IMatrix_mod_FrontWidth, IMatrix_mod_Depth, IMatrix_mod_Width, IMatrix_mod_Height, IMatrix_mod_Information } from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_PantryPulloutBom, IPartAdd_part_PantryPulloutHardware, IPartAdd_part_PantryPulloutDrill } from '../part-add-interfaces';
import { mc_PantryPulloutHardware01_createBuildPlan, mc_PantryPulloutHardware01_afterDataCompletion, mc_PantryPulloutHardware01_manufacturerDataCompletion, mc_PantryPulloutHardware01_calculateContainerModules, mc_PantryPulloutHardware01_prepareContext } from '../../modules/mc_PantryPulloutHardware01';

export interface cbp_mc_PantryPulloutHardware01 extends IModBaseProp
  , IPartAdd_part_PantryPulloutBom, IPartAdd_part_PantryPulloutHardware, IPartAdd_part_PantryPulloutDrill, IModVarNonNull_mod_PantryPulloutDesign, IModVarNonNull_mod_PantryPulloutType, IModVarNonNull_mod_PantryPulloutColor, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_HardwareColor, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Width, IModVarNonNull_mod_Height, IModVarNonNull_mod_Information {
  parent: IModParents_mc_PantryPullout01;
...
export interface dc_mc_PantryPulloutHardware01 extends IModBaseProp
  , IModVar_mod_PantryPulloutDesign, IModVar_mod_PantryPulloutType, IModVar_mod_PantryPulloutColor, IModVar_mod_FrontId, IModVar_mod_HardwareColor, IModVar_mod_TypeElement, IModVar_mod_ParentName, IModVar_mod_ModuleName, IModVar_mod_FrontWidth, IModVar_mod_Depth, IModVar_mod_Width, IModVar_mod_Height, IModVar_mod_Information {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
  seal(): IModuleNonNull_mc_PantryPulloutHardware01;
  parent: IModParents_mc_PantryPullout01;
}

export interface pc_mc_PantryPulloutHardware01 extends dc_mc_PantryPulloutHardware01 {
...
export interface adc_base_mc_PantryPulloutHardware01 extends IModBaseProp
  , IModVarNonNull_mod_PantryPulloutDesign, IModVarNonNull_mod_PantryPulloutType, IModVarNonNull_mod_PantryPulloutColor, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_HardwareColor, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Width, IModVarNonNull_mod_Height, IModVarNonNull_mod_Information {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_PantryPulloutHardware01 extends adc_base_mc_PantryPulloutHardware01 {
}

export interface ccm_mc_PantryPulloutHardware01 extends adc_base_mc_PantryPulloutHardware01 {
}


export class OD_M_mc_PantryPulloutHardware01 extends OD_Base implements pc_mc_PantryPulloutHardware01, dc_mc_PantryPulloutHardware01
  , IModParents_mc_PantryPulloutHardware01
  , IModVar_mod_PantryPulloutDesign, IModVar_mod_PantryPulloutType, IModVar_mod_PantryPulloutColor, IModVar_mod_FrontId, IModVar_mod_HardwareColor, IModVar_mod_TypeElement, IModVar_mod_ParentName, IModVar_mod_ModuleName, IModVar_mod_FrontWidth, IModVar_mod_Depth, IModVar_mod_Width, IModVar_mod_Height, IModVar_mod_Information {
  constructor(parent: IModParents_mc_PantryPullout01, manufacturerMode?: boolean) {
    super('mc_PantryPulloutHardware01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_PantryPulloutHardware01_NonNull(this);
  }
  parent: IModParents_mc_PantryPullout01;
  _selfNonNull: OD_M_mc_PantryPulloutHardware01_NonNull;

  override variants: string[] = ['mod_PantryPulloutDesign', 'mod_PantryPulloutType', 'mod_PantryPulloutColor', 'mod_FrontId', 'mod_HardwareColor', 'mod_TypeElement', 'mod_ParentName', 'mod_ModuleName', 'mod_FrontWidth', 'mod_Depth', 'mod_Width', 'mod_Height', 'mod_Information',];
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mc_PantryPulloutHardware01";
    }
  ...
  #manufacturerDataCompletionInternal = mc_PantryPulloutHardware01_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_PantryPulloutHardware01_NonNull(this);
  ...
  #prepareContextInternal = mc_PantryPulloutHardware01_prepareContext;
  seal(): IModuleNonNull_mc_PantryPulloutHardware01 {
    this.afterDataCompletion();
    const adc = new OD_M_mc_PantryPulloutHardware01_NonNull(this);
    return adc;
  }
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_PantryPulloutHardware01_NonNull(this);
    ccm.calculateContainerModules();
    this.m.forEach(subMod => subMod.calculateContainerModules());
  }

  addpart_PantryPulloutBom(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_PantryPulloutBom_PartVarsWritable {
    var c = new P_part_PantryPulloutBom(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_PantryPulloutHardware(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_PantryPulloutHardware_PartVarsWritable {
    var c = new P_part_PantryPulloutHardware(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_PantryPulloutDrill(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_PantryPulloutDrill_PartVarsWritable {
    var c = new P_part_PantryPulloutDrill(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }

  override createBuildPlan(): void {
    var cbp = new OD_M_mc_PantryPulloutHardware01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_PantryPulloutHardware01_NonNull implements cbp_mc_PantryPulloutHardware01, adc_mc_PantryPulloutHardware01, ccm_mc_PantryPulloutHardware01, IPartParentsNonNull_mc_PantryPulloutHardware01 {
  constructor(parent: OD_M_mc_PantryPulloutHardware01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_PantryPulloutHardware01;
  ...
  #createBuildPlanInternal = mc_PantryPulloutHardware01_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_PantryPulloutHardware01_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = mc_PantryPulloutHardware01_calculateContainerModules;
  ...
  parent: IModParents_mc_PantryPullout01;
  addpart_PantryPulloutBom(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_PantryPulloutBom_PartVarsWritable {
    return this.#internalParent.addpart_PantryPulloutBom(x, y, z, dimx, dimy, dimz);
  }
  addpart_PantryPulloutHardware(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_PantryPulloutHardware_PartVarsWritable {
    return this.#internalParent.addpart_PantryPulloutHardware(x, y, z, dimx, dimy, dimz);
  }
  addpart_PantryPulloutDrill(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_PantryPulloutDrill_PartVarsWritable {
    return this.#internalParent.addpart_PantryPulloutDrill(x, y, z, dimx, dimy, dimz);
  }
