...
export interface pc_mc_StorageunitBackwall01 extends dc_mc_StorageunitBackwall01 {
...
export interface adc_base_mc_StorageunitBackwall01 extends IModBaseProp
  , IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseVisBack, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Height, IModVarNonNull_mod_Width, IModVarNonNull_mod_CarcaseBackwallColor, IModVarNonNull_mod_CarcaseBackwallProgram, IModVarNonNull_mod_CarcaseOutsideColor, IModVarNonNull_mod_CarcaseEdgeColor, IModVarNonNull_mod_CarcaseOutsideProgram, IModVarNonNull_mod_EdgeBackType, IModVarNonNull_mod_EdgeLeftType, IModVarNonNull_mod_EdgeFrontType, IModVarNonNull_mod_EdgeRightType, IModVarNonNull_mod_EdgeJointType, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_CarcaseProgram, IModVarNonNull_mod_CarcaseConnectionLeftTop, IModVarNonNull_mod_CarcaseConnectionRightTop, IModVarNonNull_mod_SlopedCeilingConstruction, IModVarNonNull_mod_SlopeAngle, IModVarNonNull_mod_TypeElement {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_StorageunitBackwall01 extends adc_base_mc_StorageunitBackwall01 {
}

export interface ccm_mc_StorageunitBackwall01 extends adc_base_mc_StorageunitBackwall01 {
}


export class OD_M_mc_StorageunitBackwall01 extends OD_Base implements pc_mc_StorageunitBackwall01, dc_mc_StorageunitBackwall01
  ...
  #prepareContextInternal = mc_StorageunitBackwall01_prepareContext;
  seal(): IModuleNonNull_mc_StorageunitBackwall01 {
  ...
  override validateSelections(): void {
    ...
    this.mod_CarcaseBackwallColor_matrix = VariantValidation.mod_CarcaseBackwallColor(this, this.mod_CarcaseBackwallColor);
    this.mod_CarcaseBackwallProgram_matrix = VariantValidation.mod_CarcaseBackwallProgram(this, this.mod_CarcaseBackwallProgram);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_StorageunitBackwall01_NonNull(this);
  ...
  addpart_Backwall(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Backwall_PartVarsWritable {
    var c = new P_part_Backwall(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_StorageunitBackwall01_NonNull implements cbp_mc_StorageunitBackwall01, adc_mc_StorageunitBackwall01, ccm_mc_StorageunitBackwall01, IPartParentsNonNull_mc_StorageunitBackwall01 {
  ...
  #calculateContainerModulesInternal = mc_StorageunitBackwall01_calculateContainerModules;
