...
export interface pc_mf_CornerFillerFront extends dc_mf_CornerFillerFront {
...
export interface adc_base_mf_CornerFillerFront extends IModBaseProp
...
export interface adc_mf_CornerFillerFront extends adc_base_mf_CornerFillerFront {
  addOD_M_mc_CornerFillerFront01(index?: number): dc_mc_CornerFillerFront01;
}

export interface ccm_mf_CornerFillerFront extends adc_base_mf_CornerFillerFront {
}


export class OD_M_mf_CornerFillerFront extends OD_Base implements pc_mf_CornerFillerFront, dc_mf_CornerFillerFront
  , IModParents_mc_CornerFillerFront01_mc_FillerFront01_mf_CornerFillerFront, IModParents_mf_CornerFillerFront_mr_CornerFiller
  , IModVar_mod_WidthLeft, IModVar_mod_WidthRight, IModVar_mod_HeightLeft, IModVar_mod_HeightRight, IModVar_mod_CarcaseId, IModVar_mod_CornerunitStraightConstruction, IModVar_mod_CornerunitFrontWidth, IModVar_mod_CarcaseDirection, IModVar_mod_FingergripTop, IModVar_mod_FrontColor, IModVar_mod_FrontDesign, IModVar_mod_FrontEdgeColor, IModVar_mod_FrontEdgeThk, IModVar_mod_FrontGapCarcase, IModVar_mod_FrontGapHor, IModVar_mod_FrontGapVert, IModVar_mod_FrontId, IModVar_mod_FrontOversizeBtm, IModVar_mod_FrontOversizeTop, IModVar_mod_FrontPosStart, IModVar_mod_FrontProgram, IModVar_mod_ModuleName, IModVar_mod_ParentName, IModVar_mod_PlinthAreaHeight, IModVar_mod_CarcaseDepth, IModVar_mod_CarcaseHeight, IModVar_mod_CarcaseWidth, IModVar_mod_ThkLeft, IModVar_mod_ThkRight, IModVar_mod_HandleDesign, IModVar_mod_HandlePosType, IModVar_mod_HandleColor, IModVar_mod_CornerunitStraightFillerConstruction, IModVar_mod_TypeElement, IModVar_mod_FillerType, IModVar_mod_FillerHardware, IModVar_mod_CarcasePartInfo, IModVar_mod_Originpos, IModVar_mod_FingergripTopType, IModVar_mod_FingergripBtmType, IModVar_mod_FrontOversizeLeft, IModVar_mod_FrontOversizeRight {
  ...
  override variants: string[] = ['mod_WidthLeft', 'mod_WidthRight', 'mod_HeightLeft', 'mod_HeightRight', 'mod_CarcaseId', 'mod_CornerunitStraightConstruction', 'mod_CornerunitFrontWidth', 'mod_CarcaseDirection', 'mod_FingergripTop', 'mod_FrontColor', 'mod_FrontDesign', 'mod_FrontEdgeColor', 'mod_FrontEdgeThk', 'mod_FrontGapCarcase', 'mod_FrontGapHor', 'mod_FrontGapVert', 'mod_FrontId', 'mod_FrontOversizeBtm', 'mod_FrontOversizeTop', 'mod_FrontPosStart', 'mod_FrontProgram', 'mod_ModuleName', 'mod_ParentName', 'mod_PlinthAreaHeight', 'mod_CarcaseDepth', 'mod_CarcaseHeight', 'mod_CarcaseWidth', 'mod_ThkLeft', 'mod_ThkRight', 'mod_HandleDesign', 'mod_HandlePosType', 'mod_HandleColor', 'mod_CornerunitStraightFillerConstruction', 'mod_TypeElement', 'mod_FillerType', 'mod_FillerHardware', 'mod_CarcasePartInfo', 'mod_Originpos', 'mod_FingergripTopType', 'mod_FingergripBtmType', 'mod_FrontOversizeLeft', 'mod_FrontOversizeRight',];
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_CornerunitFrontWidth === undefined) {
      this.mod_CornerunitFrontWidth = 100;
    }
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mf_CornerFillerFront";
    }
    if (this.mod_ParentName === undefined) {
      this.mod_ParentName = "mf_CornerFillerFront";
    }
  ...
  #prepareContextInternal = mf_CornerFillerFront_prepareContext;
  seal(): IModuleNonNull_mf_CornerFillerFront {
  ...
  override validateSelections(): void {
    ...
    this.mod_HeightLeft_matrix = VariantValidation.mod_HeightLeft(this, this.mod_HeightLeft);
    this.mod_HeightRight_matrix = VariantValidation.mod_HeightRight(this, this.mod_HeightRight);
    this.mod_CarcaseId_matrix = VariantValidation.mod_CarcaseId(this, this.mod_CarcaseId);
    this.mod_CornerunitStraightConstruction_matrix = VariantValidation.mod_CornerunitStraightConstruction(this, this.mod_CornerunitStraightConstruction);
    this.mod_CornerunitFrontWidth_matrix = VariantValidation.mod_CornerunitFrontWidth(this, this.mod_CornerunitFrontWidth);
    ...
    this.mod_ThkLeft_matrix = VariantValidation.mod_ThkLeft(this, this.mod_ThkLeft);
    this.mod_ThkRight_matrix = VariantValidation.mod_ThkRight(this, this.mod_ThkRight);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mf_CornerFillerFront_NonNull(this);
  ...
  addpart_FillerUnit(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_FillerUnit_PartVarsWritable {
    var c = new P_part_FillerUnit(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mf_CornerFillerFront_NonNull implements cbp_mf_CornerFillerFront, adc_mf_CornerFillerFront, ccm_mf_CornerFillerFront, IPartParentsNonNull_mc_CornerFillerFront01_mc_FillerFront01_mf_CornerFillerFront, IPartParentsNonNull_mf_CornerFillerFront_mr_CornerFiller {
  ...
  #calculateContainerModulesInternal = mf_CornerFillerFront_calculateContainerModules;
