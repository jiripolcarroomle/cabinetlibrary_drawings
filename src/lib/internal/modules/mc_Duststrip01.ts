...
import { mc_Duststrip01_createBuildPlan, mc_Duststrip01_afterDataCompletion, mc_Duststrip01_manufacturerDataCompletion, mc_Duststrip01_calculateContainerModules, mc_Duststrip01_prepareContext } from '../../modules/mc_Duststrip01';
...
export interface pc_mc_Duststrip01 extends dc_mc_Duststrip01 {
...
export interface adc_base_mc_Duststrip01 extends IModBaseProp
  , IModVarNonNull_mod_VertDividerType, IModVarNonNull_mod_DoorType, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapHorTop, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontType, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_FrontThk, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_FrontHeight, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_HardwareId, IModVarNonNull_mod_CarcaseSpaceDimension {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_Duststrip01 extends adc_base_mc_Duststrip01 {
}

export interface ccm_mc_Duststrip01 extends adc_base_mc_Duststrip01 {
}


export class OD_M_mc_Duststrip01 extends OD_Base implements pc_mc_Duststrip01, dc_mc_Duststrip01
  ...
  #prepareContextInternal = mc_Duststrip01_prepareContext;
  seal(): IModuleNonNull_mc_Duststrip01 {
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Duststrip01_NonNull(this);
  ...
  addpart_Duststrip(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Duststrip_PartVarsWritable {
    var c = new P_part_Duststrip(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_Duststrip01_NonNull implements cbp_mc_Duststrip01, adc_mc_Duststrip01, ccm_mc_Duststrip01, IPartParentsNonNull_mc_Duststrip01 {
  ...
  #calculateContainerModulesInternal = mc_Duststrip01_calculateContainerModules;
