...
import { mc_Fingergrip01_createBuildPlan, mc_Fingergrip01_afterDataCompletion, mc_Fingergrip01_manufacturerDataCompletion, mc_Fingergrip01_calculateContainerModules, mc_Fingergrip01_prepareContext } from '../../modules/mc_Fingergrip01';
...
export interface pc_mc_Fingergrip01 extends dc_mc_Fingergrip01 {
...
export interface adc_base_mc_Fingergrip01 extends IModBaseProp
...
export interface adc_mc_Fingergrip01 extends adc_base_mc_Fingergrip01 {
}

export interface ccm_mc_Fingergrip01 extends adc_base_mc_Fingergrip01 {
}


export class OD_M_mc_Fingergrip01 extends OD_Base implements pc_mc_Fingergrip01, dc_mc_Fingergrip01
  ...
  #prepareContextInternal = mc_Fingergrip01_prepareContext;
  seal(): IModuleNonNull_mc_Fingergrip01 {
  ...
  override validateSelections(): void {
    this.mod_FingergripColor_matrix = VariantValidation.mod_FingergripColor(this, this.mod_FingergripColor);
    this.mod_FingergripType_matrix = VariantValidation.mod_FingergripType(this, this.mod_FingergripType);
    this.mod_FingergripLength_matrix = VariantValidation.mod_FingergripLength(this, this.mod_FingergripLength);
    this.mod_FingergripPostype_matrix = VariantValidation.mod_FingergripPostype(this, this.mod_FingergripPostype);
  }

  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Fingergrip01_NonNull(this);
  ...
  addpart_FingergripTop(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_FingergripTop_PartVarsWritable {
    var c = new P_part_FingergripTop(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_FingergripMiddle(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_FingergripMiddle_PartVarsWritable {
    var c = new P_part_FingergripMiddle(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_Fingergrip01_NonNull implements cbp_mc_Fingergrip01, adc_mc_Fingergrip01, ccm_mc_Fingergrip01, IPartParentsNonNull_mc_Fingergrip01 {
  ...
  #calculateContainerModulesInternal = mc_Fingergrip01_calculateContainerModules;
