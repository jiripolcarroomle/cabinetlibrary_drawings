...
export interface pc_mc_CleatVert01 extends dc_mc_CleatVert01 {
...
export interface adc_base_mc_CleatVert01 extends IModBaseProp
...
export interface adc_mc_CleatVert01 extends adc_base_mc_CleatVert01 {
}

export interface ccm_mc_CleatVert01 extends adc_base_mc_CleatVert01 {
}


export class OD_M_mc_CleatVert01 extends OD_Base implements pc_mc_CleatVert01, dc_mc_CleatVert01
  ...
  #prepareContextInternal = mc_CleatVert01_prepareContext;
  seal(): IModuleNonNull_mc_CleatVert01 {
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_CleatVert01_NonNull(this);
  ...
  addpart_CleatVert(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_CleatVert_PartVarsWritable {
    var c = new P_part_CleatVert(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_CleatVert01_NonNull implements cbp_mc_CleatVert01, adc_mc_CleatVert01, ccm_mc_CleatVert01, IPartParentsNonNull_mc_CleatVert01 {
  ...
  #calculateContainerModulesInternal = mc_CleatVert01_calculateContainerModules;
