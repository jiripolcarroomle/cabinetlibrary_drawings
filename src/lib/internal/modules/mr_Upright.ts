...
import { IModuleNonNull_mr_Upright, IModParents_mr_StorageunitSingle_mr_Upright, IPartParentsNonNull_mr_StorageunitSingle_mr_Upright } from '../mod-interfaces'
import { IModVar_mod_UprightColor, IModVarNonNull_mod_UprightColor, IModVar_mod_UprightFloorProfileColor, IModVarNonNull_mod_UprightFloorProfileColor, IModVar_mod_UprightDepth, IModVarNonNull_mod_UprightDepth, IModVar_mod_UprightHeight, IModVarNonNull_mod_UprightHeight, IModVar_mod_PlinthAreaHeight, IModVarNonNull_mod_PlinthAreaHeight, IModVar_mod_UprightThk, IModVarNonNull_mod_UprightThk, IModVar_mod_UprightOverhang, IModVarNonNull_mod_UprightOverhang, IModVar_mod_CreateCountertop, IModVarNonNull_mod_CreateCountertop, IModVar_mod_UprightConstruction, IModVarNonNull_mod_UprightConstruction, IModVar_mod_HeightPosInsertion, IModVarNonNull_mod_HeightPosInsertion, IModVar_mod_TypeElement, IModVarNonNull_mod_TypeElement, IModVar_mod_UprightProgram, IModVarNonNull_mod_UprightProgram, IModVar_mod_CreateBacksplash, IModVarNonNull_mod_CreateBacksplash, IModVar_mod_CountertopThk, IModVarNonNull_mod_CountertopThk, IModVar_mod_UprightOverdimensionBtm, IModVarNonNull_mod_UprightOverdimensionBtm, IModVar_mod_UprightOverdimensionTop, IModVarNonNull_mod_UprightOverdimensionTop, IModVar_mod_CreatePaneltop, IModVarNonNull_mod_CreatePaneltop, IModVar_mod_CreateCeilingFiller, IModVarNonNull_mod_CreateCeilingFiller } from '../var-interfaces'
import { VariantValidation, IMatrix_mod_UprightColor, IMatrix_mod_UprightFloorProfileColor, IMatrix_mod_UprightDepth, IMatrix_mod_UprightHeight, IMatrix_mod_PlinthAreaHeight, IMatrix_mod_UprightThk, IMatrix_mod_UprightOverhang, IMatrix_mod_CreateCountertop, IMatrix_mod_UprightConstruction, IMatrix_mod_HeightPosInsertion, IMatrix_mod_TypeElement, IMatrix_mod_UprightProgram, IMatrix_mod_CreateBacksplash, IMatrix_mod_CountertopThk, IMatrix_mod_UprightOverdimensionBtm, IMatrix_mod_UprightOverdimensionTop, IMatrix_mod_CreatePaneltop, IMatrix_mod_CreateCeilingFiller } from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'
import { IGlobalVarsParent } from '../global-vars-parent'

import { mr_Upright_createBuildPlan, mr_Upright_afterDataCompletion, mr_Upright_manufacturerDataCompletion, mr_Upright_calculateContainerModules, mr_Upright_prepareContext } from '../../modules/mr_Upright';

export interface cbp_mr_Upright extends IModBaseProp
  , IModVarNonNull_mod_UprightColor, IModVarNonNull_mod_UprightFloorProfileColor, IModVarNonNull_mod_UprightDepth, IModVarNonNull_mod_UprightHeight, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_UprightThk, IModVarNonNull_mod_UprightOverhang, IModVarNonNull_mod_CreateCountertop, IModVarNonNull_mod_UprightConstruction, IModVarNonNull_mod_HeightPosInsertion, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_UprightProgram, IModVarNonNull_mod_CreateBacksplash, IModVarNonNull_mod_CountertopThk, IModVarNonNull_mod_UprightOverdimensionBtm, IModVarNonNull_mod_UprightOverdimensionTop, IModVarNonNull_mod_CreatePaneltop, IModVarNonNull_mod_CreateCeilingFiller {
...
export interface dc_mr_Upright extends IModBaseProp
  , IModVar_mod_UprightColor, IModVar_mod_UprightFloorProfileColor, IModVar_mod_UprightDepth, IModVar_mod_UprightHeight, IModVar_mod_PlinthAreaHeight, IModVar_mod_UprightThk, IModVar_mod_UprightOverhang, IModVar_mod_CreateCountertop, IModVar_mod_UprightConstruction, IModVar_mod_HeightPosInsertion, IModVar_mod_TypeElement, IModVar_mod_UprightProgram, IModVar_mod_CreateBacksplash, IModVar_mod_CountertopThk, IModVar_mod_UprightOverdimensionBtm, IModVar_mod_UprightOverdimensionTop, IModVar_mod_CreatePaneltop, IModVar_mod_CreateCeilingFiller {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
...
export interface pc_mr_Upright extends dc_mr_Upright {
...
export interface adc_base_mr_Upright extends IModBaseProp
  , IModVarNonNull_mod_UprightColor, IModVarNonNull_mod_UprightFloorProfileColor, IModVarNonNull_mod_UprightDepth, IModVarNonNull_mod_UprightHeight, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_UprightThk, IModVarNonNull_mod_UprightOverhang, IModVarNonNull_mod_CreateCountertop, IModVarNonNull_mod_UprightConstruction, IModVarNonNull_mod_HeightPosInsertion, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_UprightProgram, IModVarNonNull_mod_CreateBacksplash, IModVarNonNull_mod_CountertopThk, IModVarNonNull_mod_UprightOverdimensionBtm, IModVarNonNull_mod_UprightOverdimensionTop, IModVarNonNull_mod_CreatePaneltop, IModVarNonNull_mod_CreateCeilingFiller {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
...
export interface adc_mr_Upright extends adc_base_mr_Upright {
  addOD_M_mc_Upright01(index?: number): dc_mc_Upright01;
}

export interface ccm_mr_Upright extends adc_base_mr_Upright {
}


export class OD_M_mr_Upright extends OD_Base implements pc_mr_Upright, dc_mr_Upright
  , IModParents_mr_StorageunitSingle_mr_Upright
  , IModVar_mod_UprightColor, IModVar_mod_UprightFloorProfileColor, IModVar_mod_UprightDepth, IModVar_mod_UprightHeight, IModVar_mod_PlinthAreaHeight, IModVar_mod_UprightThk, IModVar_mod_UprightOverhang, IModVar_mod_CreateCountertop, IModVar_mod_UprightConstruction, IModVar_mod_HeightPosInsertion, IModVar_mod_TypeElement, IModVar_mod_UprightProgram, IModVar_mod_CreateBacksplash, IModVar_mod_CountertopThk, IModVar_mod_UprightOverdimensionBtm, IModVar_mod_UprightOverdimensionTop, IModVar_mod_CreatePaneltop, IModVar_mod_CreateCeilingFiller {
  ...
  override variants: string[] = ['mod_UprightColor', 'mod_UprightFloorProfileColor', 'mod_UprightDepth', 'mod_UprightHeight', 'mod_PlinthAreaHeight', 'mod_UprightThk', 'mod_UprightOverhang', 'mod_CreateCountertop', 'mod_UprightConstruction', 'mod_HeightPosInsertion', 'mod_TypeElement', 'mod_UprightProgram', 'mod_CreateBacksplash', 'mod_CountertopThk', 'mod_UprightOverdimensionBtm', 'mod_UprightOverdimensionTop', 'mod_CreatePaneltop', 'mod_CreateCeilingFiller',];
  ...
  #mod_UprightProgram?: string;
  get mod_UprightProgram(): string | undefined { return this.#mod_UprightProgram }
  set mod_UprightProgram(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_UprightProgram' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_UprightProgram === value) return;
    this.#mod_UprightProgram = value;
  }

  mod_UprightProgram_matrix?: IMatrix_mod_UprightProgram;
  ...
  #mod_UprightOverdimensionBtm?: number;
  get mod_UprightOverdimensionBtm(): number | undefined { return this.#mod_UprightOverdimensionBtm }
  set mod_UprightOverdimensionBtm(value: number | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_UprightOverdimensionBtm' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_UprightOverdimensionBtm === value) return;
    this.#mod_UprightOverdimensionBtm = value;
  }

  mod_UprightOverdimensionBtm_matrix?: IMatrix_mod_UprightOverdimensionBtm;
  #mod_UprightOverdimensionTop?: number;
  get mod_UprightOverdimensionTop(): number | undefined { return this.#mod_UprightOverdimensionTop }
  set mod_UprightOverdimensionTop(value: number | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_UprightOverdimensionTop' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_UprightOverdimensionTop === value) return;
    this.#mod_UprightOverdimensionTop = value;
  }

  mod_UprightOverdimensionTop_matrix?: IMatrix_mod_UprightOverdimensionTop;
  ...
  override getAttributes(): Map<string, any> {
    ...
    res.set('mod_UprightProgram', this.mod_UprightProgram);
    res.set('mod_CreateBacksplash', this.mod_CreateBacksplash);
    res.set('mod_CountertopThk', this.mod_CountertopThk);
    res.set('mod_UprightOverdimensionBtm', this.mod_UprightOverdimensionBtm);
    res.set('mod_UprightOverdimensionTop', this.mod_UprightOverdimensionTop);
  ...
  override loadJson(json: any, withSubModules: boolean = true, manufacturerMode: boolean) {
    ...
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_UprightProgram');
      const val = _toString(json['attributes']['mod_UprightProgram'], 'mod_UprightProgram');
      internal_leaveValidateVariant();
      this.mod_UprightProgram = val;
    }
    {
    ...
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_UprightOverdimensionBtm');
      const val = _toFloat(json['attributes']['mod_UprightOverdimensionBtm'], 'mod_UprightOverdimensionBtm');
      internal_leaveValidateVariant();
      this.mod_UprightOverdimensionBtm = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_UprightOverdimensionTop');
      const val = _toFloat(json['attributes']['mod_UprightOverdimensionTop'], 'mod_UprightOverdimensionTop');
      internal_leaveValidateVariant();
      this.mod_UprightOverdimensionTop = val;
    }
    {
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_TypeElement === undefined) {
      this.mod_TypeElement = "Upright";
    }
    if (this.mod_UprightProgram === undefined) {
      this.mod_UprightProgram = "ModernNature";
    }
    if (this.mod_CreateBacksplash === undefined) {
      this.mod_CreateBacksplash = false;
    }
    if (this.mod_UprightOverdimensionBtm === undefined) {
      this.mod_UprightOverdimensionBtm = 0;
    }
    if (this.mod_UprightOverdimensionTop === undefined) {
      this.mod_UprightOverdimensionTop = 0;
    }
  ...
  #dataCompletionSetDefaultScripts_globalVars() {
    ...
    if (this.mod_UprightThk === undefined) {
      this.mod_UprightThk = this.g.basic_UprightThk;
    }
  ...
  #prepareContextInternal = mr_Upright_prepareContext;
  seal(): IModuleNonNull_mr_Upright {
  ...
  override validateSelections(): void {
    this.mod_UprightColor_matrix = VariantValidation.mod_UprightColor(this, this.mod_UprightColor);
    this.mod_UprightFloorProfileColor_matrix = VariantValidation.mod_UprightFloorProfileColor(this, this.mod_UprightFloorProfileColor);
    this.mod_UprightDepth_matrix = VariantValidation.mod_UprightDepth(this, this.mod_UprightDepth);
    this.mod_UprightHeight_matrix = VariantValidation.mod_UprightHeight(this, this.mod_UprightHeight);
    this.mod_PlinthAreaHeight_matrix = VariantValidation.mod_PlinthAreaHeight(this, this.mod_PlinthAreaHeight);
    this.mod_UprightThk_matrix = VariantValidation.mod_UprightThk(this, this.mod_UprightThk);
    this.mod_UprightOverhang_matrix = VariantValidation.mod_UprightOverhang(this, this.mod_UprightOverhang);
    this.mod_CreateCountertop_matrix = VariantValidation.mod_CreateCountertop(this, this.mod_CreateCountertop);
    this.mod_UprightConstruction_matrix = VariantValidation.mod_UprightConstruction(this, this.mod_UprightConstruction);
    ...
    this.mod_UprightProgram_matrix = VariantValidation.mod_UprightProgram(this, this.mod_UprightProgram);
    ...
    this.mod_UprightOverdimensionBtm_matrix = VariantValidation.mod_UprightOverdimensionBtm(this, this.mod_UprightOverdimensionBtm);
    this.mod_UprightOverdimensionTop_matrix = VariantValidation.mod_UprightOverdimensionTop(this, this.mod_UprightOverdimensionTop);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mr_Upright_NonNull(this);
...
class OD_M_mr_Upright_NonNull implements cbp_mr_Upright, adc_mr_Upright, ccm_mr_Upright, IPartParentsNonNull_mr_StorageunitSingle_mr_Upright {
  ...
  #calculateContainerModulesInternal = mr_Upright_calculateContainerModules;
  ...
  get mod_UprightColor_matrix(): IMatrix_mod_UprightColor {
    return this.#internalParent.mod_UprightColor_matrix!;
  }
  ...
  get mod_UprightConstruction_matrix(): IMatrix_mod_UprightConstruction {
    return this.#internalParent.mod_UprightConstruction_matrix!;
  }
  ...
  get mod_UprightProgram(): string {
    return this.#internalParent.mod_UprightProgram!;
  }
  get mod_UprightProgram_matrix(): IMatrix_mod_UprightProgram {
    return this.#internalParent.mod_UprightProgram_matrix!;
  }
  ...
  get mod_UprightOverdimensionBtm(): number {
    return this.#internalParent.mod_UprightOverdimensionBtm!;
  }
  get mod_UprightOverdimensionTop(): number {
    return this.#internalParent.mod_UprightOverdimensionTop!;
  }
