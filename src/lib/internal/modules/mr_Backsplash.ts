...
import { IModVar_mod_BacksplashColor, IModVarNonNull_mod_BacksplashColor, IModVar_mod_BacksplashHeight, IModVarNonNull_mod_BacksplashHeight, IModVar_mod_BacksplashThk, IModVarNonNull_mod_BacksplashThk, IModVar_mod_CountertopOverhangFront, IModVarNonNull_mod_CountertopOverhangFront, IModVar_mod_CountertopOverhangLeft, IModVarNonNull_mod_CountertopOverhangLeft, IModVar_mod_CountertopOverhangRight, IModVarNonNull_mod_CountertopOverhangRight } from '../var-interfaces'
...
export interface adc_mr_Backsplash extends adc_base_mr_Backsplash {
  addOD_M_mc_Backsplash(index?: number): dc_mc_Backsplash;
}

export interface ccm_mr_Backsplash extends adc_base_mr_Backsplash {
}
...
export class OD_M_mr_Backsplash extends OD_Base implements dc_mr_Backsplash
  ...
  override variants: string[] = ['mod_BacksplashColor', 'mod_BacksplashHeight', 'mod_BacksplashThk', 'mod_CountertopOverhangFront', 'mod_CountertopOverhangLeft', 'mod_CountertopOverhangRight',];
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mr_Backsplash_NonNull(this);
...
class OD_M_mr_Backsplash_NonNull implements cbp_mr_Backsplash, adc_mr_Backsplash, ccm_mr_Backsplash, IPartParentsNonNull_mr_Backsplash {
  ...
  #calculateContainerModulesInternal = mr_Backsplash_calculateContainerModules;
