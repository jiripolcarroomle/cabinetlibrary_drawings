...
import { IModParents_mf_CornerFillerFront_mr_CornerFiller } from '../mod-interfaces'
...
export interface pc_mc_CornerFillerFront01 extends dc_mc_CornerFillerFront01 {
...
export interface adc_base_mc_CornerFillerFront01 extends IModBaseProp
  , IModVarNonNull_mod_CarcaseDirection, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_FingergripTop, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontOversizeBtm, IModVarNonNull_mod_FrontOversizeTop, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_HandleDesign, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_FrontHeight, IModVarNonNull_mod_FrontThk, IModVarNonNull_mod_DoorDirection, IModVarNonNull_mod_HandlePosMatrix, IModVarNonNull_mod_HandlePosType, IModVarNonNull_mod_HandleColor, IModVarNonNull_mod_CornerunitStraightFillerConstruction, IModVarNonNull_mod_FillerType, IModVarNonNull_mod_FillerHardware, IModVarNonNull_mod_Direction, IModVarNonNull_mod_CarcasePartInfo, IModVarNonNull_mod_FillerHardwareInfo, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_FingergripTopType, IModVarNonNull_mod_FingergripBtmType, IModVarNonNull_mod_FrontOversizeLeft, IModVarNonNull_mod_FrontOversizeRight, IModVarNonNull_mod_FrontType {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
  ct_tab_FrontConstruction: ct2_tab_FrontConstruction;
}

export interface adc_mc_CornerFillerFront01 extends adc_base_mc_CornerFillerFront01 {
  addOD_M_mc_ThermoformedPanel01(index?: number): dc_mc_ThermoformedPanel01;
  addOD_M_mc_PanelWoodFrame01(index?: number): dc_mc_PanelWoodFrame01;
  addOD_M_mc_MetalFrame01(index?: number): dc_mc_MetalFrame01;
  addOD_M_mc_Handlestrip01(index?: number): dc_mc_Handlestrip01;
...
export interface ccm_mc_CornerFillerFront01 extends adc_base_mc_CornerFillerFront01 {
}


export class OD_M_mc_CornerFillerFront01 extends OD_Base implements pc_mc_CornerFillerFront01, dc_mc_CornerFillerFront01
  ...
  , IModVar_mod_CarcaseDirection, IModVar_mod_CarcaseId, IModVar_mod_FingergripTop, IModVar_mod_FrontColor, IModVar_mod_FrontDesign, IModVar_mod_FrontEdgeColor, IModVar_mod_FrontEdgeThk, IModVar_mod_FrontGapCarcase, IModVar_mod_FrontGapHor, IModVar_mod_FrontGapVert, IModVar_mod_FrontId, IModVar_mod_FrontOversizeBtm, IModVar_mod_FrontOversizeTop, IModVar_mod_FrontPosStart, IModVar_mod_FrontProgram, IModVar_mod_ModuleName, IModVar_mod_ParentName, IModVar_mod_PlinthAreaHeight, IModVar_mod_HandleDesign, IModVar_mod_FrontWidth, IModVar_mod_FrontHeight, IModVar_mod_FrontThk, IModVar_mod_DoorDirection, IModVar_mod_HandlePosMatrix, IModVar_mod_HandlePosType, IModVar_mod_HandleColor, IModVar_mod_CornerunitStraightFillerConstruction, IModVar_mod_FillerType, IModVar_mod_FillerHardware, IModVar_mod_Direction, IModVar_mod_CarcasePartInfo, IModVar_mod_FillerHardwareInfo, IModVar_mod_Originpos, IModVar_mod_TypeElement, IModVar_mod_FingergripTopType, IModVar_mod_FingergripBtmType, IModVar_mod_FrontOversizeLeft, IModVar_mod_FrontOversizeRight, IModVar_mod_FrontType {
  constructor(parent: IModParents_mf_CornerFillerFront_mr_CornerFiller, manufacturerMode?: boolean) {
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mc_CornerFillerFront01";
    }
  ...
  #prepareContextInternal = mc_CornerFillerFront01_prepareContext;
  seal(): IModuleNonNull_mc_CornerFillerFront01 {
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_CornerFillerFront01_NonNull(this);
  ...
  addpart_FillerHardware(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_FillerHardware_PartVarsWritable {
    var c = new P_part_FillerHardware(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_FillerHardwareProcessing(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_FillerHardwareProcessing_PartVarsWritable {
    var c = new P_part_FillerHardwareProcessing(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_CornerFillerFront01_NonNull implements cbp_mc_CornerFillerFront01, adc_mc_CornerFillerFront01, ccm_mc_CornerFillerFront01, IPartParentsNonNull_mc_BaseunitFridge01_mc_CornerFillerFront01_mc_Dishwasher01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_BaseunitFridge01_mc_CornerFillerFront01_mc_Dishwasher01_mc_Door01_mc_Drawer01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01, IPartParentsNonNull_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_Fixedfront01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_CornerFillerFront01_mc_FillerFront01_mf_CornerFillerFront, IPartParentsNonNull_mc_CornerFillerFront01_mc_FillerFront01 {
  ...
  #calculateContainerModulesInternal = mc_CornerFillerFront01_calculateContainerModules;
