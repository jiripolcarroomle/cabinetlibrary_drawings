...
export interface pc_mc_Dishwasher01 extends dc_mc_Dishwasher01 {
...
export interface adc_base_mc_Dishwasher01 extends IModBaseProp
...
export interface adc_mc_Dishwasher01 extends adc_base_mc_Dishwasher01 {
  addOD_M_mc_FrontPanel01(index?: number): dc_mc_FrontPanel01;
  addOD_M_mc_PanelWoodFrame01(index?: number): dc_mc_PanelWoodFrame01;
  addOD_M_mc_Handle01(index?: number): dc_mc_Handle01;
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic;
...
export interface ccm_mc_Dishwasher01 extends adc_base_mc_Dishwasher01 {
}


export class OD_M_mc_Dishwasher01 extends OD_Base implements pc_mc_Dishwasher01, dc_mc_Dishwasher01
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mc_Dishwasher01";
    }
  ...
  #manufacturerDataCompletionInternal = mc_Dishwasher01_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_Dishwasher01_NonNull(this);
  ...
  #prepareContextInternal = mc_Dishwasher01_prepareContext;
  seal(): IModuleNonNull_mc_Dishwasher01 {
    this.afterDataCompletion();
    const adc = new OD_M_mc_Dishwasher01_NonNull(this);
    return adc;
  }
  ...
  override validateSelections(): void {
    ...
    this.mod_DishwasherSupplier_matrix = VariantValidation.mod_DishwasherSupplier(this, this.mod_DishwasherSupplier);
    this.mod_DishwasherId_matrix = VariantValidation.mod_DishwasherId(this, this.mod_DishwasherId);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Dishwasher01_NonNull(this);
  ...
  addpart_DropZone(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_DropZone_PartVarsWritable {
    var c = new P_part_DropZone(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }

  override createBuildPlan(): void {
    var cbp = new OD_M_mc_Dishwasher01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_Dishwasher01_NonNull implements cbp_mc_Dishwasher01, adc_mc_Dishwasher01, ccm_mc_Dishwasher01, IPartParentsNonNull_mc_BaseunitFridge01_mc_CornerFillerFront01_mc_Dishwasher01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_BaseunitFridge01_mc_CornerFillerFront01_mc_Dishwasher01_mc_Door01_mc_Drawer01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood, IPartParentsNonNull_mc_Dishwasher01_mr_Appliance, IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01 {
  constructor(parent: OD_M_mc_Dishwasher01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_Dishwasher01;
  ...
  #createBuildPlanInternal = mc_Dishwasher01_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_Dishwasher01_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = mc_Dishwasher01_calculateContainerModules;
