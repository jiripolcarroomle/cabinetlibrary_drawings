...
import { IP_part_ClothingOrganizerBoard_PartVarsWritable, P_part_ClothingOrganizerBoard } from '../parts/part_ClothingOrganizerBoard'
import { IModuleNonNull_mc_ClothingOrganizerBoard01, IModParents_mc_ClothingOrganizerBoard01, IPartParentsNonNull_mc_ClothingOrganizerBoard01 } from '../mod-interfaces'
import { IModVar_mod_ClothingOrganizerBoardColor, IModVarNonNull_mod_ClothingOrganizerBoardColor, IModVar_mod_Depth, IModVarNonNull_mod_Depth, IModVar_mod_Height, IModVarNonNull_mod_Height, IModVar_mod_Width, IModVarNonNull_mod_Width } from '../var-interfaces'
import { VariantValidation, IMatrix_mod_ClothingOrganizerBoardColor, IMatrix_mod_Depth, IMatrix_mod_Height, IMatrix_mod_Width } from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_ClothingOrganizerBoard } from '../part-add-interfaces';
import { mc_ClothingOrganizerBoard01_createBuildPlan, mc_ClothingOrganizerBoard01_afterDataCompletion, mc_ClothingOrganizerBoard01_manufacturerDataCompletion, mc_ClothingOrganizerBoard01_calculateContainerModules, mc_ClothingOrganizerBoard01_prepareContext } from '../../modules/mc_ClothingOrganizerBoard01';

export interface cbp_mc_ClothingOrganizerBoard01 extends IModBaseProp
  , IPartAdd_part_ClothingOrganizerBoard, IModVarNonNull_mod_ClothingOrganizerBoardColor, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Height, IModVarNonNull_mod_Width {
...
export interface dc_mc_ClothingOrganizerBoard01 extends IModBaseProp
  , IModVar_mod_ClothingOrganizerBoardColor, IModVar_mod_Depth, IModVar_mod_Height, IModVar_mod_Width {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
  seal(): IModuleNonNull_mc_ClothingOrganizerBoard01;
  parent: IModParents_me_ClothingOrganizer01;
}

export interface pc_mc_ClothingOrganizerBoard01 extends dc_mc_ClothingOrganizerBoard01 {
...
export interface adc_base_mc_ClothingOrganizerBoard01 extends IModBaseProp
  , IModVarNonNull_mod_ClothingOrganizerBoardColor, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Height, IModVarNonNull_mod_Width {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_ClothingOrganizerBoard01 extends adc_base_mc_ClothingOrganizerBoard01 {
}

export interface ccm_mc_ClothingOrganizerBoard01 extends adc_base_mc_ClothingOrganizerBoard01 {
}


export class OD_M_mc_ClothingOrganizerBoard01 extends OD_Base implements pc_mc_ClothingOrganizerBoard01, dc_mc_ClothingOrganizerBoard01
  , IModParents_mc_ClothingOrganizerBoard01
  , IModVar_mod_ClothingOrganizerBoardColor, IModVar_mod_Depth, IModVar_mod_Height, IModVar_mod_Width {
  constructor(parent: IModParents_me_ClothingOrganizer01, manufacturerMode?: boolean) {
    super('mc_ClothingOrganizerBoard01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_ClothingOrganizerBoard01_NonNull(this);
  }
  parent: IModParents_me_ClothingOrganizer01;
  _selfNonNull: OD_M_mc_ClothingOrganizerBoard01_NonNull;

  override variants: string[] = ['mod_ClothingOrganizerBoardColor', 'mod_Depth', 'mod_Height', 'mod_Width',];
  ...
  #dataCompletionAssignDerivedData() {
    ...
    if (this.mod_ClothingOrganizerBoardColor === undefined) {
      ...
      while (s !== undefined) {
        if (s.variants.includes('mod_ClothingOrganizerBoardColor')) {
          let pv = <IModVar_mod_ClothingOrganizerBoardColor>s;
          if (pv.mod_ClothingOrganizerBoardColor !== undefined) {
            this.mod_ClothingOrganizerBoardColor = (<IModVar_mod_ClothingOrganizerBoardColor>s).mod_ClothingOrganizerBoardColor;
            break;
          };
        }
        s = s.parentBase;
  ...
  #manufacturerDataCompletionInternal = mc_ClothingOrganizerBoard01_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_ClothingOrganizerBoard01_NonNull(this);
  ...
  #prepareContextInternal = mc_ClothingOrganizerBoard01_prepareContext;
  seal(): IModuleNonNull_mc_ClothingOrganizerBoard01 {
    this.afterDataCompletion();
    const adc = new OD_M_mc_ClothingOrganizerBoard01_NonNull(this);
    return adc;
  }
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_ClothingOrganizerBoard01_NonNull(this);
  ...
  addpart_ClothingOrganizerBoard(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_ClothingOrganizerBoard_PartVarsWritable {
    var c = new P_part_ClothingOrganizerBoard(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }

  override createBuildPlan(): void {
    var cbp = new OD_M_mc_ClothingOrganizerBoard01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_ClothingOrganizerBoard01_NonNull implements cbp_mc_ClothingOrganizerBoard01, adc_mc_ClothingOrganizerBoard01, ccm_mc_ClothingOrganizerBoard01, IPartParentsNonNull_mc_ClothingOrganizerBoard01 {
  constructor(parent: OD_M_mc_ClothingOrganizerBoard01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_ClothingOrganizerBoard01;
  ...
  #createBuildPlanInternal = mc_ClothingOrganizerBoard01_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_ClothingOrganizerBoard01_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = mc_ClothingOrganizerBoard01_calculateContainerModules;
  ...
  parent: IModParents_me_ClothingOrganizer01;
  addpart_ClothingOrganizerBoard(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_ClothingOrganizerBoard_PartVarsWritable {
    return this.#internalParent.addpart_ClothingOrganizerBoard(x, y, z, dimx, dimy, dimz);
  }
