...
export interface pc_mr_CornerFiller extends dc_mr_CornerFiller {
...
export interface adc_base_mr_CornerFiller extends IModBaseProp
  , IModVarNonNull_mod_CarcaseColor, IModVarNonNull_mod_CarcaseConnectionLeftBtm, IModVarNonNull_mod_CarcaseConnectionLeftTop, IModVarNonNull_mod_CarcaseConnectionRightBtm, IModVarNonNull_mod_CarcaseConnectionRightTop, IModVarNonNull_mod_CarcaseEdgeBackColor, IModVarNonNull_mod_CarcaseEdgeColor, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_CarcaseEdgeFrontColor, IModVarNonNull_mod_CarcaseFrontConstruction, IModVarNonNull_mod_CarcaseOutsideColor, IModVarNonNull_mod_CarcaseProgram, IModVarNonNull_mod_CarcaseOutsideProgram, IModVarNonNull_mod_CarcasePartConnectionBackHor, IModVarNonNull_mod_CarcasePartConnectionBackVert, IModVarNonNull_mod_CarcasePartConnectionBtmVert, IModVarNonNull_mod_CarcasePartConnectionLeftHor, IModVarNonNull_mod_CarcasePartConnectionRightHor, IModVarNonNull_mod_CarcasePartConnectionTopVert, IModVarNonNull_mod_CarcasePartInfo, IModVarNonNull_mod_CarcaseShelfbtmConstruction, IModVarNonNull_mod_CarcaseShelfbtmOversizeLeft, IModVarNonNull_mod_CarcaseShelfbtmOversizeRight, IModVarNonNull_mod_CarcaseShelftopConstruction, IModVarNonNull_mod_CarcaseShelftopOversizeLeft, IModVarNonNull_mod_CarcaseShelftopOversizeRight, IModVarNonNull_mod_CarcaseSidepanelleftOversizeBtm, IModVarNonNull_mod_CarcaseSidepanelleftOversizeTop, IModVarNonNull_mod_CarcaseSidepanelrightOversizeBtm, IModVarNonNull_mod_CarcaseSidepanelrightOversizeTop, IModVarNonNull_mod_CarcaseVisBack, IModVarNonNull_mod_CarcaseVisBtm, IModVarNonNull_mod_CarcaseVisLeft, IModVarNonNull_mod_CarcaseVisRight, IModVarNonNull_mod_CarcaseVisTop, IModVarNonNull_mod_CountertopInfo, IModVarNonNull_mod_CountertopThk, IModVarNonNull_mod_CreateCountertop, IModVarNonNull_mod_CreateFingergrip, IModVarNonNull_mod_CreatePaneltop, IModVarNonNull_mod_CreateToekick, IModVarNonNull_mod_DepthLeft, IModVarNonNull_mod_DepthRight, IModVarNonNull_mod_FillerDepthLeft, IModVarNonNull_mod_FillerDepthRight, IModVarNonNull_mod_FillerHardware, IModVarNonNull_mod_FillerType, IModVarNonNull_mod_FingergripType, IModVarNonNull_mod_FittingConnectionBtmVert, IModVarNonNull_mod_FittingConnectionLeftBtm, IModVarNonNull_mod_FittingConnectionLeftHor, IModVarNonNull_mod_FittingConnectionLeftTop, IModVarNonNull_mod_FittingConnectionRightBtm, IModVarNonNull_mod_FittingConnectionRightHor, IModVarNonNull_mod_FittingConnectionRightTop, IModVarNonNull_mod_FittingConnectionTopVert, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapHorTop, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_HardwareColor, IModVarNonNull_mod_Height, IModVarNonNull_mod_HeightPosInsertion, IModVarNonNull_mod_Model, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_PlinthAreaDesign, IModVarNonNull_mod_PlinthAreaElementColor, IModVarNonNull_mod_PlinthAreaExtraItem, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_PlinthAreaPosBackMatrix, IModVarNonNull_mod_PlinthAreaPosFrontMatrix, IModVarNonNull_mod_PlinthAreaPositionInfo, IModVarNonNull_mod_PlinthAreaPosLeftMatrix, IModVarNonNull_mod_PlinthAreaPosRightMatrix, IModVarNonNull_mod_PlinthAreaVisLeft, IModVarNonNull_mod_PlinthAreaVisRight, IModVarNonNull_mod_ShelfbtmThk, IModVarNonNull_mod_ShelftopThk, IModVarNonNull_mod_SidepanelleftThk, IModVarNonNull_mod_SidepanelrightThk, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_WidthLeft, IModVarNonNull_mod_WidthRight, IModVarNonNull_mod_TotalDimLeft, IModVarNonNull_mod_TotalDimRight, IModVarNonNull_mod_SidepanelleftType, IModVarNonNull_mod_SidepanelrightType, IModVarNonNull_mod_CarcaseSidepanelleftOversizeInsideWall, IModVarNonNull_mod_CarcaseSidepanelrightOversizeInsideWall, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_CornerunitDimensionLogic, IModVarNonNull_mod_HandleDesign, IModVarNonNull_mod_HandleColor, IModVarNonNull_mod_HandlePosType, IModVarNonNull_mod_CornerunitStraightFillerConstruction, IModVarNonNull_mod_HeightLeft, IModVarNonNull_mod_HeightRight, IModVarNonNull_mod_ThkLeft, IModVarNonNull_mod_ThkRight, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_FingergripTop, IModVarNonNull_mod_FrontOversizeBtm, IModVarNonNull_mod_FrontOversizeLeft, IModVarNonNull_mod_FrontOversizeRight, IModVarNonNull_mod_FrontOversizeTop, IModVarNonNull_mod_FingergripTopType, IModVarNonNull_mod_FingergripBtmType, IModVarNonNull_mod_FrontDescriptor, IModVarNonNull_mod_CreateBacksplash, IModVarNonNull_mod_CreateCeilingFiller {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
  ct_tab_CornerFillerFrontpanelConstruction: ct2_tab_CornerFillerFrontpanelConstruction;
...
export interface adc_mr_CornerFiller extends adc_base_mr_CornerFiller {
  addOD_M_mc_Cornerunit01(index?: number): dc_mc_Cornerunit01;
  addOD_M_mc_CornerFillerFront01(index?: number): dc_mc_CornerFillerFront01;
}

export interface ccm_mr_CornerFiller extends adc_base_mr_CornerFiller {
}


export class OD_M_mr_CornerFiller extends OD_Base implements pc_mr_CornerFiller, dc_mr_CornerFiller
  , IModParents_mr_CornerFiller, IModParents_mf_CornerFillerFront_mr_CornerFiller
  , IModVar_mod_CarcaseColor, IModVar_mod_CarcaseConnectionLeftBtm, IModVar_mod_CarcaseConnectionLeftTop, IModVar_mod_CarcaseConnectionRightBtm, IModVar_mod_CarcaseConnectionRightTop, IModVar_mod_CarcaseEdgeBackColor, IModVar_mod_CarcaseEdgeColor, IModVar_mod_FrontColor, IModVar_mod_CarcaseEdgeFrontColor, IModVar_mod_CarcaseFrontConstruction, IModVar_mod_CarcaseOutsideColor, IModVar_mod_CarcaseProgram, IModVar_mod_CarcaseOutsideProgram, IModVar_mod_CarcasePartConnectionBackHor, IModVar_mod_CarcasePartConnectionBackVert, IModVar_mod_CarcasePartConnectionBtmVert, IModVar_mod_CarcasePartConnectionLeftHor, IModVar_mod_CarcasePartConnectionRightHor, IModVar_mod_CarcasePartConnectionTopVert, IModVar_mod_CarcasePartInfo, IModVar_mod_CarcaseShelfbtmConstruction, IModVar_mod_CarcaseShelfbtmOversizeLeft, IModVar_mod_CarcaseShelfbtmOversizeRight, IModVar_mod_CarcaseShelftopConstruction, IModVar_mod_CarcaseShelftopOversizeLeft, IModVar_mod_CarcaseShelftopOversizeRight, IModVar_mod_CarcaseSidepanelleftOversizeBtm, IModVar_mod_CarcaseSidepanelleftOversizeTop, IModVar_mod_CarcaseSidepanelrightOversizeBtm, IModVar_mod_CarcaseSidepanelrightOversizeTop, IModVar_mod_CarcaseVisBack, IModVar_mod_CarcaseVisBtm, IModVar_mod_CarcaseVisLeft, IModVar_mod_CarcaseVisRight, IModVar_mod_CarcaseVisTop, IModVar_mod_CountertopInfo, IModVar_mod_CountertopThk, IModVar_mod_CreateCountertop, IModVar_mod_CreateFingergrip, IModVar_mod_CreatePaneltop, IModVar_mod_CreateToekick, IModVar_mod_DepthLeft, IModVar_mod_DepthRight, IModVar_mod_FillerDepthLeft, IModVar_mod_FillerDepthRight, IModVar_mod_FillerHardware, IModVar_mod_FillerType, IModVar_mod_FingergripType, IModVar_mod_FittingConnectionBtmVert, IModVar_mod_FittingConnectionLeftBtm, IModVar_mod_FittingConnectionLeftHor, IModVar_mod_FittingConnectionLeftTop, IModVar_mod_FittingConnectionRightBtm, IModVar_mod_FittingConnectionRightHor, IModVar_mod_FittingConnectionRightTop, IModVar_mod_FittingConnectionTopVert, IModVar_mod_FrontDesign, IModVar_mod_FrontEdgeColor, IModVar_mod_FrontEdgeThk, IModVar_mod_FrontGapCarcase, IModVar_mod_FrontGapHor, IModVar_mod_FrontGapHorTop, IModVar_mod_FrontGapVert, IModVar_mod_FrontProgram, IModVar_mod_HardwareColor, IModVar_mod_Height, IModVar_mod_HeightPosInsertion, IModVar_mod_Model, IModVar_mod_ModuleName, IModVar_mod_ParentName, IModVar_mod_PlinthAreaDesign, IModVar_mod_PlinthAreaElementColor, IModVar_mod_PlinthAreaExtraItem, IModVar_mod_PlinthAreaHeight, IModVar_mod_PlinthAreaPosBackMatrix, IModVar_mod_PlinthAreaPosFrontMatrix, IModVar_mod_PlinthAreaPositionInfo, IModVar_mod_PlinthAreaPosLeftMatrix, IModVar_mod_PlinthAreaPosRightMatrix, IModVar_mod_PlinthAreaVisLeft, IModVar_mod_PlinthAreaVisRight, IModVar_mod_ShelfbtmThk, IModVar_mod_ShelftopThk, IModVar_mod_SidepanelleftThk, IModVar_mod_SidepanelrightThk, IModVar_mod_TypeElement, IModVar_mod_WidthLeft, IModVar_mod_WidthRight, IModVar_mod_TotalDimLeft, IModVar_mod_TotalDimRight, IModVar_mod_SidepanelleftType, IModVar_mod_SidepanelrightType, IModVar_mod_CarcaseSidepanelleftOversizeInsideWall, IModVar_mod_CarcaseSidepanelrightOversizeInsideWall, IModVar_mod_FrontPosStart, IModVar_mod_CornerunitDimensionLogic, IModVar_mod_HandleDesign, IModVar_mod_HandleColor, IModVar_mod_HandlePosType, IModVar_mod_CornerunitStraightFillerConstruction, IModVar_mod_HeightLeft, IModVar_mod_HeightRight, IModVar_mod_ThkLeft, IModVar_mod_ThkRight, IModVar_mod_CarcaseId, IModVar_mod_FingergripTop, IModVar_mod_FrontOversizeBtm, IModVar_mod_FrontOversizeLeft, IModVar_mod_FrontOversizeRight, IModVar_mod_FrontOversizeTop, IModVar_mod_FingergripTopType, IModVar_mod_FingergripBtmType, IModVar_mod_FrontDescriptor, IModVar_mod_CreateBacksplash, IModVar_mod_CreateCeilingFiller {
  ...
  #dataCompletionSetDefaultScripts() {
    ...
    try {
      ...
      if (this.mod_HeightLeft === undefined) {
        ...
        // ####################### CUSTOM SCRIPTS ########################
        // ###############################################################
        // CUSTOMSCRIPT_mr_CornerFiller_mod_HeightLeft_SETDEFAULT
        this.mod_HeightLeft = this.mod_Height;
        // ###############################################################
        // ################### END CUSTOM SCRIPTS ########################
        // ###############################################################
      }
      if (this.mod_HeightRight === undefined) {
        ...
        // ####################### CUSTOM SCRIPTS ########################
        // ###############################################################
        // CUSTOMSCRIPT_mr_CornerFiller_mod_HeightRight_SETDEFAULT
        this.mod_HeightRight = this.mod_Height;
        // ###############################################################
        // ################### END CUSTOM SCRIPTS ########################
        // ###############################################################
      }
  ...
  #dataCompletionSetDefaultScripts_globalVars() {
    ...
    if (this.mod_CornerunitDimensionLogic === undefined) {
      this.mod_CornerunitDimensionLogic = this.g.basic_CornerunitDimensionLogic;
    }
    if (this.mod_HandleColor === undefined) {
  ...
  #prepareContextInternal = mr_CornerFiller_prepareContext;
  seal(): IModuleNonNull_mr_CornerFiller {
  ...
  override validateSelections(): void {
    ...
    this.mod_FillerDepthLeft_matrix = VariantValidation.mod_FillerDepthLeft(this, this.mod_FillerDepthLeft);
    this.mod_FillerDepthRight_matrix = VariantValidation.mod_FillerDepthRight(this, this.mod_FillerDepthRight);
    ...
    this.mod_CornerunitDimensionLogic_matrix = VariantValidation.mod_CornerunitDimensionLogic(this, this.mod_CornerunitDimensionLogic);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mr_CornerFiller_NonNull(this);
...
class OD_M_mr_CornerFiller_NonNull implements cbp_mr_CornerFiller, adc_mr_CornerFiller, ccm_mr_CornerFiller, IPartParentsNonNull_mr_CornerFiller, IPartParentsNonNull_mf_CornerFillerFront_mr_CornerFiller {
  ...
  #calculateContainerModulesInternal = mr_CornerFiller_calculateContainerModules;
