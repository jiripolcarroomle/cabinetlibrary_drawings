...
import { OD_M_mc_MirrorBoard, dc_mc_MirrorBoard } from './mc_MirrorBoard'
import { OD_M_mf_BoardShelf, dc_mf_BoardShelf } from './mf_BoardShelf'
import { IModuleNonNull_mr_MirrorBoard, IModParents_mc_MirrorBoard_mr_MirrorBoard, IModParents_mr_CoatBoard_mr_MirrorBoard, IModParents_mr_MirrorBoard, IPartParentsNonNull_mc_MirrorBoard_mr_MirrorBoard, IPartParentsNonNull_mr_CoatBoard_mr_MirrorBoard, IPartParentsNonNull_mr_MirrorBoard } from '../mod-interfaces'
import { IModVar_mod_MirrorBoardColor, IModVarNonNull_mod_MirrorBoardColor, IModVar_mod_MirrorBoardProgram, IModVarNonNull_mod_MirrorBoardProgram, IModVar_mod_MirrorBoardId, IModVarNonNull_mod_MirrorBoardId, IModVar_mod_Width, IModVarNonNull_mod_Width, IModVar_mod_Height, IModVarNonNull_mod_Height, IModVar_mod_MirrorBoardThickness, IModVarNonNull_mod_MirrorBoardThickness, IModVar_mod_HeightPosInsertion, IModVarNonNull_mod_HeightPosInsertion, IModVar_mod_MirrorColor, IModVarNonNull_mod_MirrorColor, IModVar_mod_MirrorWidth, IModVarNonNull_mod_MirrorWidth, IModVar_mod_MirrorHeight, IModVarNonNull_mod_MirrorHeight, IModVar_mod_MirrorThickness, IModVarNonNull_mod_MirrorThickness, IModVar_mod_MirrorPositionWidth, IModVarNonNull_mod_MirrorPositionWidth, IModVar_mod_MirrorPositionHeight, IModVarNonNull_mod_MirrorPositionHeight, IModVar_mod_BoardShelfColor, IModVarNonNull_mod_BoardShelfColor, IModVar_mod_BoardShelfProgram, IModVarNonNull_mod_BoardShelfProgram } from '../var-interfaces'
import { VariantValidation, IMatrix_mod_MirrorBoardColor, IMatrix_mod_MirrorBoardProgram, IMatrix_mod_MirrorBoardId, IMatrix_mod_Width, IMatrix_mod_Height, IMatrix_mod_MirrorBoardThickness, IMatrix_mod_HeightPosInsertion, IMatrix_mod_MirrorColor, IMatrix_mod_MirrorWidth, IMatrix_mod_MirrorHeight, IMatrix_mod_MirrorThickness, IMatrix_mod_MirrorPositionWidth, IMatrix_mod_MirrorPositionHeight, IMatrix_mod_BoardShelfColor, IMatrix_mod_BoardShelfProgram } from '../selections'
...
export interface dc_mr_MirrorBoard extends IModBaseProp
...
export interface adc_mr_MirrorBoard extends adc_base_mr_MirrorBoard {
  addOD_M_mc_MirrorBoard(index?: number): dc_mc_MirrorBoard;
  addOD_M_mf_BoardShelf(index?: number): dc_mf_BoardShelf;
}

export interface ccm_mr_MirrorBoard extends adc_base_mr_MirrorBoard {
}
...
export class OD_M_mr_MirrorBoard extends OD_Base implements dc_mr_MirrorBoard
  ...
  constructor(parent?: OD_Base, manufacturerMode?: boolean) {
    super('mr_MirrorBoard', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this._g = new GlobalVars();
    this._openGroups = new Map<string, OpenGroup>();
    this._partGroups = new Map<string, PartGroup>();
    this._selfNonNull = new OD_M_mr_MirrorBoard_NonNull(this);
  }
  _selfNonNull: OD_M_mr_MirrorBoard_NonNull;
  ...
  override variants: string[] = ['mod_MirrorBoardColor', 'mod_MirrorBoardProgram', 'mod_MirrorBoardId', 'mod_Width', 'mod_Height', 'mod_MirrorBoardThickness', 'mod_HeightPosInsertion', 'mod_MirrorColor', 'mod_MirrorWidth', 'mod_MirrorHeight', 'mod_MirrorThickness', 'mod_MirrorPositionWidth', 'mod_MirrorPositionHeight', 'mod_BoardShelfColor', 'mod_BoardShelfProgram',];
  ...
  override checkPosRelevantRequiredAttributes(): void {
    if (this.#mod_MirrorBoardId !== undefined) {
      this.#mod_MirrorBoardId = undefined;
      logWarning('The attribute "mod_MirrorBoardId" was set in the order data but is not marked as "pos relevant" - the value is ignored');
    }
    ...
    if (this.#mod_MirrorWidth === undefined) {
      logWarning('The required attribute "mod_MirrorWidth" was not set in the order data');
    }
    if (this.#mod_MirrorHeight === undefined) {
      logWarning('The required attribute "mod_MirrorHeight" was not set in the order data');
    }
  }
  ...
  #manufacturerDataCompletionInternal = mr_MirrorBoard_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mr_MirrorBoard_NonNull(this);
  ...
  addOD_M_mc_MirrorBoard(index?: number): dc_mc_MirrorBoard {
    var m = new OD_M_mc_MirrorBoard(this);
    m.dataCompletion();
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mr_MirrorBoard_NonNull(this);
  ...
  override createBuildPlan(): void {
    var cbp = new OD_M_mr_MirrorBoard_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mr_MirrorBoard_NonNull implements cbp_mr_MirrorBoard, adc_mr_MirrorBoard, ccm_mr_MirrorBoard, IPartParentsNonNull_mc_MirrorBoard_mr_MirrorBoard, IPartParentsNonNull_mr_CoatBoard_mr_MirrorBoard, IPartParentsNonNull_mr_MirrorBoard {
  constructor(parent: OD_M_mr_MirrorBoard) {
    this.#internalParent = parent;
  }
  #internalParent: OD_M_mr_MirrorBoard;
  ...
  #createBuildPlanInternal = mr_MirrorBoard_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mr_MirrorBoard_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = mr_MirrorBoard_calculateContainerModules;
  ...
  addOD_M_mc_MirrorBoard(index?: number): dc_mc_MirrorBoard {
    return this.#internalParent.addOD_M_mc_MirrorBoard(index);
  }
  addOD_M_mf_BoardShelf(index?: number): dc_mf_BoardShelf {
