...
export interface adc_base_mf_Dishwasher extends IModBaseProp
  , IModVarNonNull_mod_FingergripTop, IModVarNonNull_mod_FrontHeight, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontSplit, IModVarNonNull_mod_FrontThk, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_HandleDrill, IModVarNonNull_mod_HandleLine, IModVarNonNull_mod_HandlePosLogic, IModVarNonNull_mod_FrontQtyElements, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontOversizeBtm, IModVarNonNull_mod_FrontOversizeLeft, IModVarNonNull_mod_FrontOversizeRight, IModVarNonNull_mod_FrontOversizeTop, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_FrontSplitHeight1, IModVarNonNull_mod_FrontSplitHeight2, IModVarNonNull_mod_FrontSplitHeight3, IModVarNonNull_mod_FrontSplitType1, IModVarNonNull_mod_FrontSplitType2, IModVarNonNull_mod_HandleColor, IModVarNonNull_mod_HandleLength, IModVarNonNull_mod_HandleOffsetX, IModVarNonNull_mod_HandleOffsetY, IModVarNonNull_mod_HandlePosMatrix, IModVarNonNull_mod_HandlePosType, IModVarNonNull_mod_HandlestripPos, IModVarNonNull_mod_HeightPosInsertion, IModVarNonNull_mod_HandleDesign, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_FrontGapHorTop, IModVarNonNull_mod_HingeLogic, IModVarNonNull_mod_FingergripTopType, IModVarNonNull_mod_FingergripBtmType, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_FrontDescriptor, IModVarNonNull_mod_FrameFillingType, IModVarNonNull_mod_FrontHeightSelection, IModVarNonNull_mod_DishwasherId, IModVarNonNull_mod_DishwasherSupplier, IModVarNonNull_mod_Height, IModVarNonNull_mod_Depth, IModVarNonNull_mod_DishwasherInfo, IModVarNonNull_mod_FrameFillingColor {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mf_Dishwasher extends adc_base_mf_Dishwasher {
  addOD_M_mc_Dishwasher01(index?: number): dc_mc_Dishwasher01;
}

export interface ccm_mf_Dishwasher extends adc_base_mf_Dishwasher {
}


export class OD_M_mf_Dishwasher extends OD_Base implements pc_mf_Dishwasher, dc_mf_Dishwasher
  ...
  #prepareContextInternal = mf_Dishwasher_prepareContext;
  seal(): IModuleNonNull_mf_Dishwasher {
  ...
  addOD_M_mc_Dishwasher01(index?: number): dc_mc_Dishwasher01 {
    var m = new OD_M_mc_Dishwasher01(this);
    m.dataCompletion();
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mf_Dishwasher_NonNull(this);
...
class OD_M_mf_Dishwasher_NonNull implements cbp_mf_Dishwasher, adc_mf_Dishwasher, ccm_mf_Dishwasher, IPartParentsNonNull_mf_Dishwasher {
  ...
  #calculateContainerModulesInternal = mf_Dishwasher_calculateContainerModules;
  ...
  addOD_M_mc_Dishwasher01(index?: number): dc_mc_Dishwasher01 {
    return this.#internalParent.addOD_M_mc_Dishwasher01(index);
  }
}
