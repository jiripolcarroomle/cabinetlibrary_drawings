...
import { IModParents_mc_FillerStraight01 } from '../mod-interfaces'
import { IModuleNonNull_mc_FillerSupportPanels01 } from '../mod-interfaces'
import { IModVar_mod_Information, IModVarNonNull_mod_Information } from '../var-interfaces'
import { VariantValidation, IMatrix_mod_Information } from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { mc_FillerSupportPanels01_createBuildPlan, mc_FillerSupportPanels01_afterDataCompletion, mc_FillerSupportPanels01_manufacturerDataCompletion, mc_FillerSupportPanels01_calculateContainerModules, mc_FillerSupportPanels01_prepareContext } from '../../modules/mc_FillerSupportPanels01';

export interface cbp_mc_FillerSupportPanels01 extends IModBaseProp
  , IModVarNonNull_mod_Information {
  parent: IModParents_mc_FillerStraight01;
...
export interface dc_mc_FillerSupportPanels01 extends IModBaseProp
  , IModVar_mod_Information {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
  seal(): IModuleNonNull_mc_FillerSupportPanels01;
  parent: IModParents_mc_FillerStraight01;
}

export interface pc_mc_FillerSupportPanels01 extends dc_mc_FillerSupportPanels01 {
...
export interface adc_base_mc_FillerSupportPanels01 extends IModBaseProp
  , IModVarNonNull_mod_Information {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_FillerSupportPanels01 extends adc_base_mc_FillerSupportPanels01 {
}

export interface ccm_mc_FillerSupportPanels01 extends adc_base_mc_FillerSupportPanels01 {
}


export class OD_M_mc_FillerSupportPanels01 extends OD_Base implements pc_mc_FillerSupportPanels01, dc_mc_FillerSupportPanels01

  , IModVar_mod_Information {
  constructor(parent: IModParents_mc_FillerStraight01, manufacturerMode?: boolean) {
    super('mc_FillerSupportPanels01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_FillerSupportPanels01_NonNull(this);
  }
  parent: IModParents_mc_FillerStraight01;
  _selfNonNull: OD_M_mc_FillerSupportPanels01_NonNull;

  override variants: string[] = ['mod_Information',];
  ...
  #manufacturerDataCompletionInternal = mc_FillerSupportPanels01_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_FillerSupportPanels01_NonNull(this);
  ...
  #prepareContextInternal = mc_FillerSupportPanels01_prepareContext;
  seal(): IModuleNonNull_mc_FillerSupportPanels01 {
    this.afterDataCompletion();
    const adc = new OD_M_mc_FillerSupportPanels01_NonNull(this);
    return adc;
  }
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_FillerSupportPanels01_NonNull(this);
  ...
  override createBuildPlan(): void {
    var cbp = new OD_M_mc_FillerSupportPanels01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_FillerSupportPanels01_NonNull implements cbp_mc_FillerSupportPanels01, adc_mc_FillerSupportPanels01, ccm_mc_FillerSupportPanels01 {
  constructor(parent: OD_M_mc_FillerSupportPanels01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_FillerSupportPanels01;
  ...
  #createBuildPlanInternal = mc_FillerSupportPanels01_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_FillerSupportPanels01_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = mc_FillerSupportPanels01_calculateContainerModules;
