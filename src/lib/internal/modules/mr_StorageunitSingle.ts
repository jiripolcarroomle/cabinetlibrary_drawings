...
import { OD_M_mf_Pullout, dc_mf_Pullout } from './mf_Pullout'
import { OD_M_mf_PantryPullout, dc_mf_PantryPullout } from './mf_PantryPullout'
import { OD_M_md_FrontPlaceholder, dc_md_FrontPlaceholder } from './md_FrontPlaceholder'
...
export interface dc_mr_StorageunitSingle extends IModBaseProp
  ...
  addOD_M_mf_Pullout(index?: number): dc_mf_Pullout;
  addOD_M_mf_PantryPullout(index?: number): dc_mf_PantryPullout;
  addOD_M_mc_FillerStraight01(index?: number): dc_mc_FillerStraight01;
  addOD_M_mc_Upright01(index?: number): dc_mc_Upright01;
}

export interface pc_mr_StorageunitSingle extends dc_mr_StorageunitSingle {
...
export interface adc_base_mr_StorageunitSingle extends IModBaseProp
  , IModVarNonNull_mod_BackwallPos, IModVarNonNull_mod_BackwallThk, IModVarNonNull_mod_CarcaseBackwallConstruction, IModVarNonNull_mod_CarcaseConnectionLeftBtm, IModVarNonNull_mod_CarcaseConnectionLeftTop, IModVarNonNull_mod_CarcaseConnectionRightBtm, IModVarNonNull_mod_CarcaseConnectionRightTop, IModVarNonNull_mod_CarcaseShelfbtmConstruction, IModVarNonNull_mod_CarcaseShelftopConstruction, IModVarNonNull_mod_CarcaseVisBack, IModVarNonNull_mod_CarcaseVisBtm, IModVarNonNull_mod_CarcaseVisTop, IModVarNonNull_mod_HandleLine, IModVarNonNull_mod_HandlePosLogic, IModVarNonNull_mod_HangerPosX, IModVarNonNull_mod_HangerPosY, IModVarNonNull_mod_RailhortopbackThk, IModVarNonNull_mod_RailhortopfrontThk, IModVarNonNull_mod_RailverttopbackThk, IModVarNonNull_mod_RailverttopfrontThk, IModVarNonNull_mod_ShelfbtmThk, IModVarNonNull_mod_ShelffixedThk, IModVarNonNull_mod_ShelftopThk, IModVarNonNull_mod_SidepanelleftThk, IModVarNonNull_mod_SidepanelrightThk, IModVarNonNull_mod_HardwareColor, IModVarNonNull_mod_OpeningType, IModVarNonNull_mod_CarcaseBackwallColor, IModVarNonNull_mod_CarcaseBackwallProgram, IModVarNonNull_mod_CarcaseColor, IModVarNonNull_mod_CarcaseOutsideColor, IModVarNonNull_mod_CarcaseEdgeBackColor, IModVarNonNull_mod_CarcaseEdgeColor, IModVarNonNull_mod_CarcaseEdgeFrontColor, IModVarNonNull_mod_CarcaseProgram, IModVarNonNull_mod_CarcaseOutsideProgram, IModVarNonNull_mod_CarcaseShelfbtmOversizeInsideWall, IModVarNonNull_mod_CarcaseShelfbtmOversizeLeft, IModVarNonNull_mod_CarcaseShelfbtmOversizeRight, IModVarNonNull_mod_CarcaseShelftopOversizeInsideWall, IModVarNonNull_mod_CarcaseShelftopOversizeLeft, IModVarNonNull_mod_CarcaseShelftopOversizeRight, IModVarNonNull_mod_CarcaseSidepanelleftOversizeBtm, IModVarNonNull_mod_CarcaseSidepanelleftOversizeInsideWall, IModVarNonNull_mod_CarcaseSidepanelleftOversizeTop, IModVarNonNull_mod_CarcaseSidepanelrightOversizeBtm, IModVarNonNull_mod_CarcaseSidepanelrightOversizeInsideWall, IModVarNonNull_mod_CarcaseSidepanelrightOversizeTop, IModVarNonNull_mod_CarcaseDistanceWall, IModVarNonNull_mod_Depth, IModVarNonNull_mod_FingergripType, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_HandleColor, IModVarNonNull_mod_HandleLength, IModVarNonNull_mod_HandlePosType, IModVarNonNull_mod_HangerType, IModVarNonNull_mod_Height, IModVarNonNull_mod_HeightPosInsertion, IModVarNonNull_mod_LightPosX1, IModVarNonNull_mod_LightPosX2, IModVarNonNull_mod_LightPosX3, IModVarNonNull_mod_LightPosX4, IModVarNonNull_mod_LightPosX5, IModVarNonNull_mod_LightPart, IModVarNonNull_mod_LightPosX, IModVarNonNull_mod_LightPosY, IModVarNonNull_mod_LightSystem, IModVarNonNull_mod_Model, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_ShelfadjThk, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_Width, IModVarNonNull_mod_BackwallFixedHeight, IModVarNonNull_mod_HandleDesign, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_PlinthAreaPosLeftMatrix, IModVarNonNull_mod_PlinthAreaDesign, IModVarNonNull_mod_PlinthAreaPosBackMatrix, IModVarNonNull_mod_PlinthAreaPosFrontMatrix, IModVarNonNull_mod_PlinthAreaPosRightMatrix, IModVarNonNull_mod_PlinthAreaElementColor, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_PlinthAreaExtraItem, IModVarNonNull_mod_FrontGapHorTop, IModVarNonNull_mod_ShelvesBackwallFittingConnection, IModVarNonNull_mod_FittingConnectionBtmVert, IModVarNonNull_mod_FittingConnectionLeftBtm, IModVarNonNull_mod_FittingConnectionLeftHor, IModVarNonNull_mod_FittingConnectionLeftTop, IModVarNonNull_mod_FittingConnectionRightBtm, IModVarNonNull_mod_FittingConnectionRightHor, IModVarNonNull_mod_FittingConnectionRightTop, IModVarNonNull_mod_FittingConnectionTopVert, IModVarNonNull_mod_CarcasePartConnectionBackHor, IModVarNonNull_mod_CarcasePartConnectionBackVert, IModVarNonNull_mod_CarcasePartConnectionBtmVert, IModVarNonNull_mod_CarcasePartConnectionLeftHor, IModVarNonNull_mod_CarcasePartConnectionRightHor, IModVarNonNull_mod_CarcasePartConnectionTopVert, IModVarNonNull_mod_HangerOffsetPosY, IModVarNonNull_mod_HangerColor, IModVarNonNull_mod_RackAreaOversizeCarcaseType, IModVarNonNull_mod_RackAreaManualOffsetCarcase, IModVarNonNull_mod_CleatThk, IModVarNonNull_mod_CleatWidth, IModVarNonNull_mod_VertDividerType, IModVarNonNull_mod_SidepanelmiddleThk, IModVarNonNull_mod_CarcaseFrontConstruction, IModVarNonNull_mod_CarcasePartInfo, IModVarNonNull_mod_PushtoopenLine, IModVarNonNull_mod_PushtoopenType, IModVarNonNull_mod_PushtoopenColor, IModVarNonNull_mod_CreateCountertop, IModVarNonNull_mod_CreateToekick, IModVarNonNull_mod_CreateFingergrip, IModVarNonNull_mod_CreatePaneltop, IModVarNonNull_mod_PlinthAreaPositionInfo, IModVarNonNull_mod_SlopedCeilingDimensionLogic, IModVarNonNull_mod_SlopedCeilingConstruction, IModVarNonNull_mod_SlopeAngle, IModVarNonNull_mod_BackHeight, IModVarNonNull_mod_TopDepth, IModVarNonNull_mod_CountertopThk, IModVarNonNull_mod_CountertopInfo, IModVarNonNull_mod_SidepanelleftType, IModVarNonNull_mod_SidepanelrightType, IModVarNonNull_mod_ShelfadjColor, IModVarNonNull_mod_FrameFillingColor, IModVarNonNull_mod_FrameFillingType, IModVarNonNull_mod_PulloutElementColor, IModVarNonNull_mod_PulloutDesign, IModVarNonNull_mod_PulloutType, IModVarNonNull_mod_GlobalFrontOversizeLeft, IModVarNonNull_mod_GlobalFrontOversizeRight, IModVarNonNull_mod_GlobalFrontOversizeTop, IModVarNonNull_mod_GlobalFrontOversizeBtm, IModVarNonNull_mod_CreateBacksplash, IModVarNonNull_mod_FrontSegmentColor, IModVarNonNull_mod_FrontSegmentType, IModVarNonNull_mod_DoorDirectionSelection, IModVarNonNull_mod_CreateCeilingFiller, IModVarNonNull_mod_InformationList, IModVarNonNull_mod_CarcaseVisLeftSelection, IModVarNonNull_mod_CarcaseVisRightSelection, IModVarNonNull_mod_CeilingAreaVisLeftSelection, IModVarNonNull_mod_CeilingAreaVisRightSelection, IModVarNonNull_mod_PlinthAreaVisLeftSelection, IModVarNonNull_mod_PlinthAreaVisRightSelection, IModVarNonNull_mod_CarcaseOverdimensionBackLogic, IModVarNonNull_mod_ModuleContextInformationList, IModVarNonNull_mod_AutomaticHeightAdjustment, IModVarNonNull_mod_CarcaseVisLeftAutomaticType, IModVarNonNull_mod_CarcaseVisRightAutomaticType, IModVarNonNull_mod_CarcaseCeilingDistance, IModVarNonNull_mod_PlacementLevels, IModVarNonNull_mod_HeightInputMode, IModVarNonNull_mod_CarcaseHeight, IModVarNonNull_mod_UprightThk {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
...
export interface adc_mr_StorageunitSingle extends adc_base_mr_StorageunitSingle {
  addOD_M_mc_Storageunit01(index?: number): dc_mc_Storageunit01;
  addOD_M_mf_Drawer(index?: number): dc_mf_Drawer;
  addOD_M_mc_PlinthArea01(index?: number): dc_mc_PlinthArea01;
  addOD_M_mf_Fliplift(index?: number): dc_mf_Fliplift;
...
export interface ccm_mr_StorageunitSingle extends adc_base_mr_StorageunitSingle {
  addOD_M_md_FrontPlaceholder(index?: number): dc_md_FrontPlaceholder;
}


export class OD_M_mr_StorageunitSingle extends OD_Base implements pc_mr_StorageunitSingle, dc_mr_StorageunitSingle
  , IModParents_md_FrontArticleBuilder_md_FrontPlaceholder_mr_CornerunitStraight_mr_StorageunitSingle, IModParents_mr_CornerunitStraight_mr_Filler01_mr_StorageunitSingle, IModParents_md_FrontArticleBuilder_md_FrontPlaceholder_mr_StorageunitSingle, IModParents_mr_StorageunitSingle_mr_Upright, IModParents_mr_CornerunitStraight_mr_StorageunitSingle, IModParents_mr_StorageunitSingle, IModParents_mr_FillerStraight_mr_StorageunitSingle
  , IModVar_mod_BackwallPos, IModVar_mod_BackwallThk, IModVar_mod_CarcaseBackwallConstruction, IModVar_mod_CarcaseConnectionLeftBtm, IModVar_mod_CarcaseConnectionLeftTop, IModVar_mod_CarcaseConnectionRightBtm, IModVar_mod_CarcaseConnectionRightTop, IModVar_mod_CarcaseShelfbtmConstruction, IModVar_mod_CarcaseShelftopConstruction, IModVar_mod_CarcaseVisBack, IModVar_mod_CarcaseVisBtm, IModVar_mod_CarcaseVisTop, IModVar_mod_HandleLine, IModVar_mod_HandlePosLogic, IModVar_mod_HangerPosX, IModVar_mod_HangerPosY, IModVar_mod_RailhortopbackThk, IModVar_mod_RailhortopfrontThk, IModVar_mod_RailverttopbackThk, IModVar_mod_RailverttopfrontThk, IModVar_mod_ShelfbtmThk, IModVar_mod_ShelffixedThk, IModVar_mod_ShelftopThk, IModVar_mod_SidepanelleftThk, IModVar_mod_SidepanelrightThk, IModVar_mod_HardwareColor, IModVar_mod_OpeningType, IModVar_mod_CarcaseBackwallColor, IModVar_mod_CarcaseBackwallProgram, IModVar_mod_CarcaseColor, IModVar_mod_CarcaseOutsideColor, IModVar_mod_CarcaseEdgeBackColor, IModVar_mod_CarcaseEdgeColor, IModVar_mod_CarcaseEdgeFrontColor, IModVar_mod_CarcaseProgram, IModVar_mod_CarcaseOutsideProgram, IModVar_mod_CarcaseShelfbtmOversizeInsideWall, IModVar_mod_CarcaseShelfbtmOversizeLeft, IModVar_mod_CarcaseShelfbtmOversizeRight, IModVar_mod_CarcaseShelftopOversizeInsideWall, IModVar_mod_CarcaseShelftopOversizeLeft, IModVar_mod_CarcaseShelftopOversizeRight, IModVar_mod_CarcaseSidepanelleftOversizeBtm, IModVar_mod_CarcaseSidepanelleftOversizeInsideWall, IModVar_mod_CarcaseSidepanelleftOversizeTop, IModVar_mod_CarcaseSidepanelrightOversizeBtm, IModVar_mod_CarcaseSidepanelrightOversizeInsideWall, IModVar_mod_CarcaseSidepanelrightOversizeTop, IModVar_mod_CarcaseDistanceWall, IModVar_mod_Depth, IModVar_mod_FingergripType, IModVar_mod_FrontColor, IModVar_mod_FrontEdgeColor, IModVar_mod_FrontEdgeThk, IModVar_mod_FrontGapCarcase, IModVar_mod_FrontGapHor, IModVar_mod_FrontGapVert, IModVar_mod_FrontProgram, IModVar_mod_FrontPosStart, IModVar_mod_HandleColor, IModVar_mod_HandleLength, IModVar_mod_HandlePosType, IModVar_mod_HangerType, IModVar_mod_Height, IModVar_mod_HeightPosInsertion, IModVar_mod_LightPosX1, IModVar_mod_LightPosX2, IModVar_mod_LightPosX3, IModVar_mod_LightPosX4, IModVar_mod_LightPosX5, IModVar_mod_LightPart, IModVar_mod_LightPosX, IModVar_mod_LightPosY, IModVar_mod_LightSystem, IModVar_mod_Model, IModVar_mod_PlinthAreaHeight, IModVar_mod_ShelfadjThk, IModVar_mod_TypeElement, IModVar_mod_Width, IModVar_mod_BackwallFixedHeight, IModVar_mod_HandleDesign, IModVar_mod_FrontDesign, IModVar_mod_PlinthAreaPosLeftMatrix, IModVar_mod_PlinthAreaDesign, IModVar_mod_PlinthAreaPosBackMatrix, IModVar_mod_PlinthAreaPosFrontMatrix, IModVar_mod_PlinthAreaPosRightMatrix, IModVar_mod_PlinthAreaElementColor, IModVar_mod_ParentName, IModVar_mod_ModuleName, IModVar_mod_PlinthAreaExtraItem, IModVar_mod_FrontGapHorTop, IModVar_mod_ShelvesBackwallFittingConnection, IModVar_mod_FittingConnectionBtmVert, IModVar_mod_FittingConnectionLeftBtm, IModVar_mod_FittingConnectionLeftHor, IModVar_mod_FittingConnectionLeftTop, IModVar_mod_FittingConnectionRightBtm, IModVar_mod_FittingConnectionRightHor, IModVar_mod_FittingConnectionRightTop, IModVar_mod_FittingConnectionTopVert, IModVar_mod_CarcasePartConnectionBackHor, IModVar_mod_CarcasePartConnectionBackVert, IModVar_mod_CarcasePartConnectionBtmVert, IModVar_mod_CarcasePartConnectionLeftHor, IModVar_mod_CarcasePartConnectionRightHor, IModVar_mod_CarcasePartConnectionTopVert, IModVar_mod_HangerOffsetPosY, IModVar_mod_HangerColor, IModVar_mod_RackAreaOversizeCarcaseType, IModVar_mod_RackAreaManualOffsetCarcase, IModVar_mod_CleatThk, IModVar_mod_CleatWidth, IModVar_mod_VertDividerType, IModVar_mod_SidepanelmiddleThk, IModVar_mod_CarcaseFrontConstruction, IModVar_mod_CarcasePartInfo, IModVar_mod_PushtoopenLine, IModVar_mod_PushtoopenType, IModVar_mod_PushtoopenColor, IModVar_mod_CreateCountertop, IModVar_mod_CreateToekick, IModVar_mod_CreateFingergrip, IModVar_mod_CreatePaneltop, IModVar_mod_PlinthAreaPositionInfo, IModVar_mod_SlopedCeilingDimensionLogic, IModVar_mod_SlopedCeilingConstruction, IModVar_mod_SlopeAngle, IModVar_mod_BackHeight, IModVar_mod_TopDepth, IModVar_mod_CountertopThk, IModVar_mod_CountertopInfo, IModVar_mod_SidepanelleftType, IModVar_mod_SidepanelrightType, IModVar_mod_ShelfadjColor, IModVar_mod_FrameFillingColor, IModVar_mod_FrameFillingType, IModVar_mod_PulloutElementColor, IModVar_mod_PulloutDesign, IModVar_mod_PulloutType, IModVar_mod_GlobalFrontOversizeLeft, IModVar_mod_GlobalFrontOversizeRight, IModVar_mod_GlobalFrontOversizeTop, IModVar_mod_GlobalFrontOversizeBtm, IModVar_mod_CreateBacksplash, IModVar_mod_FrontSegmentColor, IModVar_mod_FrontSegmentType, IModVar_mod_DoorDirectionSelection, IModVar_mod_CreateCeilingFiller, IModVar_mod_InformationList, IModVar_mod_CarcaseVisLeftSelection, IModVar_mod_CarcaseVisRightSelection, IModVar_mod_CeilingAreaVisLeftSelection, IModVar_mod_CeilingAreaVisRightSelection, IModVar_mod_PlinthAreaVisLeftSelection, IModVar_mod_PlinthAreaVisRightSelection, IModVar_mod_CarcaseOverdimensionBackLogic, IModVar_mod_ModuleContextInformationList, IModVar_mod_AutomaticHeightAdjustment, IModVar_mod_CarcaseVisLeftAutomaticType, IModVar_mod_CarcaseVisRightAutomaticType, IModVar_mod_CarcaseCeilingDistance, IModVar_mod_PlacementLevels, IModVar_mod_HeightInputMode, IModVar_mod_CarcaseHeight, IModVar_mod_UprightThk {
  ...
  override variants: string[] = ['mod_BackwallPos', 'mod_BackwallThk', 'mod_CarcaseBackwallConstruction', 'mod_CarcaseConnectionLeftBtm', 'mod_CarcaseConnectionLeftTop', 'mod_CarcaseConnectionRightBtm', 'mod_CarcaseConnectionRightTop', 'mod_CarcaseShelfbtmConstruction', 'mod_CarcaseShelftopConstruction', 'mod_CarcaseVisBack', 'mod_CarcaseVisBtm', 'mod_CarcaseVisTop', 'mod_HandleLine', 'mod_HandlePosLogic', 'mod_HangerPosX', 'mod_HangerPosY', 'mod_RailhortopbackThk', 'mod_RailhortopfrontThk', 'mod_RailverttopbackThk', 'mod_RailverttopfrontThk', 'mod_ShelfbtmThk', 'mod_ShelffixedThk', 'mod_ShelftopThk', 'mod_SidepanelleftThk', 'mod_SidepanelrightThk', 'mod_HardwareColor', 'mod_OpeningType', 'mod_CarcaseBackwallColor', 'mod_CarcaseBackwallProgram', 'mod_CarcaseColor', 'mod_CarcaseOutsideColor', 'mod_CarcaseEdgeBackColor', 'mod_CarcaseEdgeColor', 'mod_CarcaseEdgeFrontColor', 'mod_CarcaseProgram', 'mod_CarcaseOutsideProgram', 'mod_CarcaseShelfbtmOversizeInsideWall', 'mod_CarcaseShelfbtmOversizeLeft', 'mod_CarcaseShelfbtmOversizeRight', 'mod_CarcaseShelftopOversizeInsideWall', 'mod_CarcaseShelftopOversizeLeft', 'mod_CarcaseShelftopOversizeRight', 'mod_CarcaseSidepanelleftOversizeBtm', 'mod_CarcaseSidepanelleftOversizeInsideWall', 'mod_CarcaseSidepanelleftOversizeTop', 'mod_CarcaseSidepanelrightOversizeBtm', 'mod_CarcaseSidepanelrightOversizeInsideWall', 'mod_CarcaseSidepanelrightOversizeTop', 'mod_CarcaseDistanceWall', 'mod_Depth', 'mod_FingergripType', 'mod_FrontColor', 'mod_FrontEdgeColor', 'mod_FrontEdgeThk', 'mod_FrontGapCarcase', 'mod_FrontGapHor', 'mod_FrontGapVert', 'mod_FrontProgram', 'mod_FrontPosStart', 'mod_HandleColor', 'mod_HandleLength', 'mod_HandlePosType', 'mod_HangerType', 'mod_Height', 'mod_HeightPosInsertion', 'mod_LightPosX1', 'mod_LightPosX2', 'mod_LightPosX3', 'mod_LightPosX4', 'mod_LightPosX5', 'mod_LightPart', 'mod_LightPosX', 'mod_LightPosY', 'mod_LightSystem', 'mod_Model', 'mod_PlinthAreaHeight', 'mod_ShelfadjThk', 'mod_TypeElement', 'mod_Width', 'mod_BackwallFixedHeight', 'mod_HandleDesign', 'mod_FrontDesign', 'mod_PlinthAreaPosLeftMatrix', 'mod_PlinthAreaDesign', 'mod_PlinthAreaPosBackMatrix', 'mod_PlinthAreaPosFrontMatrix', 'mod_PlinthAreaPosRightMatrix', 'mod_PlinthAreaElementColor', 'mod_ParentName', 'mod_ModuleName', 'mod_PlinthAreaExtraItem', 'mod_FrontGapHorTop', 'mod_ShelvesBackwallFittingConnection', 'mod_FittingConnectionBtmVert', 'mod_FittingConnectionLeftBtm', 'mod_FittingConnectionLeftHor', 'mod_FittingConnectionLeftTop', 'mod_FittingConnectionRightBtm', 'mod_FittingConnectionRightHor', 'mod_FittingConnectionRightTop', 'mod_FittingConnectionTopVert', 'mod_CarcasePartConnectionBackHor', 'mod_CarcasePartConnectionBackVert', 'mod_CarcasePartConnectionBtmVert', 'mod_CarcasePartConnectionLeftHor', 'mod_CarcasePartConnectionRightHor', 'mod_CarcasePartConnectionTopVert', 'mod_HangerOffsetPosY', 'mod_HangerColor', 'mod_RackAreaOversizeCarcaseType', 'mod_RackAreaManualOffsetCarcase', 'mod_CleatThk', 'mod_CleatWidth', 'mod_VertDividerType', 'mod_SidepanelmiddleThk', 'mod_CarcaseFrontConstruction', 'mod_CarcasePartInfo', 'mod_PushtoopenLine', 'mod_PushtoopenType', 'mod_PushtoopenColor', 'mod_CreateCountertop', 'mod_CreateToekick', 'mod_CreateFingergrip', 'mod_CreatePaneltop', 'mod_PlinthAreaPositionInfo', 'mod_SlopedCeilingDimensionLogic', 'mod_SlopedCeilingConstruction', 'mod_SlopeAngle', 'mod_BackHeight', 'mod_TopDepth', 'mod_CountertopThk', 'mod_CountertopInfo', 'mod_SidepanelleftType', 'mod_SidepanelrightType', 'mod_ShelfadjColor', 'mod_FrameFillingColor', 'mod_FrameFillingType', 'mod_PulloutElementColor', 'mod_PulloutDesign', 'mod_PulloutType', 'mod_GlobalFrontOversizeLeft', 'mod_GlobalFrontOversizeRight', 'mod_GlobalFrontOversizeTop', 'mod_GlobalFrontOversizeBtm', 'mod_CreateBacksplash', 'mod_FrontSegmentColor', 'mod_FrontSegmentType', 'mod_DoorDirectionSelection', 'mod_CreateCeilingFiller', 'mod_InformationList', 'mod_CarcaseVisLeftSelection', 'mod_CarcaseVisRightSelection', 'mod_CeilingAreaVisLeftSelection', 'mod_CeilingAreaVisRightSelection', 'mod_PlinthAreaVisLeftSelection', 'mod_PlinthAreaVisRightSelection', 'mod_CarcaseOverdimensionBackLogic', 'mod_ModuleContextInformationList', 'mod_AutomaticHeightAdjustment', 'mod_CarcaseVisLeftAutomaticType', 'mod_CarcaseVisRightAutomaticType', 'mod_CarcaseCeilingDistance', 'mod_PlacementLevels', 'mod_HeightInputMode', 'mod_CarcaseHeight', 'mod_UprightThk',];
  ...
  get mod_CarcaseVisLeftSelection(): string | undefined { return this.#mod_CarcaseVisLeftSelection }
  set mod_CarcaseVisLeftSelection(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_CarcaseVisLeftSelection' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_CarcaseVisLeftSelection === value) return;
    this.#mod_CarcaseVisLeftSelection = value;
  }

  mod_CarcaseVisLeftSelection_matrix?: IMatrix_mod_CarcaseVisLeftSelection;
  #mod_CarcaseVisRightSelection?: string;
  get mod_CarcaseVisRightSelection(): string | undefined { return this.#mod_CarcaseVisRightSelection }
  set mod_CarcaseVisRightSelection(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_CarcaseVisRightSelection' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_CarcaseVisRightSelection === value) return;
    this.#mod_CarcaseVisRightSelection = value;
  }

  mod_CarcaseVisRightSelection_matrix?: IMatrix_mod_CarcaseVisRightSelection;
  #mod_CeilingAreaVisLeftSelection?: string;
  get mod_CeilingAreaVisLeftSelection(): string | undefined { return this.#mod_CeilingAreaVisLeftSelection }
  set mod_CeilingAreaVisLeftSelection(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_CeilingAreaVisLeftSelection' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_CeilingAreaVisLeftSelection === value) return;
    this.#mod_CeilingAreaVisLeftSelection = value;
  }

  mod_CeilingAreaVisLeftSelection_matrix?: IMatrix_mod_CeilingAreaVisLeftSelection;
  #mod_CeilingAreaVisRightSelection?: string;
  get mod_CeilingAreaVisRightSelection(): string | undefined { return this.#mod_CeilingAreaVisRightSelection }
  set mod_CeilingAreaVisRightSelection(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_CeilingAreaVisRightSelection' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_CeilingAreaVisRightSelection === value) return;
    this.#mod_CeilingAreaVisRightSelection = value;
  }

  mod_CeilingAreaVisRightSelection_matrix?: IMatrix_mod_CeilingAreaVisRightSelection;
  #mod_PlinthAreaVisLeftSelection?: string;
  get mod_PlinthAreaVisLeftSelection(): string | undefined { return this.#mod_PlinthAreaVisLeftSelection }
  set mod_PlinthAreaVisLeftSelection(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_PlinthAreaVisLeftSelection' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_PlinthAreaVisLeftSelection === value) return;
    this.#mod_PlinthAreaVisLeftSelection = value;
  }

  mod_PlinthAreaVisLeftSelection_matrix?: IMatrix_mod_PlinthAreaVisLeftSelection;
  #mod_PlinthAreaVisRightSelection?: string;
  get mod_PlinthAreaVisRightSelection(): string | undefined { return this.#mod_PlinthAreaVisRightSelection }
  set mod_PlinthAreaVisRightSelection(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_PlinthAreaVisRightSelection' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_PlinthAreaVisRightSelection === value) return;
    this.#mod_PlinthAreaVisRightSelection = value;
  }

  mod_PlinthAreaVisRightSelection_matrix?: IMatrix_mod_PlinthAreaVisRightSelection;
  #mod_CarcaseOverdimensionBackLogic?: string;
  get mod_CarcaseOverdimensionBackLogic(): string | undefined { return this.#mod_CarcaseOverdimensionBackLogic }
  set mod_CarcaseOverdimensionBackLogic(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_CarcaseOverdimensionBackLogic' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_CarcaseOverdimensionBackLogic === value) return;
    this.#mod_CarcaseOverdimensionBackLogic = value;
  }

  mod_CarcaseOverdimensionBackLogic_matrix?: IMatrix_mod_CarcaseOverdimensionBackLogic;
  #mod_ModuleContextInformationList: string[] = [];
  get mod_ModuleContextInformationList(): string[] { return this.#mod_ModuleContextInformationList; }
  #mod_AutomaticHeightAdjustment?: boolean;
  get mod_AutomaticHeightAdjustment(): boolean | undefined { return this.#mod_AutomaticHeightAdjustment }
  set mod_AutomaticHeightAdjustment(value: boolean | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_AutomaticHeightAdjustment' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_AutomaticHeightAdjustment === value) return;
    this.#mod_AutomaticHeightAdjustment = value;
  }

  mod_AutomaticHeightAdjustment_matrix?: IMatrix_mod_AutomaticHeightAdjustment;
  #mod_CarcaseVisLeftAutomaticType?: string;
  get mod_CarcaseVisLeftAutomaticType(): string | undefined { return this.#mod_CarcaseVisLeftAutomaticType }
  set mod_CarcaseVisLeftAutomaticType(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_CarcaseVisLeftAutomaticType' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_CarcaseVisLeftAutomaticType === value) return;
    this.#mod_CarcaseVisLeftAutomaticType = value;
  }

  mod_CarcaseVisLeftAutomaticType_matrix?: IMatrix_mod_CarcaseVisLeftAutomaticType;
  #mod_CarcaseVisRightAutomaticType?: string;
  get mod_CarcaseVisRightAutomaticType(): string | undefined { return this.#mod_CarcaseVisRightAutomaticType }
  set mod_CarcaseVisRightAutomaticType(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_CarcaseVisRightAutomaticType' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_CarcaseVisRightAutomaticType === value) return;
    this.#mod_CarcaseVisRightAutomaticType = value;
  }

  mod_CarcaseVisRightAutomaticType_matrix?: IMatrix_mod_CarcaseVisRightAutomaticType;
  #mod_CarcaseCeilingDistance?: number;
  get mod_CarcaseCeilingDistance(): number | undefined { return this.#mod_CarcaseCeilingDistance }
  set mod_CarcaseCeilingDistance(value: number | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_CarcaseCeilingDistance' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_CarcaseCeilingDistance === value) return;
    this.#mod_CarcaseCeilingDistance = value;
  }

  mod_CarcaseCeilingDistance_matrix?: IMatrix_mod_CarcaseCeilingDistance;
  #mod_PlacementLevels?: string;
  get mod_PlacementLevels(): string | undefined { return this.#mod_PlacementLevels }
  set mod_PlacementLevels(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_PlacementLevels' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_PlacementLevels === value) return;
    this.#mod_PlacementLevels = value;
  }

  mod_PlacementLevels_matrix?: IMatrix_mod_PlacementLevels;
  #mod_HeightInputMode?: string;
  get mod_HeightInputMode(): string | undefined { return this.#mod_HeightInputMode }
  set mod_HeightInputMode(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_HeightInputMode' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_HeightInputMode === value) return;
    this.#mod_HeightInputMode = value;
  }

  mod_HeightInputMode_matrix?: IMatrix_mod_HeightInputMode;
  ...
  override getAttributes(): Map<string, any> {
    ...
    res.set('mod_CarcaseVisLeftSelection', this.mod_CarcaseVisLeftSelection);
    res.set('mod_CarcaseVisRightSelection', this.mod_CarcaseVisRightSelection);
    res.set('mod_CeilingAreaVisLeftSelection', this.mod_CeilingAreaVisLeftSelection);
    res.set('mod_CeilingAreaVisRightSelection', this.mod_CeilingAreaVisRightSelection);
    res.set('mod_PlinthAreaVisLeftSelection', this.mod_PlinthAreaVisLeftSelection);
    res.set('mod_PlinthAreaVisRightSelection', this.mod_PlinthAreaVisRightSelection);
    res.set('mod_CarcaseOverdimensionBackLogic', this.mod_CarcaseOverdimensionBackLogic);
    res.set('mod_ModuleContextInformationList', JSON.stringify(this.mod_ModuleContextInformationList));
    res.set('mod_AutomaticHeightAdjustment', this.mod_AutomaticHeightAdjustment);
    res.set('mod_CarcaseVisLeftAutomaticType', this.mod_CarcaseVisLeftAutomaticType);
    res.set('mod_CarcaseVisRightAutomaticType', this.mod_CarcaseVisRightAutomaticType);
    res.set('mod_CarcaseCeilingDistance', this.mod_CarcaseCeilingDistance);
    res.set('mod_PlacementLevels', this.mod_PlacementLevels);
    res.set('mod_HeightInputMode', this.mod_HeightInputMode);
  ...
  override loadJson(json: any, withSubModules: boolean = true, manufacturerMode: boolean) {
    ...
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_CarcaseVisLeftSelection');
      const val = _toString(json['attributes']['mod_CarcaseVisLeftSelection'], 'mod_CarcaseVisLeftSelection');
      internal_leaveValidateVariant();
      this.mod_CarcaseVisLeftSelection = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_CarcaseVisRightSelection');
      const val = _toString(json['attributes']['mod_CarcaseVisRightSelection'], 'mod_CarcaseVisRightSelection');
      internal_leaveValidateVariant();
      this.mod_CarcaseVisRightSelection = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_CeilingAreaVisLeftSelection');
      const val = _toString(json['attributes']['mod_CeilingAreaVisLeftSelection'], 'mod_CeilingAreaVisLeftSelection');
      internal_leaveValidateVariant();
      this.mod_CeilingAreaVisLeftSelection = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_CeilingAreaVisRightSelection');
      const val = _toString(json['attributes']['mod_CeilingAreaVisRightSelection'], 'mod_CeilingAreaVisRightSelection');
      internal_leaveValidateVariant();
      this.mod_CeilingAreaVisRightSelection = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_PlinthAreaVisLeftSelection');
      const val = _toString(json['attributes']['mod_PlinthAreaVisLeftSelection'], 'mod_PlinthAreaVisLeftSelection');
      internal_leaveValidateVariant();
      this.mod_PlinthAreaVisLeftSelection = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_PlinthAreaVisRightSelection');
      const val = _toString(json['attributes']['mod_PlinthAreaVisRightSelection'], 'mod_PlinthAreaVisRightSelection');
      internal_leaveValidateVariant();
      this.mod_PlinthAreaVisRightSelection = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_CarcaseOverdimensionBackLogic');
      const val = _toString(json['attributes']['mod_CarcaseOverdimensionBackLogic'], 'mod_CarcaseOverdimensionBackLogic');
      internal_leaveValidateVariant();
      this.mod_CarcaseOverdimensionBackLogic = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_AutomaticHeightAdjustment');
      const val = _toBoolean(json['attributes']['mod_AutomaticHeightAdjustment'], 'mod_AutomaticHeightAdjustment');
      internal_leaveValidateVariant();
      this.mod_AutomaticHeightAdjustment = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_CarcaseVisLeftAutomaticType');
      const val = _toString(json['attributes']['mod_CarcaseVisLeftAutomaticType'], 'mod_CarcaseVisLeftAutomaticType');
      internal_leaveValidateVariant();
      this.mod_CarcaseVisLeftAutomaticType = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_CarcaseVisRightAutomaticType');
      const val = _toString(json['attributes']['mod_CarcaseVisRightAutomaticType'], 'mod_CarcaseVisRightAutomaticType');
      internal_leaveValidateVariant();
      this.mod_CarcaseVisRightAutomaticType = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_CarcaseCeilingDistance');
      const val = _toFloat(json['attributes']['mod_CarcaseCeilingDistance'], 'mod_CarcaseCeilingDistance');
      internal_leaveValidateVariant();
      this.mod_CarcaseCeilingDistance = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_PlacementLevels');
      const val = _toString(json['attributes']['mod_PlacementLevels'], 'mod_PlacementLevels');
      internal_leaveValidateVariant();
      this.mod_PlacementLevels = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_HeightInputMode');
      const val = _toString(json['attributes']['mod_HeightInputMode'], 'mod_HeightInputMode');
      internal_leaveValidateVariant();
      this.mod_HeightInputMode = val;
    }
    {
  ...
  override checkPosRelevantRequiredAttributes(): void {
    ...
    if (this.#mod_CarcasePartConnectionBackVert !== undefined) {
      this.#mod_CarcasePartConnectionBackVert = undefined;
      logWarning('The attribute "mod_CarcasePartConnectionBackVert" was set in the order data but is not marked as "pos relevant" - the value is ignored');
    }
    if (this.#mod_CarcasePartConnectionBtmVert !== undefined) {
      this.#mod_CarcasePartConnectionBtmVert = undefined;
      logWarning('The attribute "mod_CarcasePartConnectionBtmVert" was set in the order data but is not marked as "pos relevant" - the value is ignored');
    }
    ...
    if (this.#mod_CarcasePartConnectionTopVert !== undefined) {
      this.#mod_CarcasePartConnectionTopVert = undefined;
      logWarning('The attribute "mod_CarcasePartConnectionTopVert" was set in the order data but is not marked as "pos relevant" - the value is ignored');
    }
    ...
    if (this.#mod_CarcaseOverdimensionBackLogic !== undefined) {
      this.#mod_CarcaseOverdimensionBackLogic = undefined;
      logWarning('The attribute "mod_CarcaseOverdimensionBackLogic" was set in the order data but is not marked as "pos relevant" - the value is ignored');
    }
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_PulloutElementColor === undefined) {
      this.mod_PulloutElementColor = "silver";
    }
    if (this.mod_PulloutDesign === undefined) {
      this.mod_PulloutDesign = "snelloFioro";
    }
    if (this.mod_PulloutType === undefined) {
      this.mod_PulloutType = "No15";
    }
    ...
    if (this.mod_FrontSegmentColor === undefined) {
      this.mod_FrontSegmentColor = "FloatGlass";
    }
    if (this.mod_FrontSegmentType === undefined) {
      this.mod_FrontSegmentType = "Automatic";
    }
    if (this.mod_CreateCeilingFiller === undefined) {
      this.mod_CreateCeilingFiller = false;
    }
    if (this.mod_AutomaticHeightAdjustment === undefined) {
      this.mod_AutomaticHeightAdjustment = false;
    }
    if (this.mod_CarcaseHeight === undefined) {
  ...
  #dataCompletionSetDefaultScripts_globalVars() {
    ...
    if (this.mod_CarcaseVisLeftSelection === undefined) {
      this.mod_CarcaseVisLeftSelection = this.g.basic_CarcaseVisLeftSelection;
    }
    if (this.mod_CarcaseVisRightSelection === undefined) {
      this.mod_CarcaseVisRightSelection = this.g.basic_CarcaseVisRightSelection;
    }
    if (this.mod_CeilingAreaVisLeftSelection === undefined) {
      this.mod_CeilingAreaVisLeftSelection = this.g.basic_CeilingAreaVisLeftSelection;
    }
    if (this.mod_CeilingAreaVisRightSelection === undefined) {
      this.mod_CeilingAreaVisRightSelection = this.g.basic_CeilingAreaVisRightSelection;
    }
    if (this.mod_PlinthAreaVisLeftSelection === undefined) {
      this.mod_PlinthAreaVisLeftSelection = this.g.basic_PlinthAreaVisLeftSelection;
    }
    if (this.mod_PlinthAreaVisRightSelection === undefined) {
      this.mod_PlinthAreaVisRightSelection = this.g.basic_PlinthAreaVisRightSelection;
    }
    if (this.mod_CarcaseOverdimensionBackLogic === undefined) {
      this.mod_CarcaseOverdimensionBackLogic = this.g.basic_CarcaseOverdimensionBackLogic;
    }
    if (this.mod_CarcaseVisLeftAutomaticType === undefined) {
      this.mod_CarcaseVisLeftAutomaticType = this.g.basic_CarcaseVisLeftAutomaticType;
    }
    if (this.mod_CarcaseVisRightAutomaticType === undefined) {
      this.mod_CarcaseVisRightAutomaticType = this.g.basic_CarcaseVisRightAutomaticType;
    }
    if (this.mod_CarcaseCeilingDistance === undefined) {
      this.mod_CarcaseCeilingDistance = this.g.basic_CarcaseCeilingDistance;
    }
    if (this.mod_PlacementLevels === undefined) {
      this.mod_PlacementLevels = this.g.basic_PlacementLevels;
    }
    if (this.mod_HeightInputMode === undefined) {
      this.mod_HeightInputMode = this.g.basic_HeightInputMode;
    }
  ...
  #prepareContextInternal = mr_StorageunitSingle_prepareContext;
  seal(): IModuleNonNull_mr_StorageunitSingle {
  ...
  addOD_M_mf_Pullout(index?: number): dc_mf_Pullout {
    var m = new OD_M_mf_Pullout(this);
    m.dataCompletion();
    if (this._manufacturerMode) {
      m.manufacturerDataCompletion();
    }
  ...
  addOD_M_mf_PantryPullout(index?: number): dc_mf_PantryPullout {
    var m = new OD_M_mf_PantryPullout(this);
    m.dataCompletion();
    if (this._manufacturerMode) {
      m.manufacturerDataCompletion();
    }
  ...
  addOD_M_md_FrontPlaceholder(index?: number): dc_md_FrontPlaceholder {
    var m = new OD_M_md_FrontPlaceholder(this);
    m.dataCompletion();
    if (this._manufacturerMode) {
      m.manufacturerDataCompletion();
    }
  ...
  override validateSelections(): void {
    ...
    this.mod_RailhortopbackThk_matrix = VariantValidation.mod_RailhortopbackThk(this, this.mod_RailhortopbackThk);
    this.mod_RailhortopfrontThk_matrix = VariantValidation.mod_RailhortopfrontThk(this, this.mod_RailhortopfrontThk);
    this.mod_RailverttopbackThk_matrix = VariantValidation.mod_RailverttopbackThk(this, this.mod_RailverttopbackThk);
    this.mod_RailverttopfrontThk_matrix = VariantValidation.mod_RailverttopfrontThk(this, this.mod_RailverttopfrontThk);
    ...
    this.mod_CarcaseShelfbtmOversizeInsideWall_matrix = VariantValidation.mod_CarcaseShelfbtmOversizeInsideWall(this, this.mod_CarcaseShelfbtmOversizeInsideWall);
    ...
    this.mod_CarcaseShelftopOversizeInsideWall_matrix = VariantValidation.mod_CarcaseShelftopOversizeInsideWall(this, this.mod_CarcaseShelftopOversizeInsideWall);
    ...
    this.mod_LightPosX1_matrix = VariantValidation.mod_LightPosX1(this, this.mod_LightPosX1);
    this.mod_LightPosX2_matrix = VariantValidation.mod_LightPosX2(this, this.mod_LightPosX2);
    this.mod_LightPosX3_matrix = VariantValidation.mod_LightPosX3(this, this.mod_LightPosX3);
    this.mod_LightPosX4_matrix = VariantValidation.mod_LightPosX4(this, this.mod_LightPosX4);
    this.mod_LightPosX5_matrix = VariantValidation.mod_LightPosX5(this, this.mod_LightPosX5);
    this.mod_LightPart_matrix = VariantValidation.mod_LightPart(this, this.mod_LightPart);
    this.mod_LightPosX_matrix = VariantValidation.mod_LightPosX(this, this.mod_LightPosX);
    this.mod_LightPosY_matrix = VariantValidation.mod_LightPosY(this, this.mod_LightPosY);
    ...
    this.mod_BackwallFixedHeight_matrix = VariantValidation.mod_BackwallFixedHeight(this, this.mod_BackwallFixedHeight);
    ...
    this.mod_HangerOffsetPosY_matrix = VariantValidation.mod_HangerOffsetPosY(this, this.mod_HangerOffsetPosY);
    this.mod_HangerColor_matrix = VariantValidation.mod_HangerColor(this, this.mod_HangerColor);
    this.mod_RackAreaOversizeCarcaseType_matrix = VariantValidation.mod_RackAreaOversizeCarcaseType(this, this.mod_RackAreaOversizeCarcaseType);
    this.mod_RackAreaManualOffsetCarcase_matrix = VariantValidation.mod_RackAreaManualOffsetCarcase(this, this.mod_RackAreaManualOffsetCarcase);
    ...
    this.mod_CarcaseVisLeftSelection_matrix = VariantValidation.mod_CarcaseVisLeftSelection(this, this.mod_CarcaseVisLeftSelection);
    this.mod_CarcaseVisRightSelection_matrix = VariantValidation.mod_CarcaseVisRightSelection(this, this.mod_CarcaseVisRightSelection);
    this.mod_CeilingAreaVisLeftSelection_matrix = VariantValidation.mod_CeilingAreaVisLeftSelection(this, this.mod_CeilingAreaVisLeftSelection);
    this.mod_CeilingAreaVisRightSelection_matrix = VariantValidation.mod_CeilingAreaVisRightSelection(this, this.mod_CeilingAreaVisRightSelection);
    this.mod_PlinthAreaVisLeftSelection_matrix = VariantValidation.mod_PlinthAreaVisLeftSelection(this, this.mod_PlinthAreaVisLeftSelection);
    this.mod_PlinthAreaVisRightSelection_matrix = VariantValidation.mod_PlinthAreaVisRightSelection(this, this.mod_PlinthAreaVisRightSelection);
    this.mod_CarcaseOverdimensionBackLogic_matrix = VariantValidation.mod_CarcaseOverdimensionBackLogic(this, this.mod_CarcaseOverdimensionBackLogic);
    this.mod_AutomaticHeightAdjustment_matrix = VariantValidation.mod_AutomaticHeightAdjustment(this, this.mod_AutomaticHeightAdjustment);
    this.mod_CarcaseVisLeftAutomaticType_matrix = VariantValidation.mod_CarcaseVisLeftAutomaticType(this, this.mod_CarcaseVisLeftAutomaticType);
    this.mod_CarcaseVisRightAutomaticType_matrix = VariantValidation.mod_CarcaseVisRightAutomaticType(this, this.mod_CarcaseVisRightAutomaticType);
    this.mod_CarcaseCeilingDistance_matrix = VariantValidation.mod_CarcaseCeilingDistance(this, this.mod_CarcaseCeilingDistance);
    this.mod_PlacementLevels_matrix = VariantValidation.mod_PlacementLevels(this, this.mod_PlacementLevels);
    this.mod_HeightInputMode_matrix = VariantValidation.mod_HeightInputMode(this, this.mod_HeightInputMode);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mr_StorageunitSingle_NonNull(this);
...
class OD_M_mr_StorageunitSingle_NonNull implements cbp_mr_StorageunitSingle, adc_mr_StorageunitSingle, ccm_mr_StorageunitSingle, IPartParentsNonNull_md_FrontArticleBuilder_md_FrontPlaceholder_mr_CornerunitStraight_mr_StorageunitSingle, IPartParentsNonNull_mr_CornerunitStraight_mr_Filler01_mr_StorageunitSingle, IPartParentsNonNull_md_FrontArticleBuilder_md_FrontPlaceholder_mr_StorageunitSingle, IPartParentsNonNull_mr_StorageunitSingle_mr_Upright, IPartParentsNonNull_mr_CornerunitStraight_mr_StorageunitSingle, IPartParentsNonNull_mr_StorageunitSingle, IPartParentsNonNull_mr_FillerStraight_mr_StorageunitSingle {
  ...
  #calculateContainerModulesInternal = mr_StorageunitSingle_calculateContainerModules;
  ...
  get mod_CarcaseVisLeftSelection(): string {
    return this.#internalParent.mod_CarcaseVisLeftSelection!;
  }
  get mod_CarcaseVisRightSelection(): string {
    return this.#internalParent.mod_CarcaseVisRightSelection!;
  }
  get mod_CeilingAreaVisLeftSelection(): string {
    return this.#internalParent.mod_CeilingAreaVisLeftSelection!;
  }
  get mod_CeilingAreaVisRightSelection(): string {
    return this.#internalParent.mod_CeilingAreaVisRightSelection!;
  }
  get mod_PlinthAreaVisLeftSelection(): string {
    return this.#internalParent.mod_PlinthAreaVisLeftSelection!;
  }
  get mod_PlinthAreaVisRightSelection(): string {
    return this.#internalParent.mod_PlinthAreaVisRightSelection!;
  }
  get mod_CarcaseOverdimensionBackLogic(): string {
    return this.#internalParent.mod_CarcaseOverdimensionBackLogic!;
  }
  get mod_ModuleContextInformationList(): string[] {
    return this.#internalParent.mod_ModuleContextInformationList!;
  }
  get mod_AutomaticHeightAdjustment(): boolean {
    return this.#internalParent.mod_AutomaticHeightAdjustment!;
  }
  get mod_CarcaseVisLeftAutomaticType(): string {
    return this.#internalParent.mod_CarcaseVisLeftAutomaticType!;
  }
  get mod_CarcaseVisRightAutomaticType(): string {
    return this.#internalParent.mod_CarcaseVisRightAutomaticType!;
  }
  get mod_CarcaseCeilingDistance(): number {
    return this.#internalParent.mod_CarcaseCeilingDistance!;
  }
  get mod_PlacementLevels(): string {
    return this.#internalParent.mod_PlacementLevels!;
  }
  get mod_HeightInputMode(): string {
    return this.#internalParent.mod_HeightInputMode!;
  }
  ...
  addOD_M_mf_Pullout(index?: number): dc_mf_Pullout {
    return this.#internalParent.addOD_M_mf_Pullout(index);
  }
  addOD_M_mf_PantryPullout(index?: number): dc_mf_PantryPullout {
    return this.#internalParent.addOD_M_mf_PantryPullout(index);
  }
  addOD_M_md_FrontPlaceholder(index?: number): dc_md_FrontPlaceholder {
    return this.#internalParent.addOD_M_md_FrontPlaceholder(index);
  }
  addOD_M_mc_FillerStraight01(index?: number): dc_mc_FillerStraight01 {
