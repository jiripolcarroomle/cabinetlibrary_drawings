...
import { mf_BoardShelf_createBuildPlan, mf_BoardShelf_afterDataCompletion, mf_BoardShelf_manufacturerDataCompletion, mf_BoardShelf_calculateContainerModules, mf_BoardShelf_prepareContext } from '../../modules/mf_BoardShelf';
...
export interface pc_mf_BoardShelf extends dc_mf_BoardShelf {
...
export class OD_M_mf_BoardShelf extends OD_Base implements pc_mf_BoardShelf, dc_mf_BoardShelf
  ...
  #prepareContextInternal = mf_BoardShelf_prepareContext;
  seal(): IModuleNonNull_mf_BoardShelf {
