...
export interface pc_mr_Filler01 extends dc_mr_Filler01 {
...
export interface adc_base_mr_Filler01 extends IModBaseProp
...
export interface adc_mr_Filler01 extends adc_base_mr_Filler01 {
  addOD_M_mc_Storageunit01(index?: number): dc_mc_Storageunit01;
  addOD_M_mc_PlinthArea01(index?: number): dc_mc_PlinthArea01;
  addOD_M_mf_FillerFront(index?: number): dc_mf_FillerFront;
}

export interface ccm_mr_Filler01 extends adc_base_mr_Filler01 {
}


export class OD_M_mr_Filler01 extends OD_Base implements pc_mr_Filler01, dc_mr_Filler01
  ...
  #prepareContextInternal = mr_Filler01_prepareContext;
  seal(): IModuleNonNull_mr_Filler01 {
  ...
  override validateSelections(): void {
    ...
    this.mod_FillerDepth_matrix = VariantValidation.mod_FillerDepth(this, this.mod_FillerDepth);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mr_Filler01_NonNull(this);
...
class OD_M_mr_Filler01_NonNull implements cbp_mr_Filler01, adc_mr_Filler01, ccm_mr_Filler01, IPartParentsNonNull_mr_CornerunitStraight_mr_Filler01_mr_StorageunitSingle, IPartParentsNonNull_mr_Appliance_mr_Filler01, IPartParentsNonNull_mr_Filler01 {
  ...
  #calculateContainerModulesInternal = mr_Filler01_calculateContainerModules;
