...
import { IModParents_mr_PlinthAreaBaseboard } from '../mod-interfaces'
import { IP_part_Baseboard_PartVarsWritable, P_part_Baseboard } from '../parts/part_Baseboard'
import { IModuleNonNull_mc_Baseboard01, IModParents_mc_Baseboard01, IPartParentsNonNull_mc_Baseboard01 } from '../mod-interfaces'
import { IModVar_mod_BaseboardDepth, IModVarNonNull_mod_BaseboardDepth, IModVar_mod_BaseboardLength, IModVarNonNull_mod_BaseboardLength, IModVar_mod_BaseboardThk, IModVarNonNull_mod_BaseboardThk, IModVar_mod_BaseboardColor, IModVarNonNull_mod_BaseboardColor, IModVar_mod_BaseboardEdgeColor, IModVarNonNull_mod_BaseboardEdgeColor, IModVar_mod_BaseboardEdgeFrontColor, IModVarNonNull_mod_BaseboardEdgeFrontColor, IModVar_mod_BaseboardEdgeBackColor, IModVarNonNull_mod_BaseboardEdgeBackColor, IModVar_mod_BaseboardId, IModVarNonNull_mod_BaseboardId, IModVar_mod_BaseboardProgram, IModVarNonNull_mod_BaseboardProgram } from '../var-interfaces'
import { VariantValidation, IMatrix_mod_BaseboardDepth, IMatrix_mod_BaseboardLength, IMatrix_mod_BaseboardThk, IMatrix_mod_BaseboardColor, IMatrix_mod_BaseboardEdgeColor, IMatrix_mod_BaseboardEdgeFrontColor, IMatrix_mod_BaseboardEdgeBackColor, IMatrix_mod_BaseboardId, IMatrix_mod_BaseboardProgram } from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_Baseboard } from '../part-add-interfaces';
import { mc_Baseboard01_createBuildPlan, mc_Baseboard01_afterDataCompletion, mc_Baseboard01_manufacturerDataCompletion, mc_Baseboard01_calculateContainerModules, mc_Baseboard01_prepareContext } from '../../modules/mc_Baseboard01';

export interface cbp_mc_Baseboard01 extends IModBaseProp
  , IPartAdd_part_Baseboard, IModVarNonNull_mod_BaseboardDepth, IModVarNonNull_mod_BaseboardLength, IModVarNonNull_mod_BaseboardThk, IModVarNonNull_mod_BaseboardColor, IModVarNonNull_mod_BaseboardEdgeColor, IModVarNonNull_mod_BaseboardEdgeFrontColor, IModVarNonNull_mod_BaseboardEdgeBackColor, IModVarNonNull_mod_BaseboardId, IModVarNonNull_mod_BaseboardProgram {
  parent: IModParents_mr_PlinthAreaBaseboard;
...
export interface dc_mc_Baseboard01 extends IModBaseProp
  , IModVar_mod_BaseboardDepth, IModVar_mod_BaseboardLength, IModVar_mod_BaseboardThk, IModVar_mod_BaseboardColor, IModVar_mod_BaseboardEdgeColor, IModVar_mod_BaseboardEdgeFrontColor, IModVar_mod_BaseboardEdgeBackColor, IModVar_mod_BaseboardId, IModVar_mod_BaseboardProgram {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
  seal(): IModuleNonNull_mc_Baseboard01;
  parent: IModParents_mr_PlinthAreaBaseboard;
}

export interface pc_mc_Baseboard01 extends dc_mc_Baseboard01 {
...
export interface adc_base_mc_Baseboard01 extends IModBaseProp
  , IModVarNonNull_mod_BaseboardDepth, IModVarNonNull_mod_BaseboardLength, IModVarNonNull_mod_BaseboardThk, IModVarNonNull_mod_BaseboardColor, IModVarNonNull_mod_BaseboardEdgeColor, IModVarNonNull_mod_BaseboardEdgeFrontColor, IModVarNonNull_mod_BaseboardEdgeBackColor, IModVarNonNull_mod_BaseboardId, IModVarNonNull_mod_BaseboardProgram {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_Baseboard01 extends adc_base_mc_Baseboard01 {
}

export interface ccm_mc_Baseboard01 extends adc_base_mc_Baseboard01 {
}


export class OD_M_mc_Baseboard01 extends OD_Base implements pc_mc_Baseboard01, dc_mc_Baseboard01
  , IModParents_mc_Baseboard01
  , IModVar_mod_BaseboardDepth, IModVar_mod_BaseboardLength, IModVar_mod_BaseboardThk, IModVar_mod_BaseboardColor, IModVar_mod_BaseboardEdgeColor, IModVar_mod_BaseboardEdgeFrontColor, IModVar_mod_BaseboardEdgeBackColor, IModVar_mod_BaseboardId, IModVar_mod_BaseboardProgram {
  constructor(parent: IModParents_mr_PlinthAreaBaseboard, manufacturerMode?: boolean) {
    super('mc_Baseboard01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_Baseboard01_NonNull(this);
  }
  parent: IModParents_mr_PlinthAreaBaseboard;
  _selfNonNull: OD_M_mc_Baseboard01_NonNull;

  override variants: string[] = ['mod_BaseboardDepth', 'mod_BaseboardLength', 'mod_BaseboardThk', 'mod_BaseboardColor', 'mod_BaseboardEdgeColor', 'mod_BaseboardEdgeFrontColor', 'mod_BaseboardEdgeBackColor', 'mod_BaseboardId', 'mod_BaseboardProgram',];
  #mod_BaseboardDepth?: number;
  get mod_BaseboardDepth(): number | undefined { return this.#mod_BaseboardDepth }
  set mod_BaseboardDepth(value: number | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_BaseboardDepth' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_BaseboardDepth === value) return;
    this.#mod_BaseboardDepth = value;
  }

  mod_BaseboardDepth_matrix?: IMatrix_mod_BaseboardDepth;
  #mod_BaseboardLength?: number;
  get mod_BaseboardLength(): number | undefined { return this.#mod_BaseboardLength }
  set mod_BaseboardLength(value: number | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_BaseboardLength' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_BaseboardLength === value) return;
    this.#mod_BaseboardLength = value;
  }

  mod_BaseboardLength_matrix?: IMatrix_mod_BaseboardLength;
  ...
  #mod_BaseboardId?: string;
  get mod_BaseboardId(): string | undefined { return this.#mod_BaseboardId }
  set mod_BaseboardId(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_BaseboardId' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_BaseboardId === value) return;
    this.#mod_BaseboardId = value;
  }

  mod_BaseboardId_matrix?: IMatrix_mod_BaseboardId;
  ...
  override getAttributes(): Map<string, any> {
    ...
    res.set('mod_BaseboardDepth', this.mod_BaseboardDepth);
    res.set('mod_BaseboardLength', this.mod_BaseboardLength);
    ...
    res.set('mod_BaseboardId', this.mod_BaseboardId);
  ...
  override loadJson(json: any, withSubModules: boolean = true, manufacturerMode: boolean) {
    ...
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_BaseboardDepth');
      const val = _toFloat(json['attributes']['mod_BaseboardDepth'], 'mod_BaseboardDepth');
      internal_leaveValidateVariant();
      this.mod_BaseboardDepth = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_BaseboardLength');
      const val = _toFloat(json['attributes']['mod_BaseboardLength'], 'mod_BaseboardLength');
      internal_leaveValidateVariant();
      this.mod_BaseboardLength = val;
    }
    {
    ...
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_BaseboardId');
      const val = _toString(json['attributes']['mod_BaseboardId'], 'mod_BaseboardId');
      internal_leaveValidateVariant();
      this.mod_BaseboardId = val;
    }
    {
  ...
  #dataCompletionAssignDerivedData() {
    ...
    if (this.mod_BaseboardThk === undefined) {
      ...
      while (s !== undefined) {
        if (s.variants.includes('mod_BaseboardThk')) {
          let pv = <IModVar_mod_BaseboardThk>s;
          if (pv.mod_BaseboardThk !== undefined) {
            this.mod_BaseboardThk = (<IModVar_mod_BaseboardThk>s).mod_BaseboardThk;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_BaseboardColor === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_BaseboardColor')) {
          let pv = <IModVar_mod_BaseboardColor>s;
          if (pv.mod_BaseboardColor !== undefined) {
            this.mod_BaseboardColor = (<IModVar_mod_BaseboardColor>s).mod_BaseboardColor;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_BaseboardEdgeColor === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_BaseboardEdgeColor')) {
          let pv = <IModVar_mod_BaseboardEdgeColor>s;
          if (pv.mod_BaseboardEdgeColor !== undefined) {
            this.mod_BaseboardEdgeColor = (<IModVar_mod_BaseboardEdgeColor>s).mod_BaseboardEdgeColor;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_BaseboardEdgeFrontColor === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_BaseboardEdgeFrontColor')) {
          let pv = <IModVar_mod_BaseboardEdgeFrontColor>s;
          if (pv.mod_BaseboardEdgeFrontColor !== undefined) {
            this.mod_BaseboardEdgeFrontColor = (<IModVar_mod_BaseboardEdgeFrontColor>s).mod_BaseboardEdgeFrontColor;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_BaseboardEdgeBackColor === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_BaseboardEdgeBackColor')) {
          let pv = <IModVar_mod_BaseboardEdgeBackColor>s;
          if (pv.mod_BaseboardEdgeBackColor !== undefined) {
            this.mod_BaseboardEdgeBackColor = (<IModVar_mod_BaseboardEdgeBackColor>s).mod_BaseboardEdgeBackColor;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_BaseboardProgram === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_BaseboardProgram')) {
          let pv = <IModVar_mod_BaseboardProgram>s;
          if (pv.mod_BaseboardProgram !== undefined) {
            this.mod_BaseboardProgram = (<IModVar_mod_BaseboardProgram>s).mod_BaseboardProgram;
            break;
          };
        }
        s = s.parentBase;
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_BaseboardDepth === undefined) {
      this.mod_BaseboardDepth = 500;
    }
    if (this.mod_BaseboardLength === undefined) {
      this.mod_BaseboardLength = 1000;
    }
    if (this.mod_BaseboardId === undefined) {
      this.mod_BaseboardId = "";
    }
  ...
  #manufacturerDataCompletionInternal = mc_Baseboard01_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_Baseboard01_NonNull(this);
  ...
  #prepareContextInternal = mc_Baseboard01_prepareContext;
  seal(): IModuleNonNull_mc_Baseboard01 {
    this.afterDataCompletion();
    const adc = new OD_M_mc_Baseboard01_NonNull(this);
    return adc;
  }

  override validateSelections(): void {
    this.mod_BaseboardDepth_matrix = VariantValidation.mod_BaseboardDepth(this, this.mod_BaseboardDepth);
    this.mod_BaseboardLength_matrix = VariantValidation.mod_BaseboardLength(this, this.mod_BaseboardLength);
    ...
    this.mod_BaseboardId_matrix = VariantValidation.mod_BaseboardId(this, this.mod_BaseboardId);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Baseboard01_NonNull(this);
    ccm.calculateContainerModules();
    this.m.forEach(subMod => subMod.calculateContainerModules());
  }

  addpart_Baseboard(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Baseboard_PartVarsWritable {
    var c = new P_part_Baseboard(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }

  override createBuildPlan(): void {
    var cbp = new OD_M_mc_Baseboard01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_Baseboard01_NonNull implements cbp_mc_Baseboard01, adc_mc_Baseboard01, ccm_mc_Baseboard01, IPartParentsNonNull_mc_Baseboard01 {
  constructor(parent: OD_M_mc_Baseboard01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_Baseboard01;
  ...
  #createBuildPlanInternal = mc_Baseboard01_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_Baseboard01_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = mc_Baseboard01_calculateContainerModules;
  ...
  parent: IModParents_mr_PlinthAreaBaseboard;
  addpart_Baseboard(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Baseboard_PartVarsWritable {
    return this.#internalParent.addpart_Baseboard(x, y, z, dimx, dimy, dimz);
  }
  get mod_BaseboardDepth(): number {
    return this.#internalParent.mod_BaseboardDepth!;
  }
  get mod_BaseboardLength(): number {
    return this.#internalParent.mod_BaseboardLength!;
  }
  ...
  get mod_BaseboardId(): string {
    return this.#internalParent.mod_BaseboardId!;
  }
