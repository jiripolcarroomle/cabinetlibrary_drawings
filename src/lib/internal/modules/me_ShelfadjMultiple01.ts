...
import { IModuleNonNull_me_ShelfadjMultiple01, IModParents_mc_ShelfadjGroup01_me_ShelfadjMultiple01, IPartParentsNonNull_mc_ShelfadjGroup01_me_ShelfadjMultiple01 } from '../mod-interfaces'
import { IModVar_mod_CarcaseColor, IModVarNonNull_mod_CarcaseColor, IModVar_mod_CarcaseId, IModVarNonNull_mod_CarcaseId, IModVar_mod_CarcaseProgram, IModVarNonNull_mod_CarcaseProgram, IModVar_mod_CarcaseSpaceDimension, IModVarNonNull_mod_CarcaseSpaceDimension, IModVar_mod_Depth, IModVarNonNull_mod_Depth, IModVar_mod_FrontDesign, IModVarNonNull_mod_FrontDesign, IModVar_mod_FrontProgram, IModVarNonNull_mod_FrontProgram, IModVar_mod_HardwareId, IModVarNonNull_mod_HardwareId, IModVar_mod_Height, IModVarNonNull_mod_Height, IModVar_mod_ModuleName, IModVarNonNull_mod_ModuleName, IModVar_mod_ShelfadjColor, IModVarNonNull_mod_ShelfadjColor, IModVar_mod_ShelfadjDescriptor, IModVarNonNull_mod_ShelfadjDescriptor, IModVar_mod_ShelfadjDesign, IModVarNonNull_mod_ShelfadjDesign, IModVar_mod_ShelfadjDrillDistance, IModVarNonNull_mod_ShelfadjDrillDistance, IModVar_mod_ShelfadjDrillinglineOffsetBtm, IModVarNonNull_mod_ShelfadjDrillinglineOffsetBtm, IModVar_mod_ShelfadjDrillinglineOffsetTop, IModVarNonNull_mod_ShelfadjDrillinglineOffsetTop, IModVar_mod_ShelfadjDrillType, IModVarNonNull_mod_ShelfadjDrillType, IModVar_mod_ShelfadjGroupPositionY, IModVarNonNull_mod_ShelfadjGroupPositionY, IModVar_mod_ShelfadjOffsetBack, IModVarNonNull_mod_ShelfadjOffsetBack, IModVar_mod_ShelfadjOffsetFront, IModVarNonNull_mod_ShelfadjOffsetFront, IModVar_mod_ShelfadjPartParentName, IModVarNonNull_mod_ShelfadjPartParentName, IModVar_mod_ShelfadjPartParentType, IModVarNonNull_mod_ShelfadjPartParentType, IModVar_mod_ShelfadjThk, IModVarNonNull_mod_ShelfadjThk, IModVar_mod_TypeElement, IModVarNonNull_mod_TypeElement, IModVar_mod_VertDividerPosition, IModVarNonNull_mod_VertDividerPosition, IModVar_mod_VertDividerType, IModVarNonNull_mod_VertDividerType, IModVar_mod_Width, IModVarNonNull_mod_Width } from '../var-interfaces'
import { VariantValidation, IMatrix_mod_CarcaseColor, IMatrix_mod_CarcaseId, IMatrix_mod_CarcaseProgram, IMatrix_mod_Depth, IMatrix_mod_FrontDesign, IMatrix_mod_FrontProgram, IMatrix_mod_HardwareId, IMatrix_mod_Height, IMatrix_mod_ModuleName, IMatrix_mod_ShelfadjColor, IMatrix_mod_ShelfadjDescriptor, IMatrix_mod_ShelfadjDesign, IMatrix_mod_ShelfadjDrillDistance, IMatrix_mod_ShelfadjDrillinglineOffsetBtm, IMatrix_mod_ShelfadjDrillinglineOffsetTop, IMatrix_mod_ShelfadjDrillType, IMatrix_mod_ShelfadjGroupPositionY, IMatrix_mod_ShelfadjOffsetBack, IMatrix_mod_ShelfadjOffsetFront, IMatrix_mod_ShelfadjPartParentName, IMatrix_mod_ShelfadjPartParentType, IMatrix_mod_ShelfadjThk, IMatrix_mod_TypeElement, IMatrix_mod_VertDividerPosition, IMatrix_mod_VertDividerType, IMatrix_mod_Width } from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { me_ShelfadjMultiple01_createBuildPlan, me_ShelfadjMultiple01_afterDataCompletion, me_ShelfadjMultiple01_manufacturerDataCompletion, me_ShelfadjMultiple01_calculateContainerModules, me_ShelfadjMultiple01_prepareContext } from '../../modules/me_ShelfadjMultiple01';

export interface cbp_me_ShelfadjMultiple01 extends IModBaseProp
  , IModVarNonNull_mod_CarcaseColor, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseProgram, IModVarNonNull_mod_CarcaseSpaceDimension, IModVarNonNull_mod_Depth, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_HardwareId, IModVarNonNull_mod_Height, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_ShelfadjColor, IModVarNonNull_mod_ShelfadjDescriptor, IModVarNonNull_mod_ShelfadjDesign, IModVarNonNull_mod_ShelfadjDrillDistance, IModVarNonNull_mod_ShelfadjDrillinglineOffsetBtm, IModVarNonNull_mod_ShelfadjDrillinglineOffsetTop, IModVarNonNull_mod_ShelfadjDrillType, IModVarNonNull_mod_ShelfadjGroupPositionY, IModVarNonNull_mod_ShelfadjOffsetBack, IModVarNonNull_mod_ShelfadjOffsetFront, IModVarNonNull_mod_ShelfadjPartParentName, IModVarNonNull_mod_ShelfadjPartParentType, IModVarNonNull_mod_ShelfadjThk, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_VertDividerPosition, IModVarNonNull_mod_VertDividerType, IModVarNonNull_mod_Width {
...
export interface dc_me_ShelfadjMultiple01 extends IModBaseProp
  , IModVar_mod_CarcaseColor, IModVar_mod_CarcaseId, IModVar_mod_CarcaseProgram, IModVar_mod_CarcaseSpaceDimension, IModVar_mod_Depth, IModVar_mod_FrontDesign, IModVar_mod_FrontProgram, IModVar_mod_HardwareId, IModVar_mod_Height, IModVar_mod_ModuleName, IModVar_mod_ShelfadjColor, IModVar_mod_ShelfadjDescriptor, IModVar_mod_ShelfadjDesign, IModVar_mod_ShelfadjDrillDistance, IModVar_mod_ShelfadjDrillinglineOffsetBtm, IModVar_mod_ShelfadjDrillinglineOffsetTop, IModVar_mod_ShelfadjDrillType, IModVar_mod_ShelfadjGroupPositionY, IModVar_mod_ShelfadjOffsetBack, IModVar_mod_ShelfadjOffsetFront, IModVar_mod_ShelfadjPartParentName, IModVar_mod_ShelfadjPartParentType, IModVar_mod_ShelfadjThk, IModVar_mod_TypeElement, IModVar_mod_VertDividerPosition, IModVar_mod_VertDividerType, IModVar_mod_Width {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
  seal(): IModuleNonNull_me_ShelfadjMultiple01;
  parent: IModParents_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_mf_Door_mf_Fliplift_mf_RackArea;
...
export interface pc_me_ShelfadjMultiple01 extends dc_me_ShelfadjMultiple01 {
...
export interface adc_base_me_ShelfadjMultiple01 extends IModBaseProp
  , IModVarNonNull_mod_CarcaseColor, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseProgram, IModVarNonNull_mod_CarcaseSpaceDimension, IModVarNonNull_mod_Depth, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_HardwareId, IModVarNonNull_mod_Height, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_ShelfadjColor, IModVarNonNull_mod_ShelfadjDescriptor, IModVarNonNull_mod_ShelfadjDesign, IModVarNonNull_mod_ShelfadjDrillDistance, IModVarNonNull_mod_ShelfadjDrillinglineOffsetBtm, IModVarNonNull_mod_ShelfadjDrillinglineOffsetTop, IModVarNonNull_mod_ShelfadjDrillType, IModVarNonNull_mod_ShelfadjGroupPositionY, IModVarNonNull_mod_ShelfadjOffsetBack, IModVarNonNull_mod_ShelfadjOffsetFront, IModVarNonNull_mod_ShelfadjPartParentName, IModVarNonNull_mod_ShelfadjPartParentType, IModVarNonNull_mod_ShelfadjThk, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_VertDividerPosition, IModVarNonNull_mod_VertDividerType, IModVarNonNull_mod_Width {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_me_ShelfadjMultiple01 extends adc_base_me_ShelfadjMultiple01 {
  addOD_M_mc_ShelfadjDrill01(index?: number): dc_mc_ShelfadjDrill01;
  addOD_M_mc_ShelfadjFitting01(index?: number): dc_mc_ShelfadjFitting01;
  addOD_M_mc_ShelfadjGlass01(index?: number): dc_mc_ShelfadjGlass01;
  addOD_M_mc_ShelfadjWood01(index?: number): dc_mc_ShelfadjWood01;
...
export interface ccm_me_ShelfadjMultiple01 extends adc_base_me_ShelfadjMultiple01 {
}


export class OD_M_me_ShelfadjMultiple01 extends OD_Base implements pc_me_ShelfadjMultiple01, dc_me_ShelfadjMultiple01
  , IModParents_mc_ShelfadjGroup01_me_ShelfadjMultiple01
  , IModVar_mod_CarcaseColor, IModVar_mod_CarcaseId, IModVar_mod_CarcaseProgram, IModVar_mod_CarcaseSpaceDimension, IModVar_mod_Depth, IModVar_mod_FrontDesign, IModVar_mod_FrontProgram, IModVar_mod_HardwareId, IModVar_mod_Height, IModVar_mod_ModuleName, IModVar_mod_ShelfadjColor, IModVar_mod_ShelfadjDescriptor, IModVar_mod_ShelfadjDesign, IModVar_mod_ShelfadjDrillDistance, IModVar_mod_ShelfadjDrillinglineOffsetBtm, IModVar_mod_ShelfadjDrillinglineOffsetTop, IModVar_mod_ShelfadjDrillType, IModVar_mod_ShelfadjGroupPositionY, IModVar_mod_ShelfadjOffsetBack, IModVar_mod_ShelfadjOffsetFront, IModVar_mod_ShelfadjPartParentName, IModVar_mod_ShelfadjPartParentType, IModVar_mod_ShelfadjThk, IModVar_mod_TypeElement, IModVar_mod_VertDividerPosition, IModVar_mod_VertDividerType, IModVar_mod_Width {
  constructor(parent: IModParents_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_mf_Door_mf_Fliplift_mf_RackArea, manufacturerMode?: boolean) {
    super('me_ShelfadjMultiple01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_me_ShelfadjMultiple01_NonNull(this);
  }
  parent: IModParents_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_mf_Door_mf_Fliplift_mf_RackArea;
  _selfNonNull: OD_M_me_ShelfadjMultiple01_NonNull;

  override variants: string[] = ['mod_CarcaseColor', 'mod_CarcaseId', 'mod_CarcaseProgram', 'mod_CarcaseSpaceDimension', 'mod_Depth', 'mod_FrontDesign', 'mod_FrontProgram', 'mod_HardwareId', 'mod_Height', 'mod_ModuleName', 'mod_ShelfadjColor', 'mod_ShelfadjDescriptor', 'mod_ShelfadjDesign', 'mod_ShelfadjDrillDistance', 'mod_ShelfadjDrillinglineOffsetBtm', 'mod_ShelfadjDrillinglineOffsetTop', 'mod_ShelfadjDrillType', 'mod_ShelfadjGroupPositionY', 'mod_ShelfadjOffsetBack', 'mod_ShelfadjOffsetFront', 'mod_ShelfadjPartParentName', 'mod_ShelfadjPartParentType', 'mod_ShelfadjThk', 'mod_TypeElement', 'mod_VertDividerPosition', 'mod_VertDividerType', 'mod_Width',];
  ...
  #mod_ShelfadjGroupPositionY?: number;
  get mod_ShelfadjGroupPositionY(): number | undefined { return this.#mod_ShelfadjGroupPositionY }
  set mod_ShelfadjGroupPositionY(value: number | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_ShelfadjGroupPositionY' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_ShelfadjGroupPositionY === value) return;
    this.#mod_ShelfadjGroupPositionY = value;
  }

  mod_ShelfadjGroupPositionY_matrix?: IMatrix_mod_ShelfadjGroupPositionY;
  ...
  override getAttributes(): Map<string, any> {
    ...
    res.set('mod_ShelfadjGroupPositionY', this.mod_ShelfadjGroupPositionY);
  ...
  override loadJson(json: any, withSubModules: boolean = true, manufacturerMode: boolean) {
    ...
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_ShelfadjGroupPositionY');
      const val = _toFloat(json['attributes']['mod_ShelfadjGroupPositionY'], 'mod_ShelfadjGroupPositionY');
      internal_leaveValidateVariant();
      this.mod_ShelfadjGroupPositionY = val;
    }
    {
  ...
  override checkPosRelevantRequiredAttributes(): void {
    ...
    if (this.#mod_HardwareId !== undefined) {
      this.#mod_HardwareId = undefined;
      logWarning('The attribute "mod_HardwareId" was set in the order data but is not marked as "pos relevant" - the value is ignored');
    }
    ...
    if (this.#mod_ShelfadjPartParentName !== undefined) {
      this.#mod_ShelfadjPartParentName = undefined;
      logWarning('The attribute "mod_ShelfadjPartParentName" was set in the order data but is not marked as "pos relevant" - the value is ignored');
    }
    if (this.#mod_ShelfadjPartParentType !== undefined) {
      this.#mod_ShelfadjPartParentType = undefined;
      logWarning('The attribute "mod_ShelfadjPartParentType" was set in the order data but is not marked as "pos relevant" - the value is ignored');
    }
    if (this.#mod_VertDividerPosition !== undefined) {
      this.#mod_VertDividerPosition = undefined;
      logWarning('The attribute "mod_VertDividerPosition" was set in the order data but is not marked as "pos relevant" - the value is ignored');
    }
  }
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "me_ShelfadjMultiple01";
    }
    if (this.mod_ShelfadjDrillinglineOffsetBtm === undefined) {
      this.mod_ShelfadjDrillinglineOffsetBtm = 0;
    }
    if (this.mod_ShelfadjDrillinglineOffsetTop === undefined) {
      this.mod_ShelfadjDrillinglineOffsetTop = 0;
    }
    if (this.mod_ShelfadjGroupPositionY === undefined) {
      this.mod_ShelfadjGroupPositionY = 0;
    }
    if (this.mod_ShelfadjOffsetBack === undefined) {
      this.mod_ShelfadjOffsetBack = 0;
    }
    if (this.mod_ShelfadjOffsetFront === undefined) {
      this.mod_ShelfadjOffsetFront = 10;
    }
    if (this.mod_ShelfadjPartParentName === undefined) {
  ...
  #manufacturerDataCompletionInternal = me_ShelfadjMultiple01_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_me_ShelfadjMultiple01_NonNull(this);
  ...
  #prepareContextInternal = me_ShelfadjMultiple01_prepareContext;
  seal(): IModuleNonNull_me_ShelfadjMultiple01 {
    this.afterDataCompletion();
    const adc = new OD_M_me_ShelfadjMultiple01_NonNull(this);
    return adc;
  }
  ...
  override validateSelections(): void {
    ...
    this.mod_ShelfadjDrillinglineOffsetBtm_matrix = VariantValidation.mod_ShelfadjDrillinglineOffsetBtm(this, this.mod_ShelfadjDrillinglineOffsetBtm);
    this.mod_ShelfadjDrillinglineOffsetTop_matrix = VariantValidation.mod_ShelfadjDrillinglineOffsetTop(this, this.mod_ShelfadjDrillinglineOffsetTop);
    this.mod_ShelfadjDrillType_matrix = VariantValidation.mod_ShelfadjDrillType(this, this.mod_ShelfadjDrillType);
    this.mod_ShelfadjGroupPositionY_matrix = VariantValidation.mod_ShelfadjGroupPositionY(this, this.mod_ShelfadjGroupPositionY);
    ...
    this.mod_ShelfadjPartParentName_matrix = VariantValidation.mod_ShelfadjPartParentName(this, this.mod_ShelfadjPartParentName);
    this.mod_ShelfadjPartParentType_matrix = VariantValidation.mod_ShelfadjPartParentType(this, this.mod_ShelfadjPartParentType);
    ...
    this.mod_VertDividerPosition_matrix = VariantValidation.mod_VertDividerPosition(this, this.mod_VertDividerPosition);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_me_ShelfadjMultiple01_NonNull(this);
  ...
  override createBuildPlan(): void {
    var cbp = new OD_M_me_ShelfadjMultiple01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_me_ShelfadjMultiple01_NonNull implements cbp_me_ShelfadjMultiple01, adc_me_ShelfadjMultiple01, ccm_me_ShelfadjMultiple01, IPartParentsNonNull_mc_ShelfadjGroup01_me_ShelfadjMultiple01 {
  constructor(parent: OD_M_me_ShelfadjMultiple01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_me_ShelfadjMultiple01;
  ...
  #createBuildPlanInternal = me_ShelfadjMultiple01_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = me_ShelfadjMultiple01_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = me_ShelfadjMultiple01_calculateContainerModules;
  ...
  get mod_ShelfadjGroupPositionY(): number {
    return this.#internalParent.mod_ShelfadjGroupPositionY!;
  }
