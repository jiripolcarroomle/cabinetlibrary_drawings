...
import { IModVar_mod_HangerPosX, IModVarNonNull_mod_HangerPosX, IModVar_mod_HangerPosY, IModVarNonNull_mod_HangerPosY, IModVar_mod_HangerType, IModVarNonNull_mod_HangerType, IModVar_mod_ModuleName, IModVarNonNull_mod_ModuleName, IModVar_mod_HangerInfo, IModVarNonNull_mod_HangerInfo, IModVar_mod_BackwallThk, IModVarNonNull_mod_BackwallThk, IModVar_mod_Originpos, IModVarNonNull_mod_Originpos, IModVar_mod_CarcaseId, IModVarNonNull_mod_CarcaseId } from '../var-interfaces'
import { VariantValidation, IMatrix_mod_HangerPosX, IMatrix_mod_HangerPosY, IMatrix_mod_HangerType, IMatrix_mod_ModuleName, IMatrix_mod_BackwallThk, IMatrix_mod_CarcaseId } from '../selections'
...
import { mc_HangerSystem01_createBuildPlan, mc_HangerSystem01_afterDataCompletion, mc_HangerSystem01_manufacturerDataCompletion, mc_HangerSystem01_calculateContainerModules, mc_HangerSystem01_prepareContext } from '../../modules/mc_HangerSystem01';

export interface cbp_mc_HangerSystem01 extends IModBaseProp
  , IPartAdd_part_HangerSystem, IPartAdd_part_HangerSystemBom, IPartAdd_part_HangerDrill, IModVarNonNull_mod_HangerPosX, IModVarNonNull_mod_HangerPosY, IModVarNonNull_mod_HangerType, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_HangerInfo, IModVarNonNull_mod_BackwallThk, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_CarcaseId {
...
export interface dc_mc_HangerSystem01 extends IModBaseProp
  , IModVar_mod_HangerPosX, IModVar_mod_HangerPosY, IModVar_mod_HangerType, IModVar_mod_ModuleName, IModVar_mod_HangerInfo, IModVar_mod_BackwallThk, IModVar_mod_Originpos, IModVar_mod_CarcaseId {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
...
export interface pc_mc_HangerSystem01 extends dc_mc_HangerSystem01 {
...
export interface adc_base_mc_HangerSystem01 extends IModBaseProp
  , IModVarNonNull_mod_HangerPosX, IModVarNonNull_mod_HangerPosY, IModVarNonNull_mod_HangerType, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_HangerInfo, IModVarNonNull_mod_BackwallThk, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_CarcaseId {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_HangerSystem01 extends adc_base_mc_HangerSystem01 {
}

export interface ccm_mc_HangerSystem01 extends adc_base_mc_HangerSystem01 {
}


export class OD_M_mc_HangerSystem01 extends OD_Base implements pc_mc_HangerSystem01, dc_mc_HangerSystem01
  ...
  override variants: string[] = ['mod_HangerPosX', 'mod_HangerPosY', 'mod_HangerType', 'mod_ModuleName', 'mod_HangerInfo', 'mod_BackwallThk', 'mod_Originpos', 'mod_CarcaseId',];
  ...
  #prepareContextInternal = mc_HangerSystem01_prepareContext;
  seal(): IModuleNonNull_mc_HangerSystem01 {
  ...
  override validateSelections(): void {
    this.mod_HangerPosX_matrix = VariantValidation.mod_HangerPosX(this, this.mod_HangerPosX);
    this.mod_HangerPosY_matrix = VariantValidation.mod_HangerPosY(this, this.mod_HangerPosY);
    this.mod_HangerType_matrix = VariantValidation.mod_HangerType(this, this.mod_HangerType);
    this.mod_ModuleName_matrix = VariantValidation.mod_ModuleName(this, this.mod_ModuleName);
    this.mod_BackwallThk_matrix = VariantValidation.mod_BackwallThk(this, this.mod_BackwallThk);
    this.mod_CarcaseId_matrix = VariantValidation.mod_CarcaseId(this, this.mod_CarcaseId);
  }

  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_HangerSystem01_NonNull(this);
  ...
  addpart_HangerSystem(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_HangerSystem_PartVarsWritable {
    var c = new P_part_HangerSystem(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_HangerSystemBom(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_HangerSystemBom_PartVarsWritable {
    var c = new P_part_HangerSystemBom(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_HangerDrill(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_HangerDrill_PartVarsWritable {
    var c = new P_part_HangerDrill(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_HangerSystem01_NonNull implements cbp_mc_HangerSystem01, adc_mc_HangerSystem01, ccm_mc_HangerSystem01, IPartParentsNonNull_mc_HangerSystem01 {
  ...
  #calculateContainerModulesInternal = mc_HangerSystem01_calculateContainerModules;
