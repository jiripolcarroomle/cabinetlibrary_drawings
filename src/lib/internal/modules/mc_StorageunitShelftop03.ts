...
import { mc_StorageunitShelftop03_createBuildPlan, mc_StorageunitShelftop03_afterDataCompletion, mc_StorageunitShelftop03_manufacturerDataCompletion, mc_StorageunitShelftop03_calculateContainerModules, mc_StorageunitShelftop03_prepareContext } from '../../modules/mc_StorageunitShelftop03';
...
export interface pc_mc_StorageunitShelftop03 extends dc_mc_StorageunitShelftop03 {
...
export interface adc_base_mc_StorageunitShelftop03 extends IModBaseProp
  , IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseVisTop, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Height, IModVarNonNull_mod_ShelftopConstruction, IModVarNonNull_mod_Width, IModVarNonNull_mod_CarcaseColor, IModVarNonNull_mod_CarcaseOutsideColor, IModVarNonNull_mod_CarcaseEdgeBackColor, IModVarNonNull_mod_CarcaseEdgeColor, IModVarNonNull_mod_CarcaseEdgeFrontColor, IModVarNonNull_mod_CarcaseProgram, IModVarNonNull_mod_CarcaseOutsideProgram, IModVarNonNull_mod_EdgeFrontType, IModVarNonNull_mod_EdgeBackType, IModVarNonNull_mod_EdgeLeftType, IModVarNonNull_mod_EdgeRightType, IModVarNonNull_mod_EdgeJointType, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_CarcaseConnectionLeftTop, IModVarNonNull_mod_CarcaseConnectionRightTop, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_HardwareColor, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_FittingConnectionLeftTop, IModVarNonNull_mod_FittingConnectionRightTop, IModVarNonNull_mod_FittingConnectionTopVert, IModVarNonNull_mod_CarcasePartConnectionTopVert, IModVarNonNull_mod_PartInfo, IModVarNonNull_mod_SlopeAngle {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_StorageunitShelftop03 extends adc_base_mc_StorageunitShelftop03 {
}

export interface ccm_mc_StorageunitShelftop03 extends adc_base_mc_StorageunitShelftop03 {
}


export class OD_M_mc_StorageunitShelftop03 extends OD_Base implements pc_mc_StorageunitShelftop03, dc_mc_StorageunitShelftop03
  ...
  #prepareContextInternal = mc_StorageunitShelftop03_prepareContext;
  seal(): IModuleNonNull_mc_StorageunitShelftop03 {
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_StorageunitShelftop03_NonNull(this);
...
class OD_M_mc_StorageunitShelftop03_NonNull implements cbp_mc_StorageunitShelftop03, adc_mc_StorageunitShelftop03, ccm_mc_StorageunitShelftop03 {
  ...
  #calculateContainerModulesInternal = mc_StorageunitShelftop03_calculateContainerModules;
