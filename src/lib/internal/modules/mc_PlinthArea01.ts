...
export interface pc_mc_PlinthArea01 extends dc_mc_PlinthArea01 {
...
export interface adc_base_mc_PlinthArea01 extends IModBaseProp
  , IModVarNonNull_mod_CarcaseDepth, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseWidth, IModVarNonNull_mod_SidepanelleftThk, IModVarNonNull_mod_SidepanelrightThk, IModVarNonNull_mod_CarcaseSidepanelleftOversizeBtm, IModVarNonNull_mod_CarcaseSidepanelrightOversizeBtm, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_PlinthAreaPosLeftMatrix, IModVarNonNull_mod_PlinthAreaDesign, IModVarNonNull_mod_PlinthAreaPosBackMatrix, IModVarNonNull_mod_PlinthAreaPosFrontMatrix, IModVarNonNull_mod_PlinthAreaPosRightMatrix, IModVarNonNull_mod_PlinthAreaPosLogic, IModVarNonNull_mod_ShelfbtmThk, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_PlinthAreaElementColor, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_PlinthAreaExtraItem, IModVarNonNull_mod_PlinthAreaPositionInfo, IModVarNonNull_mod_LegInsertion, IModVarNonNull_mod_Weight {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
  ct_tab_PlinthAreaSettings: ct2_tab_PlinthAreaSettings;
...
export interface adc_mc_PlinthArea01 extends adc_base_mc_PlinthArea01 {
  addOD_M_mc_Leg01(index?: number): dc_mc_Leg01;
}

export interface ccm_mc_PlinthArea01 extends adc_base_mc_PlinthArea01 {
}


export class OD_M_mc_PlinthArea01 extends OD_Base implements pc_mc_PlinthArea01, dc_mc_PlinthArea01
  , IModParents_mc_PlinthArea01_mr_PlinthAreaBaseboard
  , IModVar_mod_CarcaseDepth, IModVar_mod_CarcaseId, IModVar_mod_CarcaseWidth, IModVar_mod_SidepanelleftThk, IModVar_mod_SidepanelrightThk, IModVar_mod_CarcaseSidepanelleftOversizeBtm, IModVar_mod_CarcaseSidepanelrightOversizeBtm, IModVar_mod_PlinthAreaHeight, IModVar_mod_PlinthAreaPosLeftMatrix, IModVar_mod_PlinthAreaDesign, IModVar_mod_PlinthAreaPosBackMatrix, IModVar_mod_PlinthAreaPosFrontMatrix, IModVar_mod_PlinthAreaPosRightMatrix, IModVar_mod_PlinthAreaPosLogic, IModVar_mod_ShelfbtmThk, IModVar_mod_TypeElement, IModVar_mod_PlinthAreaElementColor, IModVar_mod_ModuleName, IModVar_mod_PlinthAreaExtraItem, IModVar_mod_PlinthAreaPositionInfo, IModVar_mod_LegInsertion, IModVar_mod_Weight {
  ...
  override variants: string[] = ['mod_CarcaseDepth', 'mod_CarcaseId', 'mod_CarcaseWidth', 'mod_SidepanelleftThk', 'mod_SidepanelrightThk', 'mod_CarcaseSidepanelleftOversizeBtm', 'mod_CarcaseSidepanelrightOversizeBtm', 'mod_PlinthAreaHeight', 'mod_PlinthAreaPosLeftMatrix', 'mod_PlinthAreaDesign', 'mod_PlinthAreaPosBackMatrix', 'mod_PlinthAreaPosFrontMatrix', 'mod_PlinthAreaPosRightMatrix', 'mod_PlinthAreaPosLogic', 'mod_ShelfbtmThk', 'mod_TypeElement', 'mod_PlinthAreaElementColor', 'mod_ModuleName', 'mod_PlinthAreaExtraItem', 'mod_PlinthAreaPositionInfo', 'mod_LegInsertion', 'mod_Weight',];
  ...
  #prepareContextInternal = mc_PlinthArea01_prepareContext;
  seal(): IModuleNonNull_mc_PlinthArea01 {
  ...
  override validateSelections(): void {
    ...
    this.mod_LegInsertion_matrix = VariantValidation.mod_LegInsertion(this, this.mod_LegInsertion);
    this.mod_Weight_matrix = VariantValidation.mod_Weight(this, this.mod_Weight);
  }

  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_PlinthArea01_NonNull(this);
...
class OD_M_mc_PlinthArea01_NonNull implements cbp_mc_PlinthArea01, adc_mc_PlinthArea01, ccm_mc_PlinthArea01, IPartParentsNonNull_mc_PlinthArea01_mr_PlinthAreaBaseboard {
  ...
  #calculateContainerModulesInternal = mc_PlinthArea01_calculateContainerModules;
