...
export interface dc_mf_RackArea extends IModBaseProp
  ...
  addOD_M_me_LaundryMachine(index?: number): dc_me_LaundryMachine;
  addOD_M_me_ClothingOrganizer01(index?: number): dc_me_ClothingOrganizer01;
}

export interface pc_mf_RackArea extends dc_mf_RackArea {
...
export interface adc_base_mf_RackArea extends IModBaseProp
  , IModVarNonNull_mod_BackwallPos, IModVarNonNull_mod_CarcaseBackwallConstruction, IModVarNonNull_mod_CarcaseDepth, IModVarNonNull_mod_CarcaseHeight, IModVarNonNull_mod_CarcaseWidth, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapHorTop, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_HeightPosInsertion, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_ShelffixedThk, IModVarNonNull_mod_SidepanelleftThk, IModVarNonNull_mod_SidepanelrightThk, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontOversizeBtm, IModVarNonNull_mod_FrontOversizeLeft, IModVarNonNull_mod_FrontOversizeRight, IModVarNonNull_mod_FrontOversizeTop, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_FrontThk, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_ShelfadjDesign, IModVarNonNull_mod_ShelfadjDrillDistance, IModVarNonNull_mod_ShelfadjDrillinglineOffsetTop, IModVarNonNull_mod_ShelfadjDrillType, IModVarNonNull_mod_ShelfadjOffsetBack, IModVarNonNull_mod_ShelfadjOffsetFront, IModVarNonNull_mod_ShelfadjThk, IModVarNonNull_mod_ShelffixedBtm, IModVarNonNull_mod_ShelffixedOffsetFront, IModVarNonNull_mod_ShelffixedOversizeBack, IModVarNonNull_mod_ShelffixedOversizeFront, IModVarNonNull_mod_ShelffixedPos, IModVarNonNull_mod_ShelffixedTop, IModVarNonNull_mod_ShelffixedType, IModVarNonNull_mod_FrontHeight, IModVarNonNull_mod_FingergripBtmType, IModVarNonNull_mod_FingergripTop, IModVarNonNull_mod_FingergripTopType, IModVarNonNull_mod_RackAreaType, IModVarNonNull_mod_CarcasePartConnectionLeftHor, IModVarNonNull_mod_CarcasePartConnectionBackHor, IModVarNonNull_mod_CarcasePartConnectionRightHor, IModVarNonNull_mod_FittingConnectionLeftHor, IModVarNonNull_mod_FittingConnectionRightHor, IModVarNonNull_mod_ShelvesBackwallFittingConnection, IModVarNonNull_mod_RackAreaShelftopConstruction, IModVarNonNull_mod_CarcaseSpaceDimension, IModVarNonNull_mod_FrontHeightSelection, IModVarNonNull_mod_ShelfadjColor, IModVarNonNull_mod_ShelfadjDescriptor {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mf_RackArea extends adc_base_mf_RackArea {
  addOD_M_mc_ShelfadjGroup01(index?: number): dc_mc_ShelfadjGroup01;
  addOD_M_mc_RackArea01(index?: number): dc_mc_RackArea01;
  addOD_M_mc_ShelffixedGroup01(index?: number): dc_mc_ShelffixedGroup01;
  addOD_M_me_ShelfadjMultiple01(index?: number): dc_me_ShelfadjMultiple01;
...
export interface ccm_mf_RackArea extends adc_base_mf_RackArea {
}


export class OD_M_mf_RackArea extends OD_Base implements pc_mf_RackArea, dc_mf_RackArea
  , IModParents_mf_Door_mf_Fliplift_mf_RackArea, IModParents_mf_RackArea, IModParents_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_mf_Door_mf_Fliplift_mf_RackArea
  , IModVar_mod_BackwallPos, IModVar_mod_CarcaseBackwallConstruction, IModVar_mod_CarcaseDepth, IModVar_mod_CarcaseHeight, IModVar_mod_CarcaseWidth, IModVar_mod_FrontColor, IModVar_mod_FrontGapCarcase, IModVar_mod_FrontGapHor, IModVar_mod_FrontGapHorTop, IModVar_mod_FrontGapVert, IModVar_mod_FrontProgram, IModVar_mod_HeightPosInsertion, IModVar_mod_ModuleName, IModVar_mod_ParentName, IModVar_mod_PlinthAreaHeight, IModVar_mod_ShelffixedThk, IModVar_mod_SidepanelleftThk, IModVar_mod_SidepanelrightThk, IModVar_mod_TypeElement, IModVar_mod_CarcaseId, IModVar_mod_FrontId, IModVar_mod_FrontOversizeBtm, IModVar_mod_FrontOversizeLeft, IModVar_mod_FrontOversizeRight, IModVar_mod_FrontOversizeTop, IModVar_mod_FrontPosStart, IModVar_mod_FrontThk, IModVar_mod_FrontWidth, IModVar_mod_Originpos, IModVar_mod_ShelfadjDesign, IModVar_mod_ShelfadjDrillDistance, IModVar_mod_ShelfadjDrillinglineOffsetTop, IModVar_mod_ShelfadjDrillType, IModVar_mod_ShelfadjOffsetBack, IModVar_mod_ShelfadjOffsetFront, IModVar_mod_ShelfadjThk, IModVar_mod_ShelffixedBtm, IModVar_mod_ShelffixedOffsetFront, IModVar_mod_ShelffixedOversizeBack, IModVar_mod_ShelffixedOversizeFront, IModVar_mod_ShelffixedPos, IModVar_mod_ShelffixedTop, IModVar_mod_ShelffixedType, IModVar_mod_FrontHeight, IModVar_mod_FingergripBtmType, IModVar_mod_FingergripTop, IModVar_mod_FingergripTopType, IModVar_mod_RackAreaType, IModVar_mod_CarcasePartConnectionLeftHor, IModVar_mod_CarcasePartConnectionBackHor, IModVar_mod_CarcasePartConnectionRightHor, IModVar_mod_FittingConnectionLeftHor, IModVar_mod_FittingConnectionRightHor, IModVar_mod_ShelvesBackwallFittingConnection, IModVar_mod_RackAreaShelftopConstruction, IModVar_mod_CarcaseSpaceDimension, IModVar_mod_FrontHeightSelection, IModVar_mod_ShelfadjColor, IModVar_mod_ShelfadjDescriptor {
  ...
  override checkPosRelevantRequiredAttributes(): void {
    ...
    if (this.#mod_CarcasePartConnectionLeftHor !== undefined) {
      this.#mod_CarcasePartConnectionLeftHor = undefined;
      logWarning('The attribute "mod_CarcasePartConnectionLeftHor" was set in the order data but is not marked as "pos relevant" - the value is ignored');
    }
    if (this.#mod_CarcasePartConnectionBackHor !== undefined) {
      this.#mod_CarcasePartConnectionBackHor = undefined;
      logWarning('The attribute "mod_CarcasePartConnectionBackHor" was set in the order data but is not marked as "pos relevant" - the value is ignored');
    }
    if (this.#mod_CarcasePartConnectionRightHor !== undefined) {
      this.#mod_CarcasePartConnectionRightHor = undefined;
      logWarning('The attribute "mod_CarcasePartConnectionRightHor" was set in the order data but is not marked as "pos relevant" - the value is ignored');
    }
  ...
  #prepareContextInternal = mf_RackArea_prepareContext;
  seal(): IModuleNonNull_mf_RackArea {
  ...
  addOD_M_me_LaundryMachine(index?: number): dc_me_LaundryMachine {
    var m = new OD_M_me_LaundryMachine(this);
    m.dataCompletion();
    if (this._manufacturerMode) {
      m.manufacturerDataCompletion();
    }
  ...
  override validateSelections(): void {
    ...
    this.mod_RackAreaType_matrix = VariantValidation.mod_RackAreaType(this, this.mod_RackAreaType);
    ...
    this.mod_FittingConnectionLeftHor_matrix = VariantValidation.mod_FittingConnectionLeftHor(this, this.mod_FittingConnectionLeftHor);
    this.mod_FittingConnectionRightHor_matrix = VariantValidation.mod_FittingConnectionRightHor(this, this.mod_FittingConnectionRightHor);
    this.mod_ShelvesBackwallFittingConnection_matrix = VariantValidation.mod_ShelvesBackwallFittingConnection(this, this.mod_ShelvesBackwallFittingConnection);
    this.mod_RackAreaShelftopConstruction_matrix = VariantValidation.mod_RackAreaShelftopConstruction(this, this.mod_RackAreaShelftopConstruction);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mf_RackArea_NonNull(this);
...
class OD_M_mf_RackArea_NonNull implements cbp_mf_RackArea, adc_mf_RackArea, ccm_mf_RackArea, IPartParentsNonNull_mf_Door_mf_Fliplift_mf_RackArea, IPartParentsNonNull_mf_RackArea, IPartParentsNonNull_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_mf_Door_mf_Fliplift_mf_RackArea {
  ...
  #calculateContainerModulesInternal = mf_RackArea_calculateContainerModules;
  ...
  addOD_M_me_LaundryMachine(index?: number): dc_me_LaundryMachine {
    return this.#internalParent.addOD_M_me_LaundryMachine(index);
  }
  addOD_M_me_ClothingOrganizer01(index?: number): dc_me_ClothingOrganizer01 {
