...
import { IModParents_mf_Pullout } from '../mod-interfaces'
import { IP_part_PulloutUnit_PartVarsWritable, P_part_PulloutUnit } from '../parts/part_PulloutUnit'
import { OD_M_mc_PulloutHardware01, dc_mc_PulloutHardware01 } from './mc_PulloutHardware01'
...
export interface pc_mc_Pullout01 extends dc_mc_Pullout01 {
...
export interface adc_base_mc_Pullout01 extends IModBaseProp
...
export interface adc_mc_Pullout01 extends adc_base_mc_Pullout01 {
  addOD_M_mc_PulloutHardware01(index?: number): dc_mc_PulloutHardware01;
  addOD_M_mc_FrontPanel01(index?: number): dc_mc_FrontPanel01;
  addOD_M_mc_Handle01(index?: number): dc_mc_Handle01;
  addOD_M_mc_Handlestrip01(index?: number): dc_mc_Handlestrip01;
...
export class OD_M_mc_Pullout01 extends OD_Base implements pc_mc_Pullout01, dc_mc_Pullout01
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mc_Pullout01";
    }
  ...
  #manufacturerDataCompletionInternal = mc_Pullout01_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_Pullout01_NonNull(this);
  ...
  #prepareContextInternal = mc_Pullout01_prepareContext;
  seal(): IModuleNonNull_mc_Pullout01 {
    this.afterDataCompletion();
    const adc = new OD_M_mc_Pullout01_NonNull(this);
    return adc;
  }

  addOD_M_mc_PulloutHardware01(index?: number): dc_mc_PulloutHardware01 {
    var m = new OD_M_mc_PulloutHardware01(this);
    m.dataCompletion();
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Pullout01_NonNull(this);
    ccm.calculateContainerModules();
    this.m.forEach(subMod => subMod.calculateContainerModules());
  }

  addpart_PulloutUnit(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_PulloutUnit_PartVarsWritable {
    var c = new P_part_PulloutUnit(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }

  override createBuildPlan(): void {
    var cbp = new OD_M_mc_Pullout01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_Pullout01_NonNull implements cbp_mc_Pullout01, adc_mc_Pullout01, ccm_mc_Pullout01, IPartParentsNonNull_mc_BaseunitFridge01_mc_CornerFillerFront01_mc_Dishwasher01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_BaseunitFridge01_mc_CornerFillerFront01_mc_Dishwasher01_mc_Door01_mc_Drawer01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_Fixedfront01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_Pullout01 {
  constructor(parent: OD_M_mc_Pullout01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_Pullout01;
  ...
  #createBuildPlanInternal = mc_Pullout01_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_Pullout01_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = mc_Pullout01_calculateContainerModules;
  ...
  ct_tab_PulloutHardwareInsertionSettings: ct2_tab_PulloutHardwareInsertionSettings = new ct2_tab_PulloutHardwareInsertionSettings();
  parent: IModParents_mf_Pullout;
  addpart_PulloutUnit(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_PulloutUnit_PartVarsWritable {
    return this.#internalParent.addpart_PulloutUnit(x, y, z, dimx, dimy, dimz);
  }
  ...
  addOD_M_mc_PulloutHardware01(index?: number): dc_mc_PulloutHardware01 {
    return this.#internalParent.addOD_M_mc_PulloutHardware01(index);
  }
  addOD_M_mc_FrontPanel01(index?: number): dc_mc_FrontPanel01 {
