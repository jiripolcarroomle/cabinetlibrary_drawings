...
export interface pc_mc_Fixedfront01 extends dc_mc_Fixedfront01 {
...
export interface adc_base_mc_Fixedfront01 extends IModBaseProp
...
export interface adc_mc_Fixedfront01 extends adc_base_mc_Fixedfront01 {
  addOD_M_mc_FrontPanel01(index?: number): dc_mc_FrontPanel01;
  addOD_M_mc_PanelWoodFrame01(index?: number): dc_mc_PanelWoodFrame01;
  addOD_M_mc_MetalFrame01(index?: number): dc_mc_MetalFrame01;
  addOD_M_mc_ThermoformedPanel01(index?: number): dc_mc_ThermoformedPanel01;
...
export interface ccm_mc_Fixedfront01 extends adc_base_mc_Fixedfront01 {
}


export class OD_M_mc_Fixedfront01 extends OD_Base implements pc_mc_Fixedfront01, dc_mc_Fixedfront01
  ...
  override variants: string[] = ['mod_BackwallPos', 'mod_CarcaseDepth', 'mod_CarcaseHeight', 'mod_CarcaseId', 'mod_CarcaseSpaceDimension', 'mod_CarcaseWidth', 'mod_Depth', 'mod_FingergripTop', 'mod_FrontColor', 'mod_FrontDesign', 'mod_FrontEdgeColor', 'mod_FrontEdgeThk', 'mod_FrontGapCarcase', 'mod_FrontGapHor', 'mod_FrontGapHorTop', 'mod_FrontGapVert', 'mod_FrontHeight', 'mod_FrontId', 'mod_FrontOversizeBtm', 'mod_FrontOversizeLeft', 'mod_FrontOversizeRight', 'mod_FrontOversizeTop', 'mod_FrontPosStart', 'mod_FrontProgram', 'mod_FrontThk', 'mod_FrontWidth', 'mod_HandlestripPos', 'mod_HeightPosInsertion', 'mod_ModuleName', 'mod_Originpos', 'mod_FrameFillingType', 'mod_PlinthAreaHeight', 'mod_ShelfbtmThk', 'mod_ShelffixedBtm', 'mod_ShelffixedPos', 'mod_ShelffixedThk', 'mod_ShelffixedType', 'mod_TypeElement', 'mod_VertDividerType', 'mod_HandlePosType', 'mod_HandleDesign', 'mod_FrameFillingColor', 'mod_FirstFront', 'mod_LastFront',];
  ...
  #prepareContextInternal = mc_Fixedfront01_prepareContext;
  seal(): IModuleNonNull_mc_Fixedfront01 {
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Fixedfront01_NonNull(this);
  ...
  addpart_FixedfrontUnit(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_FixedfrontUnit_PartVarsWritable {
    var c = new P_part_FixedfrontUnit(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_Fixedfront01_NonNull implements cbp_mc_Fixedfront01, adc_mc_Fixedfront01, ccm_mc_Fixedfront01, IPartParentsNonNull_mc_BaseunitFridge01_mc_CornerFillerFront01_mc_Dishwasher01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01, IPartParentsNonNull_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_Fixedfront01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_Fixedfront01 {
  ...
  #calculateContainerModulesInternal = mc_Fixedfront01_calculateContainerModules;
