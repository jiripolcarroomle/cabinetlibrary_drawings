...
import { mc_ShelfadjDrill01_createBuildPlan, mc_ShelfadjDrill01_afterDataCompletion, mc_ShelfadjDrill01_manufacturerDataCompletion, mc_ShelfadjDrill01_calculateContainerModules, mc_ShelfadjDrill01_prepareContext } from '../../modules/mc_ShelfadjDrill01';
...
export interface pc_mc_ShelfadjDrill01 extends dc_mc_ShelfadjDrill01 {
...
export interface adc_base_mc_ShelfadjDrill01 extends IModBaseProp
  , IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_Rotation, IModVarNonNull_mod_ShelfadjDrillDistance, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Width, IModVarNonNull_mod_Height, IModVarNonNull_mod_ShelfadjSidepanelDrillDescriptor, IModVarNonNull_mod_ShelfadjBackwallDrillDescriptor, IModVarNonNull_mod_ShelfadjBackwallProcessingId, IModVarNonNull_mod_ShelfadjSidepanelProcessingBackId, IModVarNonNull_mod_ShelfadjSidepanelProcessingFrontId, IModVarNonNull_mod_ShelfadjSidepanelProcessingMiddleId, IModVarNonNull_mod_ShelfadjVertDividerProcessingId, IModVarNonNull_mod_ShelfadjVertdividerDrillDescriptor, IModVarNonNull_mod_VertDividerType, IModVarNonNull_mod_VertDividerPosition {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_ShelfadjDrill01 extends adc_base_mc_ShelfadjDrill01 {
}

export interface ccm_mc_ShelfadjDrill01 extends adc_base_mc_ShelfadjDrill01 {
}


export class OD_M_mc_ShelfadjDrill01 extends OD_Base implements pc_mc_ShelfadjDrill01, dc_mc_ShelfadjDrill01
  ...
  #prepareContextInternal = mc_ShelfadjDrill01_prepareContext;
  seal(): IModuleNonNull_mc_ShelfadjDrill01 {
  ...
  override validateSelections(): void {
    ...
    this.mod_Rotation_matrix = VariantValidation.mod_Rotation(this, this.mod_Rotation);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_ShelfadjDrill01_NonNull(this);
  ...
  addpart_ShelfadjDrill(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_ShelfadjDrill_PartVarsWritable {
    var c = new P_part_ShelfadjDrill(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_ShelfadjDrill01_NonNull implements cbp_mc_ShelfadjDrill01, adc_mc_ShelfadjDrill01, ccm_mc_ShelfadjDrill01, IPartParentsNonNull_mc_ShelfadjDrill01 {
  ...
  #calculateContainerModulesInternal = mc_ShelfadjDrill01_calculateContainerModules;
