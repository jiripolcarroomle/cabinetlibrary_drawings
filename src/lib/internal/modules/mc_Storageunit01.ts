...
export interface pc_mc_Storageunit01 extends dc_mc_Storageunit01 {
...
export interface adc_base_mc_Storageunit01 extends IModBaseProp
...
export interface adc_mc_Storageunit01 extends adc_base_mc_Storageunit01 {
  addOD_M_mc_StorageunitSidepanel01(index?: number): dc_mc_StorageunitSidepanel01;
  addOD_M_mc_StorageunitShelfbtm01(index?: number): dc_mc_StorageunitShelfbtm01;
  addOD_M_mc_StorageunitShelftop01(index?: number): dc_mc_StorageunitShelftop01;
  addOD_M_mc_StorageunitBackwall01(index?: number): dc_mc_StorageunitBackwall01;
...
export interface ccm_mc_Storageunit01 extends adc_base_mc_Storageunit01 {
}


export class OD_M_mc_Storageunit01 extends OD_Base implements pc_mc_Storageunit01, dc_mc_Storageunit01
  , IModParents_mc_Storageunit01, IModParents_mc_Cornerunit01_mc_FillerStraight01_mc_Storageunit01_mc_VertDivider01, IModParents_mc_FillerStraight01_mc_Storageunit01, IModParents_mc_PantryPullout01_mc_Storageunit01, IModParents_mc_CornerunitStraight01_mc_Storageunit01
  , IModVar_mod_BackwallPos, IModVar_mod_BackwallPosList, IModVar_mod_BackwallThk, IModVar_mod_CarcaseBackwallConstruction, IModVar_mod_CarcaseBackwallConstructionList, IModVar_mod_CarcaseConnectionLeftBtm, IModVar_mod_CarcaseConnectionLeftTop, IModVar_mod_CarcaseConnectionRightBtm, IModVar_mod_CarcaseConnectionRightTop, IModVar_mod_CarcaseDepth, IModVar_mod_CarcaseHeight, IModVar_mod_CarcaseId, IModVar_mod_CarcaseShelfbtmConstruction, IModVar_mod_CarcaseShelftopConstruction, IModVar_mod_CarcaseVisBack, IModVar_mod_CarcaseVisBtm, IModVar_mod_CarcaseVisLeft, IModVar_mod_CarcaseVisRight, IModVar_mod_CarcaseVisTop, IModVar_mod_CarcaseWidth, IModVar_mod_FingergripQtyMiddle, IModVar_mod_FingergripPos1, IModVar_mod_FingergripPos2, IModVar_mod_FingergripPos3, IModVar_mod_FingergripPos4, IModVar_mod_FingergripPos5, IModVar_mod_FingergripTop, IModVar_mod_HangerPosX, IModVar_mod_HangerPosY, IModVar_mod_RailhortopbackThk, IModVar_mod_RailhortopfrontThk, IModVar_mod_RailverttopbackThk, IModVar_mod_RailverttopfrontThk, IModVar_mod_ShelfbtmThk, IModVar_mod_ShelffixedOversizeFrontList, IModVar_mod_ShelffixedPosList, IModVar_mod_ShelffixedThk, IModVar_mod_ShelffixedTypeList, IModVar_mod_ShelftopThk, IModVar_mod_SidepanelleftThk, IModVar_mod_SidepanelleftType, IModVar_mod_SidepanelrightType, IModVar_mod_SidepanelrightThk, IModVar_mod_CarcaseBackwallColor, IModVar_mod_CarcaseBackwallProgram, IModVar_mod_CarcaseColor, IModVar_mod_CarcaseOutsideColor, IModVar_mod_CarcaseEdgeBackColor, IModVar_mod_CarcaseEdgeColor, IModVar_mod_CarcaseEdgeFrontColor, IModVar_mod_CarcaseProgram, IModVar_mod_CarcaseOutsideProgram, IModVar_mod_CarcaseShelfbtmOversizeInsideWall, IModVar_mod_CarcaseShelfbtmOversizeLeft, IModVar_mod_CarcaseShelfbtmOversizeRight, IModVar_mod_CarcaseShelftopOversizeInsideWall, IModVar_mod_CarcaseShelftopOversizeLeft, IModVar_mod_CarcaseShelftopOversizeRight, IModVar_mod_CarcaseSidepanelleftOversizeBtm, IModVar_mod_CarcaseSidepanelleftOversizeInsideWall, IModVar_mod_CarcaseSidepanelleftOversizeTop, IModVar_mod_CarcaseSidepanelrightOversizeBtm, IModVar_mod_CarcaseSidepanelrightOversizeInsideWall, IModVar_mod_CarcaseSidepanelrightOversizeTop, IModVar_mod_CarcaseDistanceWall, IModVar_mod_FingergripType, IModVar_mod_HangerType, IModVar_mod_LightPosX1, IModVar_mod_LightPosX2, IModVar_mod_LightPosX3, IModVar_mod_LightPosX4, IModVar_mod_LightPosX5, IModVar_mod_LightPart, IModVar_mod_LightPosX, IModVar_mod_LightPosY, IModVar_mod_LightSystem, IModVar_mod_PlinthAreaHeight, IModVar_mod_BackwallFixedHeight, IModVar_mod_ShelffixedOversizeBackList, IModVar_mod_CarcaseSpaceDimension, IModVar_mod_ModuleName, IModVar_mod_TypeElement, IModVar_mod_HardwareColor, IModVar_mod_CarcasePartConnectionBackHor, IModVar_mod_CarcasePartConnectionBackVert, IModVar_mod_CarcasePartConnectionBtmVert, IModVar_mod_CarcasePartConnectionLeftHor, IModVar_mod_CarcasePartConnectionRightHor, IModVar_mod_CarcasePartConnectionTopVert, IModVar_mod_HangerOffsetPosY, IModVar_mod_HangerColor, IModVar_mod_SidepanelmiddleThk, IModVar_mod_VertDividerInfoList, IModVar_mod_CarcaseFrontConstruction, IModVar_mod_CarcasePartInfo, IModVar_mod_LastFrontHeight, IModVar_mod_LastFrontName, IModVar_mod_HobHeightBlockedSpace, IModVar_mod_ShelffixedInfoList, IModVar_mod_FrontAreaInfoList, IModVar_mod_SlopedCeilingDimensionLogic, IModVar_mod_SlopedCeilingConstruction, IModVar_mod_SlopeAngle, IModVar_mod_BackHeight, IModVar_mod_TopDepth, IModVar_mod_CarcaseDirection, IModVar_mod_CarcaseMovement, IModVar_mod_Originpos, IModVar_mod_HoodInsertion, IModVar_mod_HoodInformation {
  ...
  get mod_HoodInsertion(): boolean | undefined { return this.#mod_HoodInsertion }
  set mod_HoodInsertion(value: boolean | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_HoodInsertion' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_HoodInsertion === value) return;
    this.#mod_HoodInsertion = value;
  }

  mod_HoodInsertion_matrix?: IMatrix_mod_HoodInsertion;
  ...
  override getAttributes(): Map<string, any> {
    ...
    res.set('mod_HoodInsertion', this.mod_HoodInsertion);
  ...
  override loadJson(json: any, withSubModules: boolean = true, manufacturerMode: boolean) {
    ...
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_HoodInsertion');
      const val = _toBoolean(json['attributes']['mod_HoodInsertion'], 'mod_HoodInsertion');
      internal_leaveValidateVariant();
      this.mod_HoodInsertion = val;
    }
    {
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_HoodInsertion === undefined) {
      this.mod_HoodInsertion = false;
    }
  ...
  #prepareContextInternal = mc_Storageunit01_prepareContext;
  seal(): IModuleNonNull_mc_Storageunit01 {
  ...
  addOD_M_mc_HoodCarcaseParts01(index?: number): dc_mc_HoodCarcaseParts01 {
    var m = new OD_M_mc_HoodCarcaseParts01(this);
    m.dataCompletion();
    if (this._manufacturerMode) {
      m.manufacturerDataCompletion();
    }
  ...
  override validateSelections(): void {
    ...
    this.mod_LastFrontHeight_matrix = VariantValidation.mod_LastFrontHeight(this, this.mod_LastFrontHeight);
    this.mod_LastFrontName_matrix = VariantValidation.mod_LastFrontName(this, this.mod_LastFrontName);
    this.mod_HobHeightBlockedSpace_matrix = VariantValidation.mod_HobHeightBlockedSpace(this, this.mod_HobHeightBlockedSpace);
    ...
    this.mod_CarcaseMovement_matrix = VariantValidation.mod_CarcaseMovement(this, this.mod_CarcaseMovement);
    this.mod_HoodInsertion_matrix = VariantValidation.mod_HoodInsertion(this, this.mod_HoodInsertion);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Storageunit01_NonNull(this);
  ...
  addpart_Storageunit(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Storageunit_PartVarsWritable {
    var c = new P_part_Storageunit(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_Storageunit01_NonNull implements cbp_mc_Storageunit01, adc_mc_Storageunit01, ccm_mc_Storageunit01, IPartParentsNonNull_mc_Storageunit01, IPartParentsNonNull_mc_Cornerunit01_mc_FillerStraight01_mc_Storageunit01_mc_VertDivider01, IPartParentsNonNull_mc_FillerStraight01_mc_Storageunit01, IPartParentsNonNull_mc_PantryPullout01_mc_Storageunit01, IPartParentsNonNull_mc_CornerunitStraight01_mc_Storageunit01 {
  ...
  #calculateContainerModulesInternal = mc_Storageunit01_calculateContainerModules;
  ...
  get mod_HoodInsertion(): boolean {
    return this.#internalParent.mod_HoodInsertion!;
  }
  ...
  addOD_M_mc_HoodCarcaseParts01(index?: number): dc_mc_HoodCarcaseParts01 {
    return this.#internalParent.addOD_M_mc_HoodCarcaseParts01(index);
  }
}
