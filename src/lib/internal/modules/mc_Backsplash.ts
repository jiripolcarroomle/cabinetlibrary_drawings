...
import { IModVar_mod_BacksplashColor, IModVarNonNull_mod_BacksplashColor, IModVar_mod_BacksplashHeight, IModVarNonNull_mod_BacksplashHeight, IModVar_mod_BacksplashThk, IModVarNonNull_mod_BacksplashThk, IModVar_mod_BacksplashWidth, IModVarNonNull_mod_BacksplashWidth, IModVar_mod_BacksplashId, IModVarNonNull_mod_BacksplashId } from '../var-interfaces'
import { VariantValidation, IMatrix_mod_BacksplashColor, IMatrix_mod_BacksplashHeight, IMatrix_mod_BacksplashThk, IMatrix_mod_BacksplashWidth, IMatrix_mod_BacksplashId } from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_Backsplash, IPartAdd_part_BacksplashGroup } from '../part-add-interfaces';
import { mc_Backsplash_createBuildPlan, mc_Backsplash_afterDataCompletion, mc_Backsplash_manufacturerDataCompletion, mc_Backsplash_calculateContainerModules, mc_Backsplash_prepareContext } from '../../modules/mc_Backsplash';

export interface cbp_mc_Backsplash extends IModBaseProp
  , IPartAdd_part_Backsplash, IPartAdd_part_BacksplashGroup, IModVarNonNull_mod_BacksplashColor, IModVarNonNull_mod_BacksplashHeight, IModVarNonNull_mod_BacksplashThk, IModVarNonNull_mod_BacksplashWidth, IModVarNonNull_mod_BacksplashId {
...
export interface dc_mc_Backsplash extends IModBaseProp
  , IModVar_mod_BacksplashColor, IModVar_mod_BacksplashHeight, IModVar_mod_BacksplashThk, IModVar_mod_BacksplashWidth, IModVar_mod_BacksplashId {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
...
export interface pc_mc_Backsplash extends dc_mc_Backsplash {
...
export interface adc_base_mc_Backsplash extends IModBaseProp
  , IModVarNonNull_mod_BacksplashColor, IModVarNonNull_mod_BacksplashHeight, IModVarNonNull_mod_BacksplashThk, IModVarNonNull_mod_BacksplashWidth, IModVarNonNull_mod_BacksplashId {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_Backsplash extends adc_base_mc_Backsplash {
}

export interface ccm_mc_Backsplash extends adc_base_mc_Backsplash {
}


export class OD_M_mc_Backsplash extends OD_Base implements pc_mc_Backsplash, dc_mc_Backsplash
  ...
  override variants: string[] = ['mod_BacksplashColor', 'mod_BacksplashHeight', 'mod_BacksplashThk', 'mod_BacksplashWidth', 'mod_BacksplashId',];
  ...
  #mod_BacksplashId?: string;
  get mod_BacksplashId(): string | undefined { return this.#mod_BacksplashId }
  set mod_BacksplashId(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_BacksplashId' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_BacksplashId === value) return;
    this.#mod_BacksplashId = value;
  }

  mod_BacksplashId_matrix?: IMatrix_mod_BacksplashId;
  override getAttributes(): Map<string, any> {
    ...
    res.set('mod_BacksplashId', this.mod_BacksplashId);
    return res;
  }
  override loadJson(json: any, withSubModules: boolean = true, manufacturerMode: boolean) {
    ...
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_BacksplashId');
      const val = _toString(json['attributes']['mod_BacksplashId'], 'mod_BacksplashId');
      internal_leaveValidateVariant();
      this.mod_BacksplashId = val;
    }
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_BacksplashId === undefined) {
      this.mod_BacksplashId = "Backsplash01";
    }
  ...
  #prepareContextInternal = mc_Backsplash_prepareContext;
  seal(): IModuleNonNull_mc_Backsplash {
  ...
  override validateSelections(): void {
    this.mod_BacksplashColor_matrix = VariantValidation.mod_BacksplashColor(this, this.mod_BacksplashColor);
    this.mod_BacksplashHeight_matrix = VariantValidation.mod_BacksplashHeight(this, this.mod_BacksplashHeight);
    this.mod_BacksplashThk_matrix = VariantValidation.mod_BacksplashThk(this, this.mod_BacksplashThk);
    this.mod_BacksplashWidth_matrix = VariantValidation.mod_BacksplashWidth(this, this.mod_BacksplashWidth);
    this.mod_BacksplashId_matrix = VariantValidation.mod_BacksplashId(this, this.mod_BacksplashId);
  }

  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Backsplash_NonNull(this);
  ...
  addpart_Backsplash(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Backsplash_PartVarsWritable {
    var c = new P_part_Backsplash(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_BacksplashGroup(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_BacksplashGroup_PartVarsWritable {
    var c = new P_part_BacksplashGroup(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_Backsplash_NonNull implements cbp_mc_Backsplash, adc_mc_Backsplash, ccm_mc_Backsplash, IPartParentsNonNull_mc_Backsplash {
  ...
  #calculateContainerModulesInternal = mc_Backsplash_calculateContainerModules;
  ...
  get mod_BacksplashId(): string {
    return this.#internalParent.mod_BacksplashId!;
  }
}
