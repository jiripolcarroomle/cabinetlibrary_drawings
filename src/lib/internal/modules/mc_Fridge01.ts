...
import { IModuleNonNull_mc_Fridge01, IModParents_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood, IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood } from '../mod-interfaces'
import { IModVar_mod_CarcaseDepth, IModVarNonNull_mod_CarcaseDepth, IModVar_mod_CarcaseWidth, IModVarNonNull_mod_CarcaseWidth, IModVar_mod_CarcaseHeight, IModVarNonNull_mod_CarcaseHeight, IModVar_mod_Originpos, IModVarNonNull_mod_Originpos, IModVar_mod_FridgeGraphicId, IModVarNonNull_mod_FridgeGraphicId, IModVar_mod_FirstFront, IModVarNonNull_mod_FirstFront, IModVar_mod_LastFront, IModVarNonNull_mod_LastFront, IModVar_mod_FrontGapHorTop, IModVarNonNull_mod_FrontGapHorTop } from '../var-interfaces'
import { VariantValidation, IMatrix_mod_CarcaseDepth, IMatrix_mod_CarcaseWidth, IMatrix_mod_CarcaseHeight, IMatrix_mod_FridgeGraphicId, IMatrix_mod_FirstFront, IMatrix_mod_LastFront, IMatrix_mod_FrontGapHorTop } from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { mc_Fridge01_createBuildPlan, mc_Fridge01_afterDataCompletion, mc_Fridge01_manufacturerDataCompletion, mc_Fridge01_calculateContainerModules, mc_Fridge01_prepareContext } from '../../modules/mc_Fridge01';

export interface cbp_mc_Fridge01 extends IModBaseProp
  , IModVarNonNull_mod_CarcaseDepth, IModVarNonNull_mod_CarcaseWidth, IModVarNonNull_mod_CarcaseHeight, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_FridgeGraphicId, IModVarNonNull_mod_FirstFront, IModVarNonNull_mod_LastFront, IModVarNonNull_mod_FrontGapHorTop {
...
export interface dc_mc_Fridge01 extends IModBaseProp
  , IModVar_mod_CarcaseDepth, IModVar_mod_CarcaseWidth, IModVar_mod_CarcaseHeight, IModVar_mod_Originpos, IModVar_mod_FridgeGraphicId, IModVar_mod_FirstFront, IModVar_mod_LastFront, IModVar_mod_FrontGapHorTop {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
...
export interface pc_mc_Fridge01 extends dc_mc_Fridge01 {
...
export interface adc_base_mc_Fridge01 extends IModBaseProp
  , IModVarNonNull_mod_CarcaseDepth, IModVarNonNull_mod_CarcaseWidth, IModVarNonNull_mod_CarcaseHeight, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_FridgeGraphicId, IModVarNonNull_mod_FirstFront, IModVarNonNull_mod_LastFront, IModVarNonNull_mod_FrontGapHorTop {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_Fridge01 extends adc_base_mc_Fridge01 {
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic;
}

export interface ccm_mc_Fridge01 extends adc_base_mc_Fridge01 {
}


export class OD_M_mc_Fridge01 extends OD_Base implements pc_mc_Fridge01, dc_mc_Fridge01
  , IModParents_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood
  , IModVar_mod_CarcaseDepth, IModVar_mod_CarcaseWidth, IModVar_mod_CarcaseHeight, IModVar_mod_Originpos, IModVar_mod_FridgeGraphicId, IModVar_mod_FirstFront, IModVar_mod_LastFront, IModVar_mod_FrontGapHorTop {
  ...
  override variants: string[] = ['mod_CarcaseDepth', 'mod_CarcaseWidth', 'mod_CarcaseHeight', 'mod_Originpos', 'mod_FridgeGraphicId', 'mod_FirstFront', 'mod_LastFront', 'mod_FrontGapHorTop',];
  ...
  #prepareContextInternal = mc_Fridge01_prepareContext;
  seal(): IModuleNonNull_mc_Fridge01 {
  ...
  override validateSelections(): void {
    ...
    this.mod_FridgeGraphicId_matrix = VariantValidation.mod_FridgeGraphicId(this, this.mod_FridgeGraphicId);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Fridge01_NonNull(this);
...
class OD_M_mc_Fridge01_NonNull implements cbp_mc_Fridge01, adc_mc_Fridge01, ccm_mc_Fridge01, IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood {
  ...
  #calculateContainerModulesInternal = mc_Fridge01_calculateContainerModules;
