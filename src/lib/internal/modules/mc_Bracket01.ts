...
import { mc_Bracket01_createBuildPlan, mc_Bracket01_afterDataCompletion, mc_Bracket01_manufacturerDataCompletion, mc_Bracket01_calculateContainerModules, mc_Bracket01_prepareContext } from '../../modules/mc_Bracket01';
...
export interface pc_mc_Bracket01 extends dc_mc_Bracket01 {
...
export interface adc_base_mc_Bracket01 extends IModBaseProp
...
export interface adc_mc_Bracket01 extends adc_base_mc_Bracket01 {
}

export interface ccm_mc_Bracket01 extends adc_base_mc_Bracket01 {
}


export class OD_M_mc_Bracket01 extends OD_Base implements pc_mc_Bracket01, dc_mc_Bracket01
  ...
  #prepareContextInternal = mc_Bracket01_prepareContext;
  seal(): IModuleNonNull_mc_Bracket01 {
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Bracket01_NonNull(this);
  ...
  addpart_ShelvesBrackets(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_ShelvesBrackets_PartVarsWritable {
    var c = new P_part_ShelvesBrackets(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_Bracket01_NonNull implements cbp_mc_Bracket01, adc_mc_Bracket01, ccm_mc_Bracket01, IPartParentsNonNull_mc_Bracket01 {
  ...
  #calculateContainerModulesInternal = mc_Bracket01_calculateContainerModules;
