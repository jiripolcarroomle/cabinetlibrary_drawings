...
import { IModuleNonNull_mc_VertDivider01, IModParents_mc_Cornerunit01_mc_FillerStraight01_mc_Storageunit01_mc_VertDivider01, IModParents_mc_VertDivider01, IPartParentsNonNull_mc_Cornerunit01_mc_FillerStraight01_mc_Storageunit01_mc_VertDivider01, IPartParentsNonNull_mc_VertDivider01 } from '../mod-interfaces'
...
import { mc_VertDivider01_createBuildPlan, mc_VertDivider01_afterDataCompletion, mc_VertDivider01_manufacturerDataCompletion, mc_VertDivider01_calculateContainerModules, mc_VertDivider01_prepareContext } from '../../modules/mc_VertDivider01';

export interface cbp_mc_VertDivider01 extends IModBaseProp
  , IModVarNonNull_mod_VertDividerType, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_Width, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Height {
...
export interface pc_mc_VertDivider01 extends dc_mc_VertDivider01 {
...
export interface adc_base_mc_VertDivider01 extends IModBaseProp
  , IModVarNonNull_mod_VertDividerType, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_Width, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Height {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_VertDivider01 extends adc_base_mc_VertDivider01 {
  addOD_M_mc_CleatVert01(index?: number): dc_mc_CleatVert01;
  addOD_M_mc_StorageunitSidepanel01(index?: number): dc_mc_StorageunitSidepanel01;
}

export interface ccm_mc_VertDivider01 extends adc_base_mc_VertDivider01 {
}


export class OD_M_mc_VertDivider01 extends OD_Base implements pc_mc_VertDivider01, dc_mc_VertDivider01
  , IModParents_mc_Cornerunit01_mc_FillerStraight01_mc_Storageunit01_mc_VertDivider01, IModParents_mc_VertDivider01
  , IModVar_mod_VertDividerType, IModVar_mod_CarcaseId, IModVar_mod_ModuleName, IModVar_mod_Width, IModVar_mod_Depth, IModVar_mod_Height {
  ...
  override variants: string[] = ['mod_VertDividerType', 'mod_CarcaseId', 'mod_ModuleName', 'mod_Width', 'mod_Depth', 'mod_Height',];
  ...
  #prepareContextInternal = mc_VertDivider01_prepareContext;
  seal(): IModuleNonNull_mc_VertDivider01 {
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_VertDivider01_NonNull(this);
...
class OD_M_mc_VertDivider01_NonNull implements cbp_mc_VertDivider01, adc_mc_VertDivider01, ccm_mc_VertDivider01, IPartParentsNonNull_mc_Cornerunit01_mc_FillerStraight01_mc_Storageunit01_mc_VertDivider01, IPartParentsNonNull_mc_VertDivider01 {
  ...
  #calculateContainerModulesInternal = mc_VertDivider01_calculateContainerModules;
