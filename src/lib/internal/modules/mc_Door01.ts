...
export interface dc_mc_Door01 extends IModBaseProp
  ...
  addOD_M_mc_SegmentFront01(index?: number): dc_mc_SegmentFront01;
}

export interface pc_mc_Door01 extends dc_mc_Door01 {
...
export interface adc_base_mc_Door01 extends IModBaseProp
...
export interface adc_mc_Door01 extends adc_base_mc_Door01 {
  addOD_M_mc_FrontPanelGlass01(index?: number): dc_mc_FrontPanelGlass01;
  addOD_M_mc_FrontPanel01(index?: number): dc_mc_FrontPanel01;
  addOD_M_mc_Handle01(index?: number): dc_mc_Handle01;
  addOD_M_mc_Handlestrip01(index?: number): dc_mc_Handlestrip01;
...
export interface ccm_mc_Door01 extends adc_base_mc_Door01 {
}


export class OD_M_mc_Door01 extends OD_Base implements pc_mc_Door01, dc_mc_Door01
  ...
  #mod_HandleInsertion?: boolean;
  get mod_HandleInsertion(): boolean | undefined { return this.#mod_HandleInsertion }
  set mod_HandleInsertion(value: boolean | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_HandleInsertion' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_HandleInsertion === value) return;
    this.#mod_HandleInsertion = value;
  }

  mod_HandleInsertion_matrix?: IMatrix_mod_HandleInsertion;
  ...
  override getAttributes(): Map<string, any> {
    ...
    res.set('mod_HandleInsertion', this.mod_HandleInsertion);
  ...
  override loadJson(json: any, withSubModules: boolean = true, manufacturerMode: boolean) {
    ...
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_HandleInsertion');
      const val = _toBoolean(json['attributes']['mod_HandleInsertion'], 'mod_HandleInsertion');
      internal_leaveValidateVariant();
      this.mod_HandleInsertion = val;
    }
    {
  ...
  #dataCompletionAssignDerivedData() {
    ...
    if (this.mod_FrontSegmentDescriptor === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_FrontSegmentDescriptor')) {
          let pv = <IModVar_mod_FrontSegmentDescriptor>s;
          if (pv.mod_FrontSegmentDescriptor !== undefined) {
            this.mod_FrontSegmentDescriptor = (<IModVar_mod_FrontSegmentDescriptor>s).mod_FrontSegmentDescriptor;
            break;
          };
        }
        s = s.parentBase;
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_HandleInsertion === undefined) {
      this.mod_HandleInsertion = true;
    }
  ...
  #prepareContextInternal = mc_Door01_prepareContext;
  seal(): IModuleNonNull_mc_Door01 {
  ...
  addOD_M_mc_SegmentFront01(index?: number): dc_mc_SegmentFront01 {
    var m = new OD_M_mc_SegmentFront01(this);
    m.dataCompletion();
    if (this._manufacturerMode) {
      m.manufacturerDataCompletion();
    }
  ...
  override validateSelections(): void {
    ...
    this.mod_HandleInsertion_matrix = VariantValidation.mod_HandleInsertion(this, this.mod_HandleInsertion);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Door01_NonNull(this);
...
class OD_M_mc_Door01_NonNull implements cbp_mc_Door01, adc_mc_Door01, ccm_mc_Door01, IPartParentsNonNull_mc_BaseunitFridge01_mc_CornerFillerFront01_mc_Dishwasher01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_BaseunitFridge01_mc_CornerFillerFront01_mc_Dishwasher01_mc_Door01_mc_Drawer01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_Door01_mc_Drawer01_mc_Fliplift01, IPartParentsNonNull_mc_Door01_mc_HingeGroup01, IPartParentsNonNull_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01, IPartParentsNonNull_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_Fixedfront01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_Door01, IPartParentsNonNull_mc_Door01_mc_Fliplift01 {
  ...
  #calculateContainerModulesInternal = mc_Door01_calculateContainerModules;
  ...
  get mod_HandleInsertion(): boolean {
    return this.#internalParent.mod_HandleInsertion!;
  }
  ...
  addOD_M_mc_SegmentFront01(index?: number): dc_mc_SegmentFront01 {
    return this.#internalParent.addOD_M_mc_SegmentFront01(index);
  }
}
