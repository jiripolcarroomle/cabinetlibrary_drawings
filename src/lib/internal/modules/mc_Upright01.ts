...
import { IModParents_mr_StorageunitSingle_mr_Upright } from '../mod-interfaces'
...
import { IModVar_mod_UprightColor, IModVarNonNull_mod_UprightColor, IModVar_mod_UprightFloorProfileColor, IModVarNonNull_mod_UprightFloorProfileColor, IModVar_mod_PlinthAreaHeight, IModVarNonNull_mod_PlinthAreaHeight, IModVar_mod_UprightThk, IModVarNonNull_mod_UprightThk, IModVar_mod_UprightOverhang, IModVarNonNull_mod_UprightOverhang, IModVar_mod_UprightSide, IModVarNonNull_mod_UprightSide, IModVar_mod_Height, IModVarNonNull_mod_Height, IModVar_mod_Depth, IModVarNonNull_mod_Depth, IModVar_mod_UprightConstruction, IModVarNonNull_mod_UprightConstruction, IModVar_mod_TypeElement, IModVarNonNull_mod_TypeElement, IModVar_mod_UprightProgram, IModVarNonNull_mod_UprightProgram, IModVar_mod_UprightOverdimensionBtm, IModVarNonNull_mod_UprightOverdimensionBtm, IModVar_mod_UprightOverdimensionTop, IModVarNonNull_mod_UprightOverdimensionTop } from '../var-interfaces'
import { VariantValidation, IMatrix_mod_UprightColor, IMatrix_mod_UprightFloorProfileColor, IMatrix_mod_PlinthAreaHeight, IMatrix_mod_UprightThk, IMatrix_mod_UprightOverhang, IMatrix_mod_UprightSide, IMatrix_mod_Height, IMatrix_mod_Depth, IMatrix_mod_UprightConstruction, IMatrix_mod_TypeElement, IMatrix_mod_UprightProgram, IMatrix_mod_UprightOverdimensionBtm, IMatrix_mod_UprightOverdimensionTop } from '../selections'
...
import { mc_Upright01_createBuildPlan, mc_Upright01_afterDataCompletion, mc_Upright01_manufacturerDataCompletion, mc_Upright01_calculateContainerModules, mc_Upright01_prepareContext } from '../../modules/mc_Upright01';

export interface cbp_mc_Upright01 extends IModBaseProp
  , IPartAdd_part_FinishPanel, IPartAdd_part_FinishPanelProfile, IPartAdd_part_UprightGroup, IModVarNonNull_mod_UprightColor, IModVarNonNull_mod_UprightFloorProfileColor, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_UprightThk, IModVarNonNull_mod_UprightOverhang, IModVarNonNull_mod_UprightSide, IModVarNonNull_mod_Height, IModVarNonNull_mod_Depth, IModVarNonNull_mod_UprightConstruction, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_UprightProgram, IModVarNonNull_mod_UprightOverdimensionBtm, IModVarNonNull_mod_UprightOverdimensionTop {
  parent: IModParents_mr_StorageunitSingle_mr_Upright;
...
export interface dc_mc_Upright01 extends IModBaseProp
  , IModVar_mod_UprightColor, IModVar_mod_UprightFloorProfileColor, IModVar_mod_PlinthAreaHeight, IModVar_mod_UprightThk, IModVar_mod_UprightOverhang, IModVar_mod_UprightSide, IModVar_mod_Height, IModVar_mod_Depth, IModVar_mod_UprightConstruction, IModVar_mod_TypeElement, IModVar_mod_UprightProgram, IModVar_mod_UprightOverdimensionBtm, IModVar_mod_UprightOverdimensionTop {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
...
export interface pc_mc_Upright01 extends dc_mc_Upright01 {
...
export interface adc_base_mc_Upright01 extends IModBaseProp
  , IModVarNonNull_mod_UprightColor, IModVarNonNull_mod_UprightFloorProfileColor, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_UprightThk, IModVarNonNull_mod_UprightOverhang, IModVarNonNull_mod_UprightSide, IModVarNonNull_mod_Height, IModVarNonNull_mod_Depth, IModVarNonNull_mod_UprightConstruction, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_UprightProgram, IModVarNonNull_mod_UprightOverdimensionBtm, IModVarNonNull_mod_UprightOverdimensionTop {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_Upright01 extends adc_base_mc_Upright01 {
}

export interface ccm_mc_Upright01 extends adc_base_mc_Upright01 {
}


export class OD_M_mc_Upright01 extends OD_Base implements pc_mc_Upright01, dc_mc_Upright01
  , IModParents_mc_Upright01
  , IModVar_mod_UprightColor, IModVar_mod_UprightFloorProfileColor, IModVar_mod_PlinthAreaHeight, IModVar_mod_UprightThk, IModVar_mod_UprightOverhang, IModVar_mod_UprightSide, IModVar_mod_Height, IModVar_mod_Depth, IModVar_mod_UprightConstruction, IModVar_mod_TypeElement, IModVar_mod_UprightProgram, IModVar_mod_UprightOverdimensionBtm, IModVar_mod_UprightOverdimensionTop {
  constructor(parent: IModParents_mr_StorageunitSingle_mr_Upright, manufacturerMode?: boolean) {
  ...
  override variants: string[] = ['mod_UprightColor', 'mod_UprightFloorProfileColor', 'mod_PlinthAreaHeight', 'mod_UprightThk', 'mod_UprightOverhang', 'mod_UprightSide', 'mod_Height', 'mod_Depth', 'mod_UprightConstruction', 'mod_TypeElement', 'mod_UprightProgram', 'mod_UprightOverdimensionBtm', 'mod_UprightOverdimensionTop',];
  ...
  #dataCompletionAssignDerivedData() {
    ...
    if (this.mod_UprightProgram === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_UprightProgram')) {
          let pv = <IModVar_mod_UprightProgram>s;
          if (pv.mod_UprightProgram !== undefined) {
            this.mod_UprightProgram = (<IModVar_mod_UprightProgram>s).mod_UprightProgram;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_UprightOverdimensionBtm === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_UprightOverdimensionBtm')) {
          let pv = <IModVar_mod_UprightOverdimensionBtm>s;
          if (pv.mod_UprightOverdimensionBtm !== undefined) {
            this.mod_UprightOverdimensionBtm = (<IModVar_mod_UprightOverdimensionBtm>s).mod_UprightOverdimensionBtm;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_UprightOverdimensionTop === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_UprightOverdimensionTop')) {
          let pv = <IModVar_mod_UprightOverdimensionTop>s;
          if (pv.mod_UprightOverdimensionTop !== undefined) {
            this.mod_UprightOverdimensionTop = (<IModVar_mod_UprightOverdimensionTop>s).mod_UprightOverdimensionTop;
            break;
          };
        }
        s = s.parentBase;
  ...
  #prepareContextInternal = mc_Upright01_prepareContext;
  seal(): IModuleNonNull_mc_Upright01 {
  ...
  override validateSelections(): void {
    ...
    this.mod_UprightSide_matrix = VariantValidation.mod_UprightSide(this, this.mod_UprightSide);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Upright01_NonNull(this);
  ...
  addpart_FinishPanel(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_FinishPanel_PartVarsWritable {
    var c = new P_part_FinishPanel(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_FinishPanelProfile(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_FinishPanelProfile_PartVarsWritable {
    var c = new P_part_FinishPanelProfile(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_UprightGroup(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_UprightGroup_PartVarsWritable {
    var c = new P_part_UprightGroup(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_Upright01_NonNull implements cbp_mc_Upright01, adc_mc_Upright01, ccm_mc_Upright01, IPartParentsNonNull_mc_Upright01 {
  ...
  #calculateContainerModulesInternal = mc_Upright01_calculateContainerModules;
