...
import { mc_Pushtoopen01_createBuildPlan, mc_Pushtoopen01_afterDataCompletion, mc_Pushtoopen01_manufacturerDataCompletion, mc_Pushtoopen01_calculateContainerModules, mc_Pushtoopen01_prepareContext } from '../../modules/mc_Pushtoopen01';
...
export interface dc_mc_Pushtoopen01 extends IModBaseProp
  , IModVar_mod_PushtoopenInfo, IModVar_mod_FrontGapCarcase, IModVar_mod_CarcasePartInfo, IModVar_mod_FrontPosStart, IModVar_mod_PushtoopenLine, IModVar_mod_Originpos, IModVar_mod_FrontGapVert, IModVar_mod_FrontId {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
...
export interface pc_mc_Pushtoopen01 extends dc_mc_Pushtoopen01 {
...
export interface adc_base_mc_Pushtoopen01 extends IModBaseProp
  , IModVarNonNull_mod_PushtoopenInfo, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_CarcasePartInfo, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_PushtoopenLine, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontId {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_Pushtoopen01 extends adc_base_mc_Pushtoopen01 {
}

export interface ccm_mc_Pushtoopen01 extends adc_base_mc_Pushtoopen01 {
}


export class OD_M_mc_Pushtoopen01 extends OD_Base implements pc_mc_Pushtoopen01, dc_mc_Pushtoopen01
  ...
  override variants: string[] = ['mod_PushtoopenInfo', 'mod_FrontGapCarcase', 'mod_CarcasePartInfo', 'mod_FrontPosStart', 'mod_PushtoopenLine', 'mod_Originpos', 'mod_FrontGapVert', 'mod_FrontId',];
  ...
  #prepareContextInternal = mc_Pushtoopen01_prepareContext;
  seal(): IModuleNonNull_mc_Pushtoopen01 {
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Pushtoopen01_NonNull(this);
  ...
  addpart_Pushtoopen(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Pushtoopen_PartVarsWritable {
    var c = new P_part_Pushtoopen(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_PushtoopenDrill(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_PushtoopenDrill_PartVarsWritable {
    var c = new P_part_PushtoopenDrill(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_PushtoopenBom(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_PushtoopenBom_PartVarsWritable {
    var c = new P_part_PushtoopenBom(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_PushtoopenMountingPlateDrill(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_PushtoopenMountingPlateDrill_PartVarsWritable {
    var c = new P_part_PushtoopenMountingPlateDrill(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_Pushtoopen01_NonNull implements cbp_mc_Pushtoopen01, adc_mc_Pushtoopen01, ccm_mc_Pushtoopen01, IPartParentsNonNull_mc_Pushtoopen01 {
  ...
  #calculateContainerModulesInternal = mc_Pushtoopen01_calculateContainerModules;
