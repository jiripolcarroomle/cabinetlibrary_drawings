...
import { IModParents_me_ClothingOrganizer01 } from '../mod-interfaces'
import { IP_part_ClothingOrganizerDrilling_PartVarsWritable, P_part_ClothingOrganizerDrilling } from '../parts/part_ClothingOrganizerDrilling'
import { IP_part_ClothingOrganizerGraphic_PartVarsWritable, P_part_ClothingOrganizerGraphic } from '../parts/part_ClothingOrganizerGraphic'
import { IP_part_ClothingOrganizerUnit_PartVarsWritable, P_part_ClothingOrganizerUnit } from '../parts/part_ClothingOrganizerUnit'
import { IP_part_ClothingOrganizerBOM_PartVarsWritable, P_part_ClothingOrganizerBOM } from '../parts/part_ClothingOrganizerBOM'
import { IModuleNonNull_mc_ClothingOrganizerHardware01, IModParents_mc_ClothingOrganizerHardware01_me_ClothingOrganizer01, IModParents_mc_ClothingOrganizerHardware01, IPartParentsNonNull_mc_ClothingOrganizerHardware01_me_ClothingOrganizer01, IPartParentsNonNull_mc_ClothingOrganizerHardware01 } from '../mod-interfaces'
import { IModVar_mod_Depth, IModVarNonNull_mod_Depth, IModVar_mod_Height, IModVarNonNull_mod_Height, IModVar_mod_Width, IModVarNonNull_mod_Width, IModVar_mod_Information, IModVarNonNull_mod_Information, IModVar_mod_FrontId, IModVarNonNull_mod_FrontId } from '../var-interfaces'
import { VariantValidation, IMatrix_mod_Depth, IMatrix_mod_Height, IMatrix_mod_Width, IMatrix_mod_Information, IMatrix_mod_FrontId } from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_ClothingOrganizerDrilling, IPartAdd_part_ClothingOrganizerGraphic, IPartAdd_part_ClothingOrganizerUnit, IPartAdd_part_ClothingOrganizerBOM } from '../part-add-interfaces';
import { mc_ClothingOrganizerHardware01_createBuildPlan, mc_ClothingOrganizerHardware01_afterDataCompletion, mc_ClothingOrganizerHardware01_manufacturerDataCompletion, mc_ClothingOrganizerHardware01_calculateContainerModules, mc_ClothingOrganizerHardware01_prepareContext } from '../../modules/mc_ClothingOrganizerHardware01';

export interface cbp_mc_ClothingOrganizerHardware01 extends IModBaseProp
  , IPartAdd_part_ClothingOrganizerDrilling, IPartAdd_part_ClothingOrganizerGraphic, IPartAdd_part_ClothingOrganizerUnit, IPartAdd_part_ClothingOrganizerBOM, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Height, IModVarNonNull_mod_Width, IModVarNonNull_mod_Information, IModVarNonNull_mod_FrontId {
  parent: IModParents_me_ClothingOrganizer01;
...
export interface dc_mc_ClothingOrganizerHardware01 extends IModBaseProp
  , IModVar_mod_Depth, IModVar_mod_Height, IModVar_mod_Width, IModVar_mod_Information, IModVar_mod_FrontId {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
  seal(): IModuleNonNull_mc_ClothingOrganizerHardware01;
  parent: IModParents_me_ClothingOrganizer01;
}

export interface pc_mc_ClothingOrganizerHardware01 extends dc_mc_ClothingOrganizerHardware01 {
...
export interface adc_base_mc_ClothingOrganizerHardware01 extends IModBaseProp
  , IModVarNonNull_mod_Depth, IModVarNonNull_mod_Height, IModVarNonNull_mod_Width, IModVarNonNull_mod_Information, IModVarNonNull_mod_FrontId {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_ClothingOrganizerHardware01 extends adc_base_mc_ClothingOrganizerHardware01 {
}

export interface ccm_mc_ClothingOrganizerHardware01 extends adc_base_mc_ClothingOrganizerHardware01 {
}


export class OD_M_mc_ClothingOrganizerHardware01 extends OD_Base implements pc_mc_ClothingOrganizerHardware01, dc_mc_ClothingOrganizerHardware01
  , IModParents_mc_ClothingOrganizerHardware01_me_ClothingOrganizer01, IModParents_mc_ClothingOrganizerHardware01
  , IModVar_mod_Depth, IModVar_mod_Height, IModVar_mod_Width, IModVar_mod_Information, IModVar_mod_FrontId {
  constructor(parent: IModParents_me_ClothingOrganizer01, manufacturerMode?: boolean) {
    super('mc_ClothingOrganizerHardware01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_ClothingOrganizerHardware01_NonNull(this);
  }
  parent: IModParents_me_ClothingOrganizer01;
  _selfNonNull: OD_M_mc_ClothingOrganizerHardware01_NonNull;

  override variants: string[] = ['mod_Depth', 'mod_Height', 'mod_Width', 'mod_Information', 'mod_FrontId',];
  #mod_Depth?: number;
  ...
  #manufacturerDataCompletionInternal = mc_ClothingOrganizerHardware01_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_ClothingOrganizerHardware01_NonNull(this);
  ...
  #prepareContextInternal = mc_ClothingOrganizerHardware01_prepareContext;
  seal(): IModuleNonNull_mc_ClothingOrganizerHardware01 {
    this.afterDataCompletion();
    const adc = new OD_M_mc_ClothingOrganizerHardware01_NonNull(this);
    return adc;
  }
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_ClothingOrganizerHardware01_NonNull(this);
  ...
  addpart_ClothingOrganizerDrilling(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_ClothingOrganizerDrilling_PartVarsWritable {
    var c = new P_part_ClothingOrganizerDrilling(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_ClothingOrganizerGraphic(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_ClothingOrganizerGraphic_PartVarsWritable {
    var c = new P_part_ClothingOrganizerGraphic(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  ...
  addpart_ClothingOrganizerBOM(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_ClothingOrganizerBOM_PartVarsWritable {
    var c = new P_part_ClothingOrganizerBOM(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }

  override createBuildPlan(): void {
    var cbp = new OD_M_mc_ClothingOrganizerHardware01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_ClothingOrganizerHardware01_NonNull implements cbp_mc_ClothingOrganizerHardware01, adc_mc_ClothingOrganizerHardware01, ccm_mc_ClothingOrganizerHardware01, IPartParentsNonNull_mc_ClothingOrganizerHardware01_me_ClothingOrganizer01, IPartParentsNonNull_mc_ClothingOrganizerHardware01 {
  constructor(parent: OD_M_mc_ClothingOrganizerHardware01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_ClothingOrganizerHardware01;
  ...
  #createBuildPlanInternal = mc_ClothingOrganizerHardware01_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_ClothingOrganizerHardware01_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = mc_ClothingOrganizerHardware01_calculateContainerModules;
  ...
  parent: IModParents_me_ClothingOrganizer01;
  addpart_ClothingOrganizerDrilling(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_ClothingOrganizerDrilling_PartVarsWritable {
    return this.#internalParent.addpart_ClothingOrganizerDrilling(x, y, z, dimx, dimy, dimz);
  }
  addpart_ClothingOrganizerGraphic(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_ClothingOrganizerGraphic_PartVarsWritable {
    return this.#internalParent.addpart_ClothingOrganizerGraphic(x, y, z, dimx, dimy, dimz);
  }
  addpart_ClothingOrganizerUnit(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_ClothingOrganizerUnit_PartVarsWritable {
    return this.#internalParent.addpart_ClothingOrganizerUnit(x, y, z, dimx, dimy, dimz);
  }
  addpart_ClothingOrganizerBOM(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_ClothingOrganizerBOM_PartVarsWritable {
    return this.#internalParent.addpart_ClothingOrganizerBOM(x, y, z, dimx, dimy, dimz);
  }
