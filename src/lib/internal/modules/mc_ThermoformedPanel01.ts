...
import { mc_ThermoformedPanel01_createBuildPlan, mc_ThermoformedPanel01_afterDataCompletion, mc_ThermoformedPanel01_manufacturerDataCompletion, mc_ThermoformedPanel01_calculateContainerModules } from '../../modules/mc_ThermoformedPanel01';
...
export interface adc_mc_ThermoformedPanel01 extends adc_base_mc_ThermoformedPanel01 {
}

export interface ccm_mc_ThermoformedPanel01 extends adc_base_mc_ThermoformedPanel01 {
}
...
export class OD_M_mc_ThermoformedPanel01 extends OD_Base implements dc_mc_ThermoformedPanel01
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_ThermoformedPanel01_NonNull(this);
...
class OD_M_mc_ThermoformedPanel01_NonNull implements cbp_mc_ThermoformedPanel01, adc_mc_ThermoformedPanel01, ccm_mc_ThermoformedPanel01 {
  ...
  #calculateContainerModulesInternal = mc_ThermoformedPanel01_calculateContainerModules;
