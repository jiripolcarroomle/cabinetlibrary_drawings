...
import { mc_Shelves01_createBuildPlan, mc_Shelves01_afterDataCompletion, mc_Shelves01_manufacturerDataCompletion, mc_Shelves01_calculateContainerModules, mc_Shelves01_prepareContext } from '../../modules/mc_Shelves01';
...
export interface pc_mc_Shelves01 extends dc_mc_Shelves01 {
...
export interface adc_base_mc_Shelves01 extends IModBaseProp
...
export interface adc_mc_Shelves01 extends adc_base_mc_Shelves01 {
}

export interface ccm_mc_Shelves01 extends adc_base_mc_Shelves01 {
}


export class OD_M_mc_Shelves01 extends OD_Base implements pc_mc_Shelves01, dc_mc_Shelves01
  ...
  #prepareContextInternal = mc_Shelves01_prepareContext;
  seal(): IModuleNonNull_mc_Shelves01 {
  ...
  override validateSelections(): void {
    ...
    this.mod_ShelvesThk_matrix = VariantValidation.mod_ShelvesThk(this, this.mod_ShelvesThk);
    this.mod_ShelvesColor_matrix = VariantValidation.mod_ShelvesColor(this, this.mod_ShelvesColor);
    this.mod_ShelvesBrackets_matrix = VariantValidation.mod_ShelvesBrackets(this, this.mod_ShelvesBrackets);
    this.mod_ShelvesBracketsColor_matrix = VariantValidation.mod_ShelvesBracketsColor(this, this.mod_ShelvesBracketsColor);
  }

  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Shelves01_NonNull(this);
  ...
  addpart_Shelves(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Shelves_PartVarsWritable {
    var c = new P_part_Shelves(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_Shelves01_NonNull implements cbp_mc_Shelves01, adc_mc_Shelves01, ccm_mc_Shelves01, IPartParentsNonNull_mc_Shelves01 {
  ...
  #calculateContainerModulesInternal = mc_Shelves01_calculateContainerModules;
