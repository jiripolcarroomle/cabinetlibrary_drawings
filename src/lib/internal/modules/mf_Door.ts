...
import { IModParents_md_FrontArticleBuilder_md_FrontPlaceholder_mr_CornerunitStraight_mr_StorageunitSingle } from '../mod-interfaces'
...
export interface pc_mf_Door extends dc_mf_Door {
...
export interface adc_base_mf_Door extends IModBaseProp
  , IModVarNonNull_mod_BackwallPos, IModVarNonNull_mod_CarcaseBackwallConstruction, IModVarNonNull_mod_CarcaseDepth, IModVarNonNull_mod_CarcaseHeight, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseWidth, IModVarNonNull_mod_DoorDirection, IModVarNonNull_mod_DoorType, IModVarNonNull_mod_FingergripTop, IModVarNonNull_mod_FrontHeight, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontSplit, IModVarNonNull_mod_FrontThk, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_HandleDrill, IModVarNonNull_mod_HandleLine, IModVarNonNull_mod_HandlePosLogic, IModVarNonNull_mod_HingePos1, IModVarNonNull_mod_HingePos2, IModVarNonNull_mod_HingePos3, IModVarNonNull_mod_HingePos4, IModVarNonNull_mod_HingePos5, IModVarNonNull_mod_HingePos6, IModVarNonNull_mod_FrontQtyElements, IModVarNonNull_mod_ShelffixedThk, IModVarNonNull_mod_ShelffixedType, IModVarNonNull_mod_SidepanelleftThk, IModVarNonNull_mod_SidepanelrightThk, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontOversizeBtm, IModVarNonNull_mod_FrontOversizeLeft, IModVarNonNull_mod_FrontOversizeRight, IModVarNonNull_mod_FrontOversizeTop, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_FrontSplitHeight1, IModVarNonNull_mod_FrontSplitHeight2, IModVarNonNull_mod_FrontSplitHeight3, IModVarNonNull_mod_FrontSplitType1, IModVarNonNull_mod_FrontSplitType2, IModVarNonNull_mod_HandleColor, IModVarNonNull_mod_HandleLength, IModVarNonNull_mod_HandleOffsetX, IModVarNonNull_mod_HandleOffsetY, IModVarNonNull_mod_HandlePosMatrix, IModVarNonNull_mod_HandlePosType, IModVarNonNull_mod_HandlestripPos, IModVarNonNull_mod_HeightPosInsertion, IModVarNonNull_mod_HingeType, IModVarNonNull_mod_ShelfadjDrillDistance, IModVarNonNull_mod_ShelfadjDrillType, IModVarNonNull_mod_ShelfadjOffsetBack, IModVarNonNull_mod_ShelfadjOffsetFront, IModVarNonNull_mod_ShelfadjThk, IModVarNonNull_mod_ShelffixedBtm, IModVarNonNull_mod_ShelffixedPos, IModVarNonNull_mod_ShelffixedOffsetFront, IModVarNonNull_mod_ShelffixedOversizeFront, IModVarNonNull_mod_ShelffixedOversizeBack, IModVarNonNull_mod_HandleDesign, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_ShelfadjDesign, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_FrontGapHorTop, IModVarNonNull_mod_HingeLogic, IModVarNonNull_mod_FingergripTopType, IModVarNonNull_mod_FingergripBtmType, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_MountingPlateType, IModVarNonNull_mod_InteriorEquipmentHinge, IModVarNonNull_mod_HingeColor, IModVarNonNull_mod_ShelffixedTop, IModVarNonNull_mod_VertDividerType, IModVarNonNull_mod_SidepanelmiddleThk, IModVarNonNull_mod_FrontDescriptor, IModVarNonNull_mod_CarcaseFrontConstruction, IModVarNonNull_mod_CarcaseSpaceDimension, IModVarNonNull_mod_CarcaseDirectionInfo, IModVarNonNull_mod_CarcasePartInfo, IModVarNonNull_mod_VertDividerInfoList, IModVarNonNull_mod_PushtoopenLine, IModVarNonNull_mod_PushtoopenOffset, IModVarNonNull_mod_PushtoopenPosition, IModVarNonNull_mod_PushtoopenType, IModVarNonNull_mod_PushtoopenColor, IModVarNonNull_mod_OpeningType, IModVarNonNull_mod_FrontHeightSelection, IModVarNonNull_mod_ShelfadjColor, IModVarNonNull_mod_ShelfadjDescriptor, IModVarNonNull_mod_FrameFillingColor, IModVarNonNull_mod_FrameFillingType, IModVarNonNull_mod_FirstFront, IModVarNonNull_mod_LastFront, IModVarNonNull_mod_HandlePosMatrixMultiple, IModVarNonNull_mod_FrontSegmentType, IModVarNonNull_mod_FrontSegmentColor, IModVarNonNull_mod_FrontSegmentDescriptor, IModVarNonNull_mod_DoorDirectionSelection, IModVarNonNull_mod_Information, IModVarNonNull_mod_DoorTypeSelection {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mf_Door extends adc_base_mf_Door {
  addOD_M_mc_Door01(index?: number): dc_mc_Door01;
  addOD_M_mc_ShelfadjGroup01(index?: number): dc_mc_ShelfadjGroup01;
  addOD_M_me_ShelfadjMultiple01(index?: number): dc_me_ShelfadjMultiple01;
  addOD_M_me_ClothingOrganizer01(index?: number): dc_me_ClothingOrganizer01;
...
export interface ccm_mf_Door extends adc_base_mf_Door {
  addOD_M_md_EquipmentPlaceholder(index?: number): dc_md_EquipmentPlaceholder;
}


export class OD_M_mf_Door extends OD_Base implements pc_mf_Door, dc_mf_Door
  , IModParents_mf_Door_mf_Fridge, IModParents_mf_Door_mf_Fliplift_mf_RackArea, IModParents_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_mf_Door_mf_Fliplift_mf_RackArea, IModParents_mf_Door
  , IModVar_mod_BackwallPos, IModVar_mod_CarcaseBackwallConstruction, IModVar_mod_CarcaseDepth, IModVar_mod_CarcaseHeight, IModVar_mod_CarcaseId, IModVar_mod_CarcaseWidth, IModVar_mod_DoorDirection, IModVar_mod_DoorType, IModVar_mod_FingergripTop, IModVar_mod_FrontHeight, IModVar_mod_FrontId, IModVar_mod_FrontSplit, IModVar_mod_FrontThk, IModVar_mod_FrontWidth, IModVar_mod_HandleDrill, IModVar_mod_HandleLine, IModVar_mod_HandlePosLogic, IModVar_mod_HingePos1, IModVar_mod_HingePos2, IModVar_mod_HingePos3, IModVar_mod_HingePos4, IModVar_mod_HingePos5, IModVar_mod_HingePos6, IModVar_mod_FrontQtyElements, IModVar_mod_ShelffixedThk, IModVar_mod_ShelffixedType, IModVar_mod_SidepanelleftThk, IModVar_mod_SidepanelrightThk, IModVar_mod_FrontPosStart, IModVar_mod_FrontColor, IModVar_mod_FrontEdgeColor, IModVar_mod_FrontEdgeThk, IModVar_mod_FrontGapCarcase, IModVar_mod_FrontGapHor, IModVar_mod_FrontGapVert, IModVar_mod_FrontOversizeBtm, IModVar_mod_FrontOversizeLeft, IModVar_mod_FrontOversizeRight, IModVar_mod_FrontOversizeTop, IModVar_mod_FrontProgram, IModVar_mod_FrontSplitHeight1, IModVar_mod_FrontSplitHeight2, IModVar_mod_FrontSplitHeight3, IModVar_mod_FrontSplitType1, IModVar_mod_FrontSplitType2, IModVar_mod_HandleColor, IModVar_mod_HandleLength, IModVar_mod_HandleOffsetX, IModVar_mod_HandleOffsetY, IModVar_mod_HandlePosMatrix, IModVar_mod_HandlePosType, IModVar_mod_HandlestripPos, IModVar_mod_HeightPosInsertion, IModVar_mod_HingeType, IModVar_mod_ShelfadjDrillDistance, IModVar_mod_ShelfadjDrillType, IModVar_mod_ShelfadjOffsetBack, IModVar_mod_ShelfadjOffsetFront, IModVar_mod_ShelfadjThk, IModVar_mod_ShelffixedBtm, IModVar_mod_ShelffixedPos, IModVar_mod_ShelffixedOffsetFront, IModVar_mod_ShelffixedOversizeFront, IModVar_mod_ShelffixedOversizeBack, IModVar_mod_HandleDesign, IModVar_mod_FrontDesign, IModVar_mod_ShelfadjDesign, IModVar_mod_Originpos, IModVar_mod_PlinthAreaHeight, IModVar_mod_ParentName, IModVar_mod_ModuleName, IModVar_mod_FrontGapHorTop, IModVar_mod_HingeLogic, IModVar_mod_FingergripTopType, IModVar_mod_FingergripBtmType, IModVar_mod_TypeElement, IModVar_mod_MountingPlateType, IModVar_mod_InteriorEquipmentHinge, IModVar_mod_HingeColor, IModVar_mod_ShelffixedTop, IModVar_mod_VertDividerType, IModVar_mod_SidepanelmiddleThk, IModVar_mod_FrontDescriptor, IModVar_mod_CarcaseFrontConstruction, IModVar_mod_CarcaseSpaceDimension, IModVar_mod_CarcaseDirectionInfo, IModVar_mod_CarcasePartInfo, IModVar_mod_VertDividerInfoList, IModVar_mod_PushtoopenLine, IModVar_mod_PushtoopenOffset, IModVar_mod_PushtoopenPosition, IModVar_mod_PushtoopenType, IModVar_mod_PushtoopenColor, IModVar_mod_OpeningType, IModVar_mod_FrontHeightSelection, IModVar_mod_ShelfadjColor, IModVar_mod_ShelfadjDescriptor, IModVar_mod_FrameFillingColor, IModVar_mod_FrameFillingType, IModVar_mod_FirstFront, IModVar_mod_LastFront, IModVar_mod_HandlePosMatrixMultiple, IModVar_mod_FrontSegmentType, IModVar_mod_FrontSegmentColor, IModVar_mod_FrontSegmentDescriptor, IModVar_mod_DoorDirectionSelection, IModVar_mod_Information, IModVar_mod_DoorTypeSelection {
  ...
  #mod_FrontSegmentType?: string;
  get mod_FrontSegmentType(): string | undefined { return this.#mod_FrontSegmentType }
  set mod_FrontSegmentType(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_FrontSegmentType' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_FrontSegmentType === value) return;
    this.#mod_FrontSegmentType = value;
  }

  mod_FrontSegmentType_matrix?: IMatrix_mod_FrontSegmentType;
  #mod_FrontSegmentColor?: string;
  get mod_FrontSegmentColor(): string | undefined { return this.#mod_FrontSegmentColor }
  set mod_FrontSegmentColor(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_FrontSegmentColor' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_FrontSegmentColor === value) return;
    this.#mod_FrontSegmentColor = value;
  }

  mod_FrontSegmentColor_matrix?: IMatrix_mod_FrontSegmentColor;
  #mod_FrontSegmentDescriptor?: string;
  get mod_FrontSegmentDescriptor(): string | undefined { return this.#mod_FrontSegmentDescriptor }
  set mod_FrontSegmentDescriptor(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_FrontSegmentDescriptor' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_FrontSegmentDescriptor === value) return;
    this.#mod_FrontSegmentDescriptor = value;
  }

  mod_FrontSegmentDescriptor_matrix?: IMatrix_mod_FrontSegmentDescriptor;
  #mod_DoorDirectionSelection?: string;
  get mod_DoorDirectionSelection(): string | undefined { return this.#mod_DoorDirectionSelection }
  set mod_DoorDirectionSelection(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_DoorDirectionSelection' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_DoorDirectionSelection === value) return;
    this.#mod_DoorDirectionSelection = value;
  }

  mod_DoorDirectionSelection_matrix?: IMatrix_mod_DoorDirectionSelection;
  ...
  #mod_DoorTypeSelection?: string;
  get mod_DoorTypeSelection(): string | undefined { return this.#mod_DoorTypeSelection }
  set mod_DoorTypeSelection(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_DoorTypeSelection' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_DoorTypeSelection === value) return;
    this.#mod_DoorTypeSelection = value;
  }

  mod_DoorTypeSelection_matrix?: IMatrix_mod_DoorTypeSelection;
  override getAttributes(): Map<string, any> {
    ...
    res.set('mod_DoorDirectionSelection', this.mod_DoorDirectionSelection);
    res.set('mod_Information', this.mod_Information);
    res.set('mod_DoorTypeSelection', this.mod_DoorTypeSelection);
    return res;
  }
  ...
  override loadJson(json: any, withSubModules: boolean = true, manufacturerMode: boolean) {
    ...
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_FrontSegmentType');
      const val = _toString(json['attributes']['mod_FrontSegmentType'], 'mod_FrontSegmentType');
      internal_leaveValidateVariant();
      this.mod_FrontSegmentType = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_FrontSegmentColor');
      const val = _toString(json['attributes']['mod_FrontSegmentColor'], 'mod_FrontSegmentColor');
      internal_leaveValidateVariant();
      this.mod_FrontSegmentColor = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_FrontSegmentDescriptor');
      const val = _toString(json['attributes']['mod_FrontSegmentDescriptor'], 'mod_FrontSegmentDescriptor');
      internal_leaveValidateVariant();
      this.mod_FrontSegmentDescriptor = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_DoorDirectionSelection');
      const val = _toString(json['attributes']['mod_DoorDirectionSelection'], 'mod_DoorDirectionSelection');
      internal_leaveValidateVariant();
      this.mod_DoorDirectionSelection = val;
    }
    {
    ...
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_DoorTypeSelection');
      const val = _toString(json['attributes']['mod_DoorTypeSelection'], 'mod_DoorTypeSelection');
      internal_leaveValidateVariant();
      this.mod_DoorTypeSelection = val;
    }
  ...
  override checkPosRelevantRequiredAttributes(): void {
    ...
    if (this.#mod_DoorDirection !== undefined) {
      this.#mod_DoorDirection = undefined;
      logWarning('The attribute "mod_DoorDirection" was set in the order data but is not marked as "pos relevant" - the value is ignored');
    }
    if (this.#mod_DoorType !== undefined) {
      this.#mod_DoorType = undefined;
      logWarning('The attribute "mod_DoorType" was set in the order data but is not marked as "pos relevant" - the value is ignored');
    }
  ...
  #dataCompletionAssignDerivedData() {
    ...
    if (this.mod_FrontSegmentType === undefined) {
      let s = this.parentBase;
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_FrontSegmentType')) {
          let pv = <IModVar_mod_FrontSegmentType>s;
          if (pv.mod_FrontSegmentType !== undefined) {
            this.mod_FrontSegmentType = (<IModVar_mod_FrontSegmentType>s).mod_FrontSegmentType;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_FrontSegmentColor === undefined) {
      let s = this.parentBase;
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_FrontSegmentColor')) {
          let pv = <IModVar_mod_FrontSegmentColor>s;
          if (pv.mod_FrontSegmentColor !== undefined) {
            this.mod_FrontSegmentColor = (<IModVar_mod_FrontSegmentColor>s).mod_FrontSegmentColor;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_DoorDirectionSelection === undefined) {
      let s = this.parentBase;
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_DoorDirectionSelection')) {
          let pv = <IModVar_mod_DoorDirectionSelection>s;
          if (pv.mod_DoorDirectionSelection !== undefined) {
            this.mod_DoorDirectionSelection = (<IModVar_mod_DoorDirectionSelection>s).mod_DoorDirectionSelection;
            break;
          };
        }
        s = s.parentBase;
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_HandlePosMatrixMultiple === undefined) {
      this.mod_HandlePosMatrixMultiple = "DoubleCenter";
    }
    if (this.mod_FrontSegmentDescriptor === undefined) {
      this.mod_FrontSegmentDescriptor = "";
    }
    if (this.mod_Information === undefined) {
  ...
  #dataCompletionSetDefaultScripts_globalVars() {
    ...
    if (this.mod_DoorTypeSelection === undefined) {
      this.mod_DoorTypeSelection = this.g.basic_DoorType;
    }
    internal_leaveDataCompletionSetDefaultScripts_globalVars();
  }
  ...
  #prepareContextInternal = mf_Door_prepareContext;
  seal(): IModuleNonNull_mf_Door {
  ...
  addOD_M_me_HoodInsert(index?: number): dc_me_HoodInsert {
    var m = new OD_M_me_HoodInsert(this);
    m.dataCompletion();
    if (this._manufacturerMode) {
      m.manufacturerDataCompletion();
    }
  ...
  addOD_M_md_EquipmentPlaceholder(index?: number): dc_md_EquipmentPlaceholder {
    var m = new OD_M_md_EquipmentPlaceholder(this);
    m.dataCompletion();
    if (this._manufacturerMode) {
      m.manufacturerDataCompletion();
    }
  ...
  override validateSelections(): void {
    ...
    this.mod_FrontSplitHeight1_matrix = VariantValidation.mod_FrontSplitHeight1(this, this.mod_FrontSplitHeight1);
    this.mod_FrontSplitHeight2_matrix = VariantValidation.mod_FrontSplitHeight2(this, this.mod_FrontSplitHeight2);
    this.mod_FrontSplitHeight3_matrix = VariantValidation.mod_FrontSplitHeight3(this, this.mod_FrontSplitHeight3);
    ...
    this.mod_ShelfadjOffsetBack_matrix = VariantValidation.mod_ShelfadjOffsetBack(this, this.mod_ShelfadjOffsetBack);
    this.mod_ShelfadjOffsetFront_matrix = VariantValidation.mod_ShelfadjOffsetFront(this, this.mod_ShelfadjOffsetFront);
    this.mod_ShelfadjThk_matrix = VariantValidation.mod_ShelfadjThk(this, this.mod_ShelfadjThk);
    ...
    this.mod_FrontDescriptor_matrix = VariantValidation.mod_FrontDescriptor(this, this.mod_FrontDescriptor);
    ...
    this.mod_CarcaseDirectionInfo_matrix = VariantValidation.mod_CarcaseDirectionInfo(this, this.mod_CarcaseDirectionInfo);
    this.mod_PushtoopenLine_matrix = VariantValidation.mod_PushtoopenLine(this, this.mod_PushtoopenLine);
    this.mod_PushtoopenOffset_matrix = VariantValidation.mod_PushtoopenOffset(this, this.mod_PushtoopenOffset);
    this.mod_PushtoopenPosition_matrix = VariantValidation.mod_PushtoopenPosition(this, this.mod_PushtoopenPosition);
    this.mod_PushtoopenType_matrix = VariantValidation.mod_PushtoopenType(this, this.mod_PushtoopenType);
    this.mod_PushtoopenColor_matrix = VariantValidation.mod_PushtoopenColor(this, this.mod_PushtoopenColor);
    ...
    this.mod_FrontSegmentType_matrix = VariantValidation.mod_FrontSegmentType(this, this.mod_FrontSegmentType);
    this.mod_FrontSegmentColor_matrix = VariantValidation.mod_FrontSegmentColor(this, this.mod_FrontSegmentColor);
    this.mod_FrontSegmentDescriptor_matrix = VariantValidation.mod_FrontSegmentDescriptor(this, this.mod_FrontSegmentDescriptor);
    this.mod_DoorDirectionSelection_matrix = VariantValidation.mod_DoorDirectionSelection(this, this.mod_DoorDirectionSelection);
    this.mod_Information_matrix = VariantValidation.mod_Information(this, this.mod_Information);
    this.mod_DoorTypeSelection_matrix = VariantValidation.mod_DoorTypeSelection(this, this.mod_DoorTypeSelection);
  }

  override calculateContainerModules(): void {
    let ccm = new OD_M_mf_Door_NonNull(this);
...
class OD_M_mf_Door_NonNull implements cbp_mf_Door, adc_mf_Door, ccm_mf_Door, IPartParentsNonNull_mf_Door_mf_Fridge, IPartParentsNonNull_mf_Door_mf_Fliplift_mf_RackArea, IPartParentsNonNull_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_mf_Door_mf_Fliplift_mf_RackArea, IPartParentsNonNull_mf_Door {
  ...
  #calculateContainerModulesInternal = mf_Door_calculateContainerModules;
  ...
  get mod_FrontSegmentType(): string {
    return this.#internalParent.mod_FrontSegmentType!;
  }
  get mod_FrontSegmentColor(): string {
    return this.#internalParent.mod_FrontSegmentColor!;
  }
  get mod_FrontSegmentColor_matrix(): IMatrix_mod_FrontSegmentColor {
    return this.#internalParent.mod_FrontSegmentColor_matrix!;
  }
  get mod_FrontSegmentDescriptor(): string {
    return this.#internalParent.mod_FrontSegmentDescriptor!;
  }
  get mod_DoorDirectionSelection(): string {
    return this.#internalParent.mod_DoorDirectionSelection!;
  }
  get mod_Information(): string {
    return this.#internalParent.mod_Information!;
  }
  get mod_DoorTypeSelection(): string {
    return this.#internalParent.mod_DoorTypeSelection!;
  }
  addOD_M_mc_Door01(index?: number): dc_mc_Door01 {
  ...
  addOD_M_me_HoodInsert(index?: number): dc_me_HoodInsert {
    return this.#internalParent.addOD_M_me_HoodInsert(index);
  }
  addOD_M_md_EquipmentPlaceholder(index?: number): dc_md_EquipmentPlaceholder {
    return this.#internalParent.addOD_M_md_EquipmentPlaceholder(index);
  }
}
