...
import { IModParents_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_Fixedfront01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01 } from '../mod-interfaces'
...
export interface adc_mc_Handlestrip01 extends adc_base_mc_Handlestrip01 {
}

export interface ccm_mc_Handlestrip01 extends adc_base_mc_Handlestrip01 {
}
...
export class OD_M_mc_Handlestrip01 extends OD_Base implements dc_mc_Handlestrip01
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Handlestrip01_NonNull(this);
  ...
  addpart_Handlestrip(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Handlestrip_PartVarsWritable {
    var c = new P_part_Handlestrip(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_HandlestripDrill(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_HandlestripDrill_PartVarsWritable {
    var c = new P_part_HandlestripDrill(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_Handlestrip01_NonNull implements cbp_mc_Handlestrip01, adc_mc_Handlestrip01, ccm_mc_Handlestrip01, IPartParentsNonNull_mc_Handlestrip01 {
  ...
  #calculateContainerModulesInternal = mc_Handlestrip01_calculateContainerModules;
