...
export interface adc_mr_Toekick extends adc_base_mr_Toekick {
  addOD_M_mc_Toekick(index?: number): dc_mc_Toekick;
}

export interface ccm_mr_Toekick extends adc_base_mr_Toekick {
}
...
export class OD_M_mr_Toekick extends OD_Base implements dc_mr_Toekick
  ...
  override variants: string[] = ['mod_ToekickColor', 'mod_ToekickThk', 'mod_ToekickReductionTop', 'mod_ToekickConnectionOverhang', 'mod_ToekickConnectionSequence', 'mod_ToekickSidepanelOverdimensionBtm', 'mod_ToekickSidepanelTransitionType', 'mod_ToekickId', 'mod_LengthList', 'mod_ToekickProgram',];
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mr_Toekick_NonNull(this);
...
class OD_M_mr_Toekick_NonNull implements cbp_mr_Toekick, adc_mr_Toekick, ccm_mr_Toekick, IPartParentsNonNull_mr_PlinthAreaBaseboard_mr_Toekick {
  ...
  #calculateContainerModulesInternal = mr_Toekick_calculateContainerModules;
