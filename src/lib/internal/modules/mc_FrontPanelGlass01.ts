...
import { IModVar_mod_Depth, IModVarNonNull_mod_Depth, IModVar_mod_FrontId, IModVarNonNull_mod_FrontId, IModVar_mod_FrontType, IModVarNonNull_mod_FrontType, IModVar_mod_Height, IModVarNonNull_mod_Height, IModVar_mod_Width, IModVarNonNull_mod_Width, IModVar_mod_FrontProgram, IModVarNonNull_mod_FrontProgram, IModVar_mod_ModuleName, IModVarNonNull_mod_ModuleName } from '../var-interfaces'
import { VariantValidation, IMatrix_mod_Depth, IMatrix_mod_FrontId, IMatrix_mod_FrontType, IMatrix_mod_Height, IMatrix_mod_Width, IMatrix_mod_FrontProgram, IMatrix_mod_ModuleName } from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_FrontGlass, IPartAdd_part_Frontprofile } from '../part-add-interfaces';
import { mc_FrontPanelGlass01_createBuildPlan, mc_FrontPanelGlass01_afterDataCompletion, mc_FrontPanelGlass01_manufacturerDataCompletion, mc_FrontPanelGlass01_calculateContainerModules, mc_FrontPanelGlass01_prepareContext } from '../../modules/mc_FrontPanelGlass01';

export interface cbp_mc_FrontPanelGlass01 extends IModBaseProp
  , IPartAdd_part_FrontGlass, IPartAdd_part_Frontprofile, IModVarNonNull_mod_Depth, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontType, IModVarNonNull_mod_Height, IModVarNonNull_mod_Width, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_ModuleName {
...
export interface dc_mc_FrontPanelGlass01 extends IModBaseProp
  , IModVar_mod_Depth, IModVar_mod_FrontId, IModVar_mod_FrontType, IModVar_mod_Height, IModVar_mod_Width, IModVar_mod_FrontProgram, IModVar_mod_ModuleName {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
...
export interface pc_mc_FrontPanelGlass01 extends dc_mc_FrontPanelGlass01 {
...
export interface adc_base_mc_FrontPanelGlass01 extends IModBaseProp
  , IModVarNonNull_mod_Depth, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontType, IModVarNonNull_mod_Height, IModVarNonNull_mod_Width, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_ModuleName {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_FrontPanelGlass01 extends adc_base_mc_FrontPanelGlass01 {
}

export interface ccm_mc_FrontPanelGlass01 extends adc_base_mc_FrontPanelGlass01 {
}


export class OD_M_mc_FrontPanelGlass01 extends OD_Base implements pc_mc_FrontPanelGlass01, dc_mc_FrontPanelGlass01
  ...
  override variants: string[] = ['mod_Depth', 'mod_FrontId', 'mod_FrontType', 'mod_Height', 'mod_Width', 'mod_FrontProgram', 'mod_ModuleName',];
  #mod_Depth?: number;
  ...
  #prepareContextInternal = mc_FrontPanelGlass01_prepareContext;
  seal(): IModuleNonNull_mc_FrontPanelGlass01 {
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_FrontPanelGlass01_NonNull(this);
  ...
  addpart_FrontGlass(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_FrontGlass_PartVarsWritable {
    var c = new P_part_FrontGlass(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_Frontprofile(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Frontprofile_PartVarsWritable {
    var c = new P_part_Frontprofile(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_FrontPanelGlass01_NonNull implements cbp_mc_FrontPanelGlass01, adc_mc_FrontPanelGlass01, ccm_mc_FrontPanelGlass01, IPartParentsNonNull_mc_FrontPanelGlass01 {
  ...
  #calculateContainerModulesInternal = mc_FrontPanelGlass01_calculateContainerModules;
