...
import { IModParents_mf_PantryPullout } from '../mod-interfaces'
import { IP_part_PantryPulloutUnit_PartVarsWritable, P_part_PantryPulloutUnit } from '../parts/part_PantryPulloutUnit'
...
export interface dc_mc_PantryPullout01 extends IModBaseProp
  ...
  addOD_M_mc_PantryPulloutHardware01(index?: number): dc_mc_PantryPulloutHardware01;
  addOD_M_mc_StorageunitShelffixed01(index?: number): dc_mc_StorageunitShelffixed01;
}

export interface pc_mc_PantryPullout01 extends dc_mc_PantryPullout01 {
...
export interface adc_base_mc_PantryPullout01 extends IModBaseProp
  , IModVarNonNull_mod_BackwallPos, IModVarNonNull_mod_CarcaseDepth, IModVarNonNull_mod_CarcaseHeight, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseWidth, IModVarNonNull_mod_FingergripTop, IModVarNonNull_mod_FrontHeight, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontSplit, IModVarNonNull_mod_FrontThk, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_HandleDrill, IModVarNonNull_mod_HandleLine, IModVarNonNull_mod_HandlePosLogic, IModVarNonNull_mod_FrontQtyElements, IModVarNonNull_mod_ShelffixedType, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontOversizeBtm, IModVarNonNull_mod_FrontOversizeLeft, IModVarNonNull_mod_FrontOversizeRight, IModVarNonNull_mod_FrontOversizeTop, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_FrontSplitType1, IModVarNonNull_mod_FrontSplitType2, IModVarNonNull_mod_HandleColor, IModVarNonNull_mod_HandleLength, IModVarNonNull_mod_HandleOffsetX, IModVarNonNull_mod_HandleOffsetY, IModVarNonNull_mod_HandlePosMatrix, IModVarNonNull_mod_HandlePosType, IModVarNonNull_mod_HandlestripPos, IModVarNonNull_mod_HeightPosInsertion, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_ShelffixedBtm, IModVarNonNull_mod_ShelffixedPos, IModVarNonNull_mod_HandleDesign, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_FrontGapHorTop, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_Depth, IModVarNonNull_mod_ShelfbtmThk, IModVarNonNull_mod_ShelffixedThk, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_VertDividerType, IModVarNonNull_mod_CarcaseSpaceDimension, IModVarNonNull_mod_FrameFillingType, IModVarNonNull_mod_FrameFillingColor, IModVarNonNull_mod_DrawerOpeningDistance, IModVarNonNull_mod_FirstFront, IModVarNonNull_mod_LastFront, IModVarNonNull_mod_PantryPulloutDesign, IModVarNonNull_mod_PantryPulloutType, IModVarNonNull_mod_PantryPulloutColor, IModVarNonNull_mod_Information, IModVarNonNull_mod_InformationList, IModVarNonNull_mod_HardwareColor, IModVarNonNull_mod_FrontSplitDescriptor, IModVarNonNull_mod_HandlePosMatrixMultiple, IModVarNonNull_mod_HandleActivated, IModVarNonNull_mod_GlobalFrontOversizeBtm, IModVarNonNull_mod_GlobalFrontOversizeLeft {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_PantryPullout01 extends adc_base_mc_PantryPullout01 {
  addOD_M_mc_FrontPanel01(index?: number): dc_mc_FrontPanel01;
  addOD_M_mc_Handle01(index?: number): dc_mc_Handle01;
  addOD_M_mc_Handlestrip01(index?: number): dc_mc_Handlestrip01;
  addOD_M_mc_PanelWoodFrame01(index?: number): dc_mc_PanelWoodFrame01;
...
export interface ccm_mc_PantryPullout01 extends adc_base_mc_PantryPullout01 {
}


export class OD_M_mc_PantryPullout01 extends OD_Base implements pc_mc_PantryPullout01, dc_mc_PantryPullout01
  ...
  , IModVar_mod_BackwallPos, IModVar_mod_CarcaseDepth, IModVar_mod_CarcaseHeight, IModVar_mod_CarcaseId, IModVar_mod_CarcaseWidth, IModVar_mod_FingergripTop, IModVar_mod_FrontHeight, IModVar_mod_FrontId, IModVar_mod_FrontSplit, IModVar_mod_FrontThk, IModVar_mod_FrontWidth, IModVar_mod_HandleDrill, IModVar_mod_HandleLine, IModVar_mod_HandlePosLogic, IModVar_mod_FrontQtyElements, IModVar_mod_ShelffixedType, IModVar_mod_FrontPosStart, IModVar_mod_FrontColor, IModVar_mod_FrontEdgeColor, IModVar_mod_FrontEdgeThk, IModVar_mod_FrontGapCarcase, IModVar_mod_FrontGapHor, IModVar_mod_FrontGapVert, IModVar_mod_FrontOversizeBtm, IModVar_mod_FrontOversizeLeft, IModVar_mod_FrontOversizeRight, IModVar_mod_FrontOversizeTop, IModVar_mod_FrontProgram, IModVar_mod_FrontSplitType1, IModVar_mod_FrontSplitType2, IModVar_mod_HandleColor, IModVar_mod_HandleLength, IModVar_mod_HandleOffsetX, IModVar_mod_HandleOffsetY, IModVar_mod_HandlePosMatrix, IModVar_mod_HandlePosType, IModVar_mod_HandlestripPos, IModVar_mod_HeightPosInsertion, IModVar_mod_PlinthAreaHeight, IModVar_mod_ShelffixedBtm, IModVar_mod_ShelffixedPos, IModVar_mod_HandleDesign, IModVar_mod_ModuleName, IModVar_mod_FrontGapHorTop, IModVar_mod_FrontDesign, IModVar_mod_Depth, IModVar_mod_ShelfbtmThk, IModVar_mod_ShelffixedThk, IModVar_mod_TypeElement, IModVar_mod_Originpos, IModVar_mod_VertDividerType, IModVar_mod_CarcaseSpaceDimension, IModVar_mod_FrameFillingType, IModVar_mod_FrameFillingColor, IModVar_mod_DrawerOpeningDistance, IModVar_mod_FirstFront, IModVar_mod_LastFront, IModVar_mod_PantryPulloutDesign, IModVar_mod_PantryPulloutType, IModVar_mod_PantryPulloutColor, IModVar_mod_Information, IModVar_mod_InformationList, IModVar_mod_HardwareColor, IModVar_mod_FrontSplitDescriptor, IModVar_mod_HandlePosMatrixMultiple, IModVar_mod_HandleActivated, IModVar_mod_GlobalFrontOversizeBtm, IModVar_mod_GlobalFrontOversizeLeft {
  constructor(parent: IModParents_mf_PantryPullout, manufacturerMode?: boolean) {
    super('mc_PantryPullout01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_PantryPullout01_NonNull(this);
  }
  parent: IModParents_mf_PantryPullout;
  _selfNonNull: OD_M_mc_PantryPullout01_NonNull;

  override variants: string[] = ['mod_BackwallPos', 'mod_CarcaseDepth', 'mod_CarcaseHeight', 'mod_CarcaseId', 'mod_CarcaseWidth', 'mod_FingergripTop', 'mod_FrontHeight', 'mod_FrontId', 'mod_FrontSplit', 'mod_FrontThk', 'mod_FrontWidth', 'mod_HandleDrill', 'mod_HandleLine', 'mod_HandlePosLogic', 'mod_FrontQtyElements', 'mod_ShelffixedType', 'mod_FrontPosStart', 'mod_FrontColor', 'mod_FrontEdgeColor', 'mod_FrontEdgeThk', 'mod_FrontGapCarcase', 'mod_FrontGapHor', 'mod_FrontGapVert', 'mod_FrontOversizeBtm', 'mod_FrontOversizeLeft', 'mod_FrontOversizeRight', 'mod_FrontOversizeTop', 'mod_FrontProgram', 'mod_FrontSplitType1', 'mod_FrontSplitType2', 'mod_HandleColor', 'mod_HandleLength', 'mod_HandleOffsetX', 'mod_HandleOffsetY', 'mod_HandlePosMatrix', 'mod_HandlePosType', 'mod_HandlestripPos', 'mod_HeightPosInsertion', 'mod_PlinthAreaHeight', 'mod_ShelffixedBtm', 'mod_ShelffixedPos', 'mod_HandleDesign', 'mod_ModuleName', 'mod_FrontGapHorTop', 'mod_FrontDesign', 'mod_Depth', 'mod_ShelfbtmThk', 'mod_ShelffixedThk', 'mod_TypeElement', 'mod_Originpos', 'mod_VertDividerType', 'mod_CarcaseSpaceDimension', 'mod_FrameFillingType', 'mod_FrameFillingColor', 'mod_DrawerOpeningDistance', 'mod_FirstFront', 'mod_LastFront', 'mod_PantryPulloutDesign', 'mod_PantryPulloutType', 'mod_PantryPulloutColor', 'mod_Information', 'mod_InformationList', 'mod_HardwareColor', 'mod_FrontSplitDescriptor', 'mod_HandlePosMatrixMultiple', 'mod_HandleActivated', 'mod_GlobalFrontOversizeBtm', 'mod_GlobalFrontOversizeLeft',];
  ...
  #dataCompletionAssignDerivedData() {
    ...
    if (this.mod_FirstFront === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_FirstFront')) {
          let pv = <IModVar_mod_FirstFront>s;
          if (pv.mod_FirstFront !== undefined) {
            this.mod_FirstFront = (<IModVar_mod_FirstFront>s).mod_FirstFront;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_LastFront === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_LastFront')) {
          let pv = <IModVar_mod_LastFront>s;
          if (pv.mod_LastFront !== undefined) {
            this.mod_LastFront = (<IModVar_mod_LastFront>s).mod_LastFront;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_PantryPulloutDesign === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_PantryPulloutDesign')) {
          let pv = <IModVar_mod_PantryPulloutDesign>s;
          if (pv.mod_PantryPulloutDesign !== undefined) {
            this.mod_PantryPulloutDesign = (<IModVar_mod_PantryPulloutDesign>s).mod_PantryPulloutDesign;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_PantryPulloutType === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_PantryPulloutType')) {
          let pv = <IModVar_mod_PantryPulloutType>s;
          if (pv.mod_PantryPulloutType !== undefined) {
            this.mod_PantryPulloutType = (<IModVar_mod_PantryPulloutType>s).mod_PantryPulloutType;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_PantryPulloutColor === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_PantryPulloutColor')) {
          let pv = <IModVar_mod_PantryPulloutColor>s;
          if (pv.mod_PantryPulloutColor !== undefined) {
            this.mod_PantryPulloutColor = (<IModVar_mod_PantryPulloutColor>s).mod_PantryPulloutColor;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_HandlePosMatrixMultiple === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_HandlePosMatrixMultiple')) {
          let pv = <IModVar_mod_HandlePosMatrixMultiple>s;
          if (pv.mod_HandlePosMatrixMultiple !== undefined) {
            this.mod_HandlePosMatrixMultiple = (<IModVar_mod_HandlePosMatrixMultiple>s).mod_HandlePosMatrixMultiple;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_HandleActivated === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_HandleActivated')) {
          let pv = <IModVar_mod_HandleActivated>s;
          if (pv.mod_HandleActivated !== undefined) {
            this.mod_HandleActivated = (<IModVar_mod_HandleActivated>s).mod_HandleActivated;
            break;
          };
        }
        s = s.parentBase;
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mc_PantryPullout01";
    }
  ...
  #manufacturerDataCompletionInternal = mc_PantryPullout01_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_PantryPullout01_NonNull(this);
  ...
  #prepareContextInternal = mc_PantryPullout01_prepareContext;
  seal(): IModuleNonNull_mc_PantryPullout01 {
    this.afterDataCompletion();
    const adc = new OD_M_mc_PantryPullout01_NonNull(this);
    return adc;
  }
  ...
  addOD_M_mc_PantryPulloutHardware01(index?: number): dc_mc_PantryPulloutHardware01 {
    var m = new OD_M_mc_PantryPulloutHardware01(this);
    m.dataCompletion();
    if (this._manufacturerMode) {
      m.manufacturerDataCompletion();
    }
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_PantryPullout01_NonNull(this);
    ccm.calculateContainerModules();
    this.m.forEach(subMod => subMod.calculateContainerModules());
  }

  addpart_PantryPulloutUnit(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_PantryPulloutUnit_PartVarsWritable {
    var c = new P_part_PantryPulloutUnit(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }

  override createBuildPlan(): void {
    var cbp = new OD_M_mc_PantryPullout01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_PantryPullout01_NonNull implements cbp_mc_PantryPullout01, adc_mc_PantryPullout01, ccm_mc_PantryPullout01, IPartParentsNonNull_mc_BaseunitFridge01_mc_CornerFillerFront01_mc_Dishwasher01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_BaseunitFridge01_mc_CornerFillerFront01_mc_Dishwasher01_mc_Door01_mc_Drawer01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_Fixedfront01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_PantryPullout01_mc_Storageunit01, IPartParentsNonNull_mc_PantryPullout01 {
  constructor(parent: OD_M_mc_PantryPullout01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_PantryPullout01;
  ...
  #createBuildPlanInternal = mc_PantryPullout01_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_PantryPullout01_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = mc_PantryPullout01_calculateContainerModules;
  ...
  parent: IModParents_mf_PantryPullout;
  addpart_PantryPulloutUnit(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_PantryPulloutUnit_PartVarsWritable {
    return this.#internalParent.addpart_PantryPulloutUnit(x, y, z, dimx, dimy, dimz);
  }
  ...
  addOD_M_mc_PantryPulloutHardware01(index?: number): dc_mc_PantryPulloutHardware01 {
    return this.#internalParent.addOD_M_mc_PantryPulloutHardware01(index);
  }
  addOD_M_mc_StorageunitShelffixed01(index?: number): dc_mc_StorageunitShelffixed01 {
