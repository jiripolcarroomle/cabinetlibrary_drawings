...
import { IPartAdd_part_DoorSegmented, IPartAdd_part_SegmentedFront } from '../part-add-interfaces';
import { mc_SegmentFront01_createBuildPlan, mc_SegmentFront01_afterDataCompletion, mc_SegmentFront01_manufacturerDataCompletion, mc_SegmentFront01_calculateContainerModules } from '../../modules/mc_SegmentFront01';
...
export interface adc_mc_SegmentFront01 extends adc_base_mc_SegmentFront01 {
}

export interface ccm_mc_SegmentFront01 extends adc_base_mc_SegmentFront01 {
}


export class OD_M_mc_SegmentFront01 extends OD_Base implements dc_mc_SegmentFront01
  ...
  constructor(parent: IModParents_mc_Door01, manufacturerMode?: boolean) {
    ...
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_SegmentFront01_NonNull(this);
  }
  parent: IModParents_mc_Door01;
  ...
  #manufacturerDataCompletionInternal = mc_SegmentFront01_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_SegmentFront01_NonNull(this);
  ...
  seal(): IModuleNonNull_mc_SegmentFront01 {
    ...
    const adc = new OD_M_mc_SegmentFront01_NonNull(this);
    return adc;
  }
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_SegmentFront01_NonNull(this);
  ...
  addpart_DoorSegmented(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_DoorSegmented_PartVarsWritable {
    var c = new P_part_DoorSegmented(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_SegmentedFront(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_SegmentedFront_PartVarsWritable {
    var c = new P_part_SegmentedFront(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }

  override createBuildPlan(): void {
    var cbp = new OD_M_mc_SegmentFront01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_SegmentFront01_NonNull implements cbp_mc_SegmentFront01, adc_mc_SegmentFront01, ccm_mc_SegmentFront01, IPartParentsNonNull_mc_SegmentFront01 {
  constructor(parent: OD_M_mc_SegmentFront01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_SegmentFront01;
  ...
  #createBuildPlanInternal = mc_SegmentFront01_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_SegmentFront01_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = mc_SegmentFront01_calculateContainerModules;
  ...
  parent: IModParents_mc_Door01;
  addpart_DoorSegmented(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_DoorSegmented_PartVarsWritable {
    return this.#internalParent.addpart_DoorSegmented(x, y, z, dimx, dimy, dimz);
  }
  addpart_SegmentedFront(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_SegmentedFront_PartVarsWritable {
    return this.#internalParent.addpart_SegmentedFront(x, y, z, dimx, dimy, dimz);
  }
