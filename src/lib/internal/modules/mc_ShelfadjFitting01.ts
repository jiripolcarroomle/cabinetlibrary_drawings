...
import { IModParents_mc_ShelfadjGroup01_me_ShelfadjMultiple01 } from '../mod-interfaces'
...
import { mc_ShelfadjFitting01_createBuildPlan, mc_ShelfadjFitting01_afterDataCompletion, mc_ShelfadjFitting01_manufacturerDataCompletion, mc_ShelfadjFitting01_calculateContainerModules, mc_ShelfadjFitting01_prepareContext } from '../../modules/mc_ShelfadjFitting01';
...
export interface cbp_mc_ShelfadjFitting01 extends IModBaseProp
  ...
  parent: IModParents_mc_ShelfadjGroup01_me_ShelfadjMultiple01;
...
export interface pc_mc_ShelfadjFitting01 extends dc_mc_ShelfadjFitting01 {
...
export interface adc_base_mc_ShelfadjFitting01 extends IModBaseProp
  , IModVarNonNull_mod_Depth, IModVarNonNull_mod_Height, IModVarNonNull_mod_Width, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_ShelfadjBackwallDrillDescriptor, IModVarNonNull_mod_ShelfadjDrillDistance, IModVarNonNull_mod_ShelfadjBackwallProcessingId, IModVarNonNull_mod_ShelfadjSidepanelDrillDescriptor, IModVarNonNull_mod_ShelfadjSidepanelProcessingBackId, IModVarNonNull_mod_ShelfadjSidepanelProcessingFrontId, IModVarNonNull_mod_ShelfadjSidepanelProcessingMiddleId, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_ShelfadjVertDividerProcessingId, IModVarNonNull_mod_ShelfadjVertdividerDrillDescriptor, IModVarNonNull_mod_VertDividerType, IModVarNonNull_mod_VertDividerPosition {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_ShelfadjFitting01 extends adc_base_mc_ShelfadjFitting01 {
}

export interface ccm_mc_ShelfadjFitting01 extends adc_base_mc_ShelfadjFitting01 {
}


export class OD_M_mc_ShelfadjFitting01 extends OD_Base implements pc_mc_ShelfadjFitting01, dc_mc_ShelfadjFitting01
  , IModParents_mc_ShelfadjFitting01_mc_ShelfadjGroup01, IModParents_mc_ShelfadjFitting01
  , IModVar_mod_Depth, IModVar_mod_Height, IModVar_mod_Width, IModVar_mod_CarcaseId, IModVar_mod_ShelfadjBackwallDrillDescriptor, IModVar_mod_ShelfadjDrillDistance, IModVar_mod_ShelfadjBackwallProcessingId, IModVar_mod_ShelfadjSidepanelDrillDescriptor, IModVar_mod_ShelfadjSidepanelProcessingBackId, IModVar_mod_ShelfadjSidepanelProcessingFrontId, IModVar_mod_ShelfadjSidepanelProcessingMiddleId, IModVar_mod_ModuleName, IModVar_mod_ShelfadjVertDividerProcessingId, IModVar_mod_ShelfadjVertdividerDrillDescriptor, IModVar_mod_VertDividerType, IModVar_mod_VertDividerPosition {
  constructor(parent: IModParents_mc_ShelfadjGroup01_me_ShelfadjMultiple01, manufacturerMode?: boolean) {
  ...
  #prepareContextInternal = mc_ShelfadjFitting01_prepareContext;
  seal(): IModuleNonNull_mc_ShelfadjFitting01 {
  ...
  override validateSelections(): void {
    ...
    this.mod_ShelfadjBackwallDrillDescriptor_matrix = VariantValidation.mod_ShelfadjBackwallDrillDescriptor(this, this.mod_ShelfadjBackwallDrillDescriptor);
    this.mod_ShelfadjDrillDistance_matrix = VariantValidation.mod_ShelfadjDrillDistance(this, this.mod_ShelfadjDrillDistance);
    this.mod_ShelfadjBackwallProcessingId_matrix = VariantValidation.mod_ShelfadjBackwallProcessingId(this, this.mod_ShelfadjBackwallProcessingId);
    this.mod_ShelfadjSidepanelDrillDescriptor_matrix = VariantValidation.mod_ShelfadjSidepanelDrillDescriptor(this, this.mod_ShelfadjSidepanelDrillDescriptor);
    this.mod_ShelfadjSidepanelProcessingBackId_matrix = VariantValidation.mod_ShelfadjSidepanelProcessingBackId(this, this.mod_ShelfadjSidepanelProcessingBackId);
    this.mod_ShelfadjSidepanelProcessingFrontId_matrix = VariantValidation.mod_ShelfadjSidepanelProcessingFrontId(this, this.mod_ShelfadjSidepanelProcessingFrontId);
    this.mod_ShelfadjSidepanelProcessingMiddleId_matrix = VariantValidation.mod_ShelfadjSidepanelProcessingMiddleId(this, this.mod_ShelfadjSidepanelProcessingMiddleId);
    this.mod_ModuleName_matrix = VariantValidation.mod_ModuleName(this, this.mod_ModuleName);
    this.mod_ShelfadjVertDividerProcessingId_matrix = VariantValidation.mod_ShelfadjVertDividerProcessingId(this, this.mod_ShelfadjVertDividerProcessingId);
    this.mod_ShelfadjVertdividerDrillDescriptor_matrix = VariantValidation.mod_ShelfadjVertdividerDrillDescriptor(this, this.mod_ShelfadjVertdividerDrillDescriptor);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_ShelfadjFitting01_NonNull(this);
  ...
  addpart_HardwareShelfadjDrill(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_HardwareShelfadjDrill_PartVarsWritable {
    var c = new P_part_HardwareShelfadjDrill(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_ShelfadjFitting01_NonNull implements cbp_mc_ShelfadjFitting01, adc_mc_ShelfadjFitting01, ccm_mc_ShelfadjFitting01, IPartParentsNonNull_mc_ShelfadjFitting01_mc_ShelfadjGroup01, IPartParentsNonNull_mc_ShelfadjFitting01 {
  ...
  #calculateContainerModulesInternal = mc_ShelfadjFitting01_calculateContainerModules;
