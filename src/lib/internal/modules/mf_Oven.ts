...
export interface pc_mf_Oven extends dc_mf_Oven {
...
export interface adc_base_mf_Oven extends IModBaseProp
  , IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseDepth, IModVarNonNull_mod_CarcaseHeight, IModVarNonNull_mod_CarcaseWidth, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_ShelffixedThk, IModVarNonNull_mod_SidepanelleftThk, IModVarNonNull_mod_SidepanelrightThk, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_ShelffixedInfoList, IModVarNonNull_mod_OvenSupplier1, IModVarNonNull_mod_OvenGap1, IModVarNonNull_mod_OvenId1, IModVarNonNull_mod_OvenSupplier3, IModVarNonNull_mod_OvenSupplier2, IModVarNonNull_mod_OvenGap2, IModVarNonNull_mod_OvenId2, IModVarNonNull_mod_OvenGap3, IModVarNonNull_mod_OvenId3, IModVarNonNull_mod_OvenShelffixedOverhangTop, IModVarNonNull_mod_OvenGap4, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_CarcaseSpaceDimension, IModVarNonNull_mod_ShelfbtmThk, IModVarNonNull_mod_Information {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mf_Oven extends adc_base_mf_Oven {
  addOD_M_mc_Oven01(index?: number): dc_mc_Oven01;
}

export interface ccm_mf_Oven extends adc_base_mf_Oven {
}


export class OD_M_mf_Oven extends OD_Base implements pc_mf_Oven, dc_mf_Oven
  , IModParents_mf_Oven
  , IModVar_mod_CarcaseId, IModVar_mod_CarcaseDepth, IModVar_mod_CarcaseHeight, IModVar_mod_CarcaseWidth, IModVar_mod_ParentName, IModVar_mod_ShelffixedThk, IModVar_mod_SidepanelleftThk, IModVar_mod_SidepanelrightThk, IModVar_mod_Originpos, IModVar_mod_FrontPosStart, IModVar_mod_TypeElement, IModVar_mod_FrontId, IModVar_mod_ModuleName, IModVar_mod_ShelffixedInfoList, IModVar_mod_OvenSupplier1, IModVar_mod_OvenGap1, IModVar_mod_OvenId1, IModVar_mod_OvenSupplier3, IModVar_mod_OvenSupplier2, IModVar_mod_OvenGap2, IModVar_mod_OvenId2, IModVar_mod_OvenGap3, IModVar_mod_OvenId3, IModVar_mod_OvenShelffixedOverhangTop, IModVar_mod_OvenGap4, IModVar_mod_FrontGapHor, IModVar_mod_CarcaseSpaceDimension, IModVar_mod_ShelfbtmThk, IModVar_mod_Information {
  ...
  override variants: string[] = ['mod_CarcaseId', 'mod_CarcaseDepth', 'mod_CarcaseHeight', 'mod_CarcaseWidth', 'mod_ParentName', 'mod_ShelffixedThk', 'mod_SidepanelleftThk', 'mod_SidepanelrightThk', 'mod_Originpos', 'mod_FrontPosStart', 'mod_TypeElement', 'mod_FrontId', 'mod_ModuleName', 'mod_ShelffixedInfoList', 'mod_OvenSupplier1', 'mod_OvenGap1', 'mod_OvenId1', 'mod_OvenSupplier3', 'mod_OvenSupplier2', 'mod_OvenGap2', 'mod_OvenId2', 'mod_OvenGap3', 'mod_OvenId3', 'mod_OvenShelffixedOverhangTop', 'mod_OvenGap4', 'mod_FrontGapHor', 'mod_CarcaseSpaceDimension', 'mod_ShelfbtmThk', 'mod_Information',];
  ...
  #prepareContextInternal = mf_Oven_prepareContext;
  seal(): IModuleNonNull_mf_Oven {
  ...
  override validateSelections(): void {
    ...
    this.mod_OvenSupplier1_matrix = VariantValidation.mod_OvenSupplier1(this, this.mod_OvenSupplier1);
    this.mod_OvenGap1_matrix = VariantValidation.mod_OvenGap1(this, this.mod_OvenGap1);
    this.mod_OvenId1_matrix = VariantValidation.mod_OvenId1(this, this.mod_OvenId1);
    this.mod_OvenSupplier3_matrix = VariantValidation.mod_OvenSupplier3(this, this.mod_OvenSupplier3);
    this.mod_OvenSupplier2_matrix = VariantValidation.mod_OvenSupplier2(this, this.mod_OvenSupplier2);
    this.mod_OvenGap2_matrix = VariantValidation.mod_OvenGap2(this, this.mod_OvenGap2);
    this.mod_OvenId2_matrix = VariantValidation.mod_OvenId2(this, this.mod_OvenId2);
    this.mod_OvenGap3_matrix = VariantValidation.mod_OvenGap3(this, this.mod_OvenGap3);
    this.mod_OvenId3_matrix = VariantValidation.mod_OvenId3(this, this.mod_OvenId3);
    this.mod_OvenShelffixedOverhangTop_matrix = VariantValidation.mod_OvenShelffixedOverhangTop(this, this.mod_OvenShelffixedOverhangTop);
    this.mod_OvenGap4_matrix = VariantValidation.mod_OvenGap4(this, this.mod_OvenGap4);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mf_Oven_NonNull(this);
...
class OD_M_mf_Oven_NonNull implements cbp_mf_Oven, adc_mf_Oven, ccm_mf_Oven, IPartParentsNonNull_mf_Oven {
  ...
  #calculateContainerModulesInternal = mf_Oven_calculateContainerModules;
