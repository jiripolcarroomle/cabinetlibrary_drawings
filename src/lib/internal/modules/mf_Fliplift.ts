...
export interface pc_mf_Fliplift extends dc_mf_Fliplift {
...
export interface adc_base_mf_Fliplift extends IModBaseProp
  , IModVarNonNull_mod_BackwallPos, IModVarNonNull_mod_CarcaseBackwallConstruction, IModVarNonNull_mod_CarcaseDepth, IModVarNonNull_mod_CarcaseHeight, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseWidth, IModVarNonNull_mod_FingergripTop, IModVarNonNull_mod_FlipliftType, IModVarNonNull_mod_FrontHeight, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontThk, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_HandleDrill, IModVarNonNull_mod_HandleLine, IModVarNonNull_mod_HandlePosLogic, IModVarNonNull_mod_HingePos1, IModVarNonNull_mod_HingePos2, IModVarNonNull_mod_HingePos3, IModVarNonNull_mod_HingePos4, IModVarNonNull_mod_HingePos5, IModVarNonNull_mod_HingePos6, IModVarNonNull_mod_FrontQtyElements, IModVarNonNull_mod_ShelffixedThk, IModVarNonNull_mod_ShelffixedType, IModVarNonNull_mod_SidepanelleftThk, IModVarNonNull_mod_SidepanelrightThk, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_HardwareColor, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontOversizeBtm, IModVarNonNull_mod_FrontOversizeLeft, IModVarNonNull_mod_FrontOversizeRight, IModVarNonNull_mod_FrontOversizeTop, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_HandleColor, IModVarNonNull_mod_HandleLength, IModVarNonNull_mod_HandleOffsetX, IModVarNonNull_mod_HandleOffsetY, IModVarNonNull_mod_HandlePosMatrix, IModVarNonNull_mod_HandlePosType, IModVarNonNull_mod_HandlestripPos, IModVarNonNull_mod_HeightPosInsertion, IModVarNonNull_mod_HingeType, IModVarNonNull_mod_PlinthAreaHeight, IModVarNonNull_mod_ShelfadjDrillDistance, IModVarNonNull_mod_ShelfadjDrillType, IModVarNonNull_mod_ShelfadjOffsetBack, IModVarNonNull_mod_ShelfadjOffsetFront, IModVarNonNull_mod_ShelfadjThk, IModVarNonNull_mod_ShelffixedBtm, IModVarNonNull_mod_ShelffixedPos, IModVarNonNull_mod_ShelffixedOffsetFront, IModVarNonNull_mod_ShelffixedOversizeFront, IModVarNonNull_mod_ShelffixedOversizeBack, IModVarNonNull_mod_HandleDesign, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_FingergripTopType, IModVarNonNull_mod_FingergripBtmType, IModVarNonNull_mod_ShelffixedTop, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_CarcaseSpaceDimension, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_ShelfadjDesign, IModVarNonNull_mod_FrontSplitDescriptor, IModVarNonNull_mod_PushtoopenColor, IModVarNonNull_mod_PushtoopenLine, IModVarNonNull_mod_PushtoopenOffset, IModVarNonNull_mod_PushtoopenPosition, IModVarNonNull_mod_PushtoopenType, IModVarNonNull_mod_CarcasePartInfo, IModVarNonNull_mod_HingeColor, IModVarNonNull_mod_HingeLogic, IModVarNonNull_mod_MountingPlateType, IModVarNonNull_mod_FlipliftHardwareColor, IModVarNonNull_mod_FlipliftHardwareType, IModVarNonNull_mod_FrontHeightSelection, IModVarNonNull_mod_ShelfadjColor, IModVarNonNull_mod_ShelfadjDescriptor, IModVarNonNull_mod_FrameFillingColor, IModVarNonNull_mod_FirstFront, IModVarNonNull_mod_LastFront, IModVarNonNull_mod_FrontSegmentType, IModVarNonNull_mod_FrontSegmentColor, IModVarNonNull_mod_FrontSegmentDescriptor {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mf_Fliplift extends adc_base_mf_Fliplift {
  addOD_M_mc_Fliplift01(index?: number): dc_mc_Fliplift01;
  addOD_M_mc_ShelfadjGroup01(index?: number): dc_mc_ShelfadjGroup01;
  addOD_M_me_ShelfadjMultiple01(index?: number): dc_me_ShelfadjMultiple01;
  addOD_M_me_ClothingOrganizer01(index?: number): dc_me_ClothingOrganizer01;
...
export interface ccm_mf_Fliplift extends adc_base_mf_Fliplift {
}


export class OD_M_mf_Fliplift extends OD_Base implements pc_mf_Fliplift, dc_mf_Fliplift
  , IModParents_mf_Fliplift, IModParents_mf_Door_mf_Fliplift_mf_RackArea, IModParents_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_mf_Door_mf_Fliplift_mf_RackArea
  , IModVar_mod_BackwallPos, IModVar_mod_CarcaseBackwallConstruction, IModVar_mod_CarcaseDepth, IModVar_mod_CarcaseHeight, IModVar_mod_CarcaseId, IModVar_mod_CarcaseWidth, IModVar_mod_FingergripTop, IModVar_mod_FlipliftType, IModVar_mod_FrontHeight, IModVar_mod_FrontId, IModVar_mod_FrontThk, IModVar_mod_FrontWidth, IModVar_mod_HandleDrill, IModVar_mod_HandleLine, IModVar_mod_HandlePosLogic, IModVar_mod_HingePos1, IModVar_mod_HingePos2, IModVar_mod_HingePos3, IModVar_mod_HingePos4, IModVar_mod_HingePos5, IModVar_mod_HingePos6, IModVar_mod_FrontQtyElements, IModVar_mod_ShelffixedThk, IModVar_mod_ShelffixedType, IModVar_mod_SidepanelleftThk, IModVar_mod_SidepanelrightThk, IModVar_mod_FrontPosStart, IModVar_mod_HardwareColor, IModVar_mod_FrontColor, IModVar_mod_FrontEdgeColor, IModVar_mod_FrontEdgeThk, IModVar_mod_FrontGapCarcase, IModVar_mod_FrontGapHor, IModVar_mod_FrontGapVert, IModVar_mod_FrontOversizeBtm, IModVar_mod_FrontOversizeLeft, IModVar_mod_FrontOversizeRight, IModVar_mod_FrontOversizeTop, IModVar_mod_FrontProgram, IModVar_mod_HandleColor, IModVar_mod_HandleLength, IModVar_mod_HandleOffsetX, IModVar_mod_HandleOffsetY, IModVar_mod_HandlePosMatrix, IModVar_mod_HandlePosType, IModVar_mod_HandlestripPos, IModVar_mod_HeightPosInsertion, IModVar_mod_HingeType, IModVar_mod_PlinthAreaHeight, IModVar_mod_ShelfadjDrillDistance, IModVar_mod_ShelfadjDrillType, IModVar_mod_ShelfadjOffsetBack, IModVar_mod_ShelfadjOffsetFront, IModVar_mod_ShelfadjThk, IModVar_mod_ShelffixedBtm, IModVar_mod_ShelffixedPos, IModVar_mod_ShelffixedOffsetFront, IModVar_mod_ShelffixedOversizeFront, IModVar_mod_ShelffixedOversizeBack, IModVar_mod_HandleDesign, IModVar_mod_Originpos, IModVar_mod_ParentName, IModVar_mod_FingergripTopType, IModVar_mod_FingergripBtmType, IModVar_mod_ShelffixedTop, IModVar_mod_ModuleName, IModVar_mod_CarcaseSpaceDimension, IModVar_mod_FrontDesign, IModVar_mod_ShelfadjDesign, IModVar_mod_FrontSplitDescriptor, IModVar_mod_PushtoopenColor, IModVar_mod_PushtoopenLine, IModVar_mod_PushtoopenOffset, IModVar_mod_PushtoopenPosition, IModVar_mod_PushtoopenType, IModVar_mod_CarcasePartInfo, IModVar_mod_HingeColor, IModVar_mod_HingeLogic, IModVar_mod_MountingPlateType, IModVar_mod_FlipliftHardwareColor, IModVar_mod_FlipliftHardwareType, IModVar_mod_FrontHeightSelection, IModVar_mod_ShelfadjColor, IModVar_mod_ShelfadjDescriptor, IModVar_mod_FrameFillingColor, IModVar_mod_FirstFront, IModVar_mod_LastFront, IModVar_mod_FrontSegmentType, IModVar_mod_FrontSegmentColor, IModVar_mod_FrontSegmentDescriptor {
  ...
  #prepareContextInternal = mf_Fliplift_prepareContext;
  seal(): IModuleNonNull_mf_Fliplift {
  ...
  override validateSelections(): void {
    ...
    this.mod_FlipliftHardwareColor_matrix = VariantValidation.mod_FlipliftHardwareColor(this, this.mod_FlipliftHardwareColor);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mf_Fliplift_NonNull(this);
...
class OD_M_mf_Fliplift_NonNull implements cbp_mf_Fliplift, adc_mf_Fliplift, ccm_mf_Fliplift, IPartParentsNonNull_mf_Fliplift, IPartParentsNonNull_mf_Door_mf_Fliplift_mf_RackArea, IPartParentsNonNull_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_mf_Door_mf_Fliplift_mf_RackArea {
  ...
  #calculateContainerModulesInternal = mf_Fliplift_calculateContainerModules;
