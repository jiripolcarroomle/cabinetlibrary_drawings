...
export interface adc_mc_Fliplift01 extends adc_base_mc_Fliplift01 {
  addOD_M_mc_FrontPanelGlass01(index?: number): dc_mc_FrontPanelGlass01;
  addOD_M_mc_FrontPanel01(index?: number): dc_mc_FrontPanel01;
  addOD_M_mc_Handle01(index?: number): dc_mc_Handle01;
  addOD_M_mc_Handlestrip01(index?: number): dc_mc_Handlestrip01;
...
export interface ccm_mc_Fliplift01 extends adc_base_mc_Fliplift01 {
}
...
export class OD_M_mc_Fliplift01 extends OD_Base implements dc_mc_Fliplift01
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_InteriorEquipmentHinge === undefined) {
      this.mod_InteriorEquipmentHinge = "None";
    }
  ...
  override validateSelections(): void {
    ...
    this.mod_FlipliftFrontNumber_matrix = VariantValidation.mod_FlipliftFrontNumber(this, this.mod_FlipliftFrontNumber);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Fliplift01_NonNull(this);
  ...
  addpart_FlipliftUnit(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_FlipliftUnit_PartVarsWritable {
    var c = new P_part_FlipliftUnit(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_Fliplift01_NonNull implements cbp_mc_Fliplift01, adc_mc_Fliplift01, ccm_mc_Fliplift01, IPartParentsNonNull_mc_BaseunitFridge01_mc_CornerFillerFront01_mc_Dishwasher01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_BaseunitFridge01_mc_CornerFillerFront01_mc_Dishwasher01_mc_Door01_mc_Drawer01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_Door01_mc_Drawer01_mc_Fliplift01, IPartParentsNonNull_mc_Fliplift01, IPartParentsNonNull_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01, IPartParentsNonNull_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_Fixedfront01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_Door01_mc_Fliplift01 {
  ...
  #calculateContainerModulesInternal = mc_Fliplift01_calculateContainerModules;
