...
import { md_FrontPlaceholder_createBuildPlan, md_FrontPlaceholder_afterDataCompletion, md_FrontPlaceholder_manufacturerDataCompletion, md_FrontPlaceholder_calculateContainerModules, md_FrontPlaceholder_prepareContext } from '../../modules/md_FrontPlaceholder';

export interface cbp_md_FrontPlaceholder extends IModBaseProp
...
export interface dc_md_FrontPlaceholder extends IModBaseProp
  , IModVar_mod_Width, IModVar_mod_Depth, IModVar_mod_Height {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
  seal(): IModuleNonNull_md_FrontPlaceholder;
  parent: IModParents_mr_StorageunitSingle;
...
export interface pc_md_FrontPlaceholder extends dc_md_FrontPlaceholder {
...
export interface adc_base_md_FrontPlaceholder extends IModBaseProp
  , IModVarNonNull_mod_Width, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Height {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_md_FrontPlaceholder extends adc_base_md_FrontPlaceholder {
  addOD_M_mf_Door(index?: number): dc_mf_Door;
  addOD_M_mf_Drawer(index?: number): dc_mf_Drawer;
  addOD_M_mf_Fliplift(index?: number): dc_mf_Fliplift;
  addOD_M_mf_RackArea(index?: number): dc_mf_RackArea;
...
export interface ccm_md_FrontPlaceholder extends adc_base_md_FrontPlaceholder {
}


export class OD_M_md_FrontPlaceholder extends OD_Base implements pc_md_FrontPlaceholder, dc_md_FrontPlaceholder
  ...
  constructor(parent: IModParents_mr_StorageunitSingle, manufacturerMode?: boolean) {
    super('md_FrontPlaceholder', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!, true);
    this.parent = parent;
    this._selfNonNull = new OD_M_md_FrontPlaceholder_NonNull(this);
  }
  parent: IModParents_mr_StorageunitSingle;
  _selfNonNull: OD_M_md_FrontPlaceholder_NonNull;
  ...
  #manufacturerDataCompletionInternal = md_FrontPlaceholder_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_md_FrontPlaceholder_NonNull(this);
  ...
  #prepareContextInternal = md_FrontPlaceholder_prepareContext;
  seal(): IModuleNonNull_md_FrontPlaceholder {
    this.afterDataCompletion();
    const adc = new OD_M_md_FrontPlaceholder_NonNull(this);
    return adc;
  }
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_md_FrontPlaceholder_NonNull(this);
  ...
  addpart_Placeholder(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Placeholder_PartVarsWritable {
    var c = new P_part_Placeholder(this._selfNonNull, x, y, z, dimx, dimy, dimz, true);
    this.p.push(c);
    return c;
  }

  override createBuildPlan(): void {
    var cbp = new OD_M_md_FrontPlaceholder_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_md_FrontPlaceholder_NonNull implements cbp_md_FrontPlaceholder, adc_md_FrontPlaceholder, ccm_md_FrontPlaceholder, IPartParentsNonNull_md_FrontArticleBuilder_md_FrontPlaceholder_mr_CornerunitStraight_mr_StorageunitSingle, IPartParentsNonNull_md_FrontArticleBuilder_md_FrontPlaceholder_mr_StorageunitSingle, IPartParentsNonNull_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_md_FrontArticleBuilder_md_FrontPlaceholder {
  constructor(parent: OD_M_md_FrontPlaceholder) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_md_FrontPlaceholder;
  ...
  #createBuildPlanInternal = md_FrontPlaceholder_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = md_FrontPlaceholder_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = md_FrontPlaceholder_calculateContainerModules;
