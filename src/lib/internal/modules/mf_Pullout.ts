...
export class OD_M_mf_Pullout extends OD_Base implements pc_mf_Pullout, dc_mf_Pullout
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_PulloutDesign === undefined) {
      this.mod_PulloutDesign = "arenaClassic";
    }
    if (this.mod_PulloutConnectionPosition === undefined) {
      this.mod_PulloutConnectionPosition = "left";
    }
    if (this.mod_FirstFront === undefined) {
  ...
  #dataCompletionSetDefaultScripts() {
    ...
    try {
      if (this.mod_FrontWidth === undefined) {
        ...
        // ####################### CUSTOM SCRIPTS ########################
        // ###############################################################
        // CUSTOMSCRIPT_mf_Pullout_mod_FrontWidth_SETDEFAULT
  ...
  #manufacturerDataCompletionInternal = mf_Pullout_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mf_Pullout_NonNull(this);
  ...
  #prepareContextInternal = mf_Pullout_prepareContext;
  seal(): IModuleNonNull_mf_Pullout {
    this.afterDataCompletion();
    const adc = new OD_M_mf_Pullout_NonNull(this);
    return adc;
  }

  addOD_M_mc_Pullout01(index?: number): dc_mc_Pullout01 {
    var m = new OD_M_mc_Pullout01(this);
    m.dataCompletion();
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mf_Pullout_NonNull(this);
  ...
  override createBuildPlan(): void {
    var cbp = new OD_M_mf_Pullout_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mf_Pullout_NonNull implements cbp_mf_Pullout, adc_mf_Pullout, ccm_mf_Pullout, IPartParentsNonNull_mf_Pullout {
  constructor(parent: OD_M_mf_Pullout) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mf_Pullout;
  ...
  #createBuildPlanInternal = mf_Pullout_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mf_Pullout_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = mf_Pullout_calculateContainerModules;
  ...
  addOD_M_mc_Pullout01(index?: number): dc_mc_Pullout01 {
    return this.#internalParent.addOD_M_mc_Pullout01(index);
  }
}
