...
import { IModuleNonNull_md_EquipmentPlaceholder, IModParents_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_mf_Door_mf_Fliplift_mf_RackArea, IModParents_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_md_FrontArticleBuilder_md_FrontPlaceholder, IPartParentsNonNull_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_mf_Door_mf_Fliplift_mf_RackArea, IPartParentsNonNull_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_md_FrontArticleBuilder_md_FrontPlaceholder } from '../mod-interfaces'
import { IModVar_mod_Depth, IModVarNonNull_mod_Depth, IModVar_mod_Height, IModVarNonNull_mod_Height, IModVar_mod_Width, IModVarNonNull_mod_Width } from '../var-interfaces'
import { VariantValidation, IMatrix_mod_Depth, IMatrix_mod_Height, IMatrix_mod_Width } from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_Placeholder } from '../part-add-interfaces';
import { md_EquipmentPlaceholder_createBuildPlan, md_EquipmentPlaceholder_afterDataCompletion, md_EquipmentPlaceholder_manufacturerDataCompletion, md_EquipmentPlaceholder_calculateContainerModules, md_EquipmentPlaceholder_prepareContext } from '../../modules/md_EquipmentPlaceholder';

export interface cbp_md_EquipmentPlaceholder extends IModBaseProp
  , IPartAdd_part_Placeholder, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Height, IModVarNonNull_mod_Width {
...
export interface dc_md_EquipmentPlaceholder extends IModBaseProp
  , IModVar_mod_Depth, IModVar_mod_Height, IModVar_mod_Width {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
  seal(): IModuleNonNull_md_EquipmentPlaceholder;
  parent: IModParents_mf_Door;
...
export interface pc_md_EquipmentPlaceholder extends dc_md_EquipmentPlaceholder {
...
export interface adc_base_md_EquipmentPlaceholder extends IModBaseProp
  , IModVarNonNull_mod_Depth, IModVarNonNull_mod_Height, IModVarNonNull_mod_Width {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_md_EquipmentPlaceholder extends adc_base_md_EquipmentPlaceholder {
  addOD_M_me_ShelfadjMultiple01(index?: number): dc_me_ShelfadjMultiple01;
  addOD_M_me_ClothingOrganizer01(index?: number): dc_me_ClothingOrganizer01;
}

export interface ccm_md_EquipmentPlaceholder extends adc_base_md_EquipmentPlaceholder {
}


export class OD_M_md_EquipmentPlaceholder extends OD_Base implements pc_md_EquipmentPlaceholder, dc_md_EquipmentPlaceholder
  , IModParents_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_mf_Door_mf_Fliplift_mf_RackArea, IModParents_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_md_FrontArticleBuilder_md_FrontPlaceholder
  , IModVar_mod_Depth, IModVar_mod_Height, IModVar_mod_Width {
  constructor(parent: IModParents_mf_Door, manufacturerMode?: boolean) {
    super('md_EquipmentPlaceholder', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!, true);
    this.parent = parent;
    this._selfNonNull = new OD_M_md_EquipmentPlaceholder_NonNull(this);
  }
  parent: IModParents_mf_Door;
  _selfNonNull: OD_M_md_EquipmentPlaceholder_NonNull;

  override variants: string[] = ['mod_Depth', 'mod_Height', 'mod_Width',];
  #mod_Depth?: number;
  ...
  #manufacturerDataCompletionInternal = md_EquipmentPlaceholder_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_md_EquipmentPlaceholder_NonNull(this);
  ...
  #prepareContextInternal = md_EquipmentPlaceholder_prepareContext;
  seal(): IModuleNonNull_md_EquipmentPlaceholder {
    this.afterDataCompletion();
    const adc = new OD_M_md_EquipmentPlaceholder_NonNull(this);
    return adc;
  }
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_md_EquipmentPlaceholder_NonNull(this);
  ...
  override createBuildPlan(): void {
    var cbp = new OD_M_md_EquipmentPlaceholder_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_md_EquipmentPlaceholder_NonNull implements cbp_md_EquipmentPlaceholder, adc_md_EquipmentPlaceholder, ccm_md_EquipmentPlaceholder, IPartParentsNonNull_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_mf_Door_mf_Fliplift_mf_RackArea, IPartParentsNonNull_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_md_FrontArticleBuilder_md_FrontPlaceholder {
  constructor(parent: OD_M_md_EquipmentPlaceholder) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_md_EquipmentPlaceholder;
  ...
  #createBuildPlanInternal = md_EquipmentPlaceholder_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = md_EquipmentPlaceholder_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = md_EquipmentPlaceholder_calculateContainerModules;
