...
export interface pc_mc_Countertop01 extends dc_mc_Countertop01 {
...
export interface adc_base_mc_Countertop01 extends IModBaseProp
...
export interface adc_mc_Countertop01 extends adc_base_mc_Countertop01 {
}

export interface ccm_mc_Countertop01 extends adc_base_mc_Countertop01 {
}


export class OD_M_mc_Countertop01 extends OD_Base implements pc_mc_Countertop01, dc_mc_Countertop01
  ...
  #prepareContextInternal = mc_Countertop01_prepareContext;
  seal(): IModuleNonNull_mc_Countertop01 {
  ...
  override validateSelections(): void {
    this.mod_CountertopLeftEndType_matrix = VariantValidation.mod_CountertopLeftEndType(this, this.mod_CountertopLeftEndType);
    this.mod_CountertopColor_matrix = VariantValidation.mod_CountertopColor(this, this.mod_CountertopColor);
    this.mod_CountertopEdgeBackType_matrix = VariantValidation.mod_CountertopEdgeBackType(this, this.mod_CountertopEdgeBackType);
    this.mod_CountertopEdgeFrontType_matrix = VariantValidation.mod_CountertopEdgeFrontType(this, this.mod_CountertopEdgeFrontType);
    this.mod_CountertopEdgeLeftType_matrix = VariantValidation.mod_CountertopEdgeLeftType(this, this.mod_CountertopEdgeLeftType);
    this.mod_CountertopEdgeRightType_matrix = VariantValidation.mod_CountertopEdgeRightType(this, this.mod_CountertopEdgeRightType);
    this.mod_CountertopId_matrix = VariantValidation.mod_CountertopId(this, this.mod_CountertopId);
    this.mod_CountertopDepth_matrix = VariantValidation.mod_CountertopDepth(this, this.mod_CountertopDepth);
    this.mod_CountertopThk_matrix = VariantValidation.mod_CountertopThk(this, this.mod_CountertopThk);
    this.mod_CountertopRightEndType_matrix = VariantValidation.mod_CountertopRightEndType(this, this.mod_CountertopRightEndType);
    this.mod_CountertopWidth_matrix = VariantValidation.mod_CountertopWidth(this, this.mod_CountertopWidth);
    this.mod_CountertopConnectionLengthLeft_matrix = VariantValidation.mod_CountertopConnectionLengthLeft(this, this.mod_CountertopConnectionLengthLeft);
    this.mod_CountertopOverhangLeft_matrix = VariantValidation.mod_CountertopOverhangLeft(this, this.mod_CountertopOverhangLeft);
    this.mod_CountertopOverhangRight_matrix = VariantValidation.mod_CountertopOverhangRight(this, this.mod_CountertopOverhangRight);
    this.mod_CountertopConnectionLengthRight_matrix = VariantValidation.mod_CountertopConnectionLengthRight(this, this.mod_CountertopConnectionLengthRight);
    this.mod_CountertopConnectionOversize_matrix = VariantValidation.mod_CountertopConnectionOversize(this, this.mod_CountertopConnectionOversize);
    this.mod_CountertopProgram_matrix = VariantValidation.mod_CountertopProgram(this, this.mod_CountertopProgram);
  }

  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Countertop01_NonNull(this);
  ...
  addpart_Countertop(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Countertop_PartVarsWritable {
    var c = new P_part_Countertop(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_CountertopGroup(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_CountertopGroup_PartVarsWritable {
    var c = new P_part_CountertopGroup(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_Countertop01_NonNull implements cbp_mc_Countertop01, adc_mc_Countertop01, ccm_mc_Countertop01, IPartParentsNonNull_mc_Countertop01 {
  ...
  #calculateContainerModulesInternal = mc_Countertop01_calculateContainerModules;
