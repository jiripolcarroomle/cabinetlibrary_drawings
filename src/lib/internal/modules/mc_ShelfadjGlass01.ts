...
import { mc_ShelfadjGlass01_createBuildPlan, mc_ShelfadjGlass01_afterDataCompletion, mc_ShelfadjGlass01_manufacturerDataCompletion, mc_ShelfadjGlass01_calculateContainerModules, mc_ShelfadjGlass01_prepareContext } from '../../modules/mc_ShelfadjGlass01';
...
export interface pc_mc_ShelfadjGlass01 extends dc_mc_ShelfadjGlass01 {
...
export interface adc_base_mc_ShelfadjGlass01 extends IModBaseProp
  , IModVarNonNull_mod_Width, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Height, IModVarNonNull_mod_ShelfadjThk, IModVarNonNull_mod_CarcaseColor, IModVarNonNull_mod_CarcaseEdgeColor, IModVarNonNull_mod_CarcaseEdgeFrontColor, IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_ShelfadjOffsetFront, IModVarNonNull_mod_ShelfadjOffsetBack, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_HardwareId, IModVarNonNull_mod_ShelfadjColor, IModVarNonNull_mod_CarcaseProgram {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_ShelfadjGlass01 extends adc_base_mc_ShelfadjGlass01 {
}

export interface ccm_mc_ShelfadjGlass01 extends adc_base_mc_ShelfadjGlass01 {
}


export class OD_M_mc_ShelfadjGlass01 extends OD_Base implements pc_mc_ShelfadjGlass01, dc_mc_ShelfadjGlass01
  ...
  override variants: string[] = ['mod_Width', 'mod_Depth', 'mod_Height', 'mod_ShelfadjThk', 'mod_CarcaseColor', 'mod_CarcaseEdgeColor', 'mod_CarcaseEdgeFrontColor', 'mod_CarcaseId', 'mod_ShelfadjOffsetFront', 'mod_ShelfadjOffsetBack', 'mod_ModuleName', 'mod_HardwareId', 'mod_ShelfadjColor', 'mod_CarcaseProgram',];
  #mod_Width?: number;
  ...
  #prepareContextInternal = mc_ShelfadjGlass01_prepareContext;
  seal(): IModuleNonNull_mc_ShelfadjGlass01 {
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_ShelfadjGlass01_NonNull(this);
  ...
  addpart_ShelfadjGlass(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_ShelfadjGlass_PartVarsWritable {
    var c = new P_part_ShelfadjGlass(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_ShelfadjGlass01_NonNull implements cbp_mc_ShelfadjGlass01, adc_mc_ShelfadjGlass01, ccm_mc_ShelfadjGlass01, IPartParentsNonNull_mc_ShelfadjGlass01 {
  ...
  #calculateContainerModulesInternal = mc_ShelfadjGlass01_calculateContainerModules;
