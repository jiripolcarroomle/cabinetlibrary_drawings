...
export interface pc_mc_StorageunitShelftop04 extends dc_mc_StorageunitShelftop04 {
...
export interface adc_base_mc_StorageunitShelftop04 extends IModBaseProp
  , IModVarNonNull_mod_CarcaseId, IModVarNonNull_mod_CarcaseVisTop, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Height, IModVarNonNull_mod_ShelftopConstruction, IModVarNonNull_mod_Width, IModVarNonNull_mod_CarcaseColor, IModVarNonNull_mod_CarcaseOutsideColor, IModVarNonNull_mod_CarcaseEdgeBackColor, IModVarNonNull_mod_CarcaseEdgeColor, IModVarNonNull_mod_CarcaseEdgeFrontColor, IModVarNonNull_mod_CarcaseProgram, IModVarNonNull_mod_CarcaseOutsideProgram, IModVarNonNull_mod_EdgeFrontType, IModVarNonNull_mod_EdgeBackType, IModVarNonNull_mod_EdgeLeftType, IModVarNonNull_mod_EdgeRightType, IModVarNonNull_mod_EdgeJointType, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_CarcaseConnectionLeftTop, IModVarNonNull_mod_CarcaseConnectionRightTop, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_HardwareColor, IModVarNonNull_mod_ParentName, IModVarNonNull_mod_FittingConnectionLeftTop, IModVarNonNull_mod_FittingConnectionRightTop, IModVarNonNull_mod_FittingConnectionTopVert, IModVarNonNull_mod_CarcasePartConnectionTopVert, IModVarNonNull_mod_BackHeight, IModVarNonNull_mod_CarcaseDepth, IModVarNonNull_mod_SlopeAngle, IModVarNonNull_mod_SlopedCeilingConstruction, IModVarNonNull_mod_CarcaseHeight, IModVarNonNull_mod_TopDepth, IModVarNonNull_mod_PartInfo {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_StorageunitShelftop04 extends adc_base_mc_StorageunitShelftop04 {
}

export interface ccm_mc_StorageunitShelftop04 extends adc_base_mc_StorageunitShelftop04 {
}


export class OD_M_mc_StorageunitShelftop04 extends OD_Base implements pc_mc_StorageunitShelftop04, dc_mc_StorageunitShelftop04
  ...
  #prepareContextInternal = mc_StorageunitShelftop04_prepareContext;
  seal(): IModuleNonNull_mc_StorageunitShelftop04 {
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_StorageunitShelftop04_NonNull(this);
  ...
  addpart_SlopedCeilingShelftopAngle(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_SlopedCeilingShelftopAngle_PartVarsWritable {
    var c = new P_part_SlopedCeilingShelftopAngle(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_SlopedCeilingShelftopHor(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_SlopedCeilingShelftopHor_PartVarsWritable {
    var c = new P_part_SlopedCeilingShelftopHor(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_StorageunitShelftop04_NonNull implements cbp_mc_StorageunitShelftop04, adc_mc_StorageunitShelftop04, ccm_mc_StorageunitShelftop04, IPartParentsNonNull_mc_StorageunitShelftop04 {
  ...
  #calculateContainerModulesInternal = mc_StorageunitShelftop04_calculateContainerModules;
