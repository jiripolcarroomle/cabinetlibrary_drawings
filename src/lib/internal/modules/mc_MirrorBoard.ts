...
import { IModParents_mr_MirrorBoard } from '../mod-interfaces'
import { IP_part_MirrorBoard_PartVarsWritable, P_part_MirrorBoard } from '../parts/part_MirrorBoard'
import { IP_part_MirrorBoardGroup_PartVarsWritable, P_part_MirrorBoardGroup } from '../parts/part_MirrorBoardGroup'
import { OD_M_mc_Mirror, dc_mc_Mirror } from './mc_Mirror'
import { IModuleNonNull_mc_MirrorBoard, IModParents_mc_MirrorBoard_mr_MirrorBoard, IModParents_mc_MirrorBoard, IPartParentsNonNull_mc_MirrorBoard_mr_MirrorBoard, IPartParentsNonNull_mc_MirrorBoard } from '../mod-interfaces'
import { IModVar_mod_MirrorBoardColor, IModVarNonNull_mod_MirrorBoardColor, IModVar_mod_MirrorBoardProgram, IModVarNonNull_mod_MirrorBoardProgram, IModVar_mod_MirrorBoardId, IModVarNonNull_mod_MirrorBoardId, IModVar_mod_Width, IModVarNonNull_mod_Width, IModVar_mod_Height, IModVarNonNull_mod_Height, IModVar_mod_MirrorBoardThickness, IModVarNonNull_mod_MirrorBoardThickness, IModVar_mod_MirrorColor, IModVarNonNull_mod_MirrorColor, IModVar_mod_MirrorWidth, IModVarNonNull_mod_MirrorWidth, IModVar_mod_MirrorHeight, IModVarNonNull_mod_MirrorHeight, IModVar_mod_MirrorThickness, IModVarNonNull_mod_MirrorThickness, IModVar_mod_MirrorPositionWidth, IModVarNonNull_mod_MirrorPositionWidth, IModVar_mod_MirrorPositionHeight, IModVarNonNull_mod_MirrorPositionHeight } from '../var-interfaces'
import { VariantValidation, IMatrix_mod_MirrorBoardColor, IMatrix_mod_MirrorBoardProgram, IMatrix_mod_MirrorBoardId, IMatrix_mod_Width, IMatrix_mod_Height, IMatrix_mod_MirrorBoardThickness, IMatrix_mod_MirrorColor, IMatrix_mod_MirrorWidth, IMatrix_mod_MirrorHeight, IMatrix_mod_MirrorThickness, IMatrix_mod_MirrorPositionWidth, IMatrix_mod_MirrorPositionHeight } from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { IPartAdd_part_MirrorBoard, IPartAdd_part_MirrorBoardGroup } from '../part-add-interfaces';
import { mc_MirrorBoard_createBuildPlan, mc_MirrorBoard_afterDataCompletion, mc_MirrorBoard_manufacturerDataCompletion, mc_MirrorBoard_calculateContainerModules, mc_MirrorBoard_prepareContext } from '../../modules/mc_MirrorBoard';

export interface cbp_mc_MirrorBoard extends IModBaseProp
  , IPartAdd_part_MirrorBoard, IPartAdd_part_MirrorBoardGroup, IModVarNonNull_mod_MirrorBoardColor, IModVarNonNull_mod_MirrorBoardProgram, IModVarNonNull_mod_MirrorBoardId, IModVarNonNull_mod_Width, IModVarNonNull_mod_Height, IModVarNonNull_mod_MirrorBoardThickness, IModVarNonNull_mod_MirrorColor, IModVarNonNull_mod_MirrorWidth, IModVarNonNull_mod_MirrorHeight, IModVarNonNull_mod_MirrorThickness, IModVarNonNull_mod_MirrorPositionWidth, IModVarNonNull_mod_MirrorPositionHeight {
  parent: IModParents_mr_MirrorBoard;
...
export interface dc_mc_MirrorBoard extends IModBaseProp
  , IModVar_mod_MirrorBoardColor, IModVar_mod_MirrorBoardProgram, IModVar_mod_MirrorBoardId, IModVar_mod_Width, IModVar_mod_Height, IModVar_mod_MirrorBoardThickness, IModVar_mod_MirrorColor, IModVar_mod_MirrorWidth, IModVar_mod_MirrorHeight, IModVar_mod_MirrorThickness, IModVar_mod_MirrorPositionWidth, IModVar_mod_MirrorPositionHeight {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
  seal(): IModuleNonNull_mc_MirrorBoard;
  parent: IModParents_mr_MirrorBoard;
  addOD_M_mc_Mirror(index?: number): dc_mc_Mirror;
}

export interface pc_mc_MirrorBoard extends dc_mc_MirrorBoard {
...
export interface adc_base_mc_MirrorBoard extends IModBaseProp
  , IModVarNonNull_mod_MirrorBoardColor, IModVarNonNull_mod_MirrorBoardProgram, IModVarNonNull_mod_MirrorBoardId, IModVarNonNull_mod_Width, IModVarNonNull_mod_Height, IModVarNonNull_mod_MirrorBoardThickness, IModVarNonNull_mod_MirrorColor, IModVarNonNull_mod_MirrorWidth, IModVarNonNull_mod_MirrorHeight, IModVarNonNull_mod_MirrorThickness, IModVarNonNull_mod_MirrorPositionWidth, IModVarNonNull_mod_MirrorPositionHeight {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_MirrorBoard extends adc_base_mc_MirrorBoard {
  addOD_M_mc_Mirror(index?: number): dc_mc_Mirror;
}

export interface ccm_mc_MirrorBoard extends adc_base_mc_MirrorBoard {
}


export class OD_M_mc_MirrorBoard extends OD_Base implements pc_mc_MirrorBoard, dc_mc_MirrorBoard
  , IModParents_mc_MirrorBoard_mr_MirrorBoard, IModParents_mc_MirrorBoard
  , IModVar_mod_MirrorBoardColor, IModVar_mod_MirrorBoardProgram, IModVar_mod_MirrorBoardId, IModVar_mod_Width, IModVar_mod_Height, IModVar_mod_MirrorBoardThickness, IModVar_mod_MirrorColor, IModVar_mod_MirrorWidth, IModVar_mod_MirrorHeight, IModVar_mod_MirrorThickness, IModVar_mod_MirrorPositionWidth, IModVar_mod_MirrorPositionHeight {
  constructor(parent: IModParents_mr_MirrorBoard, manufacturerMode?: boolean) {
    super('mc_MirrorBoard', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_MirrorBoard_NonNull(this);
  }
  parent: IModParents_mr_MirrorBoard;
  _selfNonNull: OD_M_mc_MirrorBoard_NonNull;

  override variants: string[] = ['mod_MirrorBoardColor', 'mod_MirrorBoardProgram', 'mod_MirrorBoardId', 'mod_Width', 'mod_Height', 'mod_MirrorBoardThickness', 'mod_MirrorColor', 'mod_MirrorWidth', 'mod_MirrorHeight', 'mod_MirrorThickness', 'mod_MirrorPositionWidth', 'mod_MirrorPositionHeight',];
  #mod_MirrorBoardColor?: string;
  get mod_MirrorBoardColor(): string | undefined { return this.#mod_MirrorBoardColor }
  set mod_MirrorBoardColor(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_MirrorBoardColor' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_MirrorBoardColor === value) return;
    this.#mod_MirrorBoardColor = value;
  }

  mod_MirrorBoardColor_matrix?: IMatrix_mod_MirrorBoardColor;
  #mod_MirrorBoardProgram?: string;
  get mod_MirrorBoardProgram(): string | undefined { return this.#mod_MirrorBoardProgram }
  set mod_MirrorBoardProgram(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_MirrorBoardProgram' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_MirrorBoardProgram === value) return;
    this.#mod_MirrorBoardProgram = value;
  }

  mod_MirrorBoardProgram_matrix?: IMatrix_mod_MirrorBoardProgram;
  #mod_MirrorBoardId?: string;
  get mod_MirrorBoardId(): string | undefined { return this.#mod_MirrorBoardId }
  set mod_MirrorBoardId(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_MirrorBoardId' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_MirrorBoardId === value) return;
    this.#mod_MirrorBoardId = value;
  }

  mod_MirrorBoardId_matrix?: IMatrix_mod_MirrorBoardId;
  #mod_Width?: number;
  ...
  #mod_MirrorBoardThickness?: number;
  get mod_MirrorBoardThickness(): number | undefined { return this.#mod_MirrorBoardThickness }
  set mod_MirrorBoardThickness(value: number | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_MirrorBoardThickness' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_MirrorBoardThickness === value) return;
    this.#mod_MirrorBoardThickness = value;
  }

  mod_MirrorBoardThickness_matrix?: IMatrix_mod_MirrorBoardThickness;
  #mod_MirrorColor?: string;
  get mod_MirrorColor(): string | undefined { return this.#mod_MirrorColor }
  set mod_MirrorColor(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_MirrorColor' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_MirrorColor === value) return;
    this.#mod_MirrorColor = value;
  }

  mod_MirrorColor_matrix?: IMatrix_mod_MirrorColor;
  #mod_MirrorWidth?: number;
  get mod_MirrorWidth(): number | undefined { return this.#mod_MirrorWidth }
  set mod_MirrorWidth(value: number | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_MirrorWidth' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_MirrorWidth === value) return;
    this.#mod_MirrorWidth = value;
  }

  mod_MirrorWidth_matrix?: IMatrix_mod_MirrorWidth;
  #mod_MirrorHeight?: number;
  get mod_MirrorHeight(): number | undefined { return this.#mod_MirrorHeight }
  set mod_MirrorHeight(value: number | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_MirrorHeight' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_MirrorHeight === value) return;
    this.#mod_MirrorHeight = value;
  }

  mod_MirrorHeight_matrix?: IMatrix_mod_MirrorHeight;
  #mod_MirrorThickness?: number;
  get mod_MirrorThickness(): number | undefined { return this.#mod_MirrorThickness }
  set mod_MirrorThickness(value: number | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_MirrorThickness' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_MirrorThickness === value) return;
    this.#mod_MirrorThickness = value;
  }

  mod_MirrorThickness_matrix?: IMatrix_mod_MirrorThickness;
  #mod_MirrorPositionWidth?: number;
  get mod_MirrorPositionWidth(): number | undefined { return this.#mod_MirrorPositionWidth }
  set mod_MirrorPositionWidth(value: number | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_MirrorPositionWidth' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_MirrorPositionWidth === value) return;
    this.#mod_MirrorPositionWidth = value;
  }

  mod_MirrorPositionWidth_matrix?: IMatrix_mod_MirrorPositionWidth;
  #mod_MirrorPositionHeight?: number;
  get mod_MirrorPositionHeight(): number | undefined { return this.#mod_MirrorPositionHeight }
  set mod_MirrorPositionHeight(value: number | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_MirrorPositionHeight' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_MirrorPositionHeight === value) return;
    this.#mod_MirrorPositionHeight = value;
  }

  mod_MirrorPositionHeight_matrix?: IMatrix_mod_MirrorPositionHeight;
  override getAttributes(): Map<string, any> {
    let res = new Map<string, any>();
    res.set('mod_MirrorBoardColor', this.mod_MirrorBoardColor);
    res.set('mod_MirrorBoardProgram', this.mod_MirrorBoardProgram);
    res.set('mod_MirrorBoardId', this.mod_MirrorBoardId);
    res.set('mod_Width', this.mod_Width);
    res.set('mod_Height', this.mod_Height);
    res.set('mod_MirrorBoardThickness', this.mod_MirrorBoardThickness);
    res.set('mod_MirrorColor', this.mod_MirrorColor);
    res.set('mod_MirrorWidth', this.mod_MirrorWidth);
    res.set('mod_MirrorHeight', this.mod_MirrorHeight);
    res.set('mod_MirrorThickness', this.mod_MirrorThickness);
    res.set('mod_MirrorPositionWidth', this.mod_MirrorPositionWidth);
    res.set('mod_MirrorPositionHeight', this.mod_MirrorPositionHeight);
    return res;
  }
  override loadJson(json: any, withSubModules: boolean = true, manufacturerMode: boolean) {
    ...
    // only take over the attributes we know...
    {
      ...
      const val = _toString(json['attributes']['mod_MirrorBoardColor'], 'mod_MirrorBoardColor');
      internal_leaveValidateVariant();
      this.mod_MirrorBoardColor = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_MirrorBoardProgram');
      const val = _toString(json['attributes']['mod_MirrorBoardProgram'], 'mod_MirrorBoardProgram');
      internal_leaveValidateVariant();
      this.mod_MirrorBoardProgram = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_MirrorBoardId');
      const val = _toString(json['attributes']['mod_MirrorBoardId'], 'mod_MirrorBoardId');
      internal_leaveValidateVariant();
      this.mod_MirrorBoardId = val;
    }
    {
    ...
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_MirrorBoardThickness');
      const val = _toFloat(json['attributes']['mod_MirrorBoardThickness'], 'mod_MirrorBoardThickness');
      internal_leaveValidateVariant();
      this.mod_MirrorBoardThickness = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_MirrorColor');
      const val = _toString(json['attributes']['mod_MirrorColor'], 'mod_MirrorColor');
      internal_leaveValidateVariant();
      this.mod_MirrorColor = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_MirrorWidth');
      const val = _toFloat(json['attributes']['mod_MirrorWidth'], 'mod_MirrorWidth');
      internal_leaveValidateVariant();
      this.mod_MirrorWidth = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_MirrorHeight');
      const val = _toFloat(json['attributes']['mod_MirrorHeight'], 'mod_MirrorHeight');
      internal_leaveValidateVariant();
      this.mod_MirrorHeight = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_MirrorThickness');
      const val = _toFloat(json['attributes']['mod_MirrorThickness'], 'mod_MirrorThickness');
      internal_leaveValidateVariant();
      this.mod_MirrorThickness = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_MirrorPositionWidth');
      const val = _toFloat(json['attributes']['mod_MirrorPositionWidth'], 'mod_MirrorPositionWidth');
      internal_leaveValidateVariant();
      this.mod_MirrorPositionWidth = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_MirrorPositionHeight');
      const val = _toFloat(json['attributes']['mod_MirrorPositionHeight'], 'mod_MirrorPositionHeight');
      internal_leaveValidateVariant();
      this.mod_MirrorPositionHeight = val;
    }
  ...
  #dataCompletionAssignDerivedData() {
    ...
    if (this.mod_MirrorBoardColor === undefined) {
      let s = this.parentBase;
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_MirrorBoardColor')) {
          let pv = <IModVar_mod_MirrorBoardColor>s;
          if (pv.mod_MirrorBoardColor !== undefined) {
            this.mod_MirrorBoardColor = (<IModVar_mod_MirrorBoardColor>s).mod_MirrorBoardColor;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_MirrorBoardProgram === undefined) {
      let s = this.parentBase;
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_MirrorBoardProgram')) {
          let pv = <IModVar_mod_MirrorBoardProgram>s;
          if (pv.mod_MirrorBoardProgram !== undefined) {
            this.mod_MirrorBoardProgram = (<IModVar_mod_MirrorBoardProgram>s).mod_MirrorBoardProgram;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_MirrorBoardId === undefined) {
      let s = this.parentBase;
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_MirrorBoardId')) {
          let pv = <IModVar_mod_MirrorBoardId>s;
          if (pv.mod_MirrorBoardId !== undefined) {
            this.mod_MirrorBoardId = (<IModVar_mod_MirrorBoardId>s).mod_MirrorBoardId;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_MirrorBoardThickness === undefined) {
      let s = this.parentBase;
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_MirrorBoardThickness')) {
          let pv = <IModVar_mod_MirrorBoardThickness>s;
          if (pv.mod_MirrorBoardThickness !== undefined) {
            this.mod_MirrorBoardThickness = (<IModVar_mod_MirrorBoardThickness>s).mod_MirrorBoardThickness;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_MirrorColor === undefined) {
      let s = this.parentBase;
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_MirrorColor')) {
          let pv = <IModVar_mod_MirrorColor>s;
          if (pv.mod_MirrorColor !== undefined) {
            this.mod_MirrorColor = (<IModVar_mod_MirrorColor>s).mod_MirrorColor;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_MirrorWidth === undefined) {
      let s = this.parentBase;
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_MirrorWidth')) {
          let pv = <IModVar_mod_MirrorWidth>s;
          if (pv.mod_MirrorWidth !== undefined) {
            this.mod_MirrorWidth = (<IModVar_mod_MirrorWidth>s).mod_MirrorWidth;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_MirrorHeight === undefined) {
      let s = this.parentBase;
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_MirrorHeight')) {
          let pv = <IModVar_mod_MirrorHeight>s;
          if (pv.mod_MirrorHeight !== undefined) {
            this.mod_MirrorHeight = (<IModVar_mod_MirrorHeight>s).mod_MirrorHeight;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_MirrorThickness === undefined) {
      let s = this.parentBase;
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_MirrorThickness')) {
          let pv = <IModVar_mod_MirrorThickness>s;
          if (pv.mod_MirrorThickness !== undefined) {
            this.mod_MirrorThickness = (<IModVar_mod_MirrorThickness>s).mod_MirrorThickness;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_MirrorPositionWidth === undefined) {
      let s = this.parentBase;
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_MirrorPositionWidth')) {
          let pv = <IModVar_mod_MirrorPositionWidth>s;
          if (pv.mod_MirrorPositionWidth !== undefined) {
            this.mod_MirrorPositionWidth = (<IModVar_mod_MirrorPositionWidth>s).mod_MirrorPositionWidth;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_MirrorPositionHeight === undefined) {
      let s = this.parentBase;
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_MirrorPositionHeight')) {
          let pv = <IModVar_mod_MirrorPositionHeight>s;
          if (pv.mod_MirrorPositionHeight !== undefined) {
            this.mod_MirrorPositionHeight = (<IModVar_mod_MirrorPositionHeight>s).mod_MirrorPositionHeight;
            break;
          };
        }
        s = s.parentBase;
  ...
  #manufacturerDataCompletionInternal = mc_MirrorBoard_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_MirrorBoard_NonNull(this);
  ...
  #prepareContextInternal = mc_MirrorBoard_prepareContext;
  seal(): IModuleNonNull_mc_MirrorBoard {
    this.afterDataCompletion();
    const adc = new OD_M_mc_MirrorBoard_NonNull(this);
    return adc;
  }

  addOD_M_mc_Mirror(index?: number): dc_mc_Mirror {
    var m = new OD_M_mc_Mirror(this);
    m.dataCompletion();
  ...
  override validateSelections(): void {
    this.mod_MirrorBoardColor_matrix = VariantValidation.mod_MirrorBoardColor(this, this.mod_MirrorBoardColor);
    this.mod_MirrorBoardProgram_matrix = VariantValidation.mod_MirrorBoardProgram(this, this.mod_MirrorBoardProgram);
    this.mod_MirrorBoardId_matrix = VariantValidation.mod_MirrorBoardId(this, this.mod_MirrorBoardId);
    ...
    this.mod_MirrorBoardThickness_matrix = VariantValidation.mod_MirrorBoardThickness(this, this.mod_MirrorBoardThickness);
    this.mod_MirrorColor_matrix = VariantValidation.mod_MirrorColor(this, this.mod_MirrorColor);
    this.mod_MirrorWidth_matrix = VariantValidation.mod_MirrorWidth(this, this.mod_MirrorWidth);
    this.mod_MirrorHeight_matrix = VariantValidation.mod_MirrorHeight(this, this.mod_MirrorHeight);
    this.mod_MirrorThickness_matrix = VariantValidation.mod_MirrorThickness(this, this.mod_MirrorThickness);
    this.mod_MirrorPositionWidth_matrix = VariantValidation.mod_MirrorPositionWidth(this, this.mod_MirrorPositionWidth);
    this.mod_MirrorPositionHeight_matrix = VariantValidation.mod_MirrorPositionHeight(this, this.mod_MirrorPositionHeight);
  }

  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_MirrorBoard_NonNull(this);
    ccm.calculateContainerModules();
    this.m.forEach(subMod => subMod.calculateContainerModules());
  }

  addpart_MirrorBoard(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_MirrorBoard_PartVarsWritable {
    var c = new P_part_MirrorBoard(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_MirrorBoardGroup(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_MirrorBoardGroup_PartVarsWritable {
    var c = new P_part_MirrorBoardGroup(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }

  override createBuildPlan(): void {
    var cbp = new OD_M_mc_MirrorBoard_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_MirrorBoard_NonNull implements cbp_mc_MirrorBoard, adc_mc_MirrorBoard, ccm_mc_MirrorBoard, IPartParentsNonNull_mc_MirrorBoard_mr_MirrorBoard, IPartParentsNonNull_mc_MirrorBoard {
  constructor(parent: OD_M_mc_MirrorBoard) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_MirrorBoard;
  ...
  #createBuildPlanInternal = mc_MirrorBoard_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_MirrorBoard_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = mc_MirrorBoard_calculateContainerModules;
  ...
  parent: IModParents_mr_MirrorBoard;
  addpart_MirrorBoard(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_MirrorBoard_PartVarsWritable {
    return this.#internalParent.addpart_MirrorBoard(x, y, z, dimx, dimy, dimz);
  }
  addpart_MirrorBoardGroup(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_MirrorBoardGroup_PartVarsWritable {
    return this.#internalParent.addpart_MirrorBoardGroup(x, y, z, dimx, dimy, dimz);
  }
  get mod_MirrorBoardColor(): string {
    return this.#internalParent.mod_MirrorBoardColor!;
  }
  get mod_MirrorBoardColor_matrix(): IMatrix_mod_MirrorBoardColor {
    return this.#internalParent.mod_MirrorBoardColor_matrix!;
  }
  get mod_MirrorBoardProgram(): string {
    return this.#internalParent.mod_MirrorBoardProgram!;
  }
  get mod_MirrorBoardProgram_matrix(): IMatrix_mod_MirrorBoardProgram {
    return this.#internalParent.mod_MirrorBoardProgram_matrix!;
  }
  get mod_MirrorBoardId(): string {
    return this.#internalParent.mod_MirrorBoardId!;
  }
  ...
  get mod_MirrorBoardThickness(): number {
    return this.#internalParent.mod_MirrorBoardThickness!;
  }
  get mod_MirrorColor(): string {
    return this.#internalParent.mod_MirrorColor!;
  }
  get mod_MirrorWidth(): number {
    return this.#internalParent.mod_MirrorWidth!;
  }
  get mod_MirrorHeight(): number {
    return this.#internalParent.mod_MirrorHeight!;
  }
  get mod_MirrorThickness(): number {
    return this.#internalParent.mod_MirrorThickness!;
  }
  get mod_MirrorPositionWidth(): number {
    return this.#internalParent.mod_MirrorPositionWidth!;
  }
  get mod_MirrorPositionHeight(): number {
    return this.#internalParent.mod_MirrorPositionHeight!;
  }
  addOD_M_mc_Mirror(index?: number): dc_mc_Mirror {
    return this.#internalParent.addOD_M_mc_Mirror(index);
  }
}
