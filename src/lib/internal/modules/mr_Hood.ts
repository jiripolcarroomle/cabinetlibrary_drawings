...
import { IModuleNonNull_mr_Hood, IModParents_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood, IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood } from '../mod-interfaces'
...
import { mr_Hood_createBuildPlan, mr_Hood_afterDataCompletion, mr_Hood_manufacturerDataCompletion, mr_Hood_calculateContainerModules, mr_Hood_prepareContext } from '../../modules/mr_Hood';
...
export interface pc_mr_Hood extends dc_mr_Hood {
...
export interface adc_base_mr_Hood extends IModBaseProp
  , IModVarNonNull_mod_HoodSupplier, IModVarNonNull_mod_HoodId, IModVarNonNull_mod_HeightPosInsertion {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
...
export interface adc_mr_Hood extends adc_base_mr_Hood {
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic;
}

export interface ccm_mr_Hood extends adc_base_mr_Hood {
}


export class OD_M_mr_Hood extends OD_Base implements pc_mr_Hood, dc_mr_Hood
  ...
  #prepareContextInternal = mr_Hood_prepareContext;
  seal(): IModuleNonNull_mr_Hood {
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mr_Hood_NonNull(this);
...
class OD_M_mr_Hood_NonNull implements cbp_mr_Hood, adc_mr_Hood, ccm_mr_Hood, IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood {
  ...
  #calculateContainerModulesInternal = mr_Hood_calculateContainerModules;
