...
import { IModuleNonNull_md_FrontArticleBuilder, IModParents_md_FrontArticleBuilder_md_FrontPlaceholder_mr_CornerunitStraight_mr_StorageunitSingle, IModParents_md_FrontArticleBuilder_md_FrontPlaceholder_mr_StorageunitSingle, IModParents_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_md_FrontArticleBuilder_md_FrontPlaceholder, IPartParentsNonNull_md_FrontArticleBuilder_md_FrontPlaceholder_mr_CornerunitStraight_mr_StorageunitSingle, IPartParentsNonNull_md_FrontArticleBuilder_md_FrontPlaceholder_mr_StorageunitSingle, IPartParentsNonNull_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_md_FrontArticleBuilder_md_FrontPlaceholder } from '../mod-interfaces'
import { IModVar_mod_Width, IModVarNonNull_mod_Width, IModVar_mod_Depth, IModVarNonNull_mod_Depth, IModVar_mod_Height, IModVarNonNull_mod_Height } from '../var-interfaces'
import { VariantValidation, IMatrix_mod_Width, IMatrix_mod_Depth, IMatrix_mod_Height } from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'
import { IGlobalVarsParent } from '../global-vars-parent'

import { IPartAdd_part_Placeholder } from '../part-add-interfaces';
import { md_FrontArticleBuilder_createBuildPlan, md_FrontArticleBuilder_afterDataCompletion, md_FrontArticleBuilder_manufacturerDataCompletion, md_FrontArticleBuilder_calculateContainerModules, md_FrontArticleBuilder_prepareContext } from '../../modules/md_FrontArticleBuilder';

export interface cbp_md_FrontArticleBuilder extends IModBaseProp
  , IPartAdd_part_Placeholder, IModVarNonNull_mod_Width, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Height {
...
export interface dc_md_FrontArticleBuilder extends IModBaseProp
  , IModVar_mod_Width, IModVar_mod_Depth, IModVar_mod_Height {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
  seal(): IModuleNonNull_md_FrontArticleBuilder;
...
export interface pc_md_FrontArticleBuilder extends dc_md_FrontArticleBuilder {
  getContextData(): IContextData | undefined;
  getContextModule(id: string): OD_Base | undefined;
}

export interface adc_base_md_FrontArticleBuilder extends IModBaseProp
  , IModVarNonNull_mod_Width, IModVarNonNull_mod_Depth, IModVarNonNull_mod_Height {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
...
export interface adc_md_FrontArticleBuilder extends adc_base_md_FrontArticleBuilder {
  addOD_M_mf_Drawer(index?: number): dc_mf_Drawer;
  addOD_M_mf_Door(index?: number): dc_mf_Door;
  addOD_M_mf_Fliplift(index?: number): dc_mf_Fliplift;
  addOD_M_mf_Fridge(index?: number): dc_mf_Fridge;
...
export interface ccm_md_FrontArticleBuilder extends adc_base_md_FrontArticleBuilder {
}


export class OD_M_md_FrontArticleBuilder extends OD_Base implements pc_md_FrontArticleBuilder, dc_md_FrontArticleBuilder
  , IModParents_md_FrontArticleBuilder_md_FrontPlaceholder_mr_CornerunitStraight_mr_StorageunitSingle, IModParents_md_FrontArticleBuilder_md_FrontPlaceholder_mr_StorageunitSingle, IModParents_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_md_FrontArticleBuilder_md_FrontPlaceholder
  , IModVar_mod_Width, IModVar_mod_Depth, IModVar_mod_Height {
  constructor(parent?: OD_Base, manufacturerMode?: boolean) {
    super('md_FrontArticleBuilder', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this._g = new GlobalVars();
    this._openGroups = new Map<string, OpenGroup>();
    this._partGroups = new Map<string, PartGroup>();
    this._selfNonNull = new OD_M_md_FrontArticleBuilder_NonNull(this);
  }
  _selfNonNull: OD_M_md_FrontArticleBuilder_NonNull;
  ...
  override variants: string[] = ['mod_Width', 'mod_Depth', 'mod_Height',];
  #mod_Width?: number;
  ...
  #manufacturerDataCompletionInternal = md_FrontArticleBuilder_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_md_FrontArticleBuilder_NonNull(this);
  ...
  #prepareContextInternal = md_FrontArticleBuilder_prepareContext;
  seal(): IModuleNonNull_md_FrontArticleBuilder {
    this.afterDataCompletion();
    const adc = new OD_M_md_FrontArticleBuilder_NonNull(this);
    return adc;
  }
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_md_FrontArticleBuilder_NonNull(this);
  ...
  override createBuildPlan(): void {
    var cbp = new OD_M_md_FrontArticleBuilder_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_md_FrontArticleBuilder_NonNull implements cbp_md_FrontArticleBuilder, adc_md_FrontArticleBuilder, ccm_md_FrontArticleBuilder, IPartParentsNonNull_md_FrontArticleBuilder_md_FrontPlaceholder_mr_CornerunitStraight_mr_StorageunitSingle, IPartParentsNonNull_md_FrontArticleBuilder_md_FrontPlaceholder_mr_StorageunitSingle, IPartParentsNonNull_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_md_FrontArticleBuilder_md_FrontPlaceholder {
  constructor(parent: OD_M_md_FrontArticleBuilder) {
    this.#internalParent = parent;
  }
  #internalParent: OD_M_md_FrontArticleBuilder;
  ...
  #createBuildPlanInternal = md_FrontArticleBuilder_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = md_FrontArticleBuilder_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = md_FrontArticleBuilder_calculateContainerModules;
