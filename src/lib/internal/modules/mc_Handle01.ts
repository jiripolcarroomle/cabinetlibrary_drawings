...
import { IModParents_mc_BaseunitFridge01_mc_CornerFillerFront01_mc_Dishwasher01_mc_Door01_mc_Drawer01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01 } from '../mod-interfaces'
...
export interface pc_mc_Handle01 extends dc_mc_Handle01 {
...
export interface adc_base_mc_Handle01 extends IModBaseProp
...
export interface adc_mc_Handle01 extends adc_base_mc_Handle01 {
}

export interface ccm_mc_Handle01 extends adc_base_mc_Handle01 {
}


export class OD_M_mc_Handle01 extends OD_Base implements pc_mc_Handle01, dc_mc_Handle01
  , IModParents_mc_Handle01
  , IModVar_mod_Depth, IModVar_mod_FrontHeight, IModVar_mod_FrontId, IModVar_mod_HandleDrill, IModVar_mod_HandleLine, IModVar_mod_HandlePosLogic, IModVar_mod_Height, IModVar_mod_FrontPosStart, IModVar_mod_Width, IModVar_mod_FrontProgram, IModVar_mod_HandleColor, IModVar_mod_HandleLength, IModVar_mod_HandleOffsetX, IModVar_mod_HandleOffsetY, IModVar_mod_HandlePosMatrix, IModVar_mod_HandlePosType, IModVar_mod_HeightPosInsertion, IModVar_mod_PlinthAreaHeight, IModVar_mod_HandleDesign, IModVar_mod_PartInfo, IModVar_mod_ModuleName, IModVar_mod_ProcessingId, IModVar_mod_ProcessingLibrary, IModVar_mod_HardwareId, IModVar_mod_Model3DGroupName, IModVar_mod_Rotation, IModVar_mod_FrontThk, IModVar_mod_FrontWidth, IModVar_mod_HandleWeightCalculations, IModVar_mod_FrontType, IModVar_mod_HardwareTypeList, IModVar_mod_FrontOversizeBtm, IModVar_mod_HandlePosFrontOversize {
  constructor(parent: IModParents_mc_BaseunitFridge01_mc_CornerFillerFront01_mc_Dishwasher01_mc_Door01_mc_Drawer01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, manufacturerMode?: boolean) {
  ...
  #prepareContextInternal = mc_Handle01_prepareContext;
  seal(): IModuleNonNull_mc_Handle01 {
  ...
  override validateSelections(): void {
    ...
    this.mod_ProcessingId_matrix = VariantValidation.mod_ProcessingId(this, this.mod_ProcessingId);
    this.mod_ProcessingLibrary_matrix = VariantValidation.mod_ProcessingLibrary(this, this.mod_ProcessingLibrary);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Handle01_NonNull(this);
  ...
  addpart_Handle(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Handle_PartVarsWritable {
    var c = new P_part_Handle(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_HandleDrill(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_HandleDrill_PartVarsWritable {
    var c = new P_part_HandleDrill(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_Handle01_NonNull implements cbp_mc_Handle01, adc_mc_Handle01, ccm_mc_Handle01, IPartParentsNonNull_mc_Handle01 {
  ...
  #calculateContainerModulesInternal = mc_Handle01_calculateContainerModules;
