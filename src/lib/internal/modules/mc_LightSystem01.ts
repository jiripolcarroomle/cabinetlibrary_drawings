...
import { mc_LightSystem01_createBuildPlan, mc_LightSystem01_afterDataCompletion, mc_LightSystem01_manufacturerDataCompletion, mc_LightSystem01_calculateContainerModules, mc_LightSystem01_prepareContext } from '../../modules/mc_LightSystem01';
...
export interface pc_mc_LightSystem01 extends dc_mc_LightSystem01 {
...
export interface adc_base_mc_LightSystem01 extends IModBaseProp
...
export interface adc_mc_LightSystem01 extends adc_base_mc_LightSystem01 {
}

export interface ccm_mc_LightSystem01 extends adc_base_mc_LightSystem01 {
}


export class OD_M_mc_LightSystem01 extends OD_Base implements pc_mc_LightSystem01, dc_mc_LightSystem01
  ...
  #prepareContextInternal = mc_LightSystem01_prepareContext;
  seal(): IModuleNonNull_mc_LightSystem01 {
  ...
  override validateSelections(): void {
    ...
    this.mod_LightSystem_matrix = VariantValidation.mod_LightSystem(this, this.mod_LightSystem);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_LightSystem01_NonNull(this);
  ...
  addpart_LightSystem(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_LightSystem_PartVarsWritable {
    var c = new P_part_LightSystem(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_LightSystem01_NonNull implements cbp_mc_LightSystem01, adc_mc_LightSystem01, ccm_mc_LightSystem01, IPartParentsNonNull_mc_LightSystem01 {
  ...
  #calculateContainerModulesInternal = mc_LightSystem01_calculateContainerModules;
