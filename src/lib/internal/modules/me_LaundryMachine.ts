...
import { IModuleNonNull_me_LaundryMachine, IModParents_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood, IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood } from '../mod-interfaces'
import { IModVar_mod_LaundryMachineId, IModVarNonNull_mod_LaundryMachineId, IModVar_mod_LaundryMachineSupplier, IModVarNonNull_mod_LaundryMachineSupplier, IModVar_mod_CarcaseSpaceDimension, IModVarNonNull_mod_CarcaseSpaceDimension } from '../var-interfaces'
import { VariantValidation, IMatrix_mod_LaundryMachineId, IMatrix_mod_LaundryMachineSupplier } from '../selections'
import { IGlobalVars, GlobalVars } from '../global-vars'

import { me_LaundryMachine_createBuildPlan, me_LaundryMachine_afterDataCompletion, me_LaundryMachine_manufacturerDataCompletion, me_LaundryMachine_calculateContainerModules, me_LaundryMachine_prepareContext } from '../../modules/me_LaundryMachine';

export interface cbp_me_LaundryMachine extends IModBaseProp
  , IModVarNonNull_mod_LaundryMachineId, IModVarNonNull_mod_LaundryMachineSupplier, IModVarNonNull_mod_CarcaseSpaceDimension {
...
export interface dc_me_LaundryMachine extends IModBaseProp
  , IModVar_mod_LaundryMachineId, IModVar_mod_LaundryMachineSupplier, IModVar_mod_CarcaseSpaceDimension {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
  seal(): IModuleNonNull_me_LaundryMachine;
  parent: IModParents_mf_RackArea;
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic;
}

export interface pc_me_LaundryMachine extends dc_me_LaundryMachine {
...
export interface adc_base_me_LaundryMachine extends IModBaseProp
  , IModVarNonNull_mod_LaundryMachineId, IModVarNonNull_mod_LaundryMachineSupplier, IModVarNonNull_mod_CarcaseSpaceDimension {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_me_LaundryMachine extends adc_base_me_LaundryMachine {
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic;
}

export interface ccm_me_LaundryMachine extends adc_base_me_LaundryMachine {
}


export class OD_M_me_LaundryMachine extends OD_Base implements pc_me_LaundryMachine, dc_me_LaundryMachine
  ...
  constructor(parent: IModParents_mf_RackArea, manufacturerMode?: boolean) {
    super('me_LaundryMachine', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_me_LaundryMachine_NonNull(this);
  }
  parent: IModParents_mf_RackArea;
  _selfNonNull: OD_M_me_LaundryMachine_NonNull;

  override variants: string[] = ['mod_LaundryMachineId', 'mod_LaundryMachineSupplier', 'mod_CarcaseSpaceDimension',];
  #mod_LaundryMachineId?: string;
  get mod_LaundryMachineId(): string | undefined { return this.#mod_LaundryMachineId }
  set mod_LaundryMachineId(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_LaundryMachineId' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_LaundryMachineId === value) return;
    this.#mod_LaundryMachineId = value;
  }

  mod_LaundryMachineId_matrix?: IMatrix_mod_LaundryMachineId;
  #mod_LaundryMachineSupplier?: string;
  get mod_LaundryMachineSupplier(): string | undefined { return this.#mod_LaundryMachineSupplier }
  set mod_LaundryMachineSupplier(value: string | undefined) {
    if (this._adcFinished) {
      logError("The property 'mod_LaundryMachineSupplier' must not be changed after the module was completed with 'afterDataCompletion'");
      return;
    }
    if (this.#mod_LaundryMachineSupplier === value) return;
    this.#mod_LaundryMachineSupplier = value;
  }

  mod_LaundryMachineSupplier_matrix?: IMatrix_mod_LaundryMachineSupplier;
  #mod_CarcaseSpaceDimension: string[] = [];
  get mod_CarcaseSpaceDimension(): string[] { return this.#mod_CarcaseSpaceDimension; }
  override getAttributes(): Map<string, any> {
    let res = new Map<string, any>();
    res.set('mod_LaundryMachineId', this.mod_LaundryMachineId);
    res.set('mod_LaundryMachineSupplier', this.mod_LaundryMachineSupplier);
  ...
  override loadJson(json: any, withSubModules: boolean = true, manufacturerMode: boolean) {
    ...
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_LaundryMachineId');
      const val = _toString(json['attributes']['mod_LaundryMachineId'], 'mod_LaundryMachineId');
      internal_leaveValidateVariant();
      this.mod_LaundryMachineId = val;
    }
    {
      internal_enterValidateVariant(this.modId, this._id, 'mod_LaundryMachineSupplier');
      const val = _toString(json['attributes']['mod_LaundryMachineSupplier'], 'mod_LaundryMachineSupplier');
      internal_leaveValidateVariant();
      this.mod_LaundryMachineSupplier = val;
    }
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_LaundryMachineId === undefined) {
      this.mod_LaundryMachineId = "GenericMachine";
    }
    if (this.mod_LaundryMachineSupplier === undefined) {
      this.mod_LaundryMachineSupplier = "GenericSupplier";
    }
  ...
  #manufacturerDataCompletionInternal = me_LaundryMachine_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_me_LaundryMachine_NonNull(this);
  ...
  #prepareContextInternal = me_LaundryMachine_prepareContext;
  seal(): IModuleNonNull_me_LaundryMachine {
    this.afterDataCompletion();
    const adc = new OD_M_me_LaundryMachine_NonNull(this);
    return adc;
  }
  ...
  override validateSelections(): void {
    this.mod_LaundryMachineId_matrix = VariantValidation.mod_LaundryMachineId(this, this.mod_LaundryMachineId);
    this.mod_LaundryMachineSupplier_matrix = VariantValidation.mod_LaundryMachineSupplier(this, this.mod_LaundryMachineSupplier);
  }

  override calculateContainerModules(): void {
    let ccm = new OD_M_me_LaundryMachine_NonNull(this);
  ...
  override createBuildPlan(): void {
    var cbp = new OD_M_me_LaundryMachine_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_me_LaundryMachine_NonNull implements cbp_me_LaundryMachine, adc_me_LaundryMachine, ccm_me_LaundryMachine, IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood {
  constructor(parent: OD_M_me_LaundryMachine) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_me_LaundryMachine;
  ...
  #createBuildPlanInternal = me_LaundryMachine_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = me_LaundryMachine_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = me_LaundryMachine_calculateContainerModules;
  ...
  parent: IModParents_mf_RackArea;
  get mod_LaundryMachineId(): string {
    return this.#internalParent.mod_LaundryMachineId!;
  }
  get mod_LaundryMachineSupplier(): string {
    return this.#internalParent.mod_LaundryMachineSupplier!;
  }
