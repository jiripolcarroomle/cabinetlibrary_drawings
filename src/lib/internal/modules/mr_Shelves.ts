...
export interface adc_mr_Shelves extends adc_base_mr_Shelves {
  addOD_M_mc_Shelves01(index?: number): dc_mc_Shelves01;
  addOD_M_mc_Bracket01(index?: number): dc_mc_Bracket01;
}

export interface ccm_mr_Shelves extends adc_base_mr_Shelves {
}
...
export class OD_M_mr_Shelves extends OD_Base implements dc_mr_Shelves
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mr_Shelves_NonNull(this);
...
class OD_M_mr_Shelves_NonNull implements cbp_mr_Shelves, adc_mr_Shelves, ccm_mr_Shelves, IPartParentsNonNull_mr_Shelves {
  ...
  #calculateContainerModulesInternal = mr_Shelves_calculateContainerModules;
