...
export interface adc_mc_StorageunitSidepanel01 extends adc_base_mc_StorageunitSidepanel01 {
}

export interface ccm_mc_StorageunitSidepanel01 extends adc_base_mc_StorageunitSidepanel01 {
}
...
export class OD_M_mc_StorageunitSidepanel01 extends OD_Base implements dc_mc_StorageunitSidepanel01
  ...
  override validateSelections(): void {
    ...
    this.mod_SidepanelType_matrix = VariantValidation.mod_SidepanelType(this, this.mod_SidepanelType);
    ...
    this.mod_EdgeBackType_matrix = VariantValidation.mod_EdgeBackType(this, this.mod_EdgeBackType);
    this.mod_EdgeFrontType_matrix = VariantValidation.mod_EdgeFrontType(this, this.mod_EdgeFrontType);
    this.mod_EdgeLeftType_matrix = VariantValidation.mod_EdgeLeftType(this, this.mod_EdgeLeftType);
    this.mod_EdgeRightType_matrix = VariantValidation.mod_EdgeRightType(this, this.mod_EdgeRightType);
    this.mod_EdgeJointType_matrix = VariantValidation.mod_EdgeJointType(this, this.mod_EdgeJointType);
    ...
    this.mod_FittingConnectionLeftBtm_matrix = VariantValidation.mod_FittingConnectionLeftBtm(this, this.mod_FittingConnectionLeftBtm);
    ...
    this.mod_FittingConnectionLeftTop_matrix = VariantValidation.mod_FittingConnectionLeftTop(this, this.mod_FittingConnectionLeftTop);
    this.mod_FittingConnectionRightBtm_matrix = VariantValidation.mod_FittingConnectionRightBtm(this, this.mod_FittingConnectionRightBtm);
    ...
    this.mod_FittingConnectionRightTop_matrix = VariantValidation.mod_FittingConnectionRightTop(this, this.mod_FittingConnectionRightTop);
    ...
    this.mod_FittingConnectionBtmVert_matrix = VariantValidation.mod_FittingConnectionBtmVert(this, this.mod_FittingConnectionBtmVert);
    this.mod_FittingConnectionTopVert_matrix = VariantValidation.mod_FittingConnectionTopVert(this, this.mod_FittingConnectionTopVert);
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_StorageunitSidepanel01_NonNull(this);
  ...
  addpart_Sidepanelleft(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Sidepanelleft_PartVarsWritable {
    var c = new P_part_Sidepanelleft(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_Sidepanelright(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Sidepanelright_PartVarsWritable {
    var c = new P_part_Sidepanelright(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
  addpart_Sidepanelmiddle(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_Sidepanelmiddle_PartVarsWritable {
    var c = new P_part_Sidepanelmiddle(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_StorageunitSidepanel01_NonNull implements cbp_mc_StorageunitSidepanel01, adc_mc_StorageunitSidepanel01, ccm_mc_StorageunitSidepanel01, IPartParentsNonNull_mc_StorageunitSidepanel01 {
  ...
  #calculateContainerModulesInternal = mc_StorageunitSidepanel01_calculateContainerModules;
