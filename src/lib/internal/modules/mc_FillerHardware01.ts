...
import { IModuleNonNull_mc_FillerHardware01 } from '../mod-interfaces'
...
import { mc_FillerHardware01_createBuildPlan, mc_FillerHardware01_afterDataCompletion, mc_FillerHardware01_manufacturerDataCompletion, mc_FillerHardware01_calculateContainerModules, mc_FillerHardware01_prepareContext } from '../../modules/mc_FillerHardware01';

export interface cbp_mc_FillerHardware01 extends IModBaseProp
...
export interface dc_mc_FillerHardware01 extends IModBaseProp
  , IModVar_mod_Information {
  m: OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
  seal(): IModuleNonNull_mc_FillerHardware01;
  parent: OD_Base;
}

export interface pc_mc_FillerHardware01 extends dc_mc_FillerHardware01 {
...
export interface adc_base_mc_FillerHardware01 extends IModBaseProp
  , IModVarNonNull_mod_Information {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_FillerHardware01 extends adc_base_mc_FillerHardware01 {
}

export interface ccm_mc_FillerHardware01 extends adc_base_mc_FillerHardware01 {
}


export class OD_M_mc_FillerHardware01 extends OD_Base implements pc_mc_FillerHardware01, dc_mc_FillerHardware01

  , IModVar_mod_Information {
  constructor(parent: OD_Base, manufacturerMode?: boolean) {
    super('mc_FillerHardware01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_FillerHardware01_NonNull(this);
  }
  parent: OD_Base;
  _selfNonNull: OD_M_mc_FillerHardware01_NonNull;
  ...
  #manufacturerDataCompletionInternal = mc_FillerHardware01_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_FillerHardware01_NonNull(this);
  ...
  #prepareContextInternal = mc_FillerHardware01_prepareContext;
  seal(): IModuleNonNull_mc_FillerHardware01 {
    this.afterDataCompletion();
    const adc = new OD_M_mc_FillerHardware01_NonNull(this);
    return adc;
  }
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_FillerHardware01_NonNull(this);
  ...
  override createBuildPlan(): void {
    var cbp = new OD_M_mc_FillerHardware01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_FillerHardware01_NonNull implements cbp_mc_FillerHardware01, adc_mc_FillerHardware01, ccm_mc_FillerHardware01 {
  constructor(parent: OD_M_mc_FillerHardware01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_FillerHardware01;
  ...
  #createBuildPlanInternal = mc_FillerHardware01_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_FillerHardware01_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = mc_FillerHardware01_calculateContainerModules;
