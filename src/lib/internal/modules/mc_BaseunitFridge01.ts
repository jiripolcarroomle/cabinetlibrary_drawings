...
import { IModParents_mf_BaseunitFridge } from '../mod-interfaces'
...
export interface pc_mc_BaseunitFridge01 extends dc_mc_BaseunitFridge01 {
...
export interface adc_base_mc_BaseunitFridge01 extends IModBaseProp
  , IModVarNonNull_mod_BaseunitFridgeId, IModVarNonNull_mod_BaseunitFridgeInfo, IModVarNonNull_mod_BaseunitFridgeSupplier, IModVarNonNull_mod_Depth, IModVarNonNull_mod_FingergripBtmType, IModVarNonNull_mod_FingergripTop, IModVarNonNull_mod_FingergripTopType, IModVarNonNull_mod_FrameFillingColor, IModVarNonNull_mod_FrameFillingType, IModVarNonNull_mod_FrontColor, IModVarNonNull_mod_FrontDescriptor, IModVarNonNull_mod_FrontDesign, IModVarNonNull_mod_FrontEdgeColor, IModVarNonNull_mod_FrontEdgeThk, IModVarNonNull_mod_FrontGapCarcase, IModVarNonNull_mod_FrontGapHor, IModVarNonNull_mod_FrontGapHorTop, IModVarNonNull_mod_FrontGapVert, IModVarNonNull_mod_FrontHeight, IModVarNonNull_mod_FrontId, IModVarNonNull_mod_FrontOversizeBtm, IModVarNonNull_mod_FrontOversizeLeft, IModVarNonNull_mod_FrontOversizeRight, IModVarNonNull_mod_FrontOversizeTop, IModVarNonNull_mod_FrontPosStart, IModVarNonNull_mod_FrontProgram, IModVarNonNull_mod_FrontQtyElements, IModVarNonNull_mod_FrontSplit, IModVarNonNull_mod_FrontSplitHeight1, IModVarNonNull_mod_FrontSplitHeight2, IModVarNonNull_mod_FrontSplitHeight3, IModVarNonNull_mod_FrontSplitType1, IModVarNonNull_mod_FrontSplitType2, IModVarNonNull_mod_FrontThk, IModVarNonNull_mod_FrontWidth, IModVarNonNull_mod_HandleColor, IModVarNonNull_mod_HandleDesign, IModVarNonNull_mod_HandleDrill, IModVarNonNull_mod_HandleLength, IModVarNonNull_mod_HandleLine, IModVarNonNull_mod_HandleOffsetX, IModVarNonNull_mod_HandleOffsetY, IModVarNonNull_mod_HandlePosLogic, IModVarNonNull_mod_HandlePosMatrix, IModVarNonNull_mod_HandlePosType, IModVarNonNull_mod_HandlestripPos, IModVarNonNull_mod_Height, IModVarNonNull_mod_HeightPosInsertion, IModVarNonNull_mod_ModuleName, IModVarNonNull_mod_OpeningAngle, IModVarNonNull_mod_Originpos, IModVarNonNull_mod_TypeElement, IModVarNonNull_mod_DoorDirection {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
  ct_tab_FrontConstruction: ct2_tab_FrontConstruction;
}

export interface adc_mc_BaseunitFridge01 extends adc_base_mc_BaseunitFridge01 {
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic;
  addOD_M_mc_Handle01(index?: number): dc_mc_Handle01;
  addOD_M_mc_FrontPanel01(index?: number): dc_mc_FrontPanel01;
  addOD_M_mc_PanelWoodFrame01(index?: number): dc_mc_PanelWoodFrame01;
...
export interface ccm_mc_BaseunitFridge01 extends adc_base_mc_BaseunitFridge01 {
}


export class OD_M_mc_BaseunitFridge01 extends OD_Base implements pc_mc_BaseunitFridge01, dc_mc_BaseunitFridge01
  , IModParents_mc_BaseunitFridge01_mc_CornerFillerFront01_mc_Dishwasher01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IModParents_mc_BaseunitFridge01_mc_CornerFillerFront01_mc_Dishwasher01_mc_Door01_mc_Drawer01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IModParents_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood, IModParents_mc_BaseunitFridge01_mc_Dishwasher01
  , IModVar_mod_BaseunitFridgeId, IModVar_mod_BaseunitFridgeInfo, IModVar_mod_BaseunitFridgeSupplier, IModVar_mod_Depth, IModVar_mod_FingergripBtmType, IModVar_mod_FingergripTop, IModVar_mod_FingergripTopType, IModVar_mod_FrameFillingColor, IModVar_mod_FrameFillingType, IModVar_mod_FrontColor, IModVar_mod_FrontDescriptor, IModVar_mod_FrontDesign, IModVar_mod_FrontEdgeColor, IModVar_mod_FrontEdgeThk, IModVar_mod_FrontGapCarcase, IModVar_mod_FrontGapHor, IModVar_mod_FrontGapHorTop, IModVar_mod_FrontGapVert, IModVar_mod_FrontHeight, IModVar_mod_FrontId, IModVar_mod_FrontOversizeBtm, IModVar_mod_FrontOversizeLeft, IModVar_mod_FrontOversizeRight, IModVar_mod_FrontOversizeTop, IModVar_mod_FrontPosStart, IModVar_mod_FrontProgram, IModVar_mod_FrontQtyElements, IModVar_mod_FrontSplit, IModVar_mod_FrontSplitHeight1, IModVar_mod_FrontSplitHeight2, IModVar_mod_FrontSplitHeight3, IModVar_mod_FrontSplitType1, IModVar_mod_FrontSplitType2, IModVar_mod_FrontThk, IModVar_mod_FrontWidth, IModVar_mod_HandleColor, IModVar_mod_HandleDesign, IModVar_mod_HandleDrill, IModVar_mod_HandleLength, IModVar_mod_HandleLine, IModVar_mod_HandleOffsetX, IModVar_mod_HandleOffsetY, IModVar_mod_HandlePosLogic, IModVar_mod_HandlePosMatrix, IModVar_mod_HandlePosType, IModVar_mod_HandlestripPos, IModVar_mod_Height, IModVar_mod_HeightPosInsertion, IModVar_mod_ModuleName, IModVar_mod_OpeningAngle, IModVar_mod_Originpos, IModVar_mod_TypeElement, IModVar_mod_DoorDirection {
  constructor(parent: IModParents_mf_BaseunitFridge, manufacturerMode?: boolean) {
    super('mc_BaseunitFridge01', parent, parent !== undefined ? parent._manufacturerMode : manufacturerMode!);
    this.parent = parent;
    this._selfNonNull = new OD_M_mc_BaseunitFridge01_NonNull(this);
  }
  parent: IModParents_mf_BaseunitFridge;
  _selfNonNull: OD_M_mc_BaseunitFridge01_NonNull;

  override variants: string[] = ['mod_BaseunitFridgeId', 'mod_BaseunitFridgeInfo', 'mod_BaseunitFridgeSupplier', 'mod_Depth', 'mod_FingergripBtmType', 'mod_FingergripTop', 'mod_FingergripTopType', 'mod_FrameFillingColor', 'mod_FrameFillingType', 'mod_FrontColor', 'mod_FrontDescriptor', 'mod_FrontDesign', 'mod_FrontEdgeColor', 'mod_FrontEdgeThk', 'mod_FrontGapCarcase', 'mod_FrontGapHor', 'mod_FrontGapHorTop', 'mod_FrontGapVert', 'mod_FrontHeight', 'mod_FrontId', 'mod_FrontOversizeBtm', 'mod_FrontOversizeLeft', 'mod_FrontOversizeRight', 'mod_FrontOversizeTop', 'mod_FrontPosStart', 'mod_FrontProgram', 'mod_FrontQtyElements', 'mod_FrontSplit', 'mod_FrontSplitHeight1', 'mod_FrontSplitHeight2', 'mod_FrontSplitHeight3', 'mod_FrontSplitType1', 'mod_FrontSplitType2', 'mod_FrontThk', 'mod_FrontWidth', 'mod_HandleColor', 'mod_HandleDesign', 'mod_HandleDrill', 'mod_HandleLength', 'mod_HandleLine', 'mod_HandleOffsetX', 'mod_HandleOffsetY', 'mod_HandlePosLogic', 'mod_HandlePosMatrix', 'mod_HandlePosType', 'mod_HandlestripPos', 'mod_Height', 'mod_HeightPosInsertion', 'mod_ModuleName', 'mod_OpeningAngle', 'mod_Originpos', 'mod_TypeElement', 'mod_DoorDirection',];
  ...
  #dataCompletionAssignDerivedData() {
    ...
    if (this.mod_BaseunitFridgeId === undefined) {
      ...
      while (s !== undefined) {
        if (s.variants.includes('mod_BaseunitFridgeId')) {
          let pv = <IModVar_mod_BaseunitFridgeId>s;
          if (pv.mod_BaseunitFridgeId !== undefined) {
            this.mod_BaseunitFridgeId = (<IModVar_mod_BaseunitFridgeId>s).mod_BaseunitFridgeId;
            break;
          };
        }
        s = s.parentBase;
    ...
    if (this.mod_BaseunitFridgeSupplier === undefined) {
      ...
      // try to find a parent with a valid value
      while (s !== undefined) {
        if (s.variants.includes('mod_BaseunitFridgeSupplier')) {
          let pv = <IModVar_mod_BaseunitFridgeSupplier>s;
          if (pv.mod_BaseunitFridgeSupplier !== undefined) {
            this.mod_BaseunitFridgeSupplier = (<IModVar_mod_BaseunitFridgeSupplier>s).mod_BaseunitFridgeSupplier;
            break;
          };
        }
        s = s.parentBase;
  ...
  #dataCompletionSetDefaultValues() {
    ...
    if (this.mod_ModuleName === undefined) {
      this.mod_ModuleName = "mc_BaseunitFridge01";
    }
  ...
  #manufacturerDataCompletionInternal = mc_BaseunitFridge01_manufacturerDataCompletion;
  override afterDataCompletion(): void {
    if (this._adcFinished) return;
    this._adcFinished = true;
    this.validateSelections();
    var adc = new OD_M_mc_BaseunitFridge01_NonNull(this);
  ...
  #prepareContextInternal = mc_BaseunitFridge01_prepareContext;
  seal(): IModuleNonNull_mc_BaseunitFridge01 {
    this.afterDataCompletion();
    const adc = new OD_M_mc_BaseunitFridge01_NonNull(this);
    return adc;
  }
  ...
  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_BaseunitFridge01_NonNull(this);
  ...
  addpart_ApplianceUnit(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_ApplianceUnit_PartVarsWritable {
    var c = new P_part_ApplianceUnit(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }

  override createBuildPlan(): void {
    var cbp = new OD_M_mc_BaseunitFridge01_NonNull(this);
    cbp.createBuildPlan();
...
class OD_M_mc_BaseunitFridge01_NonNull implements cbp_mc_BaseunitFridge01, adc_mc_BaseunitFridge01, ccm_mc_BaseunitFridge01, IPartParentsNonNull_mc_BaseunitFridge01_mc_CornerFillerFront01_mc_Dishwasher01_mc_Door01_mc_Drawer01_mc_FillerFront01_mc_Fixedfront01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_BaseunitFridge01_mc_CornerFillerFront01_mc_Dishwasher01_mc_Door01_mc_Drawer01_mc_Fliplift01_mc_PantryPullout01_mc_Pullout01, IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood, IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01 {
  constructor(parent: OD_M_mc_BaseunitFridge01) {
    this.#internalParent = parent;
    this.parent = parent.parent;
  }
  #internalParent: OD_M_mc_BaseunitFridge01;
  ...
  #createBuildPlanInternal = mc_BaseunitFridge01_createBuildPlan;
  afterDataCompletion(): void {
    this.#afterDataCompletionInternal();
  }
  #afterDataCompletionInternal = mc_BaseunitFridge01_afterDataCompletion;
  calculateContainerModules(): void {
    this.#calculateContainerModulesInternal();
  }
  #calculateContainerModulesInternal = mc_BaseunitFridge01_calculateContainerModules;
