...
import { IModuleNonNull_mc_Hob01, IModParents_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood, IModParents_mc_Hob01, IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood, IPartParentsNonNull_mc_Hob01 } from '../mod-interfaces'
...
import { mc_Hob01_createBuildPlan, mc_Hob01_afterDataCompletion, mc_Hob01_manufacturerDataCompletion, mc_Hob01_calculateContainerModules, mc_Hob01_prepareContext } from '../../modules/mc_Hob01';
...
export interface pc_mc_Hob01 extends dc_mc_Hob01 {
...
export interface adc_base_mc_Hob01 extends IModBaseProp
  , IModVarNonNull_mod_HobGraphicId, IModVarNonNull_mod_HobConstructionId {
  get m(): OD_Base[];
  setOrigin(x: number | Matrix4, y?: number, z?: number): void;
}

export interface adc_mc_Hob01 extends adc_base_mc_Hob01 {
  addOD_M_mc_ApplianceGraphic(index?: number): dc_mc_ApplianceGraphic;
}

export interface ccm_mc_Hob01 extends adc_base_mc_Hob01 {
}


export class OD_M_mc_Hob01 extends OD_Base implements pc_mc_Hob01, dc_mc_Hob01
  , IModParents_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood, IModParents_mc_Hob01
  , IModVar_mod_HobGraphicId, IModVar_mod_HobConstructionId {
  ...
  #prepareContextInternal = mc_Hob01_prepareContext;
  seal(): IModuleNonNull_mc_Hob01 {
  ...
  override validateSelections(): void {
    this.mod_HobGraphicId_matrix = VariantValidation.mod_HobGraphicId(this, this.mod_HobGraphicId);
    this.mod_HobConstructionId_matrix = VariantValidation.mod_HobConstructionId(this, this.mod_HobConstructionId);
  }

  override calculateContainerModules(): void {
    let ccm = new OD_M_mc_Hob01_NonNull(this);
  ...
  addpart_CountertopCutout(x: number, y: number, z: number, dimx: number, dimy: number, dimz: number): IP_part_CountertopCutout_PartVarsWritable {
    var c = new P_part_CountertopCutout(this._selfNonNull, x, y, z, dimx, dimy, dimz, undefined);
    this.p.push(c);
    return c;
  }
...
class OD_M_mc_Hob01_NonNull implements cbp_mc_Hob01, adc_mc_Hob01, ccm_mc_Hob01, IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01_mc_Fridge01_mc_Hob01_mc_Oven01_mc_Sink01_me_HoodInsert_me_LaundryMachine_mf_Sink_mr_Hood, IPartParentsNonNull_mc_Hob01 {
  ...
  #calculateContainerModulesInternal = mc_Hob01_calculateContainerModules;
