...
export interface IP_part_HoodShelftop_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_HoodCarcaseParts01;
}

export interface IP_part_HoodShelftop_PartVarsWritable extends IP_part_HoodShelftop_PartVarsReadOnly {
}

export class P_part_HoodShelftop extends PartBase implements IP_part_HoodShelftop_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_HoodCarcaseParts01,
    ...
    super(parent, 'part_HoodShelftop', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
  }
