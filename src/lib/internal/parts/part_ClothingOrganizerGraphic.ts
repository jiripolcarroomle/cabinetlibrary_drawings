...
export interface IP_part_ClothingOrganizerGraphic_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_ClothingOrganizerHardware01;
}

export interface IP_part_ClothingOrganizerGraphic_PartVarsWritable extends IP_part_ClothingOrganizerGraphic_PartVarsReadOnly {
}

export class P_part_ClothingOrganizerGraphic extends PartBase implements IP_part_ClothingOrganizerGraphic_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_ClothingOrganizerHardware01,
    ...
    super(parent, 'part_ClothingOrganizerGraphic', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._noNCData = true;
  }
