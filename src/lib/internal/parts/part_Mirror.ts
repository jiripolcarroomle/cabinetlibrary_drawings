...
import { IPartParentsNonNull_mc_Mirror } from '../mod-interfaces'

export interface IP_part_Mirror_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_Mirror;
}

export interface IP_part_Mirror_PartVarsWritable extends IP_part_Mirror_PartVarsReadOnly {
}

export class P_part_Mirror extends PartBase implements IP_part_Mirror_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_Mirror,
    x: number, y: number, z: number, dimx: number, dimy: number, dimz: number, isContainerPart?: boolean) {
    super(parent, 'part_Mirror', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._noNCData = true;
  }
  parent: IPartParentsNonNull_mc_Mirror; // module which created this part
