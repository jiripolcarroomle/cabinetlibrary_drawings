...
export class P_part_SlopedCeilingShelftopHor extends PartBase implements IP_part_SlopedCeilingShelftopHor_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_StorageunitShelftop04,
    ...
    super(parent, 'part_SlopedCeilingShelftopHor', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XZY';
  }
  ...
  checkAttributes() {
    ...
    if (this.#pa_ProgramGrainGroup === undefined) {
      logError('Attribute pa_ProgramGrainGroup not set in part part_SlopedCeilingShelftopHor (id: ' + this._id + ')');
    }
    if (this.#pa_ColorGrainGroup === undefined) {
      logError('Attribute pa_ColorGrainGroup not set in part part_SlopedCeilingShelftopHor (id: ' + this._id + ')');
    }
