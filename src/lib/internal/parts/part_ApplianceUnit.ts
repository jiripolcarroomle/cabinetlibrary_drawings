...
import { IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01 } from '../mod-interfaces'

export interface IP_part_ApplianceUnit_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01;
  get pa_BomId(): string;
}
...
export class P_part_ApplianceUnit extends PartBase implements IP_part_ApplianceUnit_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01,
    x: number, y: number, z: number, dimx: number, dimy: number, dimz: number, isContainerPart?: boolean) {
    super(parent, 'part_ApplianceUnit', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._hidden = true;
  }
  parent: IPartParentsNonNull_mc_BaseunitFridge01_mc_Dishwasher01; // module which created this part
