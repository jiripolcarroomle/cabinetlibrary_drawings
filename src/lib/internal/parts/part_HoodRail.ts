...
export interface IP_part_HoodRail_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_HoodCarcaseParts01;
}

export interface IP_part_HoodRail_PartVarsWritable extends IP_part_HoodRail_PartVarsReadOnly {
}

export class P_part_HoodRail extends PartBase implements IP_part_HoodRail_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_HoodCarcaseParts01,
    ...
    super(parent, 'part_HoodRail', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XZY';
  }
