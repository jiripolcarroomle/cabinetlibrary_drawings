...
import { IPartParentsNonNull_mc_HoodCarcaseParts01 } from '../mod-interfaces'

export interface IP_part_HoodSidepanelright_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_HoodCarcaseParts01;
}

export interface IP_part_HoodSidepanelright_PartVarsWritable extends IP_part_HoodSidepanelright_PartVarsReadOnly {
}

export class P_part_HoodSidepanelright extends PartBase implements IP_part_HoodSidepanelright_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_HoodCarcaseParts01,
    x: number, y: number, z: number, dimx: number, dimy: number, dimz: number, isContainerPart?: boolean) {
    super(parent, 'part_HoodSidepanelright', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'YZX';
  }
  parent: IPartParentsNonNull_mc_HoodCarcaseParts01; // module which created this part
