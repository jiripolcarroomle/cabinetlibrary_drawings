...
export interface IP_part_HoodBackwall_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_HoodCarcaseParts01;
}

export interface IP_part_HoodBackwall_PartVarsWritable extends IP_part_HoodBackwall_PartVarsReadOnly {
}

export class P_part_HoodBackwall extends PartBase implements IP_part_HoodBackwall_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_HoodCarcaseParts01,
    ...
    super(parent, 'part_HoodBackwall', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
  }
