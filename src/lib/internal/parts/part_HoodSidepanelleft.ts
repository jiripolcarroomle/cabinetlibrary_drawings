...
export interface IP_part_HoodSidepanelleft_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_HoodCarcaseParts01;
}

export interface IP_part_HoodSidepanelleft_PartVarsWritable extends IP_part_HoodSidepanelleft_PartVarsReadOnly {
}

export class P_part_HoodSidepanelleft extends PartBase implements IP_part_HoodSidepanelleft_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_HoodCarcaseParts01,
    ...
    super(parent, 'part_HoodSidepanelleft', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'YZX';
  }
