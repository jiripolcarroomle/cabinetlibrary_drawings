...
export class P_part_Panelblind extends PartBase implements IP_part_Panelblind_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_Panelblind01,
    ...
    super(parent, 'part_Panelblind', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
  }
  ...
  checkAttributes() {
    ...
    if (this.#pa_ColorGrainGroup === undefined) {
      logError('Attribute pa_ColorGrainGroup not set in part part_Panelblind (id: ' + this._id + ')');
    }
    if (this.#pa_ProgramGrainGroup === undefined) {
      logError('Attribute pa_ProgramGrainGroup not set in part part_Panelblind (id: ' + this._id + ')');
    }
