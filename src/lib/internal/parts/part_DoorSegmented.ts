...
export interface IP_part_DoorSegmented_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_SegmentFront01;
}

export interface IP_part_DoorSegmented_PartVarsWritable extends IP_part_DoorSegmented_PartVarsReadOnly {
}

export class P_part_DoorSegmented extends PartBase implements IP_part_DoorSegmented_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_SegmentFront01,
    ...
    super(parent, 'part_DoorSegmented', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._hidden = true;
  }
