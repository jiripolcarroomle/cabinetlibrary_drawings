...
export class P_part_ShelfadjFitting extends PartBase implements IP_part_ShelfadjFitting_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_ShelfadjFitting01_mc_ShelfadjGroup01,
    ...
    super(parent, 'part_ShelfadjFitting', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
  }
  ...
  setAttributes() {
    try {
      ...
      if (this.#pa_ParentName === undefined) {
        this.pa_ParentName = this.parent.mod_CarcaseId;
      }
      // ###############################################################
      // ################### END CUSTOM SCRIPTS ########################
      // ###############################################################
  ...
  checkAttributes() {
    ...
    if (this.#pa_ParentName === undefined) {
      logError('Attribute pa_ParentName not set in part part_ShelfadjFitting (id: ' + this._id + ')');
    }
