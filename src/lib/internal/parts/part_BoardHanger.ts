...
import { IPartParentsNonNull_mc_BoardHanger } from '../mod-interfaces'

export interface IP_part_BoardHanger_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_BoardHanger;
}

export interface IP_part_BoardHanger_PartVarsWritable extends IP_part_BoardHanger_PartVarsReadOnly {
}

export class P_part_BoardHanger extends PartBase implements IP_part_BoardHanger_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_BoardHanger,
    x: number, y: number, z: number, dimx: number, dimy: number, dimz: number, isContainerPart?: boolean) {
    super(parent, 'part_BoardHanger', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._noNCData = true;
  }
  parent: IPartParentsNonNull_mc_BoardHanger; // module which created this part
