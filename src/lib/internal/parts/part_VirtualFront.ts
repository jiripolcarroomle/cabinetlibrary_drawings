...
export interface IP_part_VirtualFront_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_FrontPanel01;
}

export interface IP_part_VirtualFront_PartVarsWritable extends IP_part_VirtualFront_PartVarsReadOnly {
}

export class P_part_VirtualFront extends PartBase implements IP_part_VirtualFront_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_FrontPanel01,
    ...
    super(parent, 'part_VirtualFront', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._noNCData = true;
  }
