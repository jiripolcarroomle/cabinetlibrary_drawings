...
import { IPartParentsNonNull_mc_Dishwasher01_mr_Appliance } from '../mod-interfaces'

export interface IP_part_DropZone_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_Dishwasher01_mr_Appliance;
}
...
export class P_part_DropZone extends PartBase implements IP_part_DropZone_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_Dishwasher01_mr_Appliance,
    x: number, y: number, z: number, dimx: number, dimy: number, dimz: number, isContainerPart?: boolean) {
    super(parent, 'part_DropZone', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._noNCData = true;
  }
  parent: IPartParentsNonNull_mc_Dishwasher01_mr_Appliance; // module which created this part
