...
export interface IP_part_PantryPulloutHardware_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_PantryPulloutHardware01;
}

export interface IP_part_PantryPulloutHardware_PartVarsWritable extends IP_part_PantryPulloutHardware_PartVarsReadOnly {
}

export class P_part_PantryPulloutHardware extends PartBase implements IP_part_PantryPulloutHardware_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_PantryPulloutHardware01,
    ...
    super(parent, 'part_PantryPulloutHardware', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._noNCData = true;
  }
