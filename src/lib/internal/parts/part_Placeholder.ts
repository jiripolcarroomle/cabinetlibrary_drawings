...
import { IPartParentsNonNull_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_md_FrontArticleBuilder_md_FrontPlaceholder } from '../mod-interfaces'

export interface IP_part_Placeholder_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_md_FrontArticleBuilder_md_FrontPlaceholder;
}

export interface IP_part_Placeholder_PartVarsWritable extends IP_part_Placeholder_PartVarsReadOnly {
}

export class P_part_Placeholder extends PartBase implements IP_part_Placeholder_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_md_FrontArticleBuilder_md_FrontPlaceholder,
    x: number, y: number, z: number, dimx: number, dimy: number, dimz: number, isContainerPart?: boolean) {
    super(parent, 'part_Placeholder', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._noNCData = true;
  }
  parent: IPartParentsNonNull_md_EquipmentArticleBuilder_md_EquipmentPlaceholder_md_FrontArticleBuilder_md_FrontPlaceholder; // module which created this part
