...
export class P_part_DrawerPanelWoodFrame extends PartBase implements IP_part_DrawerPanelWoodFrame_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_PanelWoodFrame01,
    ...
    super(parent, 'part_DrawerPanelWoodFrame', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._hidden = true;
  }
  ...
  checkAttributes() {
    ...
    if (this.#pa_FrameFillingColor === undefined) {
      logError('Attribute pa_FrameFillingColor not set in part part_DrawerPanelWoodFrame (id: ' + this._id + ')');
    }
