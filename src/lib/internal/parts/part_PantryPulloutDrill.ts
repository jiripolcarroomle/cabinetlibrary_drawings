...
export interface IP_part_PantryPulloutDrill_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_PantryPulloutHardware01;
}

export interface IP_part_PantryPulloutDrill_PartVarsWritable extends IP_part_PantryPulloutDrill_PartVarsReadOnly {
}

export class P_part_PantryPulloutDrill extends PartBase implements IP_part_PantryPulloutDrill_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_PantryPulloutHardware01,
    ...
    super(parent, 'part_PantryPulloutDrill', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._hidden = true;
  }
