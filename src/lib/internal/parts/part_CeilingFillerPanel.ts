...
import { IPartParentsNonNull_mc_CeilingFiller01_mc_Paneltop01 } from '../mod-interfaces'

export interface IP_part_CeilingFillerPanel_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_CeilingFiller01_mc_Paneltop01;
}
...
export class P_part_CeilingFillerPanel extends PartBase implements IP_part_CeilingFillerPanel_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_CeilingFiller01_mc_Paneltop01,
    x: number, y: number, z: number, dimx: number, dimy: number, dimz: number, isContainerPart?: boolean) {
    super(parent, 'part_CeilingFillerPanel', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
  }
  parent: IPartParentsNonNull_mc_CeilingFiller01_mc_Paneltop01; // module which created this part
