...
import { IPartParentsNonNull_mc_CoatBoard } from '../mod-interfaces'

export interface IP_part_CoatBoard_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_CoatBoard;
  get pa_BomId(): string;
...
export interface IP_part_CoatBoard_PartVarsWritable extends IP_part_CoatBoard_PartVarsReadOnly {
...
export class P_part_CoatBoard extends PartBase implements IP_part_CoatBoard_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_CoatBoard,
    x: number, y: number, z: number, dimx: number, dimy: number, dimz: number, isContainerPart?: boolean) {
    super(parent, 'part_CoatBoard', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._noNCData = true;
  }
  parent: IPartParentsNonNull_mc_CoatBoard; // module which created this part
  ...
  setAttributes() {
    try {
      ...
      if (this.#pa_EdgeLeftColor === undefined) {
        this.pa_EdgeLeftColor = this.parent.mod_CoatBoardColor;
      }
      if (this.#pa_EdgeLeftType === undefined) {
        this.pa_EdgeLeftType = 'FRE';
      }
      if (this.#pa_EdgeRightColor === undefined) {
        this.pa_EdgeRightColor = this.parent.mod_CoatBoardColor;
      }
      if (this.#pa_GrainDirection === undefined) {
        this.pa_GrainDirection = 'Neutral';
      }
      if (this.#pa_TopColor === undefined) {
        this.pa_TopColor = this.parent.mod_CoatBoardColor;
      }
      if (this.#pa_BtmColor === undefined) {
        this.pa_BtmColor = this.parent.mod_CoatBoardColor;
      }
      if (this.#pa_Program === undefined) {
        this.pa_Program = this.parent.mod_CoatBoardProgram;
      }
      ...
      if (this.#pa_ColorGrainGroup === undefined) {
        this.pa_ColorGrainGroup = this.parent.mod_CoatBoardColor_matrix.GrainGroupId;
      }
      if (this.#pa_GrainLogic === undefined) {
        this.pa_GrainLogic = 'None';
      }
      if (this.#pa_ProgramGrainGroup === undefined) {
        this.pa_ProgramGrainGroup = this.parent.mod_CoatBoardProgram_matrix.GrainGroupId;
      }
  ...
  checkAttributes() {
    ...
    if (this.#pa_BomId === undefined) {
      logError('Attribute pa_BomId not set in part part_CoatBoard (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackColor === undefined) {
      logError('Attribute pa_EdgeBackColor not set in part part_CoatBoard (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackType === undefined) {
      logError('Attribute pa_EdgeBackType not set in part part_CoatBoard (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontColor === undefined) {
      logError('Attribute pa_EdgeFrontColor not set in part part_CoatBoard (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontType === undefined) {
      logError('Attribute pa_EdgeFrontType not set in part part_CoatBoard (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeJointType === undefined) {
      logError('Attribute pa_EdgeJointType not set in part part_CoatBoard (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftColor === undefined) {
      logError('Attribute pa_EdgeLeftColor not set in part part_CoatBoard (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftType === undefined) {
      logError('Attribute pa_EdgeLeftType not set in part part_CoatBoard (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightColor === undefined) {
      logError('Attribute pa_EdgeRightColor not set in part part_CoatBoard (id: ' + this._id + ')');
    }
    if (this.#pa_GrainDirection === undefined) {
      logError('Attribute pa_GrainDirection not set in part part_CoatBoard (id: ' + this._id + ')');
    }
    if (this.#pa_TopColor === undefined) {
      logError('Attribute pa_TopColor not set in part part_CoatBoard (id: ' + this._id + ')');
    }
    if (this.#pa_BtmColor === undefined) {
      logError('Attribute pa_BtmColor not set in part part_CoatBoard (id: ' + this._id + ')');
    }
    if (this.#pa_Program === undefined) {
      logError('Attribute pa_Program not set in part part_CoatBoard (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightType === undefined) {
      logError('Attribute pa_EdgeRightType not set in part part_CoatBoard (id: ' + this._id + ')');
    }
    if (this.#pa_AdditionalInfo1 === undefined) {
      logError('Attribute pa_AdditionalInfo1 not set in part part_CoatBoard (id: ' + this._id + ')');
    }
    if (this.#pa_ColorGrainGroup === undefined) {
      logError('Attribute pa_ColorGrainGroup not set in part part_CoatBoard (id: ' + this._id + ')');
    }
    if (this.#pa_GrainLogic === undefined) {
      logError('Attribute pa_GrainLogic not set in part part_CoatBoard (id: ' + this._id + ')');
    }
    if (this.#pa_ProgramGrainGroup === undefined) {
      logError('Attribute pa_ProgramGrainGroup not set in part part_CoatBoard (id: ' + this._id + ')');
    }
    if (this.#pa_TypeElement === undefined) {
      logError('Attribute pa_TypeElement not set in part part_CoatBoard (id: ' + this._id + ')');
    }
