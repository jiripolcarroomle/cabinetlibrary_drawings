...
export class P_part_FixedfrontPanelWoodFrame extends PartBase implements IP_part_FixedfrontPanelWoodFrame_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_PanelWoodFrame01,
    ...
    super(parent, 'part_FixedfrontPanelWoodFrame', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._hidden = true;
  }
  ...
  setAttributes() {
    try {
      ...
      if (this.#pa_FrameFillingColor === undefined) {
        this.pa_FrameFillingColor = this.parent.mod_FrameFillingColor;
      }
      // ###############################################################
      // ################### END CUSTOM SCRIPTS ########################
      // ###############################################################
  ...
  checkAttributes() {
    ...
    if (this.#pa_FrameFillingColor === undefined) {
      logError('Attribute pa_FrameFillingColor not set in part part_FixedfrontPanelWoodFrame (id: ' + this._id + ')');
    }
