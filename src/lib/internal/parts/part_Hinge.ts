...
export class P_part_Hinge extends PartBase implements IP_part_Hinge_PartVarsWritable {
  constructor(parent: IModBaseProp,
    ...
    super(parent, 'part_Hinge', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._threedModel = { _3dUrl: 'https://tecconfig-preview.homag.cloud/cdn/5ebb30e7-78fb-4155-be66-20fb7a8cacbe/library/cabinetlibrary/images/0cd0ac03-b9ea-41a7-a5c0-e8b00fb1a44e_sidelefthingepart_1.obj?sv=2023-11-03&st=2026-05-30T00%3A00%3A00Z&se=2026-07-02T00%3A00%3A00Z&sr=b&sp=r&sig=gYPts4d1ghc8sbxdlHn4VkfRmQCp%2BDKNItpC0F5OA8w%3D', _3dParameters: undefined, _3dObjectId: 'bGlicmFyeS9jYWJpbmV0bGlicmFyeS9pbWFnZXMvMGNkMGFjMDMtYjllYS00MWE3LWE1YzAtZThiMDBmYjFhNDRlX3NpZGVsZWZ0aGluZ2VwYXJ0XzEub2Jq' };
  }
