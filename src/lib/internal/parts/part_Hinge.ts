...
export class P_part_Hinge extends PartBase implements IP_part_Hinge_PartVarsWritable {
  constructor(parent: IModBaseProp,
    ...
    this.parent = parent;
    this._wdt = 'XYZ';
    this._threedModel = { _3dUrl: 'https://tecconfig.homag.cloud/cdn/5ebb30e7-78fb-4155-be66-20fb7a8cacbe/library/cabinetlibrary/images/834b92c3-c041-4521-a6ca-351c6b1359e3_sidelefthingepart_1.obj?sv=2023-11-03&st=2026-04-29T00%3A00%3A00Z&se=2026-06-01T00%3A00%3A00Z&sr=b&sp=r&sig=h%2B0gJ%2Fytxe5DefZVqzeD5USREMpvXBG4DPyCMiRXHkw%3D', _3dParameters: undefined, _3dObjectId: 'bGlicmFyeS9jYWJpbmV0bGlicmFyeS9pbWFnZXMvODM0YjkyYzMtYzA0MS00NTIxLWE2Y2EtMzUxYzZiMTM1OWUzX3NpZGVsZWZ0aGluZ2VwYXJ0XzEub2Jq' };
  }
