...
import { IPartParentsNonNull_mc_Baseboard01 } from '../mod-interfaces'

export interface IP_part_Baseboard_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_Baseboard01;
  get pa_BomId(): string;
...
export interface IP_part_Baseboard_PartVarsWritable extends IP_part_Baseboard_PartVarsReadOnly {
...
export class P_part_Baseboard extends PartBase implements IP_part_Baseboard_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_Baseboard01,
    x: number, y: number, z: number, dimx: number, dimy: number, dimz: number, isContainerPart?: boolean) {
    super(parent, 'part_Baseboard', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XZY';
  }
  parent: IPartParentsNonNull_mc_Baseboard01; // module which created this part
  ...
  setAttributes() {
    try {
      ...
      // ####################### CUSTOM SCRIPTS ########################
      // ###############################################################
      // part_Baseboard_ValueScript
      if (this.#pa_BomId === undefined) {
        this.pa_BomId = this.parent.mod_BaseboardId;
      }
      if (this.#pa_BtmColor === undefined) {
        this.pa_BtmColor = this.parent.mod_BaseboardColor;
      }
      if (this.#pa_GrainDirection === undefined) {
        this.pa_GrainDirection = 'Neutral';
      }
      if (this.#pa_Program === undefined) {
        this.pa_Program = this.parent.mod_BaseboardProgram;
      }
      if (this.#pa_TopColor === undefined) {
        this.pa_TopColor = this.parent.mod_BaseboardColor;
      }
      if (this.#pa_EdgeBackColor === undefined) {
        this.pa_EdgeBackColor = this.parent.mod_BaseboardEdgeBackColor;
      }
      if (this.#pa_EdgeBackType === undefined) {
        this.pa_EdgeBackType = 'FRE';
      }
      if (this.#pa_EdgeFrontColor === undefined) {
        this.pa_EdgeFrontColor = this.parent.mod_BaseboardEdgeFrontColor;
      }
      ...
      if (this.#pa_EdgeLeftColor === undefined) {
        this.pa_EdgeLeftColor = this.parent.mod_BaseboardEdgeColor;
      }
      if (this.#pa_EdgeLeftType === undefined) {
        this.pa_EdgeLeftType = 'FRE';
      }
      if (this.#pa_EdgeRightColor === undefined) {
        this.pa_EdgeRightColor = this.parent.mod_BaseboardEdgeColor;
      }
      ...
      if (this.#pa_GrainLogic === undefined) {
        this.pa_GrainLogic = 'Library';
      }
      if (this.#pa_ColorGrainGroup === undefined) {
        this.pa_ColorGrainGroup = this.parent.mod_BaseboardColor_matrix.GrainGroupId;
      }
      if (this.#pa_ProgramGrainGroup === undefined) {
        this.pa_ProgramGrainGroup = this.parent.mod_BaseboardProgram_matrix.GrainGroupId;
      }
  ...
  checkAttributes() {
    ...
    if (this.#pa_BomId === undefined) {
      logError('Attribute pa_BomId not set in part part_Baseboard (id: ' + this._id + ')');
    }
    if (this.#pa_BtmColor === undefined) {
      logError('Attribute pa_BtmColor not set in part part_Baseboard (id: ' + this._id + ')');
    }
    if (this.#pa_GrainDirection === undefined) {
      logError('Attribute pa_GrainDirection not set in part part_Baseboard (id: ' + this._id + ')');
    }
    if (this.#pa_Program === undefined) {
      logError('Attribute pa_Program not set in part part_Baseboard (id: ' + this._id + ')');
    }
    if (this.#pa_TopColor === undefined) {
      logError('Attribute pa_TopColor not set in part part_Baseboard (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackColor === undefined) {
      logError('Attribute pa_EdgeBackColor not set in part part_Baseboard (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeBackType === undefined) {
      logError('Attribute pa_EdgeBackType not set in part part_Baseboard (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontColor === undefined) {
      logError('Attribute pa_EdgeFrontColor not set in part part_Baseboard (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeFrontType === undefined) {
      logError('Attribute pa_EdgeFrontType not set in part part_Baseboard (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeJointType === undefined) {
      logError('Attribute pa_EdgeJointType not set in part part_Baseboard (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftColor === undefined) {
      logError('Attribute pa_EdgeLeftColor not set in part part_Baseboard (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeLeftType === undefined) {
      logError('Attribute pa_EdgeLeftType not set in part part_Baseboard (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightColor === undefined) {
      logError('Attribute pa_EdgeRightColor not set in part part_Baseboard (id: ' + this._id + ')');
    }
    if (this.#pa_EdgeRightType === undefined) {
      logError('Attribute pa_EdgeRightType not set in part part_Baseboard (id: ' + this._id + ')');
    }
    if (this.#pa_AdditionalInfo1 === undefined) {
      logError('Attribute pa_AdditionalInfo1 not set in part part_Baseboard (id: ' + this._id + ')');
    }
    if (this.#pa_GrainLogic === undefined) {
      logError('Attribute pa_GrainLogic not set in part part_Baseboard (id: ' + this._id + ')');
    }
    if (this.#pa_ColorGrainGroup === undefined) {
      logError('Attribute pa_ColorGrainGroup not set in part part_Baseboard (id: ' + this._id + ')');
    }
    if (this.#pa_ProgramGrainGroup === undefined) {
      logError('Attribute pa_ProgramGrainGroup not set in part part_Baseboard (id: ' + this._id + ')');
    }
    if (this.#pa_TypeElement === undefined) {
      logError('Attribute pa_TypeElement not set in part part_Baseboard (id: ' + this._id + ')');
    }
  ...
  createBomElements() {
    try {
      ...
      if (partSelf._g?.basic_CreateBom == 'Library') { // ####################### CUSTOM SCRIPTS ########################
        ...
        const _bom = new class BOM233 extends BOM_ElementType_bomout_Board {
          constructor() { super(partSelf); }
          set(partSelf: IP_part_Baseboard_PartVarsReadOnly) {
            const part = partSelf;
  ...
  override createBomTouchElements(touch: PartTouch, partNext: PartBase, posRel: CollisionDataRel) {
    try {
      // ncout_Group: 645: part_LegDrill FromBottom
      if (touch == PartTouch.FromBottom && partNext instanceof P_part_LegDrill) {
        ...
        if (true) { // ####################### CUSTOM SCRIPTS ########################
          ...
          const _bom = new class BOMT645 extends BOM_ElementType_ncout_Group {
            constructor() { super(partSelf); }
            set(partSelf: IP_part_Baseboard_PartVarsReadOnly, touch: PartTouch, part2: IP_part_LegDrill_PartVarsReadOnly, posRel: CollisionDataRel) {
          ...
          _bom._description = "Leg - Leg drill - Baseboard";
