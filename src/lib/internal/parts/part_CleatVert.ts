...
export class P_part_CleatVert extends PartBase implements IP_part_CleatVert_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_CleatVert01,
    ...
    super(parent, 'part_CleatVert', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
  }
  ...
  checkAttributes() {
    ...
    if (this.#pa_ProgramGrainGroup === undefined) {
      logError('Attribute pa_ProgramGrainGroup not set in part part_CleatVert (id: ' + this._id + ')');
    }
    if (this.#pa_ColorGrainGroup === undefined) {
      logError('Attribute pa_ColorGrainGroup not set in part part_CleatVert (id: ' + this._id + ')');
    }
