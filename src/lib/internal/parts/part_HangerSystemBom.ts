...
export class P_part_HangerSystemBom extends PartBase implements IP_part_HangerSystemBom_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_HangerSystem01,
    ...
    super(parent, 'part_HangerSystemBom', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._hidden = true;
  }
  ...
  checkAttributes() {
    ...
    if (this.#pa_ParentName === undefined) {
      logError('Attribute pa_ParentName not set in part part_HangerSystemBom (id: ' + this._id + ')');
    }
