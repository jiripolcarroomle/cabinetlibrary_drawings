...
export interface IP_part_HoodShelfbtm_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_HoodCarcaseParts01;
}

export interface IP_part_HoodShelfbtm_PartVarsWritable extends IP_part_HoodShelfbtm_PartVarsReadOnly {
}

export class P_part_HoodShelfbtm extends PartBase implements IP_part_HoodShelfbtm_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_HoodCarcaseParts01,
    ...
    super(parent, 'part_HoodShelfbtm', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
  }
