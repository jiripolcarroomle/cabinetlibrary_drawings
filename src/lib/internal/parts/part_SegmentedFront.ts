...
import { IPartParentsNonNull_mc_SegmentFront01 } from '../mod-interfaces'

export interface IP_part_SegmentedFront_PartVarsReadOnly extends IPartBase {
  parent: IPartParentsNonNull_mc_SegmentFront01;
}

export interface IP_part_SegmentedFront_PartVarsWritable extends IP_part_SegmentedFront_PartVarsReadOnly {
}

export class P_part_SegmentedFront extends PartBase implements IP_part_SegmentedFront_PartVarsWritable {
  constructor(parent: IPartParentsNonNull_mc_SegmentFront01,
    x: number, y: number, z: number, dimx: number, dimy: number, dimz: number, isContainerPart?: boolean) {
    super(parent, 'part_SegmentedFront', x, y, z, dimx, dimy, dimz, isContainerPart);
    this.parent = parent;
    this._wdt = 'XYZ';
    this._noNCData = true;
  }
  parent: IPartParentsNonNull_mc_SegmentFront01; // module which created this part
