...
import { IFuncParents_mc_ShelfadjGroup01, IFuncParents_mc_CornerFillerFront01_mc_Door01_mc_Drawer01_mc_Fixedfront01_mc_Fliplift01_mc_Handlestrip01, IFuncParents_mc_DrawerBox01, IFuncParents_mc_HingeGroup01, IFuncParents_mc_Storageunit01, IFuncParents_mr_CornerunitStraight, IFuncParents_mf_Door, IFuncParents_mc_FrontPanel01_mc_PanelWoodFrame01, IFuncParents_mc_Handle01, IFuncParents_mc_Door01_mc_Fliplift01, IFuncParents_mc_FlipliftHardware01, IFuncParents_mc_CornerFillerFront01_mc_FillerFront01, IFuncParents_mc_Cornerunit01, IFuncParents_mc_Bracket01_mr_Shelves, IFuncParents_mc_PlinthArea01, IFuncParents_mc_PulloutHardware01, IFuncParents_mf_CornerFillerFront_mr_CornerFiller } from './var-interfaces';
...
import { IP_part_Backsplash_PartVarsReadOnly, IP_part_Backsplash_PartVarsWritable } from './parts/part_Backsplash'
import { IP_part_BacksplashGroup_PartVarsReadOnly, IP_part_BacksplashGroup_PartVarsWritable } from './parts/part_BacksplashGroup'
import { IP_part_Backwall_PartVarsReadOnly, IP_part_Backwall_PartVarsWritable } from './parts/part_Backwall'
import { IP_part_Baseboard_PartVarsReadOnly, IP_part_Baseboard_PartVarsWritable } from './parts/part_Baseboard'
import { IP_part_BaseboardGroup_PartVarsReadOnly, IP_part_BaseboardGroup_PartVarsWritable } from './parts/part_BaseboardGroup'
import { IP_part_BaseunitFridgePanel_PartVarsReadOnly, IP_part_BaseunitFridgePanel_PartVarsWritable } from './parts/part_BaseunitFridgePanel'
import { IP_part_BaseunitFridgePanelWoodFrame_PartVarsReadOnly, IP_part_BaseunitFridgePanelWoodFrame_PartVarsWritable } from './parts/part_BaseunitFridgePanelWoodFrame'
import { IP_part_BoardHanger_PartVarsReadOnly, IP_part_BoardHanger_PartVarsWritable } from './parts/part_BoardHanger'
import { IP_part_BoardShelf_PartVarsReadOnly, IP_part_BoardShelf_PartVarsWritable } from './parts/part_BoardShelf'
import { IP_part_CeilingFillerFittingPanel_PartVarsReadOnly, IP_part_CeilingFillerFittingPanel_PartVarsWritable } from './parts/part_CeilingFillerFittingPanel'
import { IP_part_CeilingFillerPanel_PartVarsReadOnly, IP_part_CeilingFillerPanel_PartVarsWritable } from './parts/part_CeilingFillerPanel'
import { IP_part_CleatVert_PartVarsReadOnly, IP_part_CleatVert_PartVarsWritable } from './parts/part_CleatVert'
import { IP_part_ClothingOrganizerBOM_PartVarsReadOnly, IP_part_ClothingOrganizerBOM_PartVarsWritable } from './parts/part_ClothingOrganizerBOM'
import { IP_part_ClothingOrganizerBoard_PartVarsReadOnly, IP_part_ClothingOrganizerBoard_PartVarsWritable } from './parts/part_ClothingOrganizerBoard'
import { IP_part_ClothingOrganizerDrilling_PartVarsReadOnly, IP_part_ClothingOrganizerDrilling_PartVarsWritable } from './parts/part_ClothingOrganizerDrilling'
import { IP_part_ClothingOrganizerGraphic_PartVarsReadOnly, IP_part_ClothingOrganizerGraphic_PartVarsWritable } from './parts/part_ClothingOrganizerGraphic'
import { IP_part_ClothingOrganizerUnit_PartVarsReadOnly, IP_part_ClothingOrganizerUnit_PartVarsWritable } from './parts/part_ClothingOrganizerUnit'
import { IP_part_CoatBoard_PartVarsReadOnly, IP_part_CoatBoard_PartVarsWritable } from './parts/part_CoatBoard'
import { IP_part_CoatBoardGroup_PartVarsReadOnly, IP_part_CoatBoardGroup_PartVarsWritable } from './parts/part_CoatBoardGroup'
import { IP_part_Cornerunit_PartVarsReadOnly, IP_part_Cornerunit_PartVarsWritable } from './parts/part_Cornerunit'
import { IP_part_Countertop_PartVarsReadOnly, IP_part_Countertop_PartVarsWritable } from './parts/part_Countertop'
import { IP_part_CountertopCutout_PartVarsReadOnly, IP_part_CountertopCutout_PartVarsWritable } from './parts/part_CountertopCutout'
import { IP_part_CountertopGroup_PartVarsReadOnly, IP_part_CountertopGroup_PartVarsWritable } from './parts/part_CountertopGroup'
import { IP_part_DishwasherPanel_PartVarsReadOnly, IP_part_DishwasherPanel_PartVarsWritable } from './parts/part_DishwasherPanel'
import { IP_part_DishwasherPanelWoodFrame_PartVarsReadOnly, IP_part_DishwasherPanelWoodFrame_PartVarsWritable } from './parts/part_DishwasherPanelWoodFrame'
import { IP_part_Door_PartVarsReadOnly, IP_part_Door_PartVarsWritable } from './parts/part_Door'
import { IP_part_DoorPanelWoodFrame_PartVarsReadOnly, IP_part_DoorPanelWoodFrame_PartVarsWritable } from './parts/part_DoorPanelWoodFrame'
import { IP_part_DoorSegmented_PartVarsReadOnly, IP_part_DoorSegmented_PartVarsWritable } from './parts/part_DoorSegmented'
import { IP_part_DoorUnit_PartVarsReadOnly, IP_part_DoorUnit_PartVarsWritable } from './parts/part_DoorUnit'
import { IP_part_Drawer_PartVarsReadOnly, IP_part_Drawer_PartVarsWritable } from './parts/part_Drawer'
import { IP_part_DrawerBackwallSteel_PartVarsReadOnly, IP_part_DrawerBackwallSteel_PartVarsWritable } from './parts/part_DrawerBackwallSteel'
import { IP_part_DrawerBackwallWood_PartVarsReadOnly, IP_part_DrawerBackwallWood_PartVarsWritable } from './parts/part_DrawerBackwallWood'
import { IP_part_DrawerBox_PartVarsReadOnly, IP_part_DrawerBox_PartVarsWritable } from './parts/part_DrawerBox'
import { IP_part_DrawerBoxBom_PartVarsReadOnly, IP_part_DrawerBoxBom_PartVarsWritable } from './parts/part_DrawerBoxBom'
import { IP_part_DrawerBoxDrilling_PartVarsReadOnly, IP_part_DrawerBoxDrilling_PartVarsWritable } from './parts/part_DrawerBoxDrilling'
import { IP_part_DrawerBoxSynchronization_PartVarsReadOnly, IP_part_DrawerBoxSynchronization_PartVarsWritable } from './parts/part_DrawerBoxSynchronization'
import { IP_part_DrawerFrontConnector_PartVarsReadOnly, IP_part_DrawerFrontConnector_PartVarsWritable } from './parts/part_DrawerFrontConnector'
import { IP_part_DrawerPanelWoodFrame_PartVarsReadOnly, IP_part_DrawerPanelWoodFrame_PartVarsWritable } from './parts/part_DrawerPanelWoodFrame'
import { IP_part_DrawerShelfbtm_PartVarsReadOnly, IP_part_DrawerShelfbtm_PartVarsWritable } from './parts/part_DrawerShelfbtm'
import { IP_part_DrawerShelfbtmConnector_PartVarsReadOnly, IP_part_DrawerShelfbtmConnector_PartVarsWritable } from './parts/part_DrawerShelfbtmConnector'
import { IP_part_DrawerShelfbtmConnectorDrilling_PartVarsReadOnly, IP_part_DrawerShelfbtmConnectorDrilling_PartVarsWritable } from './parts/part_DrawerShelfbtmConnectorDrilling'
import { IP_part_DrawerSideLeft_PartVarsReadOnly, IP_part_DrawerSideLeft_PartVarsWritable } from './parts/part_DrawerSideLeft'
import { IP_part_DrawerSideRight_PartVarsReadOnly, IP_part_DrawerSideRight_PartVarsWritable } from './parts/part_DrawerSideRight'
import { IP_part_DrawerSlideLeft_PartVarsReadOnly, IP_part_DrawerSlideLeft_PartVarsWritable } from './parts/part_DrawerSlideLeft'
import { IP_part_DrawerSlideRight_PartVarsReadOnly, IP_part_DrawerSlideRight_PartVarsWritable } from './parts/part_DrawerSlideRight'
import { IP_part_DrawerUnit_PartVarsReadOnly, IP_part_DrawerUnit_PartVarsWritable } from './parts/part_DrawerUnit'
import { IP_part_DropZone_PartVarsReadOnly, IP_part_DropZone_PartVarsWritable } from './parts/part_DropZone'
import { IP_part_Duststrip_PartVarsReadOnly, IP_part_Duststrip_PartVarsWritable } from './parts/part_Duststrip'
import { IP_part_Filler_PartVarsReadOnly, IP_part_Filler_PartVarsWritable } from './parts/part_Filler'
import { IP_part_FillerHardware_PartVarsReadOnly, IP_part_FillerHardware_PartVarsWritable } from './parts/part_FillerHardware'
import { IP_part_FillerHardwareProcessing_PartVarsReadOnly, IP_part_FillerHardwareProcessing_PartVarsWritable } from './parts/part_FillerHardwareProcessing'
import { IP_part_FillerUnit_PartVarsReadOnly, IP_part_FillerUnit_PartVarsWritable } from './parts/part_FillerUnit'
import { IP_part_FingergripMiddle_PartVarsReadOnly, IP_part_FingergripMiddle_PartVarsWritable } from './parts/part_FingergripMiddle'
import { IP_part_FingergripTop_PartVarsReadOnly, IP_part_FingergripTop_PartVarsWritable } from './parts/part_FingergripTop'
import { IP_part_FinishPanel_PartVarsReadOnly, IP_part_FinishPanel_PartVarsWritable } from './parts/part_FinishPanel'
import { IP_part_FinishPanelProfile_PartVarsReadOnly, IP_part_FinishPanelProfile_PartVarsWritable } from './parts/part_FinishPanelProfile'
import { IP_part_Fixedfront_PartVarsReadOnly, IP_part_Fixedfront_PartVarsWritable } from './parts/part_Fixedfront'
import { IP_part_FixedfrontDrill_PartVarsReadOnly, IP_part_FixedfrontDrill_PartVarsWritable } from './parts/part_FixedfrontDrill'
import { IP_part_FixedfrontPanelWoodFrame_PartVarsReadOnly, IP_part_FixedfrontPanelWoodFrame_PartVarsWritable } from './parts/part_FixedfrontPanelWoodFrame'
import { IP_part_FixedfrontUnit_PartVarsReadOnly, IP_part_FixedfrontUnit_PartVarsWritable } from './parts/part_FixedfrontUnit'
import { IP_part_Fliplift_PartVarsReadOnly, IP_part_Fliplift_PartVarsWritable } from './parts/part_Fliplift'
import { IP_part_FlipliftDrill_PartVarsReadOnly, IP_part_FlipliftDrill_PartVarsWritable } from './parts/part_FlipliftDrill'
import { IP_part_FlipliftHardwareBom_PartVarsReadOnly, IP_part_FlipliftHardwareBom_PartVarsWritable } from './parts/part_FlipliftHardwareBom'
import { IP_part_FlipliftHardwareFrontpanelDrilling_PartVarsReadOnly, IP_part_FlipliftHardwareFrontpanelDrilling_PartVarsWritable } from './parts/part_FlipliftHardwareFrontpanelDrilling'
import { IP_part_FlipliftHardwareGraphic_PartVarsReadOnly, IP_part_FlipliftHardwareGraphic_PartVarsWritable } from './parts/part_FlipliftHardwareGraphic'
import { IP_part_FlipliftHardwareSidepanelDrilling_PartVarsReadOnly, IP_part_FlipliftHardwareSidepanelDrilling_PartVarsWritable } from './parts/part_FlipliftHardwareSidepanelDrilling'
import { IP_part_FlipliftPanelWoodFrame_PartVarsReadOnly, IP_part_FlipliftPanelWoodFrame_PartVarsWritable } from './parts/part_FlipliftPanelWoodFrame'
import { IP_part_FlipliftUnit_PartVarsReadOnly, IP_part_FlipliftUnit_PartVarsWritable } from './parts/part_FlipliftUnit'
import { IP_part_FrontGlass_PartVarsReadOnly, IP_part_FrontGlass_PartVarsWritable } from './parts/part_FrontGlass'
import { IP_part_Frontprofile_PartVarsReadOnly, IP_part_Frontprofile_PartVarsWritable } from './parts/part_Frontprofile'
import { IP_part_Handle_PartVarsReadOnly, IP_part_Handle_PartVarsWritable } from './parts/part_Handle'
import { IP_part_HandleDrill_PartVarsReadOnly, IP_part_HandleDrill_PartVarsWritable } from './parts/part_HandleDrill'
import { IP_part_Handlestrip_PartVarsReadOnly, IP_part_Handlestrip_PartVarsWritable } from './parts/part_Handlestrip'
import { IP_part_HandlestripDrill_PartVarsReadOnly, IP_part_HandlestripDrill_PartVarsWritable } from './parts/part_HandlestripDrill'
import { IP_part_HangerDrill_PartVarsReadOnly, IP_part_HangerDrill_PartVarsWritable } from './parts/part_HangerDrill'
import { IP_part_HangerSystem_PartVarsReadOnly, IP_part_HangerSystem_PartVarsWritable } from './parts/part_HangerSystem'
import { IP_part_HangerSystemBom_PartVarsReadOnly, IP_part_HangerSystemBom_PartVarsWritable } from './parts/part_HangerSystemBom'
import { IP_part_HardwareShelfadjDrill_PartVarsReadOnly, IP_part_HardwareShelfadjDrill_PartVarsWritable } from './parts/part_HardwareShelfadjDrill'
import { IP_part_Heatshelf_PartVarsReadOnly, IP_part_Heatshelf_PartVarsWritable } from './parts/part_Heatshelf'
import { IP_part_HeatshelfFront_PartVarsReadOnly, IP_part_HeatshelfFront_PartVarsWritable } from './parts/part_HeatshelfFront'
import { IP_part_Hinge_PartVarsReadOnly, IP_part_Hinge_PartVarsWritable } from './parts/part_Hinge'
import { IP_part_HingeCarcase_PartVarsReadOnly, IP_part_HingeCarcase_PartVarsWritable } from './parts/part_HingeCarcase'
...
import { IP_part_MiddleSideShort_PartVarsReadOnly, IP_part_MiddleSideShort_PartVarsWritable } from './parts/part_MiddleSideShort'
import { IP_part_Mirror_PartVarsReadOnly, IP_part_Mirror_PartVarsWritable } from './parts/part_Mirror'
import { IP_part_MirrorBoard_PartVarsReadOnly, IP_part_MirrorBoard_PartVarsWritable } from './parts/part_MirrorBoard'
import { IP_part_MirrorBoardGroup_PartVarsReadOnly, IP_part_MirrorBoardGroup_PartVarsWritable } from './parts/part_MirrorBoardGroup'
import { IP_part_PanelHor_PartVarsReadOnly, IP_part_PanelHor_PartVarsWritable } from './parts/part_PanelHor'
import { IP_part_PanelUnit_PartVarsReadOnly, IP_part_PanelUnit_PartVarsWritable } from './parts/part_PanelUnit'
import { IP_part_PanelVert_PartVarsReadOnly, IP_part_PanelVert_PartVarsWritable } from './parts/part_PanelVert'
import { IP_part_PanelWoodFrameBtm_PartVarsReadOnly, IP_part_PanelWoodFrameBtm_PartVarsWritable } from './parts/part_PanelWoodFrameBtm'
import { IP_part_PanelWoodFrameFilling_PartVarsReadOnly, IP_part_PanelWoodFrameFilling_PartVarsWritable } from './parts/part_PanelWoodFrameFilling'
import { IP_part_PanelWoodFrameLeft_PartVarsReadOnly, IP_part_PanelWoodFrameLeft_PartVarsWritable } from './parts/part_PanelWoodFrameLeft'
import { IP_part_PanelWoodFrameRight_PartVarsReadOnly, IP_part_PanelWoodFrameRight_PartVarsWritable } from './parts/part_PanelWoodFrameRight'
import { IP_part_PanelWoodFrameTop_PartVarsReadOnly, IP_part_PanelWoodFrameTop_PartVarsWritable } from './parts/part_PanelWoodFrameTop'
import { IP_part_Panelblind_PartVarsReadOnly, IP_part_Panelblind_PartVarsWritable } from './parts/part_Panelblind'
import { IP_part_Paneltop_PartVarsReadOnly, IP_part_Paneltop_PartVarsWritable } from './parts/part_Paneltop'
import { IP_part_PaneltopGroup_PartVarsReadOnly, IP_part_PaneltopGroup_PartVarsWritable } from './parts/part_PaneltopGroup'
import { IP_part_PantryPullout_PartVarsReadOnly, IP_part_PantryPullout_PartVarsWritable } from './parts/part_PantryPullout'
import { IP_part_PantryPulloutBom_PartVarsReadOnly, IP_part_PantryPulloutBom_PartVarsWritable } from './parts/part_PantryPulloutBom'
import { IP_part_PantryPulloutDrill_PartVarsReadOnly, IP_part_PantryPulloutDrill_PartVarsWritable } from './parts/part_PantryPulloutDrill'
import { IP_part_PantryPulloutHardware_PartVarsReadOnly, IP_part_PantryPulloutHardware_PartVarsWritable } from './parts/part_PantryPulloutHardware'
import { IP_part_PantryPulloutUnit_PartVarsReadOnly, IP_part_PantryPulloutUnit_PartVarsWritable } from './parts/part_PantryPulloutUnit'
import { IP_part_Placeholder_PartVarsReadOnly, IP_part_Placeholder_PartVarsWritable } from './parts/part_Placeholder'
import { IP_part_PlinthAreaUnit_PartVarsReadOnly, IP_part_PlinthAreaUnit_PartVarsWritable } from './parts/part_PlinthAreaUnit'
import { IP_part_Pullout_PartVarsReadOnly, IP_part_Pullout_PartVarsWritable } from './parts/part_Pullout'
import { IP_part_PulloutHardware_PartVarsReadOnly, IP_part_PulloutHardware_PartVarsWritable } from './parts/part_PulloutHardware'
import { IP_part_PulloutHardwareDrillings_PartVarsReadOnly, IP_part_PulloutHardwareDrillings_PartVarsWritable } from './parts/part_PulloutHardwareDrillings'
import { IP_part_PulloutUnit_PartVarsReadOnly, IP_part_PulloutUnit_PartVarsWritable } from './parts/part_PulloutUnit'
import { IP_part_Pushtoopen_PartVarsReadOnly, IP_part_Pushtoopen_PartVarsWritable } from './parts/part_Pushtoopen'
import { IP_part_PushtoopenBom_PartVarsReadOnly, IP_part_PushtoopenBom_PartVarsWritable } from './parts/part_PushtoopenBom'
import { IP_part_PushtoopenDrill_PartVarsReadOnly, IP_part_PushtoopenDrill_PartVarsWritable } from './parts/part_PushtoopenDrill'
import { IP_part_PushtoopenMountingPlateDrill_PartVarsReadOnly, IP_part_PushtoopenMountingPlateDrill_PartVarsWritable } from './parts/part_PushtoopenMountingPlateDrill'
import { IP_part_RackAreaUnit_PartVarsReadOnly, IP_part_RackAreaUnit_PartVarsWritable } from './parts/part_RackAreaUnit'
import { IP_part_Railhortopback_PartVarsReadOnly, IP_part_Railhortopback_PartVarsWritable } from './parts/part_Railhortopback'
import { IP_part_Railhortopfront_PartVarsReadOnly, IP_part_Railhortopfront_PartVarsWritable } from './parts/part_Railhortopfront'
import { IP_part_Railverttopback_PartVarsReadOnly, IP_part_Railverttopback_PartVarsWritable } from './parts/part_Railverttopback'
import { IP_part_Railverttopfront_PartVarsReadOnly, IP_part_Railverttopfront_PartVarsWritable } from './parts/part_Railverttopfront'
import { IP_part_SegmentedFront_PartVarsReadOnly, IP_part_SegmentedFront_PartVarsWritable } from './parts/part_SegmentedFront'
import { IP_part_ShelfadjDrill_PartVarsReadOnly, IP_part_ShelfadjDrill_PartVarsWritable } from './parts/part_ShelfadjDrill'
import { IP_part_ShelfadjFitting_PartVarsReadOnly, IP_part_ShelfadjFitting_PartVarsWritable } from './parts/part_ShelfadjFitting'
import { IP_part_ShelfadjGlass_PartVarsReadOnly, IP_part_ShelfadjGlass_PartVarsWritable } from './parts/part_ShelfadjGlass'
import { IP_part_ShelfadjWood_PartVarsReadOnly, IP_part_ShelfadjWood_PartVarsWritable } from './parts/part_ShelfadjWood'
import { IP_part_Shelfbtm_PartVarsReadOnly, IP_part_Shelfbtm_PartVarsWritable } from './parts/part_Shelfbtm'
import { IP_part_Shelffixed_PartVarsReadOnly, IP_part_Shelffixed_PartVarsWritable } from './parts/part_Shelffixed'
import { IP_part_Shelftop_PartVarsReadOnly, IP_part_Shelftop_PartVarsWritable } from './parts/part_Shelftop'
import { IP_part_Shelves_PartVarsReadOnly, IP_part_Shelves_PartVarsWritable } from './parts/part_Shelves'
import { IP_part_ShelvesBrackets_PartVarsReadOnly, IP_part_ShelvesBrackets_PartVarsWritable } from './parts/part_ShelvesBrackets'
import { IP_part_Sidepanelleft_PartVarsReadOnly, IP_part_Sidepanelleft_PartVarsWritable } from './parts/part_Sidepanelleft'
import { IP_part_Sidepanelmiddle_PartVarsReadOnly, IP_part_Sidepanelmiddle_PartVarsWritable } from './parts/part_Sidepanelmiddle'
import { IP_part_Sidepanelright_PartVarsReadOnly, IP_part_Sidepanelright_PartVarsWritable } from './parts/part_Sidepanelright'
import { IP_part_SlopedCeilingShelftopAngle_PartVarsReadOnly, IP_part_SlopedCeilingShelftopAngle_PartVarsWritable } from './parts/part_SlopedCeilingShelftopAngle'
import { IP_part_SlopedCeilingShelftopHor_PartVarsReadOnly, IP_part_SlopedCeilingShelftopHor_PartVarsWritable } from './parts/part_SlopedCeilingShelftopHor'
import { IP_part_Storageunit_PartVarsReadOnly, IP_part_Storageunit_PartVarsWritable } from './parts/part_Storageunit'
...
export class GlobalFunc {
	...
	static process_ShelfadjPos(m: IFuncParents_mc_ShelfadjGroup01) {
		...
		try {
			...
			let arrDescPos = GlobalFunc.process_Descriptor(descriptor, usableHeight);
	...
	// Find Hinge Position\n//########################################################
	static find_HingePosition(TypeElement: string, FrontConstructionId: string, AdditionalInfo1: string, AdditionalInfo2: string, FrontHeight: number, FrontWidth: number, Weight: number, FingergripTypeTop: string, FingergripTypeBtm: string, HandleDesign: string, HandlePosType: string): ICT_tab_HingePosition {
	...
	// Hinge Settings\n//########################################################
	static find_HingeSettings(TypeElement: string, FrontType: string, AdditionalInfo1: string, AdditionalInfo2: string, FrontConstructionId: string, DoorThickness: number, Angle: number, InteriorCabinet: string): ICT_tab_HingeSettings {
		// Wildcard parameters
		let WildcardParams: any = {
			in_TypeElement: TypeElement,
			in_AdditionalInfo1: AdditionalInfo1,
	...
	static ue_StorageunitSingle(parentModule: any) {
	...
	static process_BasicTableQuery(
		table: any[],
		WildcardParams: any,
		FixedParams: any,
		RangeParams: any,
	...
	static process_Hanger(m: IFuncParents_mc_Storageunit01, BackwallPosition: number, DistanceBehindBackwallMin: number, posTop: number = 0, freeSpace: string = '') {
		...
		if (m.mod_HangerType == 'Custom') {
			...
			if (m.mod_HangerPosY == 'Automatic') { verticalOffset = retHangerMapping.VerticalOffset!; }
			else if (m.mod_HangerPosY == 'Top') { verticalOffset = 0; }
			else if (m.mod_HangerPosY == 'Middle') { verticalOffset = -m.mod_CarcaseHeight / 2; }
			else if (m.mod_HangerPosY == 'Manual') { verticalOffset = - m.mod_HangerOffsetPosY; }
	...
	static process_RackAreaOversizeCarcase(parentModule: any) {
	...
	static process_Door(m: any) {
		...
		let retDoorSettings = GlobalFunc.find_DoorSettings(m.mod_ParentName, m.mod_TypeElement, m.mod_CarcaseDirectionInfo, m.mod_FrontDesign, m.mod_FrontColor, m.mod_FrontWidth, m.mod_DoorTypeSelection, m.mod_DoorDirectionSelection, m.mod_VertDividerType);
		...
		if (retDoorSettings !== undefined) {
			...
			FrontDescriptor = m.mod_DoorTypeSelection == "Automatic" ? retDoorSettings.FrontDescriptor : m.mod_FrontDescriptor;
		...
		let DoorInfo: DoorInformation = {
			...
			RealDoorDirection: retDoorSettings.RealDoorDirection ?? '',
			RealDoorType: retDoorSettings.RealDoorType ?? ''
		};
	...
	static ue_FrontpanelWeightCalculations(Module: any, Partgroup: string, Program: string, Width: number, Height: number, Handlestrip: string, HandlePosType: string, FrontGrain: string): number {
	...
	static process_Handle(m: IFuncParents_mc_Handle01) {
		...
		//========================================================================
			...
			// Via Matrix-Position -> only if the section is Up or Down (Mode = Matrix)
			if (m.mod_HandlePosLogic == 'Matrix' && m.mod_HandlePosMatrix_matrix.Mode == 'Matrix') {
				SectorVert = m.mod_HandlePosMatrix_matrix.Section;
				if (PartGroup == 'Door') {
	...
	static find_PushtoopenSettings(TypeElement: string, FrontType: string, FrontConstructionId: string, FrontOpeningDirection: string, PushToOpenLine: string, PushToOpenPosition: string, PushToOpenType: string): ICT_tab_PushtoopenSettings[] {
		// Wildcard parameters
		let WildcardParams: any = {
			in_TypeElement: TypeElement,
			in_FrontConstructionId: FrontConstructionId,
	...
	static process_Pushtoopen(m: IFuncParents_mc_Door01_mc_Fliplift01, FrontPositionY: number, FrontHeight: number, iFrontOverlay: any, FrontOpeningDirection: string, FrontType: string, FrontConstructionId: string) {
				...
				directionArray.forEach(direction => {
					...
					if (retFlipliftMapping.CarcaseObject && retFlipliftMapping.CarcaseObject !== "None") {
						...
						retGraphicMapping.forEach((Item) => {
							...
							const [FlipliftInfo, GraphicInfo] = GlobalFunc.process_GraphicLibraryData(Item.Model3DGroupName!);
							if (!FlipliftInfo || !GraphicInfo) {
								const ErrorMessage = GlobalFunc.find_ErrorList('Error 40009', 1);
								logError(ErrorMessage.Message(""));
								return;
							}
							...
							lastElement.Data.Model3D = GraphicInfo.Model3D;
							lastElement.Data.Color = FlipliftInfo.ColorId ?? '';
							lastElement.Data.DimX = FlipliftInfo.DimensionX + FlipliftInfo.PartOffsetX;
							lastElement.Data.DimY = FlipliftInfo.DimensionY;
							lastElement.Data.DimZ = FlipliftInfo.DimensionZ + FlipliftInfo.PartOffsetZ;
							lastElement.Data.PosX = FlipliftInfo.PartOffsetX; // Doesn't make sense to change the InsertionPointX in the carcase => retGraphicLib.InsertionPointX + 
							lastElement.Data.PosY = FlipliftInfo.InsertionPointY;
							lastElement.Data.PosZ = FlipliftInfo.InsertionPointZ + FlipliftInfo.PartOffsetZ;
							lastElement.Data.DrillPosX = FlipliftInfo.InsertionPointX;
							lastElement.Data.Identifier = FlipliftInfo.Identifier!;
					...
					if (retFlipliftMapping.FrontObject && retFlipliftMapping.FrontObject !== "None") {
						...
						retGraphicMappingF.forEach((Item) => {
							...
							lastElement.Data.DimY = FlipliftInfo.DimensionY;
							lastElement.Data.DimZ = FlipliftInfo.DimensionZ + FlipliftInfo.PartOffsetZ;
							lastElement.Data.PosX = FlipliftInfo.InsertionPointX + FlipliftInfo.PartOffsetX;
							lastElement.Data.PosY = FlipliftInfo.InsertionPointY;
							lastElement.Data.PosZ = FlipliftInfo.InsertionPointZ + FlipliftInfo.PartOffsetZ;
							lastElement.Data.Identifier = FlipliftInfo.Identifier!;
	...
	static process_MathLongparts() {
		...
		const CONTOUR_ATTRIBUTE_ADD_BASEBOARD = 'AddBaseboard';
		...
		class LongPartSegment {
			 ...
			 */
			getAttributeOrDefault(attributeName: string, defaultValue: string | number): any {
				const attributeValue = this.generationContour.contour.attributes.get(attributeName);
				if (attributeValue === undefined) { return defaultValue; }
				else {
					return attributeValue as typeof defaultValue;
				}
			}
			/** Shortcut for getAttributeOrDefault === something
			 * @param attributeName attribute name
			 * @param value value to compare the attribute to
			 * @returns true if the attribute is defined and equal to the value, false otherwise
			 */
			attributeIs(attributeName: string, value: string | number): boolean {
				const attributeValue = this.generationContour.contour.attributes.get(attributeName);
				if (attributeValue === undefined) { return false; }
				else { return attributeValue === value; }
			}
		}
	...
	static find_MaterialMapping(color: string, colorIdParent: string = 'All'): ICT_tab_MaterialMapping | undefined {
	...
	static process_Fridge(m: any, carc: any, FrontNumber: number = 0, LastFront: number = 0, OvenOnTop: boolean = false) {
	...
	static process_PlinthAreaLegs(m: any, LegHeight: number = 0) {
	...
	static ue_PlinthAreaLegs(m: any, LegHeight: number = 0) {
	...
	static ue_PlinthAreaSingleLeg(m: any, input: any, leg: ICT_tab_PlinthAreaSettings, LegHeight: number = 0) {
	...
	static find_PanelWoodFrameConstruction(PartGroup: string, ConstructionId: string, FrontGrain: string, FillingGrain: string, FillingType: string): ICT_tab_PanelWoodFrameConstruction {
	...
	// Add materials to front parts
	static process_AddMaterialFront(
		Part: any,
		Module: any,
		Category: string,
		Grain: string,
	...
	// Retrieve data from table FrameFillingMapping
	static find_FrameFillingMapping(PartGroup: string, FrontProgram: string, FrontDesign: string, FrontColor: string): ICT_tab_FrameFillingMapping {
	...
	// Function to retrieve information for the Pullout Unit
	static process_Pullout(m: IFuncParents_mc_PulloutHardware01) {
		// Interfaces
	...
	// Function to retrieve Object for Pullout
	static find_PulloutMapping(PulloutType: string, PulloutDesign: string, PulloutElementColor: string, PulloutConnectionPosition: string, OpeningType: string) {
	...
	// Calculation of the oven data
	static process_Oven(root: any, oven: any, carc: any, FrontStartPos: number = 0, CabinetStartPos: number = 0): { nextFront: number; ovenData: string } {
	...
	static find_PlinthAreaBaseboardSettings(
		args: {
			TypeElement: string,
	...
	// Finds the mapping from tab_PulloutElementColorMapping
	static find_PulloutElementColorMapping(HardwareColor: string, PulloutType: string, PulloutDesign: string): ICT_tab_PulloutElementColorMapping {
	...
	static find_BaseunitFridgeMapping(Supplier: string, BaseunitFridgeId: string): ICT_tab_BaseunitFridgeMapping {
	...
	static find_BaseunitFridgeConstruction(ConstructionId: string): ICT_tab_BaseunitFridgeConstruction {
	...
	// Retrieve data from tab_FridgeNicheConstruction
	static find_FridgeNicheConstruction(startPos: number, frontHeight: number, nicheHeight: number, splittedDoor: boolean, firstFrontHeight: number, posType: string): ICT_tab_FridgeNicheConstruction {
	...
	// User Exit for module mr_Appliance
	static ue_Appliance(parentModule: any) {
	...
	// User Exit for module mr_Backsplash
	static ue_Backsplash(parentModule: any) {
		...
		parentModule._posData.set('width', parentModule.mod_Width);
		parentModule._posData.set('height', parentModule.mod_Height);
		parentModule._posData.set('color', parentModule.mod_BacksplashColor);
	...
	// User Exit for module mr_Cornerfiller
	static ue_CornerFiller(parentModule: any) {
	...
	// User Exit for module mr_CornerunitStraight
	static ue_CornerunitStraight(parentModule: any) {
	...
	// User Exit for module mr_Countertop
	static ue_Countertop(parentModule: any, posDepth: number = 0, posLength: number = 0) {
	...
	// User Exit for module mr_Filler
	static ue_Filler(parentModule: any) {
	...
	// User Exit for module mr_Fingergrip
	static ue_Fingergrip(parentModule: any, posLength: number = 0) {
	...
	// User Exit for module mr_Hood
	static ue_Hood(parentModule: any) {
	...
	// User Exit for module mr_Paneltop
	static ue_Paneltop(parentModule: any) {
	...
	// User Exit for module mr_PlinthAreabaseboard
	static ue_PlinthAreaBaseboard(parentModule: any) {
	...
	// User Exit for module mr_Shelves
	static ue_Shelves(parentModule: any) {
	...
	// User Exit for module mr_Toekick
	static ue_Toekick(parentModule: any, posLength: number = 0, posHeight: number = 0) {
	...
	// User Exit for module mr_Upright
	static ue_Upright(parentModule: any) {
	...
	// Find Laundry machine mapping
	static find_LaundryMachineMapping(Supplier: string, LaundryMachineId: string): ICT_tab_LaundryMachineMapping {
	...
	// Calculation of the front oversize on each side of the front
	static calc_FrontOversize(m: any, front: string = "All", type: string = "None"): { OversizeLeft: number; OversizeRight: number; OversizeTop: number; OversizeBottom: number; } {
	...
	// Return the list of Corner Filler Front panel Construction
	static find_CornerFillerFrontpanelConstruction(ParentModule: string, CornerFillerFrontConstruction: string, CarcaseDirection: string = 'All'): ICT_tab_CornerFillerFrontpanelConstruction[] {
	...
	// Process data for pantry pullout
	static process_PantryPullout(m: any, fsWidth: number, fsHeight: number, fsDepth: number): any {
	...
	// Find PantryPulloutMapping
	static find_PantryPulloutMapping(Type: string, Design: string, Color: string, Width: number, Depth: number, Height: number): ICT_tab_PantryPulloutMapping {
	...
	// Find PantryPulloutColorMapping
	static find_PantryPulloutColorMapping(Type: string, Design: string, Color: string): ICT_tab_PantryPulloutColorMapping {
	...
	// Find PantryPulloutConstruction
	static find_PantryPulloutConstruction(ConstructionId: string): ICT_tab_PantryPulloutConstruction {
	...
	// Get the Model3D
	static find_GraphicFileLibrary(GraphicFileId: string): ICT_tab_GraphicFileLibrary {
	...
	// Return value from tab_ComponentLibrary
	static find_ComponentLibrary(ProcessingId: string): ICT_tab_ComponentLibrary {
	...
	// Return value from tab_ComponentVariables
	static find_ComponentVariables(ComponentId: string): ICT_tab_ComponentVariables[] {
	...
	static find_ClothingOrganizerExtraItemMapping(Type: string, Design: string, ExtraItemColor: string, CarcaseProgramm: string, HardwareColor: string): ICT_tab_ClothingOrganizerExtraItemMapping | undefined {
	...
	static find_ClothingOrganizerColorMapping(Color: string, Type: string, Design: string): ICT_tab_ClothingOrganizerColorMapping {
	...
	static find_ClothingOrganizerMapping(Type: string, Design: string, Color: string, Position: string): ICT_tab_ClothingOrganizerMapping {
	...
	static process_ClothingOrganizer(m: any): {
		IsComplete: boolean;
	...
	// Find SegmentFrontConstruction
	static find_SegmentFrontConstruction(PartGroup: string, ConstructionId: string, FrontGrainGroupId: string, SegGrainGroupId: string, SegType: string, SegColor: string, FrontStartPos: number, OverlapBtm: number): ICT_tab_SegmentFrontConstruction | undefined {
	...
	// Find SegmentFrontMapping
	static find_SegmentFrontMapping(Program: string, Design: string, Color: string): ICT_tab_SegmentFrontMapping | undefined {
	...
	// Process the bomout_Hardware
	static process_HardwareBom(Elem: any, Part: any, ElementType: string, ElementCategory: string, ParentId: string, HardwareId: string, Quantity: number = 1) {
		try {
	...
	// Analyzes the space around cabinets, including walls and gaps, to automatically adjust units and insert elements such as fillers.
	static process_AnalyzeArticleSurroundings(surroundingContours: any, articlePosition: any, articleDimension: any): {
	...
	// Validate the object for the SurroundingInfo
	static process_ParseSuroundingInfo(raw: string | undefined): {
