...
export function internal_leaveCalculateContainerModules() {
  internal_leave();
}
...
export function internal_enterDataCompletionSetDefaultScripts_globalVars(moduleId: string, moduleUniqueId: string) {
  internal_enter({
    area: 'DataCompletionSetDefaultScripts_globalVars',
    moduleId: moduleId,
    moduleUniqueId: moduleUniqueId,
  });
}

export function internal_leaveDataCompletionSetDefaultScripts_globalVars() {
  internal_leave();
}
