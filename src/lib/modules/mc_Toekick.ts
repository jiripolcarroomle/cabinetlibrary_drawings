...
//#region Imports
import { cbp_mc_Toekick, dc_mc_Toekick, adc_mc_Toekick, ccm_mc_Toekick, pc_mc_Toekick } from '../internal/modules/mc_Toekick'
...
// ---------------------------------------------------------------
export function mc_Toekick_prepareContext(this: pc_mc_Toekick): void {
  internal_enterModulePrepareContext('mc_Toekick', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Toekick_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Toekick_calculateContainerModules(this: ccm_mc_Toekick): void {
  internal_enterCalculateContainerModules('mc_Toekick', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Toekick_CALCULATECONTAINERMODULES
