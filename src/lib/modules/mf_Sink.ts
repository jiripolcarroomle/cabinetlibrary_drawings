...
//#region Imports
import { cbp_mf_Sink, dc_mf_Sink, adc_mf_Sink, ccm_mf_Sink, pc_mf_Sink } from '../internal/modules/mf_Sink'
...
// ---------------------------------------------------------------
export function mf_Sink_prepareContext(this: pc_mf_Sink): void {
  internal_enterModulePrepareContext('mf_Sink', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_Sink_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mf_Sink_calculateContainerModules(this: ccm_mf_Sink): void {
  internal_enterCalculateContainerModules('mf_Sink', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_Sink_CALCULATECONTAINERMODULES
