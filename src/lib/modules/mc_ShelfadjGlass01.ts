...
//#region Imports
import { cbp_mc_ShelfadjGlass01, dc_mc_ShelfadjGlass01, adc_mc_ShelfadjGlass01, ccm_mc_ShelfadjGlass01, pc_mc_ShelfadjGlass01 } from '../internal/modules/mc_ShelfadjGlass01'
...
// ---------------------------------------------------------------
export function mc_ShelfadjGlass01_prepareContext(this: pc_mc_ShelfadjGlass01): void {
  internal_enterModulePrepareContext('mc_ShelfadjGlass01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_ShelfadjGlass01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_ShelfadjGlass01_calculateContainerModules(this: ccm_mc_ShelfadjGlass01): void {
  internal_enterCalculateContainerModules('mc_ShelfadjGlass01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_ShelfadjGlass01_CALCULATECONTAINERMODULES
