...
//#region Imports
import { cbp_mc_StorageunitBackwall01, dc_mc_StorageunitBackwall01, adc_mc_StorageunitBackwall01, ccm_mc_StorageunitBackwall01, pc_mc_StorageunitBackwall01 } from '../internal/modules/mc_StorageunitBackwall01'
...
// ---------------------------------------------------------------
export function mc_StorageunitBackwall01_prepareContext(this: pc_mc_StorageunitBackwall01): void {
  internal_enterModulePrepareContext('mc_StorageunitBackwall01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_StorageunitBackwall01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_StorageunitBackwall01_calculateContainerModules(this: ccm_mc_StorageunitBackwall01): void {
  internal_enterCalculateContainerModules('mc_StorageunitBackwall01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_StorageunitBackwall01_CALCULATECONTAINERMODULES
