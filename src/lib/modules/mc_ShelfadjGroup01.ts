...
//#region Imports
import { cbp_mc_ShelfadjGroup01, dc_mc_ShelfadjGroup01, adc_mc_ShelfadjGroup01, ccm_mc_ShelfadjGroup01, pc_mc_ShelfadjGroup01 } from '../internal/modules/mc_ShelfadjGroup01'
...
// ---------------------------------------------------------------
export function mc_ShelfadjGroup01_prepareContext(this: pc_mc_ShelfadjGroup01): void {
  internal_enterModulePrepareContext('mc_ShelfadjGroup01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_ShelfadjGroup01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_ShelfadjGroup01_calculateContainerModules(this: ccm_mc_ShelfadjGroup01): void {
  internal_enterCalculateContainerModules('mc_ShelfadjGroup01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_ShelfadjGroup01_CALCULATECONTAINERMODULES
