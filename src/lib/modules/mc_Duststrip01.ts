...
//#region Imports
import { cbp_mc_Duststrip01, dc_mc_Duststrip01, adc_mc_Duststrip01, ccm_mc_Duststrip01, pc_mc_Duststrip01 } from '../internal/modules/mc_Duststrip01'
...
// ---------------------------------------------------------------
export function mc_Duststrip01_prepareContext(this: pc_mc_Duststrip01): void {
  internal_enterModulePrepareContext('mc_Duststrip01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Duststrip01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Duststrip01_calculateContainerModules(this: ccm_mc_Duststrip01): void {
  internal_enterCalculateContainerModules('mc_Duststrip01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Duststrip01_CALCULATECONTAINERMODULES
