...
//#region Imports
import { cbp_mc_BoardShelf, dc_mc_BoardShelf, adc_mc_BoardShelf, ccm_mc_BoardShelf, pc_mc_BoardShelf } from '../internal/modules/mc_BoardShelf'
...
export function mc_BoardShelf_createBuildPlan(this: cbp_mc_BoardShelf): void {
  internal_enterModuleCreateBuildPlan('mc_BoardShelf', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_BoardShelf_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_BoardShelf_afterDataCompletion(this: adc_mc_BoardShelf): void {
  internal_enterModuleAfterDataCompletion('mc_BoardShelf', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_BoardShelf_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_BoardShelf_prepareContext(this: pc_mc_BoardShelf): void {
  internal_enterModulePrepareContext('mc_BoardShelf', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_BoardShelf_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_BoardShelf_calculateContainerModules(this: ccm_mc_BoardShelf): void {
  internal_enterCalculateContainerModules('mc_BoardShelf', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_BoardShelf_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function mc_BoardShelf_manufacturerDataCompletion(this: dc_mc_BoardShelf): void {
  internal_enterModuleManufacturerDataCompletion('mc_BoardShelf', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_BoardShelf_MANUFACTURERDATACOMPLETION
