...
//#region Imports
import { cbp_mc_StorageunitShelftop02, dc_mc_StorageunitShelftop02, adc_mc_StorageunitShelftop02, ccm_mc_StorageunitShelftop02, pc_mc_StorageunitShelftop02 } from '../internal/modules/mc_StorageunitShelftop02'
...
// ---------------------------------------------------------------
export function mc_StorageunitShelftop02_prepareContext(this: pc_mc_StorageunitShelftop02): void {
  internal_enterModulePrepareContext('mc_StorageunitShelftop02', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_StorageunitShelftop02_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_StorageunitShelftop02_calculateContainerModules(this: ccm_mc_StorageunitShelftop02): void {
  internal_enterCalculateContainerModules('mc_StorageunitShelftop02', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_StorageunitShelftop02_CALCULATECONTAINERMODULES
