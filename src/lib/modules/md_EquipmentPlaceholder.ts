...
//#region Imports
import { cbp_md_EquipmentPlaceholder, dc_md_EquipmentPlaceholder, adc_md_EquipmentPlaceholder, ccm_md_EquipmentPlaceholder, pc_md_EquipmentPlaceholder } from '../internal/modules/md_EquipmentPlaceholder'
...
export function md_EquipmentPlaceholder_createBuildPlan(this: cbp_md_EquipmentPlaceholder): void {
  internal_enterModuleCreateBuildPlan('md_EquipmentPlaceholder', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_md_EquipmentPlaceholder_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function md_EquipmentPlaceholder_afterDataCompletion(this: adc_md_EquipmentPlaceholder): void {
  internal_enterModuleAfterDataCompletion('md_EquipmentPlaceholder', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_md_EquipmentPlaceholder_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function md_EquipmentPlaceholder_prepareContext(this: pc_md_EquipmentPlaceholder): void {
  internal_enterModulePrepareContext('md_EquipmentPlaceholder', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_md_EquipmentPlaceholder_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function md_EquipmentPlaceholder_calculateContainerModules(this: ccm_md_EquipmentPlaceholder): void {
  internal_enterCalculateContainerModules('md_EquipmentPlaceholder', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_md_EquipmentPlaceholder_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function md_EquipmentPlaceholder_manufacturerDataCompletion(this: dc_md_EquipmentPlaceholder): void {
  internal_enterModuleManufacturerDataCompletion('md_EquipmentPlaceholder', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_md_EquipmentPlaceholder_MANUFACTURERDATACOMPLETION
