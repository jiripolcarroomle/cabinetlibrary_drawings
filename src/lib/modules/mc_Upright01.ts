...
//#region Imports
import { cbp_mc_Upright01, dc_mc_Upright01, adc_mc_Upright01, ccm_mc_Upright01, pc_mc_Upright01 } from '../internal/modules/mc_Upright01'
...
// ---------------------------------------------------------------
export function mc_Upright01_prepareContext(this: pc_mc_Upright01): void {
  internal_enterModulePrepareContext('mc_Upright01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Upright01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Upright01_calculateContainerModules(this: ccm_mc_Upright01): void {
  internal_enterCalculateContainerModules('mc_Upright01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Upright01_CALCULATECONTAINERMODULES
