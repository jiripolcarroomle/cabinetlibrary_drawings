...
//#region Imports
import { cbp_mf_Hob, dc_mf_Hob, adc_mf_Hob, ccm_mf_Hob, pc_mf_Hob } from '../internal/modules/mf_Hob'
...
// ---------------------------------------------------------------
export function mf_Hob_prepareContext(this: pc_mf_Hob): void {
  internal_enterModulePrepareContext('mf_Hob', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_Hob_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mf_Hob_calculateContainerModules(this: ccm_mf_Hob): void {
  internal_enterCalculateContainerModules('mf_Hob', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_Hob_CALCULATECONTAINERMODULES
