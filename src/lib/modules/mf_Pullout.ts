...
//#region Imports
import { cbp_mf_Pullout, dc_mf_Pullout, adc_mf_Pullout, ccm_mf_Pullout, pc_mf_Pullout } from '../internal/modules/mf_Pullout'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_Pullout01, OD_M_mc_Pullout01 } from '../internal/modules/mc_Pullout01'
...
export function mf_Pullout_createBuildPlan(this: cbp_mf_Pullout): void {
  internal_enterModuleCreateBuildPlan('mf_Pullout', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_Pullout_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mf_Pullout_afterDataCompletion(this: adc_mf_Pullout): void {
  internal_enterModuleAfterDataCompletion('mf_Pullout', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_Pullout_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mf_Pullout_prepareContext(this: pc_mf_Pullout): void {
  internal_enterModulePrepareContext('mf_Pullout', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_Pullout_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mf_Pullout_calculateContainerModules(this: ccm_mf_Pullout): void {
  internal_enterCalculateContainerModules('mf_Pullout', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_Pullout_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function mf_Pullout_manufacturerDataCompletion(this: dc_mf_Pullout): void {
  internal_enterModuleManufacturerDataCompletion('mf_Pullout', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_Pullout_MANUFACTURERDATACOMPLETION
