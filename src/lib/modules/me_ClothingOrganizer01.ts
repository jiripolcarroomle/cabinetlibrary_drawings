...
//#region Imports
import { cbp_me_ClothingOrganizer01, dc_me_ClothingOrganizer01, adc_me_ClothingOrganizer01, ccm_me_ClothingOrganizer01, pc_me_ClothingOrganizer01 } from '../internal/modules/me_ClothingOrganizer01'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_ClothingOrganizerBoard01, OD_M_mc_ClothingOrganizerBoard01 } from '../internal/modules/mc_ClothingOrganizerBoard01'
import { dc_mc_ClothingOrganizerHardware01, OD_M_mc_ClothingOrganizerHardware01 } from '../internal/modules/mc_ClothingOrganizerHardware01'
...
export function me_ClothingOrganizer01_createBuildPlan(this: cbp_me_ClothingOrganizer01): void {
  internal_enterModuleCreateBuildPlan('me_ClothingOrganizer01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_ClothingOrganizer01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function me_ClothingOrganizer01_afterDataCompletion(this: adc_me_ClothingOrganizer01): void {
  internal_enterModuleAfterDataCompletion('me_ClothingOrganizer01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_ClothingOrganizer01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function me_ClothingOrganizer01_prepareContext(this: pc_me_ClothingOrganizer01): void {
  internal_enterModulePrepareContext('me_ClothingOrganizer01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_ClothingOrganizer01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function me_ClothingOrganizer01_calculateContainerModules(this: ccm_me_ClothingOrganizer01): void {
  internal_enterCalculateContainerModules('me_ClothingOrganizer01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_ClothingOrganizer01_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function me_ClothingOrganizer01_manufacturerDataCompletion(this: dc_me_ClothingOrganizer01): void {
  internal_enterModuleManufacturerDataCompletion('me_ClothingOrganizer01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_ClothingOrganizer01_MANUFACTURERDATACOMPLETION
