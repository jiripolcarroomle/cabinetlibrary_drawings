...
//#region Imports
import { cbp_mc_CornerunitStraight01, dc_mc_CornerunitStraight01, adc_mc_CornerunitStraight01, ccm_mc_CornerunitStraight01, pc_mc_CornerunitStraight01 } from '../internal/modules/mc_CornerunitStraight01'
...
// ---------------------------------------------------------------
export function mc_CornerunitStraight01_prepareContext(this: pc_mc_CornerunitStraight01): void {
  internal_enterModulePrepareContext('mc_CornerunitStraight01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_CornerunitStraight01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_CornerunitStraight01_calculateContainerModules(this: ccm_mc_CornerunitStraight01): void {
  internal_enterCalculateContainerModules('mc_CornerunitStraight01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_CornerunitStraight01_CALCULATECONTAINERMODULES
