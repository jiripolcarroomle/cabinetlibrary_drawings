...
//#region Imports
import { cbp_mc_MetalFrame01, dc_mc_MetalFrame01, adc_mc_MetalFrame01, ccm_mc_MetalFrame01, pc_mc_MetalFrame01 } from '../internal/modules/mc_MetalFrame01'
...
// ---------------------------------------------------------------
export function mc_MetalFrame01_prepareContext(this: pc_mc_MetalFrame01): void {
  internal_enterModulePrepareContext('mc_MetalFrame01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_MetalFrame01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_MetalFrame01_calculateContainerModules(this: ccm_mc_MetalFrame01): void {
  internal_enterCalculateContainerModules('mc_MetalFrame01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_MetalFrame01_CALCULATECONTAINERMODULES
