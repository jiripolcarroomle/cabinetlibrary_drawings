...
//#region Imports
import { cbp_mc_FrontPanelGlass01, dc_mc_FrontPanelGlass01, adc_mc_FrontPanelGlass01, ccm_mc_FrontPanelGlass01, pc_mc_FrontPanelGlass01 } from '../internal/modules/mc_FrontPanelGlass01'
...
// ---------------------------------------------------------------
export function mc_FrontPanelGlass01_prepareContext(this: pc_mc_FrontPanelGlass01): void {
  internal_enterModulePrepareContext('mc_FrontPanelGlass01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_FrontPanelGlass01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_FrontPanelGlass01_calculateContainerModules(this: ccm_mc_FrontPanelGlass01): void {
  internal_enterCalculateContainerModules('mc_FrontPanelGlass01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_FrontPanelGlass01_CALCULATECONTAINERMODULES
