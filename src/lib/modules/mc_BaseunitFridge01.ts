...
export function mc_BaseunitFridge01_createBuildPlan(this: cbp_mc_BaseunitFridge01): void {
  internal_enterModuleCreateBuildPlan('mc_BaseunitFridge01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_BaseunitFridge01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_BaseunitFridge01_afterDataCompletion(this: adc_mc_BaseunitFridge01): void {
  internal_enterModuleAfterDataCompletion('mc_BaseunitFridge01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_BaseunitFridge01_AFTERDATACOMPLETION
    // Schuler Consulting
    // Create: October 2025
    // By Anni Chen
    // Purpose: CabinetLibrary
...
// ---------------------------------------------------------------
export function mc_BaseunitFridge01_prepareContext(this: pc_mc_BaseunitFridge01): void {
  internal_enterModulePrepareContext('mc_BaseunitFridge01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_BaseunitFridge01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_BaseunitFridge01_calculateContainerModules(this: ccm_mc_BaseunitFridge01): void {
  internal_enterCalculateContainerModules('mc_BaseunitFridge01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_BaseunitFridge01_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function mc_BaseunitFridge01_manufacturerDataCompletion(this: dc_mc_BaseunitFridge01): void {
  internal_enterModuleManufacturerDataCompletion('mc_BaseunitFridge01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_BaseunitFridge01_MANUFACTURERDATACOMPLETION
