...
//#region Imports
import { cbp_me_LaundryMachine, dc_me_LaundryMachine, adc_me_LaundryMachine, ccm_me_LaundryMachine, pc_me_LaundryMachine } from '../internal/modules/me_LaundryMachine'
...
export function me_LaundryMachine_createBuildPlan(this: cbp_me_LaundryMachine): void {
  internal_enterModuleCreateBuildPlan('me_LaundryMachine', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_LaundryMachine_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function me_LaundryMachine_afterDataCompletion(this: adc_me_LaundryMachine): void {
  internal_enterModuleAfterDataCompletion('me_LaundryMachine', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_LaundryMachine_AFTERDATACOMPLETION
    // Create: Nov 2025
    // By Joao Lisboa
...
// ---------------------------------------------------------------
export function me_LaundryMachine_prepareContext(this: pc_me_LaundryMachine): void {
  internal_enterModulePrepareContext('me_LaundryMachine', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_LaundryMachine_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function me_LaundryMachine_calculateContainerModules(this: ccm_me_LaundryMachine): void {
  internal_enterCalculateContainerModules('me_LaundryMachine', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_LaundryMachine_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function me_LaundryMachine_manufacturerDataCompletion(this: dc_me_LaundryMachine): void {
  internal_enterModuleManufacturerDataCompletion('me_LaundryMachine', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_LaundryMachine_MANUFACTURERDATACOMPLETION
