...
//#region Imports
import { cbp_mc_ThermoformedPanel01, dc_mc_ThermoformedPanel01, adc_mc_ThermoformedPanel01, ccm_mc_ThermoformedPanel01, pc_mc_ThermoformedPanel01 } from '../internal/modules/mc_ThermoformedPanel01'
...
// ---------------------------------------------------------------
export function mc_ThermoformedPanel01_prepareContext(this: pc_mc_ThermoformedPanel01): void {
  internal_enterModulePrepareContext('mc_ThermoformedPanel01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_ThermoformedPanel01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_ThermoformedPanel01_calculateContainerModules(this: ccm_mc_ThermoformedPanel01): void {
  internal_enterCalculateContainerModules('mc_ThermoformedPanel01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_ThermoformedPanel01_CALCULATECONTAINERMODULES
