...
export function md_EquipmentArticleBuilder_createBuildPlan(this: cbp_md_EquipmentArticleBuilder): void {
  internal_enterModuleCreateBuildPlan('md_EquipmentArticleBuilder', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_md_EquipmentArticleBuilder_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function md_EquipmentArticleBuilder_afterDataCompletion(this: adc_md_EquipmentArticleBuilder): void {
  internal_enterModuleAfterDataCompletion('md_EquipmentArticleBuilder', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_md_EquipmentArticleBuilder_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function md_EquipmentArticleBuilder_calculateContainerModules(this: ccm_md_EquipmentArticleBuilder): void {
  internal_enterCalculateContainerModules('md_EquipmentArticleBuilder', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_md_EquipmentArticleBuilder_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function md_EquipmentArticleBuilder_manufacturerDataCompletion(this: dc_md_EquipmentArticleBuilder): void {
  internal_enterModuleManufacturerDataCompletion('md_EquipmentArticleBuilder', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_md_EquipmentArticleBuilder_MANUFACTURERDATACOMPLETION
