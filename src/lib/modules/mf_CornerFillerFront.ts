...
//#region Imports
import { cbp_mf_CornerFillerFront, dc_mf_CornerFillerFront, adc_mf_CornerFillerFront, ccm_mf_CornerFillerFront, pc_mf_CornerFillerFront } from '../internal/modules/mf_CornerFillerFront'
...
// ---------------------------------------------------------------
export function mf_CornerFillerFront_prepareContext(this: pc_mf_CornerFillerFront): void {
  internal_enterModulePrepareContext('mf_CornerFillerFront', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_CornerFillerFront_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mf_CornerFillerFront_calculateContainerModules(this: ccm_mf_CornerFillerFront): void {
  internal_enterCalculateContainerModules('mf_CornerFillerFront', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_CornerFillerFront_CALCULATECONTAINERMODULES
