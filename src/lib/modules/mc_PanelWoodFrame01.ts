...
//#region Imports
import { cbp_mc_PanelWoodFrame01, dc_mc_PanelWoodFrame01, adc_mc_PanelWoodFrame01, ccm_mc_PanelWoodFrame01, pc_mc_PanelWoodFrame01 } from '../internal/modules/mc_PanelWoodFrame01'
...
// ---------------------------------------------------------------
export function mc_PanelWoodFrame01_prepareContext(this: pc_mc_PanelWoodFrame01): void {
  internal_enterModulePrepareContext('mc_PanelWoodFrame01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_PanelWoodFrame01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_PanelWoodFrame01_calculateContainerModules(this: ccm_mc_PanelWoodFrame01): void {
  internal_enterCalculateContainerModules('mc_PanelWoodFrame01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_PanelWoodFrame01_CALCULATECONTAINERMODULES
