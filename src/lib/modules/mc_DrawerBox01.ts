...
//#region Imports
import { cbp_mc_DrawerBox01, dc_mc_DrawerBox01, adc_mc_DrawerBox01, ccm_mc_DrawerBox01, pc_mc_DrawerBox01 } from '../internal/modules/mc_DrawerBox01'
...
export function mc_DrawerBox01_createBuildPlan(this: cbp_mc_DrawerBox01): void {
  ...
  try {
    ...
    if (BoxValid) {
      ...
      // Add the HardwareId
      hardwareElements.values.push(retInfo.BomElement.BoxHardwareId);
      hardwareElements.values.push(retInfo.BomElement.ConHardwareId);
      hardwareElements.values.push(retInfo.BottomShelfConnector.BotConHardwareId);
      hardwareElements.values.push(retInfo.Synchronization.ConHardwareId);
...
// ---------------------------------------------------------------
export function mc_DrawerBox01_prepareContext(this: pc_mc_DrawerBox01): void {
  internal_enterModulePrepareContext('mc_DrawerBox01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_DrawerBox01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_DrawerBox01_calculateContainerModules(this: ccm_mc_DrawerBox01): void {
  internal_enterCalculateContainerModules('mc_DrawerBox01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_DrawerBox01_CALCULATECONTAINERMODULES
