...
//#region Imports
import { cbp_mc_StorageunitShelftop04, dc_mc_StorageunitShelftop04, adc_mc_StorageunitShelftop04, ccm_mc_StorageunitShelftop04, pc_mc_StorageunitShelftop04 } from '../internal/modules/mc_StorageunitShelftop04'
...
// ---------------------------------------------------------------
export function mc_StorageunitShelftop04_prepareContext(this: pc_mc_StorageunitShelftop04): void {
  internal_enterModulePrepareContext('mc_StorageunitShelftop04', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_StorageunitShelftop04_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_StorageunitShelftop04_calculateContainerModules(this: ccm_mc_StorageunitShelftop04): void {
  internal_enterCalculateContainerModules('mc_StorageunitShelftop04', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_StorageunitShelftop04_CALCULATECONTAINERMODULES
