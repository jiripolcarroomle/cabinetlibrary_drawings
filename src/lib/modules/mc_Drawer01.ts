...
//#region Imports
import { cbp_mc_Drawer01, dc_mc_Drawer01, adc_mc_Drawer01, ccm_mc_Drawer01, pc_mc_Drawer01 } from '../internal/modules/mc_Drawer01'
...
// ---------------------------------------------------------------
export function mc_Drawer01_prepareContext(this: pc_mc_Drawer01): void {
  internal_enterModulePrepareContext('mc_Drawer01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Drawer01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Drawer01_calculateContainerModules(this: ccm_mc_Drawer01): void {
  internal_enterCalculateContainerModules('mc_Drawer01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Drawer01_CALCULATECONTAINERMODULES
