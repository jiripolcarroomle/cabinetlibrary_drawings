...
//#region Imports
import { cbp_mr_Toekick, dc_mr_Toekick, adc_mr_Toekick, ccm_mr_Toekick, pc_mr_Toekick } from '../internal/modules/mr_Toekick'
...
// ---------------------------------------------------------------
export function mr_Toekick_prepareContext(this: pc_mr_Toekick): void {
  internal_enterModulePrepareContext('mr_Toekick', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_Toekick_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mr_Toekick_calculateContainerModules(this: ccm_mr_Toekick): void {
  internal_enterCalculateContainerModules('mr_Toekick', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_Toekick_CALCULATECONTAINERMODULES
