...
//#region Imports
import { cbp_mc_StorageunitShelfbtm01, dc_mc_StorageunitShelfbtm01, adc_mc_StorageunitShelfbtm01, ccm_mc_StorageunitShelfbtm01, pc_mc_StorageunitShelfbtm01 } from '../internal/modules/mc_StorageunitShelfbtm01'
...
// ---------------------------------------------------------------
export function mc_StorageunitShelfbtm01_prepareContext(this: pc_mc_StorageunitShelfbtm01): void {
  internal_enterModulePrepareContext('mc_StorageunitShelfbtm01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_StorageunitShelfbtm01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_StorageunitShelfbtm01_calculateContainerModules(this: ccm_mc_StorageunitShelfbtm01): void {
  internal_enterCalculateContainerModules('mc_StorageunitShelfbtm01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_StorageunitShelfbtm01_CALCULATECONTAINERMODULES
