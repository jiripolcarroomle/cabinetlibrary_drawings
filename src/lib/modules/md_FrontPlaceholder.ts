...
//#region Imports
import { cbp_md_FrontPlaceholder, dc_md_FrontPlaceholder, adc_md_FrontPlaceholder, ccm_md_FrontPlaceholder, pc_md_FrontPlaceholder } from '../internal/modules/md_FrontPlaceholder'
...
export function md_FrontPlaceholder_createBuildPlan(this: cbp_md_FrontPlaceholder): void {
  internal_enterModuleCreateBuildPlan('md_FrontPlaceholder', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_md_FrontPlaceholder_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function md_FrontPlaceholder_afterDataCompletion(this: adc_md_FrontPlaceholder): void {
  internal_enterModuleAfterDataCompletion('md_FrontPlaceholder', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_md_FrontPlaceholder_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function md_FrontPlaceholder_prepareContext(this: pc_md_FrontPlaceholder): void {
  internal_enterModulePrepareContext('md_FrontPlaceholder', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_md_FrontPlaceholder_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function md_FrontPlaceholder_calculateContainerModules(this: ccm_md_FrontPlaceholder): void {
  internal_enterCalculateContainerModules('md_FrontPlaceholder', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_md_FrontPlaceholder_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function md_FrontPlaceholder_manufacturerDataCompletion(this: dc_md_FrontPlaceholder): void {
  internal_enterModuleManufacturerDataCompletion('md_FrontPlaceholder', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_md_FrontPlaceholder_MANUFACTURERDATACOMPLETION
