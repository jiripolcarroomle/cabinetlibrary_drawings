...
//#region Imports
import { cbp_mc_Door01, dc_mc_Door01, adc_mc_Door01, ccm_mc_Door01, pc_mc_Door01 } from '../internal/modules/mc_Door01'
...
import { dc_mc_SegmentFront01, OD_M_mc_SegmentFront01 } from '../internal/modules/mc_SegmentFront01'
...
// ---------------------------------------------------------------
export function mc_Door01_prepareContext(this: pc_mc_Door01): void {
  internal_enterModulePrepareContext('mc_Door01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Door01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Door01_calculateContainerModules(this: ccm_mc_Door01): void {
  internal_enterCalculateContainerModules('mc_Door01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Door01_CALCULATECONTAINERMODULES
