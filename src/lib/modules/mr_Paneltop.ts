...
//#region Imports
import { cbp_mr_Paneltop, dc_mr_Paneltop, adc_mr_Paneltop, ccm_mr_Paneltop, pc_mr_Paneltop } from '../internal/modules/mr_Paneltop'
...
// ---------------------------------------------------------------
export function mr_Paneltop_prepareContext(this: pc_mr_Paneltop): void {
  internal_enterModulePrepareContext('mr_Paneltop', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_Paneltop_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mr_Paneltop_calculateContainerModules(this: ccm_mr_Paneltop): void {
  internal_enterCalculateContainerModules('mr_Paneltop', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_Paneltop_CALCULATECONTAINERMODULES
