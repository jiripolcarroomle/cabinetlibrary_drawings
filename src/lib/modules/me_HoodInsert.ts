...
//#region Imports
import { cbp_me_HoodInsert, dc_me_HoodInsert, adc_me_HoodInsert, ccm_me_HoodInsert, pc_me_HoodInsert } from '../internal/modules/me_HoodInsert'
...
export function me_HoodInsert_createBuildPlan(this: cbp_me_HoodInsert): void {
  internal_enterModuleCreateBuildPlan('me_HoodInsert', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_HoodInsert_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function me_HoodInsert_afterDataCompletion(this: adc_me_HoodInsert): void {
  internal_enterModuleAfterDataCompletion('me_HoodInsert', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_HoodInsert_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function me_HoodInsert_prepareContext(this: pc_me_HoodInsert): void {
  internal_enterModulePrepareContext('me_HoodInsert', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_HoodInsert_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function me_HoodInsert_calculateContainerModules(this: ccm_me_HoodInsert): void {
  internal_enterCalculateContainerModules('me_HoodInsert', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_HoodInsert_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function me_HoodInsert_manufacturerDataCompletion(this: dc_me_HoodInsert): void {
  internal_enterModuleManufacturerDataCompletion('me_HoodInsert', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_HoodInsert_MANUFACTURERDATACOMPLETION
