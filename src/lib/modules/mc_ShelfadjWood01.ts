...
//#region Imports
import { cbp_mc_ShelfadjWood01, dc_mc_ShelfadjWood01, adc_mc_ShelfadjWood01, ccm_mc_ShelfadjWood01, pc_mc_ShelfadjWood01 } from '../internal/modules/mc_ShelfadjWood01'
...
// ---------------------------------------------------------------
export function mc_ShelfadjWood01_prepareContext(this: pc_mc_ShelfadjWood01): void {
  internal_enterModulePrepareContext('mc_ShelfadjWood01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_ShelfadjWood01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_ShelfadjWood01_calculateContainerModules(this: ccm_mc_ShelfadjWood01): void {
  internal_enterCalculateContainerModules('mc_ShelfadjWood01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_ShelfadjWood01_CALCULATECONTAINERMODULES
