...
//#region Imports
import { cbp_mc_Fixedfront01, dc_mc_Fixedfront01, adc_mc_Fixedfront01, ccm_mc_Fixedfront01, pc_mc_Fixedfront01 } from '../internal/modules/mc_Fixedfront01'
...
// ---------------------------------------------------------------
export function mc_Fixedfront01_prepareContext(this: pc_mc_Fixedfront01): void {
  internal_enterModulePrepareContext('mc_Fixedfront01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Fixedfront01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Fixedfront01_calculateContainerModules(this: ccm_mc_Fixedfront01): void {
  internal_enterCalculateContainerModules('mc_Fixedfront01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Fixedfront01_CALCULATECONTAINERMODULES
