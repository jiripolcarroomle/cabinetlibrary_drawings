...
//#region Imports
import { cbp_mc_ShelfadjFitting01, dc_mc_ShelfadjFitting01, adc_mc_ShelfadjFitting01, ccm_mc_ShelfadjFitting01, pc_mc_ShelfadjFitting01 } from '../internal/modules/mc_ShelfadjFitting01'
...
// ---------------------------------------------------------------
export function mc_ShelfadjFitting01_prepareContext(this: pc_mc_ShelfadjFitting01): void {
  internal_enterModulePrepareContext('mc_ShelfadjFitting01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_ShelfadjFitting01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_ShelfadjFitting01_calculateContainerModules(this: ccm_mc_ShelfadjFitting01): void {
  internal_enterCalculateContainerModules('mc_ShelfadjFitting01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_ShelfadjFitting01_CALCULATECONTAINERMODULES
