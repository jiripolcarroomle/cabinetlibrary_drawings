...
//#region Imports
import { cbp_mc_ShelfadjDrill01, dc_mc_ShelfadjDrill01, adc_mc_ShelfadjDrill01, ccm_mc_ShelfadjDrill01, pc_mc_ShelfadjDrill01 } from '../internal/modules/mc_ShelfadjDrill01'
...
// ---------------------------------------------------------------
export function mc_ShelfadjDrill01_prepareContext(this: pc_mc_ShelfadjDrill01): void {
  internal_enterModulePrepareContext('mc_ShelfadjDrill01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_ShelfadjDrill01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_ShelfadjDrill01_calculateContainerModules(this: ccm_mc_ShelfadjDrill01): void {
  internal_enterCalculateContainerModules('mc_ShelfadjDrill01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_ShelfadjDrill01_CALCULATECONTAINERMODULES
