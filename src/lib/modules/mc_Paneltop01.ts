...
//#region Imports
import { cbp_mc_Paneltop01, dc_mc_Paneltop01, adc_mc_Paneltop01, ccm_mc_Paneltop01, pc_mc_Paneltop01 } from '../internal/modules/mc_Paneltop01'
...
// ---------------------------------------------------------------
export function mc_Paneltop01_prepareContext(this: pc_mc_Paneltop01): void {
  internal_enterModulePrepareContext('mc_Paneltop01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Paneltop01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Paneltop01_calculateContainerModules(this: ccm_mc_Paneltop01): void {
  internal_enterCalculateContainerModules('mc_Paneltop01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Paneltop01_CALCULATECONTAINERMODULES
