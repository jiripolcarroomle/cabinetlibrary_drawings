...
//#region Imports
import { cbp_mc_Pushtoopen01, dc_mc_Pushtoopen01, adc_mc_Pushtoopen01, ccm_mc_Pushtoopen01, pc_mc_Pushtoopen01 } from '../internal/modules/mc_Pushtoopen01'
...
// ---------------------------------------------------------------
export function mc_Pushtoopen01_prepareContext(this: pc_mc_Pushtoopen01): void {
  internal_enterModulePrepareContext('mc_Pushtoopen01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Pushtoopen01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Pushtoopen01_calculateContainerModules(this: ccm_mc_Pushtoopen01): void {
  internal_enterCalculateContainerModules('mc_Pushtoopen01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Pushtoopen01_CALCULATECONTAINERMODULES
