...
//#region Imports
import { cbp_mc_Bracket01, dc_mc_Bracket01, adc_mc_Bracket01, ccm_mc_Bracket01, pc_mc_Bracket01 } from '../internal/modules/mc_Bracket01'
...
// ---------------------------------------------------------------
export function mc_Bracket01_prepareContext(this: pc_mc_Bracket01): void {
  internal_enterModulePrepareContext('mc_Bracket01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Bracket01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Bracket01_calculateContainerModules(this: ccm_mc_Bracket01): void {
  internal_enterCalculateContainerModules('mc_Bracket01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Bracket01_CALCULATECONTAINERMODULES
