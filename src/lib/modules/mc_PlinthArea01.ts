...
//#region Imports
import { cbp_mc_PlinthArea01, dc_mc_PlinthArea01, adc_mc_PlinthArea01, ccm_mc_PlinthArea01, pc_mc_PlinthArea01 } from '../internal/modules/mc_PlinthArea01'
...
// ---------------------------------------------------------------
export function mc_PlinthArea01_prepareContext(this: pc_mc_PlinthArea01): void {
  internal_enterModulePrepareContext('mc_PlinthArea01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_PlinthArea01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_PlinthArea01_calculateContainerModules(this: ccm_mc_PlinthArea01): void {
  internal_enterCalculateContainerModules('mc_PlinthArea01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_PlinthArea01_CALCULATECONTAINERMODULES
