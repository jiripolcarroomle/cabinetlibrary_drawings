...
//#region Imports
import { cbp_me_ShelfadjMultiple01, dc_me_ShelfadjMultiple01, adc_me_ShelfadjMultiple01, ccm_me_ShelfadjMultiple01, pc_me_ShelfadjMultiple01 } from '../internal/modules/me_ShelfadjMultiple01'
...
export function me_ShelfadjMultiple01_createBuildPlan(this: cbp_me_ShelfadjMultiple01): void {
  internal_enterModuleCreateBuildPlan('me_ShelfadjMultiple01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_ShelfadjMultiple01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function me_ShelfadjMultiple01_afterDataCompletion(this: adc_me_ShelfadjMultiple01): void {
  internal_enterModuleAfterDataCompletion('me_ShelfadjMultiple01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_ShelfadjMultiple01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function me_ShelfadjMultiple01_prepareContext(this: pc_me_ShelfadjMultiple01): void {
  internal_enterModulePrepareContext('me_ShelfadjMultiple01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_ShelfadjMultiple01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function me_ShelfadjMultiple01_calculateContainerModules(this: ccm_me_ShelfadjMultiple01): void {
  internal_enterCalculateContainerModules('me_ShelfadjMultiple01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_ShelfadjMultiple01_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function me_ShelfadjMultiple01_manufacturerDataCompletion(this: dc_me_ShelfadjMultiple01): void {
  internal_enterModuleManufacturerDataCompletion('me_ShelfadjMultiple01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_ShelfadjMultiple01_MANUFACTURERDATACOMPLETION
