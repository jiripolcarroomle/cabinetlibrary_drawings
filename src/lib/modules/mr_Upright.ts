...
//#region Imports
import { cbp_mr_Upright, dc_mr_Upright, adc_mr_Upright, ccm_mr_Upright, pc_mr_Upright } from '../internal/modules/mr_Upright'
...
export function mr_Upright_afterDataCompletion(this: adc_mr_Upright): void {
  ...
  try {
    ...
    let ElementHeight = this.mod_UprightHeight + this.mod_UprightOverdimensionBtm + this.mod_UprightOverdimensionTop;
    let StartingPosition = this.mod_PlinthAreaHeight - this.mod_UprightOverdimensionBtm;
    ...
    this.addDockingInfo(Dock.LeftTop, new Vector3(0, ElementHeight + StartingPosition, 0), new Vector3(0, ElementHeight + StartingPosition, this.mod_UprightDepth));
    ...
    this.addDockingInfo(Dock.RightTop, new Vector3(this.mod_UprightThk, ElementHeight + StartingPosition, 0), new Vector3(this.mod_UprightThk, ElementHeight + StartingPosition, this.mod_UprightDepth));

    // Back side
    this.addDockingInfo(Dock.BackBottom, new Vector3(0, 0, 0), new Vector3(this.mod_UprightThk, 0, 0));
    this.addDockingInfo(Dock.BackTop, new Vector3(0, ElementHeight + StartingPosition, 0), new Vector3(this.mod_UprightThk, ElementHeight + StartingPosition, 0));
...
// ---------------------------------------------------------------
export function mr_Upright_prepareContext(this: pc_mr_Upright): void {
  internal_enterModulePrepareContext('mr_Upright', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_Upright_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mr_Upright_calculateContainerModules(this: ccm_mr_Upright): void {
  internal_enterCalculateContainerModules('mr_Upright', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_Upright_CALCULATECONTAINERMODULES
