...
//#region Imports
import { cbp_mc_Baseboard01, dc_mc_Baseboard01, adc_mc_Baseboard01, ccm_mc_Baseboard01, pc_mc_Baseboard01 } from '../internal/modules/mc_Baseboard01'
...
export function mc_Baseboard01_createBuildPlan(this: cbp_mc_Baseboard01): void {
  internal_enterModuleCreateBuildPlan('mc_Baseboard01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Baseboard01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_Baseboard01_afterDataCompletion(this: adc_mc_Baseboard01): void {
  internal_enterModuleAfterDataCompletion('mc_Baseboard01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Baseboard01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_Baseboard01_prepareContext(this: pc_mc_Baseboard01): void {
  internal_enterModulePrepareContext('mc_Baseboard01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Baseboard01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Baseboard01_calculateContainerModules(this: ccm_mc_Baseboard01): void {
  internal_enterCalculateContainerModules('mc_Baseboard01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Baseboard01_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function mc_Baseboard01_manufacturerDataCompletion(this: dc_mc_Baseboard01): void {
  internal_enterModuleManufacturerDataCompletion('mc_Baseboard01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Baseboard01_MANUFACTURERDATACOMPLETION
