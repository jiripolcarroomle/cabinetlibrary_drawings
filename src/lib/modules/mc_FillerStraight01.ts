...
//#region Imports
import { cbp_mc_FillerStraight01, dc_mc_FillerStraight01, adc_mc_FillerStraight01, ccm_mc_FillerStraight01, pc_mc_FillerStraight01 } from '../internal/modules/mc_FillerStraight01'
...
import { dc_mc_FillerSupportPanels01, OD_M_mc_FillerSupportPanels01 } from '../internal/modules/mc_FillerSupportPanels01'
...
export function mc_FillerStraight01_createBuildPlan(this: cbp_mc_FillerStraight01): void {
  internal_enterModuleCreateBuildPlan('mc_FillerStraight01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_FillerStraight01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_FillerStraight01_afterDataCompletion(this: adc_mc_FillerStraight01): void {
  internal_enterModuleAfterDataCompletion('mc_FillerStraight01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_FillerStraight01_AFTERDATACOMPLETION
    ...
    if (this.mod_Direction === 'Right') {
      ...
      side.setOrigin(this.mod_Width - this.mod_SidepanelleftThk, this.mod_FrontPosStart, 300);
    }
    // ###############################################################
    // ################### END CUSTOM SCRIPTS ########################
    // ###############################################################
...
// ---------------------------------------------------------------
export function mc_FillerStraight01_prepareContext(this: pc_mc_FillerStraight01): void {
  internal_enterModulePrepareContext('mc_FillerStraight01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_FillerStraight01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_FillerStraight01_calculateContainerModules(this: ccm_mc_FillerStraight01): void {
  internal_enterCalculateContainerModules('mc_FillerStraight01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_FillerStraight01_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function mc_FillerStraight01_manufacturerDataCompletion(this: dc_mc_FillerStraight01): void {
  internal_enterModuleManufacturerDataCompletion('mc_FillerStraight01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_FillerStraight01_MANUFACTURERDATACOMPLETION
