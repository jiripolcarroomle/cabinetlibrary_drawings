...
//#region Imports
import { cbp_mc_MirrorBoard, dc_mc_MirrorBoard, adc_mc_MirrorBoard, ccm_mc_MirrorBoard, pc_mc_MirrorBoard } from '../internal/modules/mc_MirrorBoard'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_Mirror, OD_M_mc_Mirror } from '../internal/modules/mc_Mirror'
...
export function mc_MirrorBoard_createBuildPlan(this: cbp_mc_MirrorBoard): void {
  internal_enterModuleCreateBuildPlan('mc_MirrorBoard', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_MirrorBoard_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_MirrorBoard_afterDataCompletion(this: adc_mc_MirrorBoard): void {
  internal_enterModuleAfterDataCompletion('mc_MirrorBoard', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_MirrorBoard_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_MirrorBoard_prepareContext(this: pc_mc_MirrorBoard): void {
  internal_enterModulePrepareContext('mc_MirrorBoard', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_MirrorBoard_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_MirrorBoard_calculateContainerModules(this: ccm_mc_MirrorBoard): void {
  internal_enterCalculateContainerModules('mc_MirrorBoard', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_MirrorBoard_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function mc_MirrorBoard_manufacturerDataCompletion(this: dc_mc_MirrorBoard): void {
  internal_enterModuleManufacturerDataCompletion('mc_MirrorBoard', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_MirrorBoard_MANUFACTURERDATACOMPLETION
