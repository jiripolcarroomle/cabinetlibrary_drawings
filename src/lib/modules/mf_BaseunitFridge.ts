...
//#region Imports
import { cbp_mf_BaseunitFridge, dc_mf_BaseunitFridge, adc_mf_BaseunitFridge, ccm_mf_BaseunitFridge, pc_mf_BaseunitFridge } from '../internal/modules/mf_BaseunitFridge'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_BaseunitFridge01, OD_M_mc_BaseunitFridge01 } from '../internal/modules/mc_BaseunitFridge01'
...
export function mf_BaseunitFridge_createBuildPlan(this: cbp_mf_BaseunitFridge): void {
  internal_enterModuleCreateBuildPlan('mf_BaseunitFridge', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_BaseunitFridge_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mf_BaseunitFridge_afterDataCompletion(this: adc_mf_BaseunitFridge): void {
  internal_enterModuleAfterDataCompletion('mf_BaseunitFridge', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_BaseunitFridge_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mf_BaseunitFridge_prepareContext(this: pc_mf_BaseunitFridge): void {
  internal_enterModulePrepareContext('mf_BaseunitFridge', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_BaseunitFridge_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mf_BaseunitFridge_calculateContainerModules(this: ccm_mf_BaseunitFridge): void {
  internal_enterCalculateContainerModules('mf_BaseunitFridge', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_BaseunitFridge_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function mf_BaseunitFridge_manufacturerDataCompletion(this: dc_mf_BaseunitFridge): void {
  internal_enterModuleManufacturerDataCompletion('mf_BaseunitFridge', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_BaseunitFridge_MANUFACTURERDATACOMPLETION
