...
//#region Imports
import { cbp_mc_PantryPulloutHardware01, dc_mc_PantryPulloutHardware01, adc_mc_PantryPulloutHardware01, ccm_mc_PantryPulloutHardware01, pc_mc_PantryPulloutHardware01 } from '../internal/modules/mc_PantryPulloutHardware01'
...
export function mc_PantryPulloutHardware01_createBuildPlan(this: cbp_mc_PantryPulloutHardware01): void {
  internal_enterModuleCreateBuildPlan('mc_PantryPulloutHardware01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_PantryPulloutHardware01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_PantryPulloutHardware01_afterDataCompletion(this: adc_mc_PantryPulloutHardware01): void {
  internal_enterModuleAfterDataCompletion('mc_PantryPulloutHardware01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_PantryPulloutHardware01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_PantryPulloutHardware01_prepareContext(this: pc_mc_PantryPulloutHardware01): void {
  internal_enterModulePrepareContext('mc_PantryPulloutHardware01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_PantryPulloutHardware01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_PantryPulloutHardware01_calculateContainerModules(this: ccm_mc_PantryPulloutHardware01): void {
  internal_enterCalculateContainerModules('mc_PantryPulloutHardware01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_PantryPulloutHardware01_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function mc_PantryPulloutHardware01_manufacturerDataCompletion(this: dc_mc_PantryPulloutHardware01): void {
  internal_enterModuleManufacturerDataCompletion('mc_PantryPulloutHardware01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_PantryPulloutHardware01_MANUFACTURERDATACOMPLETION
