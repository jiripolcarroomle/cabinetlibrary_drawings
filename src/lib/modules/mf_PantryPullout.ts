...
//#region Imports
import { cbp_mf_PantryPullout, dc_mf_PantryPullout, adc_mf_PantryPullout, ccm_mf_PantryPullout, pc_mf_PantryPullout } from '../internal/modules/mf_PantryPullout'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_PantryPullout01, OD_M_mc_PantryPullout01 } from '../internal/modules/mc_PantryPullout01'
...
export function mf_PantryPullout_createBuildPlan(this: cbp_mf_PantryPullout): void {
  internal_enterModuleCreateBuildPlan('mf_PantryPullout', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_PantryPullout_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mf_PantryPullout_afterDataCompletion(this: adc_mf_PantryPullout): void {
  internal_enterModuleAfterDataCompletion('mf_PantryPullout', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_PantryPullout_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mf_PantryPullout_prepareContext(this: pc_mf_PantryPullout): void {
  internal_enterModulePrepareContext('mf_PantryPullout', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_PantryPullout_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mf_PantryPullout_calculateContainerModules(this: ccm_mf_PantryPullout): void {
  internal_enterCalculateContainerModules('mf_PantryPullout', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_PantryPullout_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function mf_PantryPullout_manufacturerDataCompletion(this: dc_mf_PantryPullout): void {
  internal_enterModuleManufacturerDataCompletion('mf_PantryPullout', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_PantryPullout_MANUFACTURERDATACOMPLETION
