...
//#region Imports
import { cbp_mc_Backsplash, dc_mc_Backsplash, adc_mc_Backsplash, ccm_mc_Backsplash, pc_mc_Backsplash } from '../internal/modules/mc_Backsplash'
...
// ---------------------------------------------------------------
export function mc_Backsplash_prepareContext(this: pc_mc_Backsplash): void {
  internal_enterModulePrepareContext('mc_Backsplash', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Backsplash_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Backsplash_calculateContainerModules(this: ccm_mc_Backsplash): void {
  internal_enterCalculateContainerModules('mc_Backsplash', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Backsplash_CALCULATECONTAINERMODULES
