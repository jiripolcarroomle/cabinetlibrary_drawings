...
//#region Imports
import { cbp_mr_Shelves, dc_mr_Shelves, adc_mr_Shelves, ccm_mr_Shelves, pc_mr_Shelves } from '../internal/modules/mr_Shelves'
...
// ---------------------------------------------------------------
export function mr_Shelves_prepareContext(this: pc_mr_Shelves): void {
  internal_enterModulePrepareContext('mr_Shelves', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_Shelves_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mr_Shelves_calculateContainerModules(this: ccm_mr_Shelves): void {
  internal_enterCalculateContainerModules('mr_Shelves', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_Shelves_CALCULATECONTAINERMODULES
