...
//#region Imports
import { cbp_mr_CoatBoard, dc_mr_CoatBoard, adc_mr_CoatBoard, ccm_mr_CoatBoard, pc_mr_CoatBoard } from '../internal/modules/mr_CoatBoard'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_CoatBoard, OD_M_mc_CoatBoard } from '../internal/modules/mc_CoatBoard'
...
export function mr_CoatBoard_createBuildPlan(this: cbp_mr_CoatBoard): void {
  internal_enterModuleCreateBuildPlan('mr_CoatBoard', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_CoatBoard_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mr_CoatBoard_afterDataCompletion(this: adc_mr_CoatBoard): void {
  internal_enterModuleAfterDataCompletion('mr_CoatBoard', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_CoatBoard_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mr_CoatBoard_prepareContext(this: pc_mr_CoatBoard): void {
  internal_enterModulePrepareContext('mr_CoatBoard', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_CoatBoard_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mr_CoatBoard_calculateContainerModules(this: ccm_mr_CoatBoard): void {
  internal_enterCalculateContainerModules('mr_CoatBoard', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_CoatBoard_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function mr_CoatBoard_manufacturerDataCompletion(this: dc_mr_CoatBoard): void {
  internal_enterModuleManufacturerDataCompletion('mr_CoatBoard', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_CoatBoard_MANUFACTURERDATACOMPLETION
