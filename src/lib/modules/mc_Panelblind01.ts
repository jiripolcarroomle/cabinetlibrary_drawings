...
//#region Imports
import { cbp_mc_Panelblind01, dc_mc_Panelblind01, adc_mc_Panelblind01, ccm_mc_Panelblind01, pc_mc_Panelblind01 } from '../internal/modules/mc_Panelblind01'
...
// ---------------------------------------------------------------
export function mc_Panelblind01_prepareContext(this: pc_mc_Panelblind01): void {
  internal_enterModulePrepareContext('mc_Panelblind01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Panelblind01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Panelblind01_calculateContainerModules(this: ccm_mc_Panelblind01): void {
  internal_enterCalculateContainerModules('mc_Panelblind01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Panelblind01_CALCULATECONTAINERMODULES
