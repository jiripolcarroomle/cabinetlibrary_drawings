...
//#region Imports
import { cbp_mc_Fridge01, dc_mc_Fridge01, adc_mc_Fridge01, ccm_mc_Fridge01, pc_mc_Fridge01 } from '../internal/modules/mc_Fridge01'
...
// ---------------------------------------------------------------
export function mc_Fridge01_prepareContext(this: pc_mc_Fridge01): void {
  internal_enterModulePrepareContext('mc_Fridge01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Fridge01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Fridge01_calculateContainerModules(this: ccm_mc_Fridge01): void {
  internal_enterCalculateContainerModules('mc_Fridge01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Fridge01_CALCULATECONTAINERMODULES
