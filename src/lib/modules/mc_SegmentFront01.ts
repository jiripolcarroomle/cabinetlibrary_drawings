...
//#region Imports
import { cbp_mc_SegmentFront01, dc_mc_SegmentFront01, adc_mc_SegmentFront01, ccm_mc_SegmentFront01, pc_mc_SegmentFront01 } from '../internal/modules/mc_SegmentFront01'
...
export function mc_SegmentFront01_createBuildPlan(this: cbp_mc_SegmentFront01): void {
  internal_enterModuleCreateBuildPlan('mc_SegmentFront01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_SegmentFront01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_SegmentFront01_afterDataCompletion(this: adc_mc_SegmentFront01): void {
  internal_enterModuleAfterDataCompletion('mc_SegmentFront01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_SegmentFront01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_SegmentFront01_prepareContext(this: pc_mc_SegmentFront01): void {
  internal_enterModulePrepareContext('mc_SegmentFront01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_SegmentFront01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_SegmentFront01_calculateContainerModules(this: ccm_mc_SegmentFront01): void {
  internal_enterCalculateContainerModules('mc_SegmentFront01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_SegmentFront01_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function mc_SegmentFront01_manufacturerDataCompletion(this: dc_mc_SegmentFront01): void {
  internal_enterModuleManufacturerDataCompletion('mc_SegmentFront01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_SegmentFront01_MANUFACTURERDATACOMPLETION
