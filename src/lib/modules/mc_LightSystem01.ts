...
//#region Imports
import { cbp_mc_LightSystem01, dc_mc_LightSystem01, adc_mc_LightSystem01, ccm_mc_LightSystem01, pc_mc_LightSystem01 } from '../internal/modules/mc_LightSystem01'
...
// ---------------------------------------------------------------
export function mc_LightSystem01_prepareContext(this: pc_mc_LightSystem01): void {
  internal_enterModulePrepareContext('mc_LightSystem01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_LightSystem01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_LightSystem01_calculateContainerModules(this: ccm_mc_LightSystem01): void {
  internal_enterCalculateContainerModules('mc_LightSystem01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_LightSystem01_CALCULATECONTAINERMODULES
