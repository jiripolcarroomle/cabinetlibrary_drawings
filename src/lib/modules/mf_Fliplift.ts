...
//#region Imports
import { cbp_mf_Fliplift, dc_mf_Fliplift, adc_mf_Fliplift, ccm_mf_Fliplift, pc_mf_Fliplift } from '../internal/modules/mf_Fliplift'
...
// ---------------------------------------------------------------
export function mf_Fliplift_prepareContext(this: pc_mf_Fliplift): void {
  internal_enterModulePrepareContext('mf_Fliplift', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_Fliplift_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mf_Fliplift_calculateContainerModules(this: ccm_mf_Fliplift): void {
  internal_enterCalculateContainerModules('mf_Fliplift', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_Fliplift_CALCULATECONTAINERMODULES
