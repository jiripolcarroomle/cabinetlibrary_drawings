...
//#region Imports
import { cbp_mc_Sink01, dc_mc_Sink01, adc_mc_Sink01, ccm_mc_Sink01, pc_mc_Sink01 } from '../internal/modules/mc_Sink01'
...
// ---------------------------------------------------------------
export function mc_Sink01_prepareContext(this: pc_mc_Sink01): void {
  internal_enterModulePrepareContext('mc_Sink01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Sink01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Sink01_calculateContainerModules(this: ccm_mc_Sink01): void {
  internal_enterCalculateContainerModules('mc_Sink01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Sink01_CALCULATECONTAINERMODULES
