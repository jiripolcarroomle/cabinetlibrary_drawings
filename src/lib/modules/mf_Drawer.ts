...
//#region Imports
import { cbp_mf_Drawer, dc_mf_Drawer, adc_mf_Drawer, ccm_mf_Drawer, pc_mf_Drawer } from '../internal/modules/mf_Drawer'
...
// ---------------------------------------------------------------
export function mf_Drawer_prepareContext(this: pc_mf_Drawer): void {
  internal_enterModulePrepareContext('mf_Drawer', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_Drawer_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mf_Drawer_calculateContainerModules(this: ccm_mf_Drawer): void {
  internal_enterCalculateContainerModules('mf_Drawer', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_Drawer_CALCULATECONTAINERMODULES
