...
//#region Imports
import { cbp_mc_Hob01, dc_mc_Hob01, adc_mc_Hob01, ccm_mc_Hob01, pc_mc_Hob01 } from '../internal/modules/mc_Hob01'
...
// ---------------------------------------------------------------
export function mc_Hob01_prepareContext(this: pc_mc_Hob01): void {
  internal_enterModulePrepareContext('mc_Hob01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Hob01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Hob01_calculateContainerModules(this: ccm_mc_Hob01): void {
  internal_enterCalculateContainerModules('mc_Hob01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Hob01_CALCULATECONTAINERMODULES
