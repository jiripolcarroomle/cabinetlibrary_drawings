...
//#region Imports
import { cbp_mr_MirrorBoard, dc_mr_MirrorBoard, adc_mr_MirrorBoard, ccm_mr_MirrorBoard, pc_mr_MirrorBoard } from '../internal/modules/mr_MirrorBoard'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_MirrorBoard, OD_M_mc_MirrorBoard } from '../internal/modules/mc_MirrorBoard'
import { dc_mf_BoardShelf, OD_M_mf_BoardShelf } from '../internal/modules/mf_BoardShelf'
...
export function mr_MirrorBoard_createBuildPlan(this: cbp_mr_MirrorBoard): void {
  internal_enterModuleCreateBuildPlan('mr_MirrorBoard', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_MirrorBoard_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mr_MirrorBoard_afterDataCompletion(this: adc_mr_MirrorBoard): void {
  internal_enterModuleAfterDataCompletion('mr_MirrorBoard', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_MirrorBoard_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mr_MirrorBoard_prepareContext(this: pc_mr_MirrorBoard): void {
  internal_enterModulePrepareContext('mr_MirrorBoard', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_MirrorBoard_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mr_MirrorBoard_calculateContainerModules(this: ccm_mr_MirrorBoard): void {
  internal_enterCalculateContainerModules('mr_MirrorBoard', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_MirrorBoard_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function mr_MirrorBoard_manufacturerDataCompletion(this: dc_mr_MirrorBoard): void {
  internal_enterModuleManufacturerDataCompletion('mr_MirrorBoard', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_MirrorBoard_MANUFACTURERDATACOMPLETION
