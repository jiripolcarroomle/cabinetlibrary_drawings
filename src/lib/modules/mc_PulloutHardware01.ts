...
//#region Imports
import { cbp_mc_PulloutHardware01, dc_mc_PulloutHardware01, adc_mc_PulloutHardware01, ccm_mc_PulloutHardware01, pc_mc_PulloutHardware01 } from '../internal/modules/mc_PulloutHardware01'
...
export function mc_PulloutHardware01_createBuildPlan(this: cbp_mc_PulloutHardware01): void {
  internal_enterModuleCreateBuildPlan('mc_PulloutHardware01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_PulloutHardware01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_PulloutHardware01_afterDataCompletion(this: adc_mc_PulloutHardware01): void {
  internal_enterModuleAfterDataCompletion('mc_PulloutHardware01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_PulloutHardware01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_PulloutHardware01_prepareContext(this: pc_mc_PulloutHardware01): void {
  internal_enterModulePrepareContext('mc_PulloutHardware01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_PulloutHardware01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_PulloutHardware01_calculateContainerModules(this: ccm_mc_PulloutHardware01): void {
  internal_enterCalculateContainerModules('mc_PulloutHardware01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_PulloutHardware01_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function mc_PulloutHardware01_manufacturerDataCompletion(this: dc_mc_PulloutHardware01): void {
  internal_enterModuleManufacturerDataCompletion('mc_PulloutHardware01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_PulloutHardware01_MANUFACTURERDATACOMPLETION
