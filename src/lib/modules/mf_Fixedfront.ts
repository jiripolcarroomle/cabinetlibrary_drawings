...
//#region Imports
import { cbp_mf_Fixedfront, dc_mf_Fixedfront, adc_mf_Fixedfront, ccm_mf_Fixedfront, pc_mf_Fixedfront } from '../internal/modules/mf_Fixedfront'
...
// ---------------------------------------------------------------
export function mf_Fixedfront_prepareContext(this: pc_mf_Fixedfront): void {
  internal_enterModulePrepareContext('mf_Fixedfront', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_Fixedfront_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mf_Fixedfront_calculateContainerModules(this: ccm_mf_Fixedfront): void {
  internal_enterCalculateContainerModules('mf_Fixedfront', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_Fixedfront_CALCULATECONTAINERMODULES
