...
//#region Imports
import { cbp_mc_StorageunitShelffixed01, dc_mc_StorageunitShelffixed01, adc_mc_StorageunitShelffixed01, ccm_mc_StorageunitShelffixed01, pc_mc_StorageunitShelffixed01 } from '../internal/modules/mc_StorageunitShelffixed01'
...
// ---------------------------------------------------------------
export function mc_StorageunitShelffixed01_prepareContext(this: pc_mc_StorageunitShelffixed01): void {
  internal_enterModulePrepareContext('mc_StorageunitShelffixed01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_StorageunitShelffixed01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_StorageunitShelffixed01_calculateContainerModules(this: ccm_mc_StorageunitShelffixed01): void {
  internal_enterCalculateContainerModules('mc_StorageunitShelffixed01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_StorageunitShelffixed01_CALCULATECONTAINERMODULES
