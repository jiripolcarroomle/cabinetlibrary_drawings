...
//#region Imports
import { cbp_mc_CleatVert01, dc_mc_CleatVert01, adc_mc_CleatVert01, ccm_mc_CleatVert01, pc_mc_CleatVert01 } from '../internal/modules/mc_CleatVert01'
...
// ---------------------------------------------------------------
export function mc_CleatVert01_prepareContext(this: pc_mc_CleatVert01): void {
  internal_enterModulePrepareContext('mc_CleatVert01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_CleatVert01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_CleatVert01_calculateContainerModules(this: ccm_mc_CleatVert01): void {
  internal_enterCalculateContainerModules('mc_CleatVert01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_CleatVert01_CALCULATECONTAINERMODULES
