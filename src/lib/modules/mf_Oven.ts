...
//#region Imports
import { cbp_mf_Oven, dc_mf_Oven, adc_mf_Oven, ccm_mf_Oven, pc_mf_Oven } from '../internal/modules/mf_Oven'
...
// ---------------------------------------------------------------
export function mf_Oven_prepareContext(this: pc_mf_Oven): void {
  internal_enterModulePrepareContext('mf_Oven', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_Oven_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mf_Oven_calculateContainerModules(this: ccm_mf_Oven): void {
  internal_enterCalculateContainerModules('mf_Oven', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_Oven_CALCULATECONTAINERMODULES
