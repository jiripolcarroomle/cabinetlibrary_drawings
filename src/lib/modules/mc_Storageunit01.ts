...
// ---------------------------------------------------------------
export function mc_Storageunit01_calculateContainerModules(this: ccm_mc_Storageunit01): void {
	internal_enterCalculateContainerModules('mc_Storageunit01', this._id);
	try {
		// ###############################################################
		// ####################### CUSTOM SCRIPTS ########################
		// ###############################################################
		// CUSTOMSCRIPT_mc_Storageunit01_CALCULATECONTAINERMODULES
