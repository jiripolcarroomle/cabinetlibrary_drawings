...
//#region Imports
import { cbp_mc_HingeGroup01, dc_mc_HingeGroup01, adc_mc_HingeGroup01, ccm_mc_HingeGroup01, pc_mc_HingeGroup01 } from '../internal/modules/mc_HingeGroup01'
...
// ---------------------------------------------------------------
export function mc_HingeGroup01_prepareContext(this: pc_mc_HingeGroup01): void {
  internal_enterModulePrepareContext('mc_HingeGroup01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_HingeGroup01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_HingeGroup01_calculateContainerModules(this: ccm_mc_HingeGroup01): void {
  internal_enterCalculateContainerModules('mc_HingeGroup01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_HingeGroup01_CALCULATECONTAINERMODULES
