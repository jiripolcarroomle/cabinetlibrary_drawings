...
//#region Imports
import { cbp_mc_BoardHanger, dc_mc_BoardHanger, adc_mc_BoardHanger, ccm_mc_BoardHanger, pc_mc_BoardHanger } from '../internal/modules/mc_BoardHanger'
...
export function mc_BoardHanger_createBuildPlan(this: cbp_mc_BoardHanger): void {
  internal_enterModuleCreateBuildPlan('mc_BoardHanger', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_BoardHanger_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_BoardHanger_afterDataCompletion(this: adc_mc_BoardHanger): void {
  internal_enterModuleAfterDataCompletion('mc_BoardHanger', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_BoardHanger_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_BoardHanger_prepareContext(this: pc_mc_BoardHanger): void {
  internal_enterModulePrepareContext('mc_BoardHanger', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_BoardHanger_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_BoardHanger_calculateContainerModules(this: ccm_mc_BoardHanger): void {
  internal_enterCalculateContainerModules('mc_BoardHanger', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_BoardHanger_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function mc_BoardHanger_manufacturerDataCompletion(this: dc_mc_BoardHanger): void {
  internal_enterModuleManufacturerDataCompletion('mc_BoardHanger', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_BoardHanger_MANUFACTURERDATACOMPLETION
