...
//#region Imports
import { cbp_mc_Handlestrip01, dc_mc_Handlestrip01, adc_mc_Handlestrip01, ccm_mc_Handlestrip01, pc_mc_Handlestrip01 } from '../internal/modules/mc_Handlestrip01'
...
// ---------------------------------------------------------------
export function mc_Handlestrip01_prepareContext(this: pc_mc_Handlestrip01): void {
  internal_enterModulePrepareContext('mc_Handlestrip01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Handlestrip01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Handlestrip01_calculateContainerModules(this: ccm_mc_Handlestrip01): void {
  internal_enterCalculateContainerModules('mc_Handlestrip01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Handlestrip01_CALCULATECONTAINERMODULES
