...
//#region Imports
import { cbp_mc_Hinge01, dc_mc_Hinge01, adc_mc_Hinge01, ccm_mc_Hinge01, pc_mc_Hinge01 } from '../internal/modules/mc_Hinge01'
...
// ---------------------------------------------------------------
export function mc_Hinge01_prepareContext(this: pc_mc_Hinge01): void {
  internal_enterModulePrepareContext('mc_Hinge01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Hinge01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Hinge01_calculateContainerModules(this: ccm_mc_Hinge01): void {
  internal_enterCalculateContainerModules('mc_Hinge01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Hinge01_CALCULATECONTAINERMODULES
