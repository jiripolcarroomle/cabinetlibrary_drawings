...
//#region Imports
import { cbp_mc_StorageunitShelftop03, dc_mc_StorageunitShelftop03, adc_mc_StorageunitShelftop03, ccm_mc_StorageunitShelftop03, pc_mc_StorageunitShelftop03 } from '../internal/modules/mc_StorageunitShelftop03'
...
// ---------------------------------------------------------------
export function mc_StorageunitShelftop03_prepareContext(this: pc_mc_StorageunitShelftop03): void {
  internal_enterModulePrepareContext('mc_StorageunitShelftop03', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_StorageunitShelftop03_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_StorageunitShelftop03_calculateContainerModules(this: ccm_mc_StorageunitShelftop03): void {
  internal_enterCalculateContainerModules('mc_StorageunitShelftop03', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_StorageunitShelftop03_CALCULATECONTAINERMODULES
