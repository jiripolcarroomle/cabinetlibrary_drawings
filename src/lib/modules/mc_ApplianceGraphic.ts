...
//#region Imports
import { cbp_mc_ApplianceGraphic, dc_mc_ApplianceGraphic, adc_mc_ApplianceGraphic, ccm_mc_ApplianceGraphic, pc_mc_ApplianceGraphic } from '../internal/modules/mc_ApplianceGraphic'
...
// ---------------------------------------------------------------
export function mc_ApplianceGraphic_prepareContext(this: pc_mc_ApplianceGraphic): void {
  internal_enterModulePrepareContext('mc_ApplianceGraphic', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_ApplianceGraphic_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_ApplianceGraphic_calculateContainerModules(this: ccm_mc_ApplianceGraphic): void {
  internal_enterCalculateContainerModules('mc_ApplianceGraphic', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_ApplianceGraphic_CALCULATECONTAINERMODULES
