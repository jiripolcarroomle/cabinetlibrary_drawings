...
//#region Imports
import { cbp_mc_ShelffixedGroup01, dc_mc_ShelffixedGroup01, adc_mc_ShelffixedGroup01, ccm_mc_ShelffixedGroup01, pc_mc_ShelffixedGroup01 } from '../internal/modules/mc_ShelffixedGroup01'
...
// ---------------------------------------------------------------
export function mc_ShelffixedGroup01_prepareContext(this: pc_mc_ShelffixedGroup01): void {
  internal_enterModulePrepareContext('mc_ShelffixedGroup01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_ShelffixedGroup01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_ShelffixedGroup01_calculateContainerModules(this: ccm_mc_ShelffixedGroup01): void {
  internal_enterCalculateContainerModules('mc_ShelffixedGroup01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_ShelffixedGroup01_CALCULATECONTAINERMODULES
