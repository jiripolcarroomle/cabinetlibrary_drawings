...
//#region Imports
import { cbp_mc_Leg01, dc_mc_Leg01, adc_mc_Leg01, ccm_mc_Leg01, pc_mc_Leg01 } from '../internal/modules/mc_Leg01'
...
// ---------------------------------------------------------------
export function mc_Leg01_prepareContext(this: pc_mc_Leg01): void {
  internal_enterModulePrepareContext('mc_Leg01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Leg01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Leg01_calculateContainerModules(this: ccm_mc_Leg01): void {
  internal_enterCalculateContainerModules('mc_Leg01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Leg01_CALCULATECONTAINERMODULES
