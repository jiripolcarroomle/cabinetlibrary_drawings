...
//#region Imports
import { cbp_mc_Pullout01, dc_mc_Pullout01, adc_mc_Pullout01, ccm_mc_Pullout01, pc_mc_Pullout01 } from '../internal/modules/mc_Pullout01'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_PulloutHardware01, OD_M_mc_PulloutHardware01 } from '../internal/modules/mc_PulloutHardware01'
...
export function mc_Pullout01_createBuildPlan(this: cbp_mc_Pullout01): void {
  internal_enterModuleCreateBuildPlan('mc_Pullout01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Pullout01_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_Pullout01_afterDataCompletion(this: adc_mc_Pullout01): void {
  internal_enterModuleAfterDataCompletion('mc_Pullout01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Pullout01_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_Pullout01_prepareContext(this: pc_mc_Pullout01): void {
  internal_enterModulePrepareContext('mc_Pullout01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Pullout01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Pullout01_calculateContainerModules(this: ccm_mc_Pullout01): void {
  internal_enterCalculateContainerModules('mc_Pullout01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Pullout01_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function mc_Pullout01_manufacturerDataCompletion(this: dc_mc_Pullout01): void {
  internal_enterModuleManufacturerDataCompletion('mc_Pullout01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Pullout01_MANUFACTURERDATACOMPLETION
