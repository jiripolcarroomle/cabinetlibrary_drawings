...
//#region Imports
import { cbp_mc_Countertop01, dc_mc_Countertop01, adc_mc_Countertop01, ccm_mc_Countertop01, pc_mc_Countertop01 } from '../internal/modules/mc_Countertop01'
...
// ---------------------------------------------------------------
export function mc_Countertop01_prepareContext(this: pc_mc_Countertop01): void {
  internal_enterModulePrepareContext('mc_Countertop01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Countertop01_PREPARECONTEXT
