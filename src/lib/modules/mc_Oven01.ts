...
//#region Imports
import { cbp_mc_Oven01, dc_mc_Oven01, adc_mc_Oven01, ccm_mc_Oven01, pc_mc_Oven01 } from '../internal/modules/mc_Oven01'
...
// ---------------------------------------------------------------
export function mc_Oven01_prepareContext(this: pc_mc_Oven01): void {
  internal_enterModulePrepareContext('mc_Oven01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Oven01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Oven01_calculateContainerModules(this: ccm_mc_Oven01): void {
  internal_enterCalculateContainerModules('mc_Oven01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Oven01_CALCULATECONTAINERMODULES
