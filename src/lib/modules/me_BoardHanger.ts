...
//#region Imports
import { cbp_me_BoardHanger, dc_me_BoardHanger, adc_me_BoardHanger, ccm_me_BoardHanger, pc_me_BoardHanger } from '../internal/modules/me_BoardHanger'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_BoardHanger, OD_M_mc_BoardHanger } from '../internal/modules/mc_BoardHanger'
...
export function me_BoardHanger_createBuildPlan(this: cbp_me_BoardHanger): void {
  internal_enterModuleCreateBuildPlan('me_BoardHanger', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_BoardHanger_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function me_BoardHanger_afterDataCompletion(this: adc_me_BoardHanger): void {
  internal_enterModuleAfterDataCompletion('me_BoardHanger', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_BoardHanger_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function me_BoardHanger_prepareContext(this: pc_me_BoardHanger): void {
  internal_enterModulePrepareContext('me_BoardHanger', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_BoardHanger_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function me_BoardHanger_calculateContainerModules(this: ccm_me_BoardHanger): void {
  internal_enterCalculateContainerModules('me_BoardHanger', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_BoardHanger_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function me_BoardHanger_manufacturerDataCompletion(this: dc_me_BoardHanger): void {
  internal_enterModuleManufacturerDataCompletion('me_BoardHanger', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_me_BoardHanger_MANUFACTURERDATACOMPLETION
