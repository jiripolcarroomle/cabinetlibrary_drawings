...
//#region Imports
import { cbp_mc_Handle01, dc_mc_Handle01, adc_mc_Handle01, ccm_mc_Handle01, pc_mc_Handle01 } from '../internal/modules/mc_Handle01'
...
// ---------------------------------------------------------------
export function mc_Handle01_prepareContext(this: pc_mc_Handle01): void {
  internal_enterModulePrepareContext('mc_Handle01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Handle01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Handle01_calculateContainerModules(this: ccm_mc_Handle01): void {
  internal_enterCalculateContainerModules('mc_Handle01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Handle01_CALCULATECONTAINERMODULES
