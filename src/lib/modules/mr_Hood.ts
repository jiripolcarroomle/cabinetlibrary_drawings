...
//#region Imports
import { cbp_mr_Hood, dc_mr_Hood, adc_mr_Hood, ccm_mr_Hood, pc_mr_Hood } from '../internal/modules/mr_Hood'
...
// ---------------------------------------------------------------
export function mr_Hood_prepareContext(this: pc_mr_Hood): void {
  internal_enterModulePrepareContext('mr_Hood', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_Hood_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mr_Hood_calculateContainerModules(this: ccm_mr_Hood): void {
  internal_enterCalculateContainerModules('mr_Hood', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_Hood_CALCULATECONTAINERMODULES
