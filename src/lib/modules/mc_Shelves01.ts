...
//#region Imports
import { cbp_mc_Shelves01, dc_mc_Shelves01, adc_mc_Shelves01, ccm_mc_Shelves01, pc_mc_Shelves01 } from '../internal/modules/mc_Shelves01'
...
// ---------------------------------------------------------------
export function mc_Shelves01_prepareContext(this: pc_mc_Shelves01): void {
  internal_enterModulePrepareContext('mc_Shelves01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Shelves01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Shelves01_calculateContainerModules(this: ccm_mc_Shelves01): void {
  internal_enterCalculateContainerModules('mc_Shelves01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Shelves01_CALCULATECONTAINERMODULES
