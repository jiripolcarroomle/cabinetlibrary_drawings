...
// ---------------------------------------------------------------
export function mc_FrontPanel01_prepareContext(this: pc_mc_FrontPanel01): void {
  internal_enterModulePrepareContext('mc_FrontPanel01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_FrontPanel01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_FrontPanel01_calculateContainerModules(this: ccm_mc_FrontPanel01): void {
  internal_enterCalculateContainerModules('mc_FrontPanel01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_FrontPanel01_CALCULATECONTAINERMODULES
