...
//#region Imports
import { cbp_mc_CoatBoard, dc_mc_CoatBoard, adc_mc_CoatBoard, ccm_mc_CoatBoard, pc_mc_CoatBoard } from '../internal/modules/mc_CoatBoard'
...
export function mc_CoatBoard_createBuildPlan(this: cbp_mc_CoatBoard): void {
  internal_enterModuleCreateBuildPlan('mc_CoatBoard', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_CoatBoard_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_CoatBoard_afterDataCompletion(this: adc_mc_CoatBoard): void {
  internal_enterModuleAfterDataCompletion('mc_CoatBoard', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_CoatBoard_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_CoatBoard_prepareContext(this: pc_mc_CoatBoard): void {
  internal_enterModulePrepareContext('mc_CoatBoard', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_CoatBoard_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_CoatBoard_calculateContainerModules(this: ccm_mc_CoatBoard): void {
  internal_enterCalculateContainerModules('mc_CoatBoard', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_CoatBoard_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function mc_CoatBoard_manufacturerDataCompletion(this: dc_mc_CoatBoard): void {
  internal_enterModuleManufacturerDataCompletion('mc_CoatBoard', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_CoatBoard_MANUFACTURERDATACOMPLETION
