...
//#region Imports
import { cbp_mf_BoardShelf, dc_mf_BoardShelf, adc_mf_BoardShelf, ccm_mf_BoardShelf, pc_mf_BoardShelf } from '../internal/modules/mf_BoardShelf'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_BoardShelf, OD_M_mc_BoardShelf } from '../internal/modules/mc_BoardShelf'
import { dc_me_BoardHanger, OD_M_me_BoardHanger } from '../internal/modules/me_BoardHanger'
...
export function mf_BoardShelf_createBuildPlan(this: cbp_mf_BoardShelf): void {
  internal_enterModuleCreateBuildPlan('mf_BoardShelf', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_BoardShelf_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mf_BoardShelf_afterDataCompletion(this: adc_mf_BoardShelf): void {
  internal_enterModuleAfterDataCompletion('mf_BoardShelf', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_BoardShelf_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mf_BoardShelf_prepareContext(this: pc_mf_BoardShelf): void {
  internal_enterModulePrepareContext('mf_BoardShelf', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_BoardShelf_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mf_BoardShelf_calculateContainerModules(this: ccm_mf_BoardShelf): void {
  internal_enterCalculateContainerModules('mf_BoardShelf', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_BoardShelf_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function mf_BoardShelf_manufacturerDataCompletion(this: dc_mf_BoardShelf): void {
  internal_enterModuleManufacturerDataCompletion('mf_BoardShelf', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_BoardShelf_MANUFACTURERDATACOMPLETION
