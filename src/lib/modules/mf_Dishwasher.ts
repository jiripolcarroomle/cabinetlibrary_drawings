...
//#region Imports
import { cbp_mf_Dishwasher, dc_mf_Dishwasher, adc_mf_Dishwasher, ccm_mf_Dishwasher, pc_mf_Dishwasher } from '../internal/modules/mf_Dishwasher'
import { GlobalFunc } from '../internal/global-func'
import { dc_mc_Dishwasher01, OD_M_mc_Dishwasher01 } from '../internal/modules/mc_Dishwasher01'
...
// ---------------------------------------------------------------
export function mf_Dishwasher_prepareContext(this: pc_mf_Dishwasher): void {
  internal_enterModulePrepareContext('mf_Dishwasher', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_Dishwasher_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mf_Dishwasher_calculateContainerModules(this: ccm_mf_Dishwasher): void {
  internal_enterCalculateContainerModules('mf_Dishwasher', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mf_Dishwasher_CALCULATECONTAINERMODULES
