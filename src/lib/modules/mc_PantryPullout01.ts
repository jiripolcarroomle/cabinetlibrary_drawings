...
// ---------------------------------------------------------------
export function mc_PantryPullout01_prepareContext(this: pc_mc_PantryPullout01): void {
  internal_enterModulePrepareContext('mc_PantryPullout01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_PantryPullout01_PREPARECONTEXT
