...
//#region Imports
import { cbp_mc_FlipliftHardware01, dc_mc_FlipliftHardware01, adc_mc_FlipliftHardware01, ccm_mc_FlipliftHardware01, pc_mc_FlipliftHardware01 } from '../internal/modules/mc_FlipliftHardware01'
...
export function mc_FlipliftHardware01_createBuildPlan(this: cbp_mc_FlipliftHardware01): void {
  ...
  try {
    ...
    try {
      ...
      bomPart.pa_HardwareId = jsonString;
...
// ---------------------------------------------------------------
export function mc_FlipliftHardware01_prepareContext(this: pc_mc_FlipliftHardware01): void {
  internal_enterModulePrepareContext('mc_FlipliftHardware01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_FlipliftHardware01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_FlipliftHardware01_calculateContainerModules(this: ccm_mc_FlipliftHardware01): void {
  internal_enterCalculateContainerModules('mc_FlipliftHardware01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_FlipliftHardware01_CALCULATECONTAINERMODULES
