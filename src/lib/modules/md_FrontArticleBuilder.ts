...
//#region Imports
import { cbp_md_FrontArticleBuilder, dc_md_FrontArticleBuilder, adc_md_FrontArticleBuilder, ccm_md_FrontArticleBuilder, pc_md_FrontArticleBuilder } from '../internal/modules/md_FrontArticleBuilder'
...
export function md_FrontArticleBuilder_createBuildPlan(this: cbp_md_FrontArticleBuilder): void {
  internal_enterModuleCreateBuildPlan('md_FrontArticleBuilder', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_md_FrontArticleBuilder_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function md_FrontArticleBuilder_afterDataCompletion(this: adc_md_FrontArticleBuilder): void {
  internal_enterModuleAfterDataCompletion('md_FrontArticleBuilder', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_md_FrontArticleBuilder_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function md_FrontArticleBuilder_prepareContext(this: pc_md_FrontArticleBuilder): void {
  internal_enterModulePrepareContext('md_FrontArticleBuilder', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_md_FrontArticleBuilder_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function md_FrontArticleBuilder_calculateContainerModules(this: ccm_md_FrontArticleBuilder): void {
  internal_enterCalculateContainerModules('md_FrontArticleBuilder', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_md_FrontArticleBuilder_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function md_FrontArticleBuilder_manufacturerDataCompletion(this: dc_md_FrontArticleBuilder): void {
  internal_enterModuleManufacturerDataCompletion('md_FrontArticleBuilder', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_md_FrontArticleBuilder_MANUFACTURERDATACOMPLETION
