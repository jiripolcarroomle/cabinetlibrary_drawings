...
//#region Imports
import { cbp_mc_Cornerunit01, dc_mc_Cornerunit01, adc_mc_Cornerunit01, ccm_mc_Cornerunit01, pc_mc_Cornerunit01 } from '../internal/modules/mc_Cornerunit01'
...
// ---------------------------------------------------------------
export function mc_Cornerunit01_prepareContext(this: pc_mc_Cornerunit01): void {
	internal_enterModulePrepareContext('mc_Cornerunit01', this._id);
	try {
		// ###############################################################
		// ####################### CUSTOM SCRIPTS ########################
		// ###############################################################
		// CUSTOMSCRIPT_mc_Cornerunit01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Cornerunit01_calculateContainerModules(this: ccm_mc_Cornerunit01): void {
	internal_enterCalculateContainerModules('mc_Cornerunit01', this._id);
	try {
		// ###############################################################
		// ####################### CUSTOM SCRIPTS ########################
		// ###############################################################
		// CUSTOMSCRIPT_mc_Cornerunit01_CALCULATECONTAINERMODULES
