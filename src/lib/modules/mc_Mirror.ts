...
//#region Imports
import { cbp_mc_Mirror, dc_mc_Mirror, adc_mc_Mirror, ccm_mc_Mirror, pc_mc_Mirror } from '../internal/modules/mc_Mirror'
...
export function mc_Mirror_createBuildPlan(this: cbp_mc_Mirror): void {
  internal_enterModuleCreateBuildPlan('mc_Mirror', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Mirror_CREATEBUILDPLAN
...
// ---------------------------------------------------------------
export function mc_Mirror_afterDataCompletion(this: adc_mc_Mirror): void {
  internal_enterModuleAfterDataCompletion('mc_Mirror', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Mirror_AFTERDATACOMPLETION
...
// ---------------------------------------------------------------
export function mc_Mirror_prepareContext(this: pc_mc_Mirror): void {
  internal_enterModulePrepareContext('mc_Mirror', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Mirror_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Mirror_calculateContainerModules(this: ccm_mc_Mirror): void {
  internal_enterCalculateContainerModules('mc_Mirror', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Mirror_CALCULATECONTAINERMODULES
...
// ---------------------------------------------------------------
export function mc_Mirror_manufacturerDataCompletion(this: dc_mc_Mirror): void {
  internal_enterModuleManufacturerDataCompletion('mc_Mirror', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Mirror_MANUFACTURERDATACOMPLETION
