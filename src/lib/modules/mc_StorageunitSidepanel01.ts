...
//#region Imports
import { cbp_mc_StorageunitSidepanel01, dc_mc_StorageunitSidepanel01, adc_mc_StorageunitSidepanel01, ccm_mc_StorageunitSidepanel01, pc_mc_StorageunitSidepanel01 } from '../internal/modules/mc_StorageunitSidepanel01'
...
// ---------------------------------------------------------------
export function mc_StorageunitSidepanel01_prepareContext(this: pc_mc_StorageunitSidepanel01): void {
  internal_enterModulePrepareContext('mc_StorageunitSidepanel01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_StorageunitSidepanel01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_StorageunitSidepanel01_calculateContainerModules(this: ccm_mc_StorageunitSidepanel01): void {
  internal_enterCalculateContainerModules('mc_StorageunitSidepanel01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_StorageunitSidepanel01_CALCULATECONTAINERMODULES
