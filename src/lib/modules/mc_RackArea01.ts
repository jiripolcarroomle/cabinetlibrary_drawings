...
//#region Imports
import { cbp_mc_RackArea01, dc_mc_RackArea01, adc_mc_RackArea01, ccm_mc_RackArea01, pc_mc_RackArea01 } from '../internal/modules/mc_RackArea01'
...
// ---------------------------------------------------------------
export function mc_RackArea01_prepareContext(this: pc_mc_RackArea01): void {
  internal_enterModulePrepareContext('mc_RackArea01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_RackArea01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_RackArea01_calculateContainerModules(this: ccm_mc_RackArea01): void {
  internal_enterCalculateContainerModules('mc_RackArea01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_RackArea01_CALCULATECONTAINERMODULES
