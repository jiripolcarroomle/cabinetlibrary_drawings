...
//#region Imports
import { cbp_mc_HangerSystem01, dc_mc_HangerSystem01, adc_mc_HangerSystem01, ccm_mc_HangerSystem01, pc_mc_HangerSystem01 } from '../internal/modules/mc_HangerSystem01'
...
// ---------------------------------------------------------------
export function mc_HangerSystem01_prepareContext(this: pc_mc_HangerSystem01): void {
  internal_enterModulePrepareContext('mc_HangerSystem01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_HangerSystem01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_HangerSystem01_calculateContainerModules(this: ccm_mc_HangerSystem01): void {
  internal_enterCalculateContainerModules('mc_HangerSystem01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_HangerSystem01_CALCULATECONTAINERMODULES
