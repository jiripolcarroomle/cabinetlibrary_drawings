...
//#region Imports
import { cbp_mf_Door, dc_mf_Door, adc_mf_Door, ccm_mf_Door, pc_mf_Door } from '../internal/modules/mf_Door'
...
import { dc_me_HoodInsert, OD_M_me_HoodInsert } from '../internal/modules/me_HoodInsert'
import { dc_md_EquipmentPlaceholder, OD_M_md_EquipmentPlaceholder } from '../internal/modules/md_EquipmentPlaceholder'
...
// ---------------------------------------------------------------
export function mf_Door_prepareContext(this: pc_mf_Door): void {
	internal_enterModulePrepareContext('mf_Door', this._id);
	try {
		// ###############################################################
		// ####################### CUSTOM SCRIPTS ########################
		// ###############################################################
		// CUSTOMSCRIPT_mf_Door_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mf_Door_calculateContainerModules(this: ccm_mf_Door): void {
	internal_enterCalculateContainerModules('mf_Door', this._id);
	try {
		// ###############################################################
		// ####################### CUSTOM SCRIPTS ########################
		// ###############################################################
		// CUSTOMSCRIPT_mf_Door_CALCULATECONTAINERMODULES
