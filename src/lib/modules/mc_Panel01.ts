...
//#region Imports
import { cbp_mc_Panel01, dc_mc_Panel01, adc_mc_Panel01, ccm_mc_Panel01, pc_mc_Panel01 } from '../internal/modules/mc_Panel01'
...
// ---------------------------------------------------------------
export function mc_Panel01_prepareContext(this: pc_mc_Panel01): void {
  internal_enterModulePrepareContext('mc_Panel01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Panel01_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mc_Panel01_calculateContainerModules(this: ccm_mc_Panel01): void {
  internal_enterCalculateContainerModules('mc_Panel01', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mc_Panel01_CALCULATECONTAINERMODULES
