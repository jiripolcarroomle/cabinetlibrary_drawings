...
//#region Imports
import { cbp_mr_IslandBackwall, dc_mr_IslandBackwall, adc_mr_IslandBackwall, ccm_mr_IslandBackwall, pc_mr_IslandBackwall } from '../internal/modules/mr_IslandBackwall'
...
// ---------------------------------------------------------------
export function mr_IslandBackwall_prepareContext(this: pc_mr_IslandBackwall): void {
  internal_enterModulePrepareContext('mr_IslandBackwall', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_IslandBackwall_PREPARECONTEXT
...
// ---------------------------------------------------------------
export function mr_IslandBackwall_calculateContainerModules(this: ccm_mr_IslandBackwall): void {
  internal_enterCalculateContainerModules('mr_IslandBackwall', this._id);
  try {
    // ###############################################################
    // ####################### CUSTOM SCRIPTS ########################
    // ###############################################################
    // CUSTOMSCRIPT_mr_IslandBackwall_CALCULATECONTAINERMODULES
